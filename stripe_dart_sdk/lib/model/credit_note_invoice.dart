...
class CreditNoteInvoice {
  /// Returns a new [CreditNoteInvoice] instance.
  CreditNoteInvoice({
    this.accountCountry,
    this.accountName,
  ...
  CreditNoteInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  CreditNoteInvoiceCollectionMethodEnum collectionMethod;
  ...
  CreditNoteInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  CreditNoteInvoiceObjectEnum object;
  ...
  CreditNoteInvoiceStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreditNoteInvoice &&
  ...
  /// Returns a new [CreditNoteInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreditNoteInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreditNoteInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreditNoteInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CreditNoteInvoice(
        ...
        billingReason: CreditNoteInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: CreditNoteInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: CreditNoteInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: CreditNoteInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: CreditNoteInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<CreditNoteInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreditNoteInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreditNoteInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreditNoteInvoice> mapFromJson(dynamic json) {
    final map = <String, CreditNoteInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreditNoteInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreditNoteInvoice-objects as value to a dart map
  static Map<String, List<CreditNoteInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreditNoteInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreditNoteInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class CreditNoteInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const CreditNoteInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = CreditNoteInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = CreditNoteInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = CreditNoteInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = CreditNoteInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = CreditNoteInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = CreditNoteInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = CreditNoteInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = CreditNoteInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = CreditNoteInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][CreditNoteInvoiceBillingReasonEnum].
  static const values = <CreditNoteInvoiceBillingReasonEnum>[
  ...
  static CreditNoteInvoiceBillingReasonEnum? fromJson(dynamic value) => CreditNoteInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<CreditNoteInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreditNoteInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreditNoteInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CreditNoteInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [CreditNoteInvoiceBillingReasonEnum].
class CreditNoteInvoiceBillingReasonEnumTypeTransformer {
  factory CreditNoteInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const CreditNoteInvoiceBillingReasonEnumTypeTransformer._();

  const CreditNoteInvoiceBillingReasonEnumTypeTransformer._();

  String encode(CreditNoteInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CreditNoteInvoiceBillingReasonEnum.
  ///
  ...
  CreditNoteInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return CreditNoteInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return CreditNoteInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return CreditNoteInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return CreditNoteInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return CreditNoteInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return CreditNoteInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return CreditNoteInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return CreditNoteInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return CreditNoteInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [CreditNoteInvoiceBillingReasonEnumTypeTransformer] instance.
  static CreditNoteInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class CreditNoteInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const CreditNoteInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = CreditNoteInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = CreditNoteInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][CreditNoteInvoiceCollectionMethodEnum].
  static const values = <CreditNoteInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static CreditNoteInvoiceCollectionMethodEnum? fromJson(dynamic value) => CreditNoteInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<CreditNoteInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreditNoteInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreditNoteInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CreditNoteInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [CreditNoteInvoiceCollectionMethodEnum].
class CreditNoteInvoiceCollectionMethodEnumTypeTransformer {
  factory CreditNoteInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const CreditNoteInvoiceCollectionMethodEnumTypeTransformer._();

  const CreditNoteInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(CreditNoteInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CreditNoteInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CreditNoteInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return CreditNoteInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return CreditNoteInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CreditNoteInvoiceCollectionMethodEnumTypeTransformer] instance.
  static CreditNoteInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class CreditNoteInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const CreditNoteInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = CreditNoteInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = CreditNoteInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = CreditNoteInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][CreditNoteInvoiceCustomerTaxExemptEnum].
  static const values = <CreditNoteInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static CreditNoteInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => CreditNoteInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<CreditNoteInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreditNoteInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreditNoteInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CreditNoteInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [CreditNoteInvoiceCustomerTaxExemptEnum].
class CreditNoteInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory CreditNoteInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const CreditNoteInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const CreditNoteInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(CreditNoteInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CreditNoteInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CreditNoteInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return CreditNoteInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return CreditNoteInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return CreditNoteInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CreditNoteInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static CreditNoteInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class CreditNoteInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const CreditNoteInvoiceObjectEnum._(this.value);
  ...
  static const invoice = CreditNoteInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][CreditNoteInvoiceObjectEnum].
  static const values = <CreditNoteInvoiceObjectEnum>[
    invoice,
  ];

  static CreditNoteInvoiceObjectEnum? fromJson(dynamic value) => CreditNoteInvoiceObjectEnumTypeTransformer().decode(value);

  static List<CreditNoteInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreditNoteInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreditNoteInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CreditNoteInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [CreditNoteInvoiceObjectEnum].
class CreditNoteInvoiceObjectEnumTypeTransformer {
  factory CreditNoteInvoiceObjectEnumTypeTransformer() => _instance ??= const CreditNoteInvoiceObjectEnumTypeTransformer._();

  const CreditNoteInvoiceObjectEnumTypeTransformer._();

  String encode(CreditNoteInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CreditNoteInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CreditNoteInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return CreditNoteInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CreditNoteInvoiceObjectEnumTypeTransformer] instance.
  static CreditNoteInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class CreditNoteInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const CreditNoteInvoiceStatusEnum._(this.value);
  ...
  static const draft = CreditNoteInvoiceStatusEnum._(r'draft');
  static const open = CreditNoteInvoiceStatusEnum._(r'open');
  static const paid = CreditNoteInvoiceStatusEnum._(r'paid');
  static const uncollectible = CreditNoteInvoiceStatusEnum._(r'uncollectible');
  static const void_ = CreditNoteInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][CreditNoteInvoiceStatusEnum].
  static const values = <CreditNoteInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static CreditNoteInvoiceStatusEnum? fromJson(dynamic value) => CreditNoteInvoiceStatusEnumTypeTransformer().decode(value);

  static List<CreditNoteInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreditNoteInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreditNoteInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CreditNoteInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [CreditNoteInvoiceStatusEnum].
class CreditNoteInvoiceStatusEnumTypeTransformer {
  factory CreditNoteInvoiceStatusEnumTypeTransformer() => _instance ??= const CreditNoteInvoiceStatusEnumTypeTransformer._();

  const CreditNoteInvoiceStatusEnumTypeTransformer._();

  String encode(CreditNoteInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CreditNoteInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CreditNoteInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return CreditNoteInvoiceStatusEnum.draft;
        case r'open': return CreditNoteInvoiceStatusEnum.open;
        case r'paid': return CreditNoteInvoiceStatusEnum.paid;
        case r'uncollectible': return CreditNoteInvoiceStatusEnum.uncollectible;
        case r'void': return CreditNoteInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CreditNoteInvoiceStatusEnumTypeTransformer] instance.
  static CreditNoteInvoiceStatusEnumTypeTransformer? _instance;
}
