...
class ChargeCustomer {
  /// Returns a new [ChargeCustomer] instance.
  ChargeCustomer({
    this.address,
    this.balance,
    this.cashBalance,
  ...
  ChargeCustomerObjectEnum object;
  ...
  ChargeCustomerTaxExemptEnum? taxExempt;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChargeCustomer &&
  ...
  /// Returns a new [ChargeCustomer] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ChargeCustomer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ChargeCustomer[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ChargeCustomer[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ChargeCustomer(
        ...
        object: ChargeCustomerObjectEnum.fromJson(json[r'object'])!,
        ...
        taxExempt: ChargeCustomerTaxExemptEnum.fromJson(json[r'tax_exempt']),
  ...
  static List<ChargeCustomer> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChargeCustomer>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChargeCustomer.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ChargeCustomer> mapFromJson(dynamic json) {
    final map = <String, ChargeCustomer>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChargeCustomer.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ChargeCustomer-objects as value to a dart map
  static Map<String, List<ChargeCustomer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ChargeCustomer>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ChargeCustomer.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class ChargeCustomerObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const ChargeCustomerObjectEnum._(this.value);
  ...
  static const customer = ChargeCustomerObjectEnum._(r'customer');

  /// List of all possible values in this [enum][ChargeCustomerObjectEnum].
  static const values = <ChargeCustomerObjectEnum>[
    customer,
  ];

  static ChargeCustomerObjectEnum? fromJson(dynamic value) => ChargeCustomerObjectEnumTypeTransformer().decode(value);

  static List<ChargeCustomerObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChargeCustomerObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChargeCustomerObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ChargeCustomerObjectEnum] to String,
/// and [decode] dynamic data back to [ChargeCustomerObjectEnum].
class ChargeCustomerObjectEnumTypeTransformer {
  factory ChargeCustomerObjectEnumTypeTransformer() => _instance ??= const ChargeCustomerObjectEnumTypeTransformer._();

  const ChargeCustomerObjectEnumTypeTransformer._();

  String encode(ChargeCustomerObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ChargeCustomerObjectEnum.
  ///
  ...
  ChargeCustomerObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'customer': return ChargeCustomerObjectEnum.customer;
        default:
          if (!allowNull) {
  ...
  /// Singleton [ChargeCustomerObjectEnumTypeTransformer] instance.
  static ChargeCustomerObjectEnumTypeTransformer? _instance;
}


/// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
class ChargeCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const ChargeCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = ChargeCustomerTaxExemptEnum._(r'exempt');
  static const none = ChargeCustomerTaxExemptEnum._(r'none');
  static const reverse = ChargeCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][ChargeCustomerTaxExemptEnum].
  static const values = <ChargeCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static ChargeCustomerTaxExemptEnum? fromJson(dynamic value) => ChargeCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<ChargeCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChargeCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChargeCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ChargeCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [ChargeCustomerTaxExemptEnum].
class ChargeCustomerTaxExemptEnumTypeTransformer {
  factory ChargeCustomerTaxExemptEnumTypeTransformer() => _instance ??= const ChargeCustomerTaxExemptEnumTypeTransformer._();

  const ChargeCustomerTaxExemptEnumTypeTransformer._();

  String encode(ChargeCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ChargeCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ChargeCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return ChargeCustomerTaxExemptEnum.exempt;
        case r'none': return ChargeCustomerTaxExemptEnum.none;
        case r'reverse': return ChargeCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ChargeCustomerTaxExemptEnumTypeTransformer] instance.
  static ChargeCustomerTaxExemptEnumTypeTransformer? _instance;
}
