...
class InvoiceitemInvoice {
  /// Returns a new [InvoiceitemInvoice] instance.
  InvoiceitemInvoice({
    this.accountCountry,
    this.accountName,
  ...
  InvoiceitemInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  InvoiceitemInvoiceCollectionMethodEnum collectionMethod;
  ...
  InvoiceitemInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  InvoiceitemInvoiceObjectEnum object;
  ...
  InvoiceitemInvoiceStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoiceitemInvoice &&
  ...
  /// Returns a new [InvoiceitemInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoiceitemInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoiceitemInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoiceitemInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InvoiceitemInvoice(
        ...
        billingReason: InvoiceitemInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: InvoiceitemInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: InvoiceitemInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: InvoiceitemInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: InvoiceitemInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<InvoiceitemInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceitemInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceitemInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoiceitemInvoice> mapFromJson(dynamic json) {
    final map = <String, InvoiceitemInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoiceitemInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoiceitemInvoice-objects as value to a dart map
  static Map<String, List<InvoiceitemInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoiceitemInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoiceitemInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class InvoiceitemInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceitemInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = InvoiceitemInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = InvoiceitemInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = InvoiceitemInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = InvoiceitemInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = InvoiceitemInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = InvoiceitemInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = InvoiceitemInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = InvoiceitemInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = InvoiceitemInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][InvoiceitemInvoiceBillingReasonEnum].
  static const values = <InvoiceitemInvoiceBillingReasonEnum>[
  ...
  static InvoiceitemInvoiceBillingReasonEnum? fromJson(dynamic value) => InvoiceitemInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<InvoiceitemInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceitemInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceitemInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceitemInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [InvoiceitemInvoiceBillingReasonEnum].
class InvoiceitemInvoiceBillingReasonEnumTypeTransformer {
  factory InvoiceitemInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const InvoiceitemInvoiceBillingReasonEnumTypeTransformer._();

  const InvoiceitemInvoiceBillingReasonEnumTypeTransformer._();

  String encode(InvoiceitemInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceitemInvoiceBillingReasonEnum.
  ///
  ...
  InvoiceitemInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return InvoiceitemInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return InvoiceitemInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return InvoiceitemInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return InvoiceitemInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return InvoiceitemInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return InvoiceitemInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return InvoiceitemInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return InvoiceitemInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return InvoiceitemInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [InvoiceitemInvoiceBillingReasonEnumTypeTransformer] instance.
  static InvoiceitemInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class InvoiceitemInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceitemInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = InvoiceitemInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = InvoiceitemInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][InvoiceitemInvoiceCollectionMethodEnum].
  static const values = <InvoiceitemInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static InvoiceitemInvoiceCollectionMethodEnum? fromJson(dynamic value) => InvoiceitemInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<InvoiceitemInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceitemInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceitemInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceitemInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [InvoiceitemInvoiceCollectionMethodEnum].
class InvoiceitemInvoiceCollectionMethodEnumTypeTransformer {
  factory InvoiceitemInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const InvoiceitemInvoiceCollectionMethodEnumTypeTransformer._();

  const InvoiceitemInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(InvoiceitemInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceitemInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceitemInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return InvoiceitemInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return InvoiceitemInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceitemInvoiceCollectionMethodEnumTypeTransformer] instance.
  static InvoiceitemInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class InvoiceitemInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceitemInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = InvoiceitemInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = InvoiceitemInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = InvoiceitemInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][InvoiceitemInvoiceCustomerTaxExemptEnum].
  static const values = <InvoiceitemInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static InvoiceitemInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => InvoiceitemInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<InvoiceitemInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceitemInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceitemInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceitemInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [InvoiceitemInvoiceCustomerTaxExemptEnum].
class InvoiceitemInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory InvoiceitemInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const InvoiceitemInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const InvoiceitemInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(InvoiceitemInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceitemInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceitemInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return InvoiceitemInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return InvoiceitemInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return InvoiceitemInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceitemInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static InvoiceitemInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class InvoiceitemInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceitemInvoiceObjectEnum._(this.value);
  ...
  static const invoice = InvoiceitemInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][InvoiceitemInvoiceObjectEnum].
  static const values = <InvoiceitemInvoiceObjectEnum>[
    invoice,
  ];

  static InvoiceitemInvoiceObjectEnum? fromJson(dynamic value) => InvoiceitemInvoiceObjectEnumTypeTransformer().decode(value);

  static List<InvoiceitemInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceitemInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceitemInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceitemInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [InvoiceitemInvoiceObjectEnum].
class InvoiceitemInvoiceObjectEnumTypeTransformer {
  factory InvoiceitemInvoiceObjectEnumTypeTransformer() => _instance ??= const InvoiceitemInvoiceObjectEnumTypeTransformer._();

  const InvoiceitemInvoiceObjectEnumTypeTransformer._();

  String encode(InvoiceitemInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceitemInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceitemInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return InvoiceitemInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceitemInvoiceObjectEnumTypeTransformer] instance.
  static InvoiceitemInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class InvoiceitemInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceitemInvoiceStatusEnum._(this.value);
  ...
  static const draft = InvoiceitemInvoiceStatusEnum._(r'draft');
  static const open = InvoiceitemInvoiceStatusEnum._(r'open');
  static const paid = InvoiceitemInvoiceStatusEnum._(r'paid');
  static const uncollectible = InvoiceitemInvoiceStatusEnum._(r'uncollectible');
  static const void_ = InvoiceitemInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][InvoiceitemInvoiceStatusEnum].
  static const values = <InvoiceitemInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static InvoiceitemInvoiceStatusEnum? fromJson(dynamic value) => InvoiceitemInvoiceStatusEnumTypeTransformer().decode(value);

  static List<InvoiceitemInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceitemInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceitemInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceitemInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [InvoiceitemInvoiceStatusEnum].
class InvoiceitemInvoiceStatusEnumTypeTransformer {
  factory InvoiceitemInvoiceStatusEnumTypeTransformer() => _instance ??= const InvoiceitemInvoiceStatusEnumTypeTransformer._();

  const InvoiceitemInvoiceStatusEnumTypeTransformer._();

  String encode(InvoiceitemInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceitemInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceitemInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return InvoiceitemInvoiceStatusEnum.draft;
        case r'open': return InvoiceitemInvoiceStatusEnum.open;
        case r'paid': return InvoiceitemInvoiceStatusEnum.paid;
        case r'uncollectible': return InvoiceitemInvoiceStatusEnum.uncollectible;
        case r'void': return InvoiceitemInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceitemInvoiceStatusEnumTypeTransformer] instance.
  static InvoiceitemInvoiceStatusEnumTypeTransformer? _instance;
}
