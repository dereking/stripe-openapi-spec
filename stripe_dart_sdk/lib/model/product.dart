  ...
  static Product? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Product(
        ...
        object: ProductObjectEnum.fromJson(json[r'object'])!,
...
/// String representing the object's type. Objects of the same type share the same value.
class ProductObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const ProductObjectEnum._(this.value);
  ...
  static const product = ProductObjectEnum._(r'product');

  /// List of all possible values in this [enum][ProductObjectEnum].
  static const values = <ProductObjectEnum>[
    product,
  ];

  static ProductObjectEnum? fromJson(dynamic value) => ProductObjectEnumTypeTransformer().decode(value);

  static List<ProductObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProductObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProductObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ProductObjectEnum] to String,
/// and [decode] dynamic data back to [ProductObjectEnum].
class ProductObjectEnumTypeTransformer {
  factory ProductObjectEnumTypeTransformer() => _instance ??= const ProductObjectEnumTypeTransformer._();

  const ProductObjectEnumTypeTransformer._();

  String encode(ProductObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ProductObjectEnum.
  ///
  ...
  ProductObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'product': return ProductObjectEnum.product;
        default:
          if (!allowNull) {
  ...
  /// Singleton [ProductObjectEnumTypeTransformer] instance.
  static ProductObjectEnumTypeTransformer? _instance;
}
