...
class InvoiceCustomer {
  /// Returns a new [InvoiceCustomer] instance.
  InvoiceCustomer({
    this.address,
    this.balance,
    this.cashBalance,
  ...
  InvoiceCustomerObjectEnum object;
  ...
  InvoiceCustomerTaxExemptEnum? taxExempt;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoiceCustomer &&
  ...
  /// Returns a new [InvoiceCustomer] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoiceCustomer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoiceCustomer[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoiceCustomer[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InvoiceCustomer(
        ...
        object: InvoiceCustomerObjectEnum.fromJson(json[r'object'])!,
        ...
        taxExempt: InvoiceCustomerTaxExemptEnum.fromJson(json[r'tax_exempt']),
  ...
  static List<InvoiceCustomer> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceCustomer>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceCustomer.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoiceCustomer> mapFromJson(dynamic json) {
    final map = <String, InvoiceCustomer>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoiceCustomer.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoiceCustomer-objects as value to a dart map
  static Map<String, List<InvoiceCustomer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoiceCustomer>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoiceCustomer.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class InvoiceCustomerObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceCustomerObjectEnum._(this.value);
  ...
  static const customer = InvoiceCustomerObjectEnum._(r'customer');

  /// List of all possible values in this [enum][InvoiceCustomerObjectEnum].
  static const values = <InvoiceCustomerObjectEnum>[
    customer,
  ];

  static InvoiceCustomerObjectEnum? fromJson(dynamic value) => InvoiceCustomerObjectEnumTypeTransformer().decode(value);

  static List<InvoiceCustomerObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceCustomerObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceCustomerObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceCustomerObjectEnum] to String,
/// and [decode] dynamic data back to [InvoiceCustomerObjectEnum].
class InvoiceCustomerObjectEnumTypeTransformer {
  factory InvoiceCustomerObjectEnumTypeTransformer() => _instance ??= const InvoiceCustomerObjectEnumTypeTransformer._();

  const InvoiceCustomerObjectEnumTypeTransformer._();

  String encode(InvoiceCustomerObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceCustomerObjectEnum.
  ///
  ...
  InvoiceCustomerObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'customer': return InvoiceCustomerObjectEnum.customer;
        default:
          if (!allowNull) {
  ...
  /// Singleton [InvoiceCustomerObjectEnumTypeTransformer] instance.
  static InvoiceCustomerObjectEnumTypeTransformer? _instance;
}
