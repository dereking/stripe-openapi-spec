...
class SetupIntent {
  ...
  SetupIntentCancellationReasonEnum? cancellationReason;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SetupIntent &&
  ...
  /// Returns a new [SetupIntent] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SetupIntent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SetupIntent[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SetupIntent[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SetupIntent(
        ...
        cancellationReason: SetupIntentCancellationReasonEnum.fromJson(json[r'cancellation_reason']),
        ...
        object: SetupIntentObjectEnum.fromJson(json[r'object'])!,
        ...
        status: SetupIntentStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<SetupIntent> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SetupIntent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SetupIntent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SetupIntent> mapFromJson(dynamic json) {
    final map = <String, SetupIntent>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SetupIntent.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SetupIntent-objects as value to a dart map
  static Map<String, List<SetupIntent>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SetupIntent>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SetupIntent.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Reason for cancellation of this SetupIntent, one of `abandoned`, `requested_by_customer`, or `duplicate`.
class SetupIntentCancellationReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const SetupIntentCancellationReasonEnum._(this.value);
  ...
  static const abandoned = SetupIntentCancellationReasonEnum._(r'abandoned');
  static const duplicate = SetupIntentCancellationReasonEnum._(r'duplicate');
  static const requestedByCustomer = SetupIntentCancellationReasonEnum._(r'requested_by_customer');

  /// List of all possible values in this [enum][SetupIntentCancellationReasonEnum].
  static const values = <SetupIntentCancellationReasonEnum>[
    abandoned,
    duplicate,
    requestedByCustomer,
  ];

  static SetupIntentCancellationReasonEnum? fromJson(dynamic value) => SetupIntentCancellationReasonEnumTypeTransformer().decode(value);

  static List<SetupIntentCancellationReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SetupIntentCancellationReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SetupIntentCancellationReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SetupIntentCancellationReasonEnum] to String,
/// and [decode] dynamic data back to [SetupIntentCancellationReasonEnum].
class SetupIntentCancellationReasonEnumTypeTransformer {
  factory SetupIntentCancellationReasonEnumTypeTransformer() => _instance ??= const SetupIntentCancellationReasonEnumTypeTransformer._();

  const SetupIntentCancellationReasonEnumTypeTransformer._();

  String encode(SetupIntentCancellationReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SetupIntentCancellationReasonEnum.
  ///
  ...
  SetupIntentCancellationReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'abandoned': return SetupIntentCancellationReasonEnum.abandoned;
        case r'duplicate': return SetupIntentCancellationReasonEnum.duplicate;
        case r'requested_by_customer': return SetupIntentCancellationReasonEnum.requestedByCustomer;
        default:
          if (!allowNull) {
  ...
  /// Singleton [SetupIntentCancellationReasonEnumTypeTransformer] instance.
  static SetupIntentCancellationReasonEnumTypeTransformer? _instance;
}
...
/// String representing the object's type. Objects of the same type share the same value.
class SetupIntentObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const SetupIntentObjectEnum._(this.value);
  ...
  static const setupIntent = SetupIntentObjectEnum._(r'setup_intent');

  /// List of all possible values in this [enum][SetupIntentObjectEnum].
  static const values = <SetupIntentObjectEnum>[
    setupIntent,
  ];

  static SetupIntentObjectEnum? fromJson(dynamic value) => SetupIntentObjectEnumTypeTransformer().decode(value);

  static List<SetupIntentObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SetupIntentObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SetupIntentObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SetupIntentObjectEnum] to String,
/// and [decode] dynamic data back to [SetupIntentObjectEnum].
class SetupIntentObjectEnumTypeTransformer {
  factory SetupIntentObjectEnumTypeTransformer() => _instance ??= const SetupIntentObjectEnumTypeTransformer._();

  const SetupIntentObjectEnumTypeTransformer._();

  String encode(SetupIntentObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SetupIntentObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SetupIntentObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'setup_intent': return SetupIntentObjectEnum.setupIntent;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SetupIntentObjectEnumTypeTransformer] instance.
  static SetupIntentObjectEnumTypeTransformer? _instance;
}


/// [Status](https://stripe.com/docs/payments/intents#intent-statuses) of this SetupIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `canceled`, or `succeeded`.
class SetupIntentStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const SetupIntentStatusEnum._(this.value);
  ...
  static const canceled = SetupIntentStatusEnum._(r'canceled');
  static const processing = SetupIntentStatusEnum._(r'processing');
  static const requiresAction = SetupIntentStatusEnum._(r'requires_action');
  static const requiresConfirmation = SetupIntentStatusEnum._(r'requires_confirmation');
  static const requiresPaymentMethod = SetupIntentStatusEnum._(r'requires_payment_method');
  static const succeeded = SetupIntentStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][SetupIntentStatusEnum].
  static const values = <SetupIntentStatusEnum>[
    canceled,
    processing,
    requiresAction,
  ...
  static SetupIntentStatusEnum? fromJson(dynamic value) => SetupIntentStatusEnumTypeTransformer().decode(value);

  static List<SetupIntentStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SetupIntentStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SetupIntentStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SetupIntentStatusEnum] to String,
/// and [decode] dynamic data back to [SetupIntentStatusEnum].
class SetupIntentStatusEnumTypeTransformer {
  factory SetupIntentStatusEnumTypeTransformer() => _instance ??= const SetupIntentStatusEnumTypeTransformer._();

  const SetupIntentStatusEnumTypeTransformer._();

  String encode(SetupIntentStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SetupIntentStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SetupIntentStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'canceled': return SetupIntentStatusEnum.canceled;
        case r'processing': return SetupIntentStatusEnum.processing;
        case r'requires_action': return SetupIntentStatusEnum.requiresAction;
        case r'requires_confirmation': return SetupIntentStatusEnum.requiresConfirmation;
        case r'requires_payment_method': return SetupIntentStatusEnum.requiresPaymentMethod;
        case r'succeeded': return SetupIntentStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SetupIntentStatusEnumTypeTransformer] instance.
  static SetupIntentStatusEnumTypeTransformer? _instance;
}
