...
class SepaDebitGeneratedFromCharge {
  /// Returns a new [SepaDebitGeneratedFromCharge] instance.
  ...
  SepaDebitGeneratedFromChargeObjectEnum object;
  ...
  SepaDebitGeneratedFromChargeStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SepaDebitGeneratedFromCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [SepaDebitGeneratedFromCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SepaDebitGeneratedFromCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SepaDebitGeneratedFromCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SepaDebitGeneratedFromCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SepaDebitGeneratedFromCharge(
        ...
        object: SepaDebitGeneratedFromChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: SepaDebitGeneratedFromChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<SepaDebitGeneratedFromCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SepaDebitGeneratedFromCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SepaDebitGeneratedFromCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SepaDebitGeneratedFromCharge> mapFromJson(dynamic json) {
    final map = <String, SepaDebitGeneratedFromCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SepaDebitGeneratedFromCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SepaDebitGeneratedFromCharge-objects as value to a dart map
  static Map<String, List<SepaDebitGeneratedFromCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SepaDebitGeneratedFromCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SepaDebitGeneratedFromCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class SepaDebitGeneratedFromChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const SepaDebitGeneratedFromChargeObjectEnum._(this.value);
  ...
  static const charge = SepaDebitGeneratedFromChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][SepaDebitGeneratedFromChargeObjectEnum].
  static const values = <SepaDebitGeneratedFromChargeObjectEnum>[
    charge,
  ];

  static SepaDebitGeneratedFromChargeObjectEnum? fromJson(dynamic value) => SepaDebitGeneratedFromChargeObjectEnumTypeTransformer().decode(value);

  static List<SepaDebitGeneratedFromChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SepaDebitGeneratedFromChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SepaDebitGeneratedFromChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SepaDebitGeneratedFromChargeObjectEnum] to String,
/// and [decode] dynamic data back to [SepaDebitGeneratedFromChargeObjectEnum].
class SepaDebitGeneratedFromChargeObjectEnumTypeTransformer {
  factory SepaDebitGeneratedFromChargeObjectEnumTypeTransformer() => _instance ??= const SepaDebitGeneratedFromChargeObjectEnumTypeTransformer._();

  const SepaDebitGeneratedFromChargeObjectEnumTypeTransformer._();

  String encode(SepaDebitGeneratedFromChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SepaDebitGeneratedFromChargeObjectEnum.
  ///
  ...
  SepaDebitGeneratedFromChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return SepaDebitGeneratedFromChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [SepaDebitGeneratedFromChargeObjectEnumTypeTransformer] instance.
  static SepaDebitGeneratedFromChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class SepaDebitGeneratedFromChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const SepaDebitGeneratedFromChargeStatusEnum._(this.value);
  ...
  static const failed = SepaDebitGeneratedFromChargeStatusEnum._(r'failed');
  static const pending = SepaDebitGeneratedFromChargeStatusEnum._(r'pending');
  static const succeeded = SepaDebitGeneratedFromChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][SepaDebitGeneratedFromChargeStatusEnum].
  static const values = <SepaDebitGeneratedFromChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static SepaDebitGeneratedFromChargeStatusEnum? fromJson(dynamic value) => SepaDebitGeneratedFromChargeStatusEnumTypeTransformer().decode(value);

  static List<SepaDebitGeneratedFromChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SepaDebitGeneratedFromChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SepaDebitGeneratedFromChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SepaDebitGeneratedFromChargeStatusEnum] to String,
/// and [decode] dynamic data back to [SepaDebitGeneratedFromChargeStatusEnum].
class SepaDebitGeneratedFromChargeStatusEnumTypeTransformer {
  factory SepaDebitGeneratedFromChargeStatusEnumTypeTransformer() => _instance ??= const SepaDebitGeneratedFromChargeStatusEnumTypeTransformer._();

  const SepaDebitGeneratedFromChargeStatusEnumTypeTransformer._();

  String encode(SepaDebitGeneratedFromChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SepaDebitGeneratedFromChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SepaDebitGeneratedFromChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return SepaDebitGeneratedFromChargeStatusEnum.failed;
        case r'pending': return SepaDebitGeneratedFromChargeStatusEnum.pending;
        case r'succeeded': return SepaDebitGeneratedFromChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SepaDebitGeneratedFromChargeStatusEnumTypeTransformer] instance.
  static SepaDebitGeneratedFromChargeStatusEnumTypeTransformer? _instance;
}
