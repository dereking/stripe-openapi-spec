...
class SetupIntentLatestAttempt {
  /// Returns a new [SetupIntentLatestAttempt] instance.
  ...
  SetupIntentLatestAttemptObjectEnum object;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SetupIntentLatestAttempt &&
  ...
  @override
  String toString() => 'SetupIntentLatestAttempt[application=$application, attachToSelf=$attachToSelf, created=$created, customer=$customer, flowDirections=$flowDirections, id=$id, livemode=$livemode, object=$object, onBehalfOf=$onBehalfOf, paymentMethod=$paymentMethod, paymentMethodDetails=$paymentMethodDetails, setupError=$setupError, setupIntent=$setupIntent, status=$status, usage=$usage]';
  ...
  /// Returns a new [SetupIntentLatestAttempt] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SetupIntentLatestAttempt? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SetupIntentLatestAttempt[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SetupIntentLatestAttempt[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SetupIntentLatestAttempt(
        ...
        object: SetupIntentLatestAttemptObjectEnum.fromJson(json[r'object'])!,
  ...
  static List<SetupIntentLatestAttempt> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SetupIntentLatestAttempt>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SetupIntentLatestAttempt.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SetupIntentLatestAttempt> mapFromJson(dynamic json) {
    final map = <String, SetupIntentLatestAttempt>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SetupIntentLatestAttempt.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SetupIntentLatestAttempt-objects as value to a dart map
  static Map<String, List<SetupIntentLatestAttempt>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SetupIntentLatestAttempt>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SetupIntentLatestAttempt.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class SetupIntentLatestAttemptObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const SetupIntentLatestAttemptObjectEnum._(this.value);
  ...
  static const setupAttempt = SetupIntentLatestAttemptObjectEnum._(r'setup_attempt');

  /// List of all possible values in this [enum][SetupIntentLatestAttemptObjectEnum].
  static const values = <SetupIntentLatestAttemptObjectEnum>[
    setupAttempt,
  ];

  static SetupIntentLatestAttemptObjectEnum? fromJson(dynamic value) => SetupIntentLatestAttemptObjectEnumTypeTransformer().decode(value);

  static List<SetupIntentLatestAttemptObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SetupIntentLatestAttemptObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SetupIntentLatestAttemptObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SetupIntentLatestAttemptObjectEnum] to String,
/// and [decode] dynamic data back to [SetupIntentLatestAttemptObjectEnum].
class SetupIntentLatestAttemptObjectEnumTypeTransformer {
  factory SetupIntentLatestAttemptObjectEnumTypeTransformer() => _instance ??= const SetupIntentLatestAttemptObjectEnumTypeTransformer._();

  const SetupIntentLatestAttemptObjectEnumTypeTransformer._();

  String encode(SetupIntentLatestAttemptObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SetupIntentLatestAttemptObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SetupIntentLatestAttemptObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'setup_attempt': return SetupIntentLatestAttemptObjectEnum.setupAttempt;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SetupIntentLatestAttemptObjectEnumTypeTransformer] instance.
  static SetupIntentLatestAttemptObjectEnumTypeTransformer? _instance;
}
