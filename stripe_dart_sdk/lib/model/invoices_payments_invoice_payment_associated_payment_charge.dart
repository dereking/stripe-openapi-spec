...
class InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge {
  /// Returns a new [InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge] instance.
  ...
  InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum object;
  ...
  InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge(
        ...
        object: InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge> mapFromJson(dynamic json) {
    final map = <String, InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge-objects as value to a dart map
  static Map<String, List<InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum._(this.value);
  ...
  static const charge = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum].
  static const values = <InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum>[
    charge,
  ];

  static InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum? fromJson(dynamic value) => InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumTypeTransformer().decode(value);

  static List<InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum] to String,
/// and [decode] dynamic data back to [InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum].
class InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumTypeTransformer {
  factory InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumTypeTransformer() => _instance ??= const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumTypeTransformer._();

  const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumTypeTransformer._();

  String encode(InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum.
  ///
  ...
  InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumTypeTransformer] instance.
  static InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum._(this.value);
  ...
  static const failed = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum._(r'failed');
  static const pending = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum._(r'pending');
  static const succeeded = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum].
  static const values = <InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum? fromJson(dynamic value) => InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumTypeTransformer().decode(value);

  static List<InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum] to String,
/// and [decode] dynamic data back to [InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum].
class InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumTypeTransformer {
  factory InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumTypeTransformer() => _instance ??= const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumTypeTransformer._();

  const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumTypeTransformer._();

  String encode(InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum.failed;
        case r'pending': return InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum.pending;
        case r'succeeded': return InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumTypeTransformer] instance.
  static InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumTypeTransformer? _instance;
}
