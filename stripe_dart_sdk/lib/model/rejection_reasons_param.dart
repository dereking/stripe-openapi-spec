...
class RejectionReasonsParam {
  /// Returns a new [RejectionReasonsParam] instance.
  RejectionReasonsParam({
    this.cardLogo = const [],
    this.carrierText = const [],
  });

  List<CardLogoEnum> cardLogo;

  List<CarrierTextEnum> carrierText;

  @override
  bool operator ==(Object other) => identical(this, other) || other is RejectionReasonsParam &&
  ...
  @override
  String toString() => 'RejectionReasonsParam[cardLogo=$cardLogo, carrierText=$carrierText]';
  ...
  /// Returns a new [RejectionReasonsParam] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RejectionReasonsParam? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RejectionReasonsParam[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RejectionReasonsParam[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RejectionReasonsParam(
  ...
  static List<RejectionReasonsParam> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RejectionReasonsParam>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RejectionReasonsParam.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RejectionReasonsParam> mapFromJson(dynamic json) {
    final map = <String, RejectionReasonsParam>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RejectionReasonsParam.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RejectionReasonsParam-objects as value to a dart map
  static Map<String, List<RejectionReasonsParam>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RejectionReasonsParam>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RejectionReasonsParam.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
