...
class InvoicesResourceFromInvoiceInvoice {
  /// Returns a new [InvoicesResourceFromInvoiceInvoice] instance.
  ...
  InvoicesResourceFromInvoiceInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum collectionMethod;
  ...
  InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  InvoicesResourceFromInvoiceInvoiceObjectEnum object;
  ...
  InvoicesResourceFromInvoiceInvoiceStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoicesResourceFromInvoiceInvoice &&
  ...
  /// Returns a new [InvoicesResourceFromInvoiceInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoicesResourceFromInvoiceInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoicesResourceFromInvoiceInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoicesResourceFromInvoiceInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InvoicesResourceFromInvoiceInvoice(
        ...
        billingReason: InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: InvoicesResourceFromInvoiceInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: InvoicesResourceFromInvoiceInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<InvoicesResourceFromInvoiceInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesResourceFromInvoiceInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesResourceFromInvoiceInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoicesResourceFromInvoiceInvoice> mapFromJson(dynamic json) {
    final map = <String, InvoicesResourceFromInvoiceInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoicesResourceFromInvoiceInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoicesResourceFromInvoiceInvoice-objects as value to a dart map
  static Map<String, List<InvoicesResourceFromInvoiceInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoicesResourceFromInvoiceInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoicesResourceFromInvoiceInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class InvoicesResourceFromInvoiceInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][InvoicesResourceFromInvoiceInvoiceBillingReasonEnum].
  static const values = <InvoicesResourceFromInvoiceInvoiceBillingReasonEnum>[
  ...
  static InvoicesResourceFromInvoiceInvoiceBillingReasonEnum? fromJson(dynamic value) => InvoicesResourceFromInvoiceInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<InvoicesResourceFromInvoiceInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesResourceFromInvoiceInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicesResourceFromInvoiceInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [InvoicesResourceFromInvoiceInvoiceBillingReasonEnum].
class InvoicesResourceFromInvoiceInvoiceBillingReasonEnumTypeTransformer {
  factory InvoicesResourceFromInvoiceInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const InvoicesResourceFromInvoiceInvoiceBillingReasonEnumTypeTransformer._();

  const InvoicesResourceFromInvoiceInvoiceBillingReasonEnumTypeTransformer._();

  String encode(InvoicesResourceFromInvoiceInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.
  ///
  ...
  InvoicesResourceFromInvoiceInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return InvoicesResourceFromInvoiceInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [InvoicesResourceFromInvoiceInvoiceBillingReasonEnumTypeTransformer] instance.
  static InvoicesResourceFromInvoiceInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum].
  static const values = <InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum? fromJson(dynamic value) => InvoicesResourceFromInvoiceInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum].
class InvoicesResourceFromInvoiceInvoiceCollectionMethodEnumTypeTransformer {
  factory InvoicesResourceFromInvoiceInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const InvoicesResourceFromInvoiceInvoiceCollectionMethodEnumTypeTransformer._();

  const InvoicesResourceFromInvoiceInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return InvoicesResourceFromInvoiceInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicesResourceFromInvoiceInvoiceCollectionMethodEnumTypeTransformer] instance.
  static InvoicesResourceFromInvoiceInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum].
  static const values = <InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum].
class InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static InvoicesResourceFromInvoiceInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class InvoicesResourceFromInvoiceInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicesResourceFromInvoiceInvoiceObjectEnum._(this.value);
  ...
  static const invoice = InvoicesResourceFromInvoiceInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][InvoicesResourceFromInvoiceInvoiceObjectEnum].
  static const values = <InvoicesResourceFromInvoiceInvoiceObjectEnum>[
    invoice,
  ];

  static InvoicesResourceFromInvoiceInvoiceObjectEnum? fromJson(dynamic value) => InvoicesResourceFromInvoiceInvoiceObjectEnumTypeTransformer().decode(value);

  static List<InvoicesResourceFromInvoiceInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesResourceFromInvoiceInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesResourceFromInvoiceInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicesResourceFromInvoiceInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [InvoicesResourceFromInvoiceInvoiceObjectEnum].
class InvoicesResourceFromInvoiceInvoiceObjectEnumTypeTransformer {
  factory InvoicesResourceFromInvoiceInvoiceObjectEnumTypeTransformer() => _instance ??= const InvoicesResourceFromInvoiceInvoiceObjectEnumTypeTransformer._();

  const InvoicesResourceFromInvoiceInvoiceObjectEnumTypeTransformer._();

  String encode(InvoicesResourceFromInvoiceInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicesResourceFromInvoiceInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicesResourceFromInvoiceInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return InvoicesResourceFromInvoiceInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicesResourceFromInvoiceInvoiceObjectEnumTypeTransformer] instance.
  static InvoicesResourceFromInvoiceInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class InvoicesResourceFromInvoiceInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicesResourceFromInvoiceInvoiceStatusEnum._(this.value);
  ...
  static const draft = InvoicesResourceFromInvoiceInvoiceStatusEnum._(r'draft');
  static const open = InvoicesResourceFromInvoiceInvoiceStatusEnum._(r'open');
  static const paid = InvoicesResourceFromInvoiceInvoiceStatusEnum._(r'paid');
  static const uncollectible = InvoicesResourceFromInvoiceInvoiceStatusEnum._(r'uncollectible');
  static const void_ = InvoicesResourceFromInvoiceInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][InvoicesResourceFromInvoiceInvoiceStatusEnum].
  static const values = <InvoicesResourceFromInvoiceInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static InvoicesResourceFromInvoiceInvoiceStatusEnum? fromJson(dynamic value) => InvoicesResourceFromInvoiceInvoiceStatusEnumTypeTransformer().decode(value);

  static List<InvoicesResourceFromInvoiceInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicesResourceFromInvoiceInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicesResourceFromInvoiceInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicesResourceFromInvoiceInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [InvoicesResourceFromInvoiceInvoiceStatusEnum].
class InvoicesResourceFromInvoiceInvoiceStatusEnumTypeTransformer {
  factory InvoicesResourceFromInvoiceInvoiceStatusEnumTypeTransformer() => _instance ??= const InvoicesResourceFromInvoiceInvoiceStatusEnumTypeTransformer._();

  const InvoicesResourceFromInvoiceInvoiceStatusEnumTypeTransformer._();

  String encode(InvoicesResourceFromInvoiceInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicesResourceFromInvoiceInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicesResourceFromInvoiceInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return InvoicesResourceFromInvoiceInvoiceStatusEnum.draft;
        case r'open': return InvoicesResourceFromInvoiceInvoiceStatusEnum.open;
        case r'paid': return InvoicesResourceFromInvoiceInvoiceStatusEnum.paid;
        case r'uncollectible': return InvoicesResourceFromInvoiceInvoiceStatusEnum.uncollectible;
        case r'void': return InvoicesResourceFromInvoiceInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicesResourceFromInvoiceInvoiceStatusEnumTypeTransformer] instance.
  static InvoicesResourceFromInvoiceInvoiceStatusEnumTypeTransformer? _instance;
}
