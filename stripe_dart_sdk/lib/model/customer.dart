...
class Customer {
  ...
  CustomerTaxExemptEnum? taxExempt;
  ...
  static Customer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Customer(
        ...
        object: CustomerObjectEnum.fromJson(json[r'object'])!,
        ...
        taxExempt: CustomerTaxExemptEnum.fromJson(json[r'tax_exempt']),
...
/// String representing the object's type. Objects of the same type share the same value.
class CustomerObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const CustomerObjectEnum._(this.value);
  ...
  static const customer = CustomerObjectEnum._(r'customer');

  /// List of all possible values in this [enum][CustomerObjectEnum].
  static const values = <CustomerObjectEnum>[
    customer,
  ];

  static CustomerObjectEnum? fromJson(dynamic value) => CustomerObjectEnumTypeTransformer().decode(value);

  static List<CustomerObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CustomerObjectEnum] to String,
/// and [decode] dynamic data back to [CustomerObjectEnum].
class CustomerObjectEnumTypeTransformer {
  factory CustomerObjectEnumTypeTransformer() => _instance ??= const CustomerObjectEnumTypeTransformer._();

  const CustomerObjectEnumTypeTransformer._();

  String encode(CustomerObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CustomerObjectEnum.
  ///
  ...
  CustomerObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'customer': return CustomerObjectEnum.customer;
        default:
          if (!allowNull) {
  ...
  /// Singleton [CustomerObjectEnumTypeTransformer] instance.
  static CustomerObjectEnumTypeTransformer? _instance;
}


/// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
class CustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const CustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = CustomerTaxExemptEnum._(r'exempt');
  static const none = CustomerTaxExemptEnum._(r'none');
  static const reverse = CustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][CustomerTaxExemptEnum].
  static const values = <CustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static CustomerTaxExemptEnum? fromJson(dynamic value) => CustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<CustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [CustomerTaxExemptEnum].
class CustomerTaxExemptEnumTypeTransformer {
  factory CustomerTaxExemptEnumTypeTransformer() => _instance ??= const CustomerTaxExemptEnumTypeTransformer._();

  const CustomerTaxExemptEnumTypeTransformer._();

  String encode(CustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return CustomerTaxExemptEnum.exempt;
        case r'none': return CustomerTaxExemptEnum.none;
        case r'reverse': return CustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CustomerTaxExemptEnumTypeTransformer] instance.
  static CustomerTaxExemptEnumTypeTransformer? _instance;
}
