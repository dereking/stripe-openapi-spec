...
class IssuingCardholderSpendingLimit {
  /// Returns a new [IssuingCardholderSpendingLimit] instance.
  ...
  IssuingCardholderSpendingLimitIntervalEnum interval;

  @override
  bool operator ==(Object other) => identical(this, other) || other is IssuingCardholderSpendingLimit &&
    other.amount == amount &&
  ...
  @override
  String toString() => 'IssuingCardholderSpendingLimit[amount=$amount, categories=$categories, interval=$interval]';
  ...
  /// Returns a new [IssuingCardholderSpendingLimit] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IssuingCardholderSpendingLimit? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IssuingCardholderSpendingLimit[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IssuingCardholderSpendingLimit[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IssuingCardholderSpendingLimit(
        ...
        interval: IssuingCardholderSpendingLimitIntervalEnum.fromJson(json[r'interval'])!,
      );
    }
    return null;
  }

  static List<IssuingCardholderSpendingLimit> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IssuingCardholderSpendingLimit>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IssuingCardholderSpendingLimit.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IssuingCardholderSpendingLimit> mapFromJson(dynamic json) {
    final map = <String, IssuingCardholderSpendingLimit>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IssuingCardholderSpendingLimit.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IssuingCardholderSpendingLimit-objects as value to a dart map
  static Map<String, List<IssuingCardholderSpendingLimit>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IssuingCardholderSpendingLimit>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IssuingCardholderSpendingLimit.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Interval (or event) to which the amount applies.
class IssuingCardholderSpendingLimitIntervalEnum {
  /// Instantiate a new enum with the provided [value].
  const IssuingCardholderSpendingLimitIntervalEnum._(this.value);
  ...
  static const allTime = IssuingCardholderSpendingLimitIntervalEnum._(r'all_time');
  static const daily = IssuingCardholderSpendingLimitIntervalEnum._(r'daily');
  static const monthly = IssuingCardholderSpendingLimitIntervalEnum._(r'monthly');
  static const perAuthorization = IssuingCardholderSpendingLimitIntervalEnum._(r'per_authorization');
  static const weekly = IssuingCardholderSpendingLimitIntervalEnum._(r'weekly');
  static const yearly = IssuingCardholderSpendingLimitIntervalEnum._(r'yearly');

  /// List of all possible values in this [enum][IssuingCardholderSpendingLimitIntervalEnum].
  static const values = <IssuingCardholderSpendingLimitIntervalEnum>[
    allTime,
    daily,
    monthly,
    perAuthorization,
  ...
  static IssuingCardholderSpendingLimitIntervalEnum? fromJson(dynamic value) => IssuingCardholderSpendingLimitIntervalEnumTypeTransformer().decode(value);

  static List<IssuingCardholderSpendingLimitIntervalEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IssuingCardholderSpendingLimitIntervalEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IssuingCardholderSpendingLimitIntervalEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [IssuingCardholderSpendingLimitIntervalEnum] to String,
/// and [decode] dynamic data back to [IssuingCardholderSpendingLimitIntervalEnum].
class IssuingCardholderSpendingLimitIntervalEnumTypeTransformer {
  factory IssuingCardholderSpendingLimitIntervalEnumTypeTransformer() => _instance ??= const IssuingCardholderSpendingLimitIntervalEnumTypeTransformer._();

  const IssuingCardholderSpendingLimitIntervalEnumTypeTransformer._();

  String encode(IssuingCardholderSpendingLimitIntervalEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a IssuingCardholderSpendingLimitIntervalEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  IssuingCardholderSpendingLimitIntervalEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'all_time': return IssuingCardholderSpendingLimitIntervalEnum.allTime;
        case r'daily': return IssuingCardholderSpendingLimitIntervalEnum.daily;
        case r'monthly': return IssuingCardholderSpendingLimitIntervalEnum.monthly;
        case r'per_authorization': return IssuingCardholderSpendingLimitIntervalEnum.perAuthorization;
        case r'weekly': return IssuingCardholderSpendingLimitIntervalEnum.weekly;
        case r'yearly': return IssuingCardholderSpendingLimitIntervalEnum.yearly;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [IssuingCardholderSpendingLimitIntervalEnumTypeTransformer] instance.
  static IssuingCardholderSpendingLimitIntervalEnumTypeTransformer? _instance;
}
