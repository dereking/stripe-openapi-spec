...
class Duplicate {
  /// Returns a new [Duplicate] instance.
  Duplicate({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Duplicate &&
  ...
  @override
  String toString() => 'Duplicate[additionalDocumentation=$additionalDocumentation, cardStatement=$cardStatement, cashReceipt=$cashReceipt, checkImage=$checkImage, explanation=$explanation, originalTransaction=$originalTransaction]';
  ...
  /// Returns a new [Duplicate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Duplicate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Duplicate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Duplicate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Duplicate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Duplicate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Duplicate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Duplicate> mapFromJson(dynamic json) {
    final map = <String, Duplicate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Duplicate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Duplicate-objects as value to a dart map
  static Map<String, List<Duplicate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Duplicate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Duplicate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
