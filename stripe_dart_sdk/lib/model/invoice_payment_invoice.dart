...
class InvoicePaymentInvoice {
  /// Returns a new [InvoicePaymentInvoice] instance.
  ...
  InvoicePaymentInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  InvoicePaymentInvoiceCollectionMethodEnum collectionMethod;
  ...
  InvoicePaymentInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  InvoicePaymentInvoiceObjectEnum object;
  ...
  InvoicePaymentInvoiceStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoicePaymentInvoice &&
  ...
  /// Returns a new [InvoicePaymentInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoicePaymentInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoicePaymentInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoicePaymentInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InvoicePaymentInvoice(
        ...
        billingReason: InvoicePaymentInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: InvoicePaymentInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: InvoicePaymentInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: InvoicePaymentInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: InvoicePaymentInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<InvoicePaymentInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicePaymentInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicePaymentInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoicePaymentInvoice> mapFromJson(dynamic json) {
    final map = <String, InvoicePaymentInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoicePaymentInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoicePaymentInvoice-objects as value to a dart map
  static Map<String, List<InvoicePaymentInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoicePaymentInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoicePaymentInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class InvoicePaymentInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicePaymentInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = InvoicePaymentInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = InvoicePaymentInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = InvoicePaymentInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = InvoicePaymentInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = InvoicePaymentInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = InvoicePaymentInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = InvoicePaymentInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = InvoicePaymentInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = InvoicePaymentInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][InvoicePaymentInvoiceBillingReasonEnum].
  static const values = <InvoicePaymentInvoiceBillingReasonEnum>[
  ...
  static InvoicePaymentInvoiceBillingReasonEnum? fromJson(dynamic value) => InvoicePaymentInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<InvoicePaymentInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicePaymentInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicePaymentInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicePaymentInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [InvoicePaymentInvoiceBillingReasonEnum].
class InvoicePaymentInvoiceBillingReasonEnumTypeTransformer {
  factory InvoicePaymentInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const InvoicePaymentInvoiceBillingReasonEnumTypeTransformer._();

  const InvoicePaymentInvoiceBillingReasonEnumTypeTransformer._();

  String encode(InvoicePaymentInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicePaymentInvoiceBillingReasonEnum.
  ///
  ...
  InvoicePaymentInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return InvoicePaymentInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return InvoicePaymentInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return InvoicePaymentInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return InvoicePaymentInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return InvoicePaymentInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return InvoicePaymentInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return InvoicePaymentInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return InvoicePaymentInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return InvoicePaymentInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [InvoicePaymentInvoiceBillingReasonEnumTypeTransformer] instance.
  static InvoicePaymentInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class InvoicePaymentInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicePaymentInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = InvoicePaymentInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = InvoicePaymentInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][InvoicePaymentInvoiceCollectionMethodEnum].
  static const values = <InvoicePaymentInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static InvoicePaymentInvoiceCollectionMethodEnum? fromJson(dynamic value) => InvoicePaymentInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<InvoicePaymentInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicePaymentInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicePaymentInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicePaymentInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [InvoicePaymentInvoiceCollectionMethodEnum].
class InvoicePaymentInvoiceCollectionMethodEnumTypeTransformer {
  factory InvoicePaymentInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const InvoicePaymentInvoiceCollectionMethodEnumTypeTransformer._();

  const InvoicePaymentInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(InvoicePaymentInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicePaymentInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicePaymentInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return InvoicePaymentInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return InvoicePaymentInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicePaymentInvoiceCollectionMethodEnumTypeTransformer] instance.
  static InvoicePaymentInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class InvoicePaymentInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicePaymentInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = InvoicePaymentInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = InvoicePaymentInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = InvoicePaymentInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][InvoicePaymentInvoiceCustomerTaxExemptEnum].
  static const values = <InvoicePaymentInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static InvoicePaymentInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => InvoicePaymentInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<InvoicePaymentInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicePaymentInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicePaymentInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicePaymentInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [InvoicePaymentInvoiceCustomerTaxExemptEnum].
class InvoicePaymentInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory InvoicePaymentInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const InvoicePaymentInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const InvoicePaymentInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(InvoicePaymentInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicePaymentInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicePaymentInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return InvoicePaymentInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return InvoicePaymentInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return InvoicePaymentInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicePaymentInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static InvoicePaymentInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class InvoicePaymentInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicePaymentInvoiceObjectEnum._(this.value);
  ...
  static const invoice = InvoicePaymentInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][InvoicePaymentInvoiceObjectEnum].
  static const values = <InvoicePaymentInvoiceObjectEnum>[
    invoice,
  ];

  static InvoicePaymentInvoiceObjectEnum? fromJson(dynamic value) => InvoicePaymentInvoiceObjectEnumTypeTransformer().decode(value);

  static List<InvoicePaymentInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicePaymentInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicePaymentInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicePaymentInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [InvoicePaymentInvoiceObjectEnum].
class InvoicePaymentInvoiceObjectEnumTypeTransformer {
  factory InvoicePaymentInvoiceObjectEnumTypeTransformer() => _instance ??= const InvoicePaymentInvoiceObjectEnumTypeTransformer._();

  const InvoicePaymentInvoiceObjectEnumTypeTransformer._();

  String encode(InvoicePaymentInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicePaymentInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicePaymentInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return InvoicePaymentInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicePaymentInvoiceObjectEnumTypeTransformer] instance.
  static InvoicePaymentInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class InvoicePaymentInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoicePaymentInvoiceStatusEnum._(this.value);
  ...
  static const draft = InvoicePaymentInvoiceStatusEnum._(r'draft');
  static const open = InvoicePaymentInvoiceStatusEnum._(r'open');
  static const paid = InvoicePaymentInvoiceStatusEnum._(r'paid');
  static const uncollectible = InvoicePaymentInvoiceStatusEnum._(r'uncollectible');
  static const void_ = InvoicePaymentInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][InvoicePaymentInvoiceStatusEnum].
  static const values = <InvoicePaymentInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static InvoicePaymentInvoiceStatusEnum? fromJson(dynamic value) => InvoicePaymentInvoiceStatusEnumTypeTransformer().decode(value);

  static List<InvoicePaymentInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoicePaymentInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoicePaymentInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoicePaymentInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [InvoicePaymentInvoiceStatusEnum].
class InvoicePaymentInvoiceStatusEnumTypeTransformer {
  factory InvoicePaymentInvoiceStatusEnumTypeTransformer() => _instance ??= const InvoicePaymentInvoiceStatusEnumTypeTransformer._();

  const InvoicePaymentInvoiceStatusEnumTypeTransformer._();

  String encode(InvoicePaymentInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoicePaymentInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoicePaymentInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return InvoicePaymentInvoiceStatusEnum.draft;
        case r'open': return InvoicePaymentInvoiceStatusEnum.open;
        case r'paid': return InvoicePaymentInvoiceStatusEnum.paid;
        case r'uncollectible': return InvoicePaymentInvoiceStatusEnum.uncollectible;
        case r'void': return InvoicePaymentInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoicePaymentInvoiceStatusEnumTypeTransformer] instance.
  static InvoicePaymentInvoiceStatusEnumTypeTransformer? _instance;
}
