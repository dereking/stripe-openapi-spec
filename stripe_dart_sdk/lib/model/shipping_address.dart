...
class ShippingAddress {
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  AccountGroupsSpecsPaymentsPricing? country;
  ...
  @override
  String toString() => 'ShippingAddress[city=$city, country=$country, line1=$line1, line2=$line2, postalCode=$postalCode, state=$state]';
  ...
  static ShippingAddress? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ShippingAddress(
        ...
        country: AccountGroupsSpecsPaymentsPricing.fromJson(json[r'country']),
