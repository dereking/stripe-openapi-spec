...
class ApiErrorsSource {
  /// Returns a new [ApiErrorsSource] instance.
  ApiErrorsSource({
    this.account,
  ...
  ApiErrorsSourceObjectEnum object;
  ...
  ApiErrorsSourceAllowRedisplayEnum? allowRedisplay;
  ...
  ApiErrorsSourceRegulatedStatusEnum? regulatedStatus;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorsSource &&
  ...
  /// Returns a new [ApiErrorsSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApiErrorsSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorsSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorsSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ApiErrorsSource(
        ...
        object: ApiErrorsSourceObjectEnum.fromJson(json[r'object'])!,
        ...
        allowRedisplay: ApiErrorsSourceAllowRedisplayEnum.fromJson(json[r'allow_redisplay']),
        ...
        regulatedStatus: ApiErrorsSourceRegulatedStatusEnum.fromJson(json[r'regulated_status']),
        ...
        type: ApiErrorsSourceTypeEnum.fromJson(json[r'type'])!,
  ...
  static List<ApiErrorsSource> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApiErrorsSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiErrorsSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApiErrorsSource> mapFromJson(dynamic json) {
    final map = <String, ApiErrorsSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApiErrorsSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ApiErrorsSource-objects as value to a dart map
  static Map<String, List<ApiErrorsSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorsSource>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorsSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class ApiErrorsSourceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const ApiErrorsSourceObjectEnum._(this.value);
  ...
  static const source_ = ApiErrorsSourceObjectEnum._(r'source');

  /// List of all possible values in this [enum][ApiErrorsSourceObjectEnum].
  static const values = <ApiErrorsSourceObjectEnum>[
    source_,
  ];

  static ApiErrorsSourceObjectEnum? fromJson(dynamic value) => ApiErrorsSourceObjectEnumTypeTransformer().decode(value);

  static List<ApiErrorsSourceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApiErrorsSourceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiErrorsSourceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApiErrorsSourceObjectEnum] to String,
/// and [decode] dynamic data back to [ApiErrorsSourceObjectEnum].
class ApiErrorsSourceObjectEnumTypeTransformer {
  factory ApiErrorsSourceObjectEnumTypeTransformer() => _instance ??= const ApiErrorsSourceObjectEnumTypeTransformer._();

  const ApiErrorsSourceObjectEnumTypeTransformer._();

  String encode(ApiErrorsSourceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApiErrorsSourceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ApiErrorsSourceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'source': return ApiErrorsSourceObjectEnum.source_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ApiErrorsSourceObjectEnumTypeTransformer] instance.
  static ApiErrorsSourceObjectEnumTypeTransformer? _instance;
}


/// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
class ApiErrorsSourceAllowRedisplayEnum {
  /// Instantiate a new enum with the provided [value].
  const ApiErrorsSourceAllowRedisplayEnum._(this.value);
  ...
  static const always = ApiErrorsSourceAllowRedisplayEnum._(r'always');
  static const limited = ApiErrorsSourceAllowRedisplayEnum._(r'limited');
  static const unspecified = ApiErrorsSourceAllowRedisplayEnum._(r'unspecified');

  /// List of all possible values in this [enum][ApiErrorsSourceAllowRedisplayEnum].
  static const values = <ApiErrorsSourceAllowRedisplayEnum>[
    always,
    limited,
    unspecified,
  ];

  static ApiErrorsSourceAllowRedisplayEnum? fromJson(dynamic value) => ApiErrorsSourceAllowRedisplayEnumTypeTransformer().decode(value);

  static List<ApiErrorsSourceAllowRedisplayEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApiErrorsSourceAllowRedisplayEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiErrorsSourceAllowRedisplayEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApiErrorsSourceAllowRedisplayEnum] to String,
/// and [decode] dynamic data back to [ApiErrorsSourceAllowRedisplayEnum].
class ApiErrorsSourceAllowRedisplayEnumTypeTransformer {
  factory ApiErrorsSourceAllowRedisplayEnumTypeTransformer() => _instance ??= const ApiErrorsSourceAllowRedisplayEnumTypeTransformer._();

  const ApiErrorsSourceAllowRedisplayEnumTypeTransformer._();

  String encode(ApiErrorsSourceAllowRedisplayEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApiErrorsSourceAllowRedisplayEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ApiErrorsSourceAllowRedisplayEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'always': return ApiErrorsSourceAllowRedisplayEnum.always;
        case r'limited': return ApiErrorsSourceAllowRedisplayEnum.limited;
        case r'unspecified': return ApiErrorsSourceAllowRedisplayEnum.unspecified;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ApiErrorsSourceAllowRedisplayEnumTypeTransformer] instance.
  static ApiErrorsSourceAllowRedisplayEnumTypeTransformer? _instance;
}


/// Status of a card based on the card issuer.
class ApiErrorsSourceRegulatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const ApiErrorsSourceRegulatedStatusEnum._(this.value);
  ...
  static const regulated = ApiErrorsSourceRegulatedStatusEnum._(r'regulated');
  static const unregulated = ApiErrorsSourceRegulatedStatusEnum._(r'unregulated');

  /// List of all possible values in this [enum][ApiErrorsSourceRegulatedStatusEnum].
  static const values = <ApiErrorsSourceRegulatedStatusEnum>[
    regulated,
    unregulated,
  ];

  static ApiErrorsSourceRegulatedStatusEnum? fromJson(dynamic value) => ApiErrorsSourceRegulatedStatusEnumTypeTransformer().decode(value);

  static List<ApiErrorsSourceRegulatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApiErrorsSourceRegulatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiErrorsSourceRegulatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApiErrorsSourceRegulatedStatusEnum] to String,
/// and [decode] dynamic data back to [ApiErrorsSourceRegulatedStatusEnum].
class ApiErrorsSourceRegulatedStatusEnumTypeTransformer {
  factory ApiErrorsSourceRegulatedStatusEnumTypeTransformer() => _instance ??= const ApiErrorsSourceRegulatedStatusEnumTypeTransformer._();

  const ApiErrorsSourceRegulatedStatusEnumTypeTransformer._();

  String encode(ApiErrorsSourceRegulatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApiErrorsSourceRegulatedStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ApiErrorsSourceRegulatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'regulated': return ApiErrorsSourceRegulatedStatusEnum.regulated;
        case r'unregulated': return ApiErrorsSourceRegulatedStatusEnum.unregulated;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ApiErrorsSourceRegulatedStatusEnumTypeTransformer] instance.
  static ApiErrorsSourceRegulatedStatusEnumTypeTransformer? _instance;
}


/// The `type` of the source. The `type` is a payment method, one of `ach_credit_transfer`, `ach_debit`, `alipay`, `bancontact`, `card`, `card_present`, `eps`, `giropay`, `ideal`, `multibanco`, `klarna`, `p24`, `sepa_debit`, `sofort`, `three_d_secure`, or `wechat`. An additional hash is included on the source with a name matching this value. It contains additional information specific to the [payment method](https://stripe.com/docs/sources) used.
class ApiErrorsSourceTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const ApiErrorsSourceTypeEnum._(this.value);
  ...
  static const achCreditTransfer = ApiErrorsSourceTypeEnum._(r'ach_credit_transfer');
  static const achDebit = ApiErrorsSourceTypeEnum._(r'ach_debit');
  static const acssDebit = ApiErrorsSourceTypeEnum._(r'acss_debit');
  static const alipay = ApiErrorsSourceTypeEnum._(r'alipay');
  static const auBecsDebit = ApiErrorsSourceTypeEnum._(r'au_becs_debit');
  static const bancontact = ApiErrorsSourceTypeEnum._(r'bancontact');
  static const card = ApiErrorsSourceTypeEnum._(r'card');
  static const cardPresent = ApiErrorsSourceTypeEnum._(r'card_present');
  static const eps = ApiErrorsSourceTypeEnum._(r'eps');
  static const giropay = ApiErrorsSourceTypeEnum._(r'giropay');
  static const ideal = ApiErrorsSourceTypeEnum._(r'ideal');
  static const klarna = ApiErrorsSourceTypeEnum._(r'klarna');
  static const multibanco = ApiErrorsSourceTypeEnum._(r'multibanco');
  static const p24 = ApiErrorsSourceTypeEnum._(r'p24');
  static const sepaDebit = ApiErrorsSourceTypeEnum._(r'sepa_debit');
  static const sofort = ApiErrorsSourceTypeEnum._(r'sofort');
  static const threeDSecure = ApiErrorsSourceTypeEnum._(r'three_d_secure');
  static const wechat = ApiErrorsSourceTypeEnum._(r'wechat');

  /// List of all possible values in this [enum][ApiErrorsSourceTypeEnum].
  static const values = <ApiErrorsSourceTypeEnum>[
    achCreditTransfer,
    achDebit,
    acssDebit,
    alipay,
  ...
  static ApiErrorsSourceTypeEnum? fromJson(dynamic value) => ApiErrorsSourceTypeEnumTypeTransformer().decode(value);

  static List<ApiErrorsSourceTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApiErrorsSourceTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApiErrorsSourceTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApiErrorsSourceTypeEnum] to String,
/// and [decode] dynamic data back to [ApiErrorsSourceTypeEnum].
class ApiErrorsSourceTypeEnumTypeTransformer {
  factory ApiErrorsSourceTypeEnumTypeTransformer() => _instance ??= const ApiErrorsSourceTypeEnumTypeTransformer._();

  const ApiErrorsSourceTypeEnumTypeTransformer._();

  String encode(ApiErrorsSourceTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApiErrorsSourceTypeEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ApiErrorsSourceTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ach_credit_transfer': return ApiErrorsSourceTypeEnum.achCreditTransfer;
        case r'ach_debit': return ApiErrorsSourceTypeEnum.achDebit;
        case r'acss_debit': return ApiErrorsSourceTypeEnum.acssDebit;
        case r'alipay': return ApiErrorsSourceTypeEnum.alipay;
        case r'au_becs_debit': return ApiErrorsSourceTypeEnum.auBecsDebit;
        case r'bancontact': return ApiErrorsSourceTypeEnum.bancontact;
        case r'card': return ApiErrorsSourceTypeEnum.card;
        case r'card_present': return ApiErrorsSourceTypeEnum.cardPresent;
        case r'eps': return ApiErrorsSourceTypeEnum.eps;
        case r'giropay': return ApiErrorsSourceTypeEnum.giropay;
        case r'ideal': return ApiErrorsSourceTypeEnum.ideal;
        case r'klarna': return ApiErrorsSourceTypeEnum.klarna;
        case r'multibanco': return ApiErrorsSourceTypeEnum.multibanco;
        case r'p24': return ApiErrorsSourceTypeEnum.p24;
        case r'sepa_debit': return ApiErrorsSourceTypeEnum.sepaDebit;
        case r'sofort': return ApiErrorsSourceTypeEnum.sofort;
        case r'three_d_secure': return ApiErrorsSourceTypeEnum.threeDSecure;
        case r'wechat': return ApiErrorsSourceTypeEnum.wechat;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ApiErrorsSourceTypeEnumTypeTransformer] instance.
  static ApiErrorsSourceTypeEnumTypeTransformer? _instance;
}
