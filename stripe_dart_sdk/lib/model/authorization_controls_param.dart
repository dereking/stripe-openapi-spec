...
class AuthorizationControlsParam {
  /// Returns a new [AuthorizationControlsParam] instance.
  AuthorizationControlsParam({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AuthorizationControlsParam &&
  ...
  @override
  String toString() => 'AuthorizationControlsParam[allowedCategories=$allowedCategories, allowedMerchantCountries=$allowedMerchantCountries, blockedCategories=$blockedCategories, blockedMerchantCountries=$blockedMerchantCountries, spendingLimits=$spendingLimits]';
  ...
  /// Returns a new [AuthorizationControlsParam] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AuthorizationControlsParam? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AuthorizationControlsParam[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AuthorizationControlsParam[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AuthorizationControlsParam(
  ...
  static List<AuthorizationControlsParam> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AuthorizationControlsParam>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AuthorizationControlsParam.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AuthorizationControlsParam> mapFromJson(dynamic json) {
    final map = <String, AuthorizationControlsParam>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AuthorizationControlsParam.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AuthorizationControlsParam-objects as value to a dart map
  static Map<String, List<AuthorizationControlsParam>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AuthorizationControlsParam>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AuthorizationControlsParam.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
