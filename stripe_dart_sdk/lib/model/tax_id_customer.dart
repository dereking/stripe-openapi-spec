...
class TaxIdCustomer {
  /// Returns a new [TaxIdCustomer] instance.
  TaxIdCustomer({
    this.address,
    this.balance,
    this.cashBalance,
  ...
  TaxIdCustomerObjectEnum object;
  ...
  TaxIdCustomerTaxExemptEnum? taxExempt;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TaxIdCustomer &&
  ...
  /// Returns a new [TaxIdCustomer] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TaxIdCustomer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TaxIdCustomer[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TaxIdCustomer[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return TaxIdCustomer(
        ...
        object: TaxIdCustomerObjectEnum.fromJson(json[r'object'])!,
        ...
        taxExempt: TaxIdCustomerTaxExemptEnum.fromJson(json[r'tax_exempt']),
  ...
  static List<TaxIdCustomer> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TaxIdCustomer>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TaxIdCustomer.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TaxIdCustomer> mapFromJson(dynamic json) {
    final map = <String, TaxIdCustomer>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TaxIdCustomer.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TaxIdCustomer-objects as value to a dart map
  static Map<String, List<TaxIdCustomer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TaxIdCustomer>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TaxIdCustomer.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class TaxIdCustomerObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const TaxIdCustomerObjectEnum._(this.value);
  ...
  static const customer = TaxIdCustomerObjectEnum._(r'customer');

  /// List of all possible values in this [enum][TaxIdCustomerObjectEnum].
  static const values = <TaxIdCustomerObjectEnum>[
    customer,
  ];

  static TaxIdCustomerObjectEnum? fromJson(dynamic value) => TaxIdCustomerObjectEnumTypeTransformer().decode(value);

  static List<TaxIdCustomerObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TaxIdCustomerObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TaxIdCustomerObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TaxIdCustomerObjectEnum] to String,
/// and [decode] dynamic data back to [TaxIdCustomerObjectEnum].
class TaxIdCustomerObjectEnumTypeTransformer {
  factory TaxIdCustomerObjectEnumTypeTransformer() => _instance ??= const TaxIdCustomerObjectEnumTypeTransformer._();

  const TaxIdCustomerObjectEnumTypeTransformer._();

  String encode(TaxIdCustomerObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TaxIdCustomerObjectEnum.
  ///
  ...
  TaxIdCustomerObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'customer': return TaxIdCustomerObjectEnum.customer;
        default:
          if (!allowNull) {
  ...
  /// Singleton [TaxIdCustomerObjectEnumTypeTransformer] instance.
  static TaxIdCustomerObjectEnumTypeTransformer? _instance;
}


/// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
class TaxIdCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const TaxIdCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = TaxIdCustomerTaxExemptEnum._(r'exempt');
  static const none = TaxIdCustomerTaxExemptEnum._(r'none');
  static const reverse = TaxIdCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][TaxIdCustomerTaxExemptEnum].
  static const values = <TaxIdCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static TaxIdCustomerTaxExemptEnum? fromJson(dynamic value) => TaxIdCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<TaxIdCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TaxIdCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TaxIdCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TaxIdCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [TaxIdCustomerTaxExemptEnum].
class TaxIdCustomerTaxExemptEnumTypeTransformer {
  factory TaxIdCustomerTaxExemptEnumTypeTransformer() => _instance ??= const TaxIdCustomerTaxExemptEnumTypeTransformer._();

  const TaxIdCustomerTaxExemptEnumTypeTransformer._();

  String encode(TaxIdCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TaxIdCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  TaxIdCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return TaxIdCustomerTaxExemptEnum.exempt;
        case r'none': return TaxIdCustomerTaxExemptEnum.none;
        case r'reverse': return TaxIdCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [TaxIdCustomerTaxExemptEnumTypeTransformer] instance.
  static TaxIdCustomerTaxExemptEnumTypeTransformer? _instance;
}
