...
class IssuingCardAuthorizationControls {
  /// Returns a new [IssuingCardAuthorizationControls] instance.
  ...
  List<IssuingCardAuthorizationControlsAllowedCategoriesEnum>? allowedCategories;
  ...
  List<IssuingCardAuthorizationControlsBlockedCategoriesEnum>? blockedCategories;

  /// Array of strings containing representing countries from which authorizations will be declined. Country codes should be ISO 3166 alpha-2 country codes (e.g. `US`). Cannot be set with `allowed_merchant_countries`. Provide an empty value to unset this control.
  List<String>? blockedMerchantCountries;

  /// Limit spending with amount-based rules that apply across any cards this card replaced (i.e., its `replacement_for` card and _that_ card's `replacement_for` card, up the chain).
  List<IssuingCardSpendingLimit>? spendingLimits;

  /// Currency of the amounts within `spending_limits`. Always the same as the currency of the card.
  String? spendingLimitsCurrency;

  @override
  bool operator ==(Object other) => identical(this, other) || other is IssuingCardAuthorizationControls &&
  ...
  @override
  String toString() => 'IssuingCardAuthorizationControls[allowedCategories=$allowedCategories, allowedMerchantCountries=$allowedMerchantCountries, blockedCategories=$blockedCategories, blockedMerchantCountries=$blockedMerchantCountries, spendingLimits=$spendingLimits, spendingLimitsCurrency=$spendingLimitsCurrency]';
  ...
  /// Returns a new [IssuingCardAuthorizationControls] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IssuingCardAuthorizationControls? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IssuingCardAuthorizationControls[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IssuingCardAuthorizationControls[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IssuingCardAuthorizationControls(
        ...
        blockedMerchantCountries: json[r'blocked_merchant_countries'] is Iterable
            ...
            : const [],
        spendingLimits: IssuingCardSpendingLimit.listFromJson(json[r'spending_limits']),
  ...
  static List<IssuingCardAuthorizationControls> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IssuingCardAuthorizationControls>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IssuingCardAuthorizationControls.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IssuingCardAuthorizationControls> mapFromJson(dynamic json) {
    final map = <String, IssuingCardAuthorizationControls>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IssuingCardAuthorizationControls.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IssuingCardAuthorizationControls-objects as value to a dart map
  static Map<String, List<IssuingCardAuthorizationControls>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IssuingCardAuthorizationControls>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IssuingCardAuthorizationControls.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
