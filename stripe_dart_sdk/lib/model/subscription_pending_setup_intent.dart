...
class SubscriptionPendingSetupIntent {
  /// Returns a new [SubscriptionPendingSetupIntent] instance.
  ...
  SubscriptionPendingSetupIntentCancellationReasonEnum? cancellationReason;
  ...
  SubscriptionPendingSetupIntentObjectEnum object;
  ...
  SubscriptionPendingSetupIntentStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SubscriptionPendingSetupIntent &&
  ...
  /// Returns a new [SubscriptionPendingSetupIntent] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SubscriptionPendingSetupIntent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SubscriptionPendingSetupIntent[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SubscriptionPendingSetupIntent[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SubscriptionPendingSetupIntent(
        ...
        cancellationReason: SubscriptionPendingSetupIntentCancellationReasonEnum.fromJson(json[r'cancellation_reason']),
        ...
        object: SubscriptionPendingSetupIntentObjectEnum.fromJson(json[r'object'])!,
        ...
        status: SubscriptionPendingSetupIntentStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<SubscriptionPendingSetupIntent> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionPendingSetupIntent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionPendingSetupIntent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SubscriptionPendingSetupIntent> mapFromJson(dynamic json) {
    final map = <String, SubscriptionPendingSetupIntent>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SubscriptionPendingSetupIntent.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SubscriptionPendingSetupIntent-objects as value to a dart map
  static Map<String, List<SubscriptionPendingSetupIntent>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SubscriptionPendingSetupIntent>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SubscriptionPendingSetupIntent.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Reason for cancellation of this SetupIntent, one of `abandoned`, `requested_by_customer`, or `duplicate`.
class SubscriptionPendingSetupIntentCancellationReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionPendingSetupIntentCancellationReasonEnum._(this.value);
  ...
  static const abandoned = SubscriptionPendingSetupIntentCancellationReasonEnum._(r'abandoned');
  static const duplicate = SubscriptionPendingSetupIntentCancellationReasonEnum._(r'duplicate');
  static const requestedByCustomer = SubscriptionPendingSetupIntentCancellationReasonEnum._(r'requested_by_customer');

  /// List of all possible values in this [enum][SubscriptionPendingSetupIntentCancellationReasonEnum].
  static const values = <SubscriptionPendingSetupIntentCancellationReasonEnum>[
    abandoned,
    duplicate,
    requestedByCustomer,
  ];

  static SubscriptionPendingSetupIntentCancellationReasonEnum? fromJson(dynamic value) => SubscriptionPendingSetupIntentCancellationReasonEnumTypeTransformer().decode(value);

  static List<SubscriptionPendingSetupIntentCancellationReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionPendingSetupIntentCancellationReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionPendingSetupIntentCancellationReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionPendingSetupIntentCancellationReasonEnum] to String,
/// and [decode] dynamic data back to [SubscriptionPendingSetupIntentCancellationReasonEnum].
class SubscriptionPendingSetupIntentCancellationReasonEnumTypeTransformer {
  factory SubscriptionPendingSetupIntentCancellationReasonEnumTypeTransformer() => _instance ??= const SubscriptionPendingSetupIntentCancellationReasonEnumTypeTransformer._();

  const SubscriptionPendingSetupIntentCancellationReasonEnumTypeTransformer._();

  String encode(SubscriptionPendingSetupIntentCancellationReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionPendingSetupIntentCancellationReasonEnum.
  ///
  ...
  SubscriptionPendingSetupIntentCancellationReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'abandoned': return SubscriptionPendingSetupIntentCancellationReasonEnum.abandoned;
        case r'duplicate': return SubscriptionPendingSetupIntentCancellationReasonEnum.duplicate;
        case r'requested_by_customer': return SubscriptionPendingSetupIntentCancellationReasonEnum.requestedByCustomer;
        default:
          if (!allowNull) {
  ...
  /// Singleton [SubscriptionPendingSetupIntentCancellationReasonEnumTypeTransformer] instance.
  static SubscriptionPendingSetupIntentCancellationReasonEnumTypeTransformer? _instance;
}
...
/// String representing the object's type. Objects of the same type share the same value.
class SubscriptionPendingSetupIntentObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionPendingSetupIntentObjectEnum._(this.value);
  ...
  static const setupIntent = SubscriptionPendingSetupIntentObjectEnum._(r'setup_intent');

  /// List of all possible values in this [enum][SubscriptionPendingSetupIntentObjectEnum].
  static const values = <SubscriptionPendingSetupIntentObjectEnum>[
    setupIntent,
  ];

  static SubscriptionPendingSetupIntentObjectEnum? fromJson(dynamic value) => SubscriptionPendingSetupIntentObjectEnumTypeTransformer().decode(value);

  static List<SubscriptionPendingSetupIntentObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionPendingSetupIntentObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionPendingSetupIntentObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionPendingSetupIntentObjectEnum] to String,
/// and [decode] dynamic data back to [SubscriptionPendingSetupIntentObjectEnum].
class SubscriptionPendingSetupIntentObjectEnumTypeTransformer {
  factory SubscriptionPendingSetupIntentObjectEnumTypeTransformer() => _instance ??= const SubscriptionPendingSetupIntentObjectEnumTypeTransformer._();

  const SubscriptionPendingSetupIntentObjectEnumTypeTransformer._();

  String encode(SubscriptionPendingSetupIntentObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionPendingSetupIntentObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionPendingSetupIntentObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'setup_intent': return SubscriptionPendingSetupIntentObjectEnum.setupIntent;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionPendingSetupIntentObjectEnumTypeTransformer] instance.
  static SubscriptionPendingSetupIntentObjectEnumTypeTransformer? _instance;
}


/// [Status](https://stripe.com/docs/payments/intents#intent-statuses) of this SetupIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `canceled`, or `succeeded`.
class SubscriptionPendingSetupIntentStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionPendingSetupIntentStatusEnum._(this.value);
  ...
  static const canceled = SubscriptionPendingSetupIntentStatusEnum._(r'canceled');
  static const processing = SubscriptionPendingSetupIntentStatusEnum._(r'processing');
  static const requiresAction = SubscriptionPendingSetupIntentStatusEnum._(r'requires_action');
  static const requiresConfirmation = SubscriptionPendingSetupIntentStatusEnum._(r'requires_confirmation');
  static const requiresPaymentMethod = SubscriptionPendingSetupIntentStatusEnum._(r'requires_payment_method');
  static const succeeded = SubscriptionPendingSetupIntentStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][SubscriptionPendingSetupIntentStatusEnum].
  static const values = <SubscriptionPendingSetupIntentStatusEnum>[
    canceled,
    processing,
    requiresAction,
  ...
  static SubscriptionPendingSetupIntentStatusEnum? fromJson(dynamic value) => SubscriptionPendingSetupIntentStatusEnumTypeTransformer().decode(value);

  static List<SubscriptionPendingSetupIntentStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionPendingSetupIntentStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionPendingSetupIntentStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionPendingSetupIntentStatusEnum] to String,
/// and [decode] dynamic data back to [SubscriptionPendingSetupIntentStatusEnum].
class SubscriptionPendingSetupIntentStatusEnumTypeTransformer {
  factory SubscriptionPendingSetupIntentStatusEnumTypeTransformer() => _instance ??= const SubscriptionPendingSetupIntentStatusEnumTypeTransformer._();

  const SubscriptionPendingSetupIntentStatusEnumTypeTransformer._();

  String encode(SubscriptionPendingSetupIntentStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionPendingSetupIntentStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionPendingSetupIntentStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'canceled': return SubscriptionPendingSetupIntentStatusEnum.canceled;
        case r'processing': return SubscriptionPendingSetupIntentStatusEnum.processing;
        case r'requires_action': return SubscriptionPendingSetupIntentStatusEnum.requiresAction;
        case r'requires_confirmation': return SubscriptionPendingSetupIntentStatusEnum.requiresConfirmation;
        case r'requires_payment_method': return SubscriptionPendingSetupIntentStatusEnum.requiresPaymentMethod;
        case r'succeeded': return SubscriptionPendingSetupIntentStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionPendingSetupIntentStatusEnumTypeTransformer] instance.
  static SubscriptionPendingSetupIntentStatusEnumTypeTransformer? _instance;
}
