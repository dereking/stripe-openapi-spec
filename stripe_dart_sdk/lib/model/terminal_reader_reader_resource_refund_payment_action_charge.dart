...
class TerminalReaderReaderResourceRefundPaymentActionCharge {
  /// Returns a new [TerminalReaderReaderResourceRefundPaymentActionCharge] instance.
  ...
  TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum object;
  ...
  TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TerminalReaderReaderResourceRefundPaymentActionCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [TerminalReaderReaderResourceRefundPaymentActionCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TerminalReaderReaderResourceRefundPaymentActionCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TerminalReaderReaderResourceRefundPaymentActionCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TerminalReaderReaderResourceRefundPaymentActionCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return TerminalReaderReaderResourceRefundPaymentActionCharge(
        ...
        object: TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<TerminalReaderReaderResourceRefundPaymentActionCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TerminalReaderReaderResourceRefundPaymentActionCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TerminalReaderReaderResourceRefundPaymentActionCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TerminalReaderReaderResourceRefundPaymentActionCharge> mapFromJson(dynamic json) {
    final map = <String, TerminalReaderReaderResourceRefundPaymentActionCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TerminalReaderReaderResourceRefundPaymentActionCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TerminalReaderReaderResourceRefundPaymentActionCharge-objects as value to a dart map
  static Map<String, List<TerminalReaderReaderResourceRefundPaymentActionCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TerminalReaderReaderResourceRefundPaymentActionCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TerminalReaderReaderResourceRefundPaymentActionCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum._(this.value);
  ...
  static const charge = TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum].
  static const values = <TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum>[
    charge,
  ];

  static TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum? fromJson(dynamic value) => TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnumTypeTransformer().decode(value);

  static List<TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum] to String,
/// and [decode] dynamic data back to [TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum].
class TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnumTypeTransformer {
  factory TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnumTypeTransformer() => _instance ??= const TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnumTypeTransformer._();

  const TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnumTypeTransformer._();

  String encode(TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum.
  ///
  ...
  TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnumTypeTransformer] instance.
  static TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum._(this.value);
  ...
  static const failed = TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum._(r'failed');
  static const pending = TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum._(r'pending');
  static const succeeded = TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum].
  static const values = <TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum? fromJson(dynamic value) => TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnumTypeTransformer().decode(value);

  static List<TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum] to String,
/// and [decode] dynamic data back to [TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum].
class TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnumTypeTransformer {
  factory TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnumTypeTransformer() => _instance ??= const TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnumTypeTransformer._();

  const TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnumTypeTransformer._();

  String encode(TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum.failed;
        case r'pending': return TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum.pending;
        case r'succeeded': return TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnumTypeTransformer] instance.
  static TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnumTypeTransformer? _instance;
}
