...
class SessionOptionsParamDocument {
  /// Returns a new [SessionOptionsParamDocument] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SessionOptionsParamDocument &&
  ...
  @override
  String toString() => 'SessionOptionsParamDocument[allowedTypes=$allowedTypes, requireIdNumber=$requireIdNumber, requireLiveCapture=$requireLiveCapture, requireMatchingSelfie=$requireMatchingSelfie]';
  ...
  /// Returns a new [SessionOptionsParamDocument] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SessionOptionsParamDocument? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SessionOptionsParamDocument[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SessionOptionsParamDocument[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SessionOptionsParamDocument(
  ...
  static List<SessionOptionsParamDocument> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SessionOptionsParamDocument>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SessionOptionsParamDocument.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SessionOptionsParamDocument> mapFromJson(dynamic json) {
    final map = <String, SessionOptionsParamDocument>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SessionOptionsParamDocument.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SessionOptionsParamDocument-objects as value to a dart map
  static Map<String, List<SessionOptionsParamDocument>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SessionOptionsParamDocument>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SessionOptionsParamDocument.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
