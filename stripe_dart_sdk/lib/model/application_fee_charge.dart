...
class ApplicationFeeCharge {
  /// Returns a new [ApplicationFeeCharge] instance.
  ...
  ApplicationFeeChargeObjectEnum object;
  ...
  ApplicationFeeChargeStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApplicationFeeCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [ApplicationFeeCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApplicationFeeCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApplicationFeeCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApplicationFeeCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ApplicationFeeCharge(
        ...
        object: ApplicationFeeChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: ApplicationFeeChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<ApplicationFeeCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFeeCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationFeeCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApplicationFeeCharge> mapFromJson(dynamic json) {
    final map = <String, ApplicationFeeCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApplicationFeeCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ApplicationFeeCharge-objects as value to a dart map
  static Map<String, List<ApplicationFeeCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApplicationFeeCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApplicationFeeCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class ApplicationFeeChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const ApplicationFeeChargeObjectEnum._(this.value);
  ...
  static const charge = ApplicationFeeChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][ApplicationFeeChargeObjectEnum].
  static const values = <ApplicationFeeChargeObjectEnum>[
    charge,
  ];

  static ApplicationFeeChargeObjectEnum? fromJson(dynamic value) => ApplicationFeeChargeObjectEnumTypeTransformer().decode(value);

  static List<ApplicationFeeChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFeeChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationFeeChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApplicationFeeChargeObjectEnum] to String,
/// and [decode] dynamic data back to [ApplicationFeeChargeObjectEnum].
class ApplicationFeeChargeObjectEnumTypeTransformer {
  factory ApplicationFeeChargeObjectEnumTypeTransformer() => _instance ??= const ApplicationFeeChargeObjectEnumTypeTransformer._();

  const ApplicationFeeChargeObjectEnumTypeTransformer._();

  String encode(ApplicationFeeChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApplicationFeeChargeObjectEnum.
  ///
  ...
  ApplicationFeeChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return ApplicationFeeChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [ApplicationFeeChargeObjectEnumTypeTransformer] instance.
  static ApplicationFeeChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class ApplicationFeeChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const ApplicationFeeChargeStatusEnum._(this.value);
  ...
  static const failed = ApplicationFeeChargeStatusEnum._(r'failed');
  static const pending = ApplicationFeeChargeStatusEnum._(r'pending');
  static const succeeded = ApplicationFeeChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][ApplicationFeeChargeStatusEnum].
  static const values = <ApplicationFeeChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static ApplicationFeeChargeStatusEnum? fromJson(dynamic value) => ApplicationFeeChargeStatusEnumTypeTransformer().decode(value);

  static List<ApplicationFeeChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFeeChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationFeeChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApplicationFeeChargeStatusEnum] to String,
/// and [decode] dynamic data back to [ApplicationFeeChargeStatusEnum].
class ApplicationFeeChargeStatusEnumTypeTransformer {
  factory ApplicationFeeChargeStatusEnumTypeTransformer() => _instance ??= const ApplicationFeeChargeStatusEnumTypeTransformer._();

  const ApplicationFeeChargeStatusEnumTypeTransformer._();

  String encode(ApplicationFeeChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApplicationFeeChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ApplicationFeeChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return ApplicationFeeChargeStatusEnum.failed;
        case r'pending': return ApplicationFeeChargeStatusEnum.pending;
        case r'succeeded': return ApplicationFeeChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ApplicationFeeChargeStatusEnumTypeTransformer] instance.
  static ApplicationFeeChargeStatusEnumTypeTransformer? _instance;
}
