...
class ExternalAccount {
  /// Returns a new [ExternalAccount] instance.
  ExternalAccount({
    this.account,
  ...
  ExternalAccountObjectEnum object;
  ...
  ExternalAccountAllowRedisplayEnum? allowRedisplay;
  ...
  ExternalAccountRegulatedStatusEnum? regulatedStatus;

  /// If the card number is tokenized, this is the method that was used. Can be `android_pay` (includes Google Pay), `apple_pay`, `masterpass`, `visa_checkout`, or null.
  String? tokenizationMethod;

  @override
  bool operator ==(Object other) => identical(this, other) || other is ExternalAccount &&
  ...
  /// Returns a new [ExternalAccount] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ExternalAccount? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ExternalAccount[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ExternalAccount[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ExternalAccount(
        ...
        object: ExternalAccountObjectEnum.fromJson(json[r'object'])!,
        ...
        allowRedisplay: ExternalAccountAllowRedisplayEnum.fromJson(json[r'allow_redisplay']),
        ...
        regulatedStatus: ExternalAccountRegulatedStatusEnum.fromJson(json[r'regulated_status']),
  ...
  static List<ExternalAccount> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExternalAccount>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExternalAccount.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ExternalAccount> mapFromJson(dynamic json) {
    final map = <String, ExternalAccount>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ExternalAccount.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ExternalAccount-objects as value to a dart map
  static Map<String, List<ExternalAccount>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ExternalAccount>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ExternalAccount.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class ExternalAccountObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const ExternalAccountObjectEnum._(this.value);
  ...
  static const card = ExternalAccountObjectEnum._(r'card');

  /// List of all possible values in this [enum][ExternalAccountObjectEnum].
  static const values = <ExternalAccountObjectEnum>[
    card,
  ];

  static ExternalAccountObjectEnum? fromJson(dynamic value) => ExternalAccountObjectEnumTypeTransformer().decode(value);

  static List<ExternalAccountObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExternalAccountObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExternalAccountObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ExternalAccountObjectEnum] to String,
/// and [decode] dynamic data back to [ExternalAccountObjectEnum].
class ExternalAccountObjectEnumTypeTransformer {
  factory ExternalAccountObjectEnumTypeTransformer() => _instance ??= const ExternalAccountObjectEnumTypeTransformer._();

  const ExternalAccountObjectEnumTypeTransformer._();

  String encode(ExternalAccountObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ExternalAccountObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ExternalAccountObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'card': return ExternalAccountObjectEnum.card;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ExternalAccountObjectEnumTypeTransformer] instance.
  static ExternalAccountObjectEnumTypeTransformer? _instance;
}


/// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
class ExternalAccountAllowRedisplayEnum {
  /// Instantiate a new enum with the provided [value].
  const ExternalAccountAllowRedisplayEnum._(this.value);
  ...
  static const always = ExternalAccountAllowRedisplayEnum._(r'always');
  static const limited = ExternalAccountAllowRedisplayEnum._(r'limited');
  static const unspecified = ExternalAccountAllowRedisplayEnum._(r'unspecified');

  /// List of all possible values in this [enum][ExternalAccountAllowRedisplayEnum].
  static const values = <ExternalAccountAllowRedisplayEnum>[
    always,
    limited,
    unspecified,
  ];

  static ExternalAccountAllowRedisplayEnum? fromJson(dynamic value) => ExternalAccountAllowRedisplayEnumTypeTransformer().decode(value);

  static List<ExternalAccountAllowRedisplayEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExternalAccountAllowRedisplayEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExternalAccountAllowRedisplayEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ExternalAccountAllowRedisplayEnum] to String,
/// and [decode] dynamic data back to [ExternalAccountAllowRedisplayEnum].
class ExternalAccountAllowRedisplayEnumTypeTransformer {
  factory ExternalAccountAllowRedisplayEnumTypeTransformer() => _instance ??= const ExternalAccountAllowRedisplayEnumTypeTransformer._();

  const ExternalAccountAllowRedisplayEnumTypeTransformer._();

  String encode(ExternalAccountAllowRedisplayEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ExternalAccountAllowRedisplayEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ExternalAccountAllowRedisplayEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'always': return ExternalAccountAllowRedisplayEnum.always;
        case r'limited': return ExternalAccountAllowRedisplayEnum.limited;
        case r'unspecified': return ExternalAccountAllowRedisplayEnum.unspecified;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ExternalAccountAllowRedisplayEnumTypeTransformer] instance.
  static ExternalAccountAllowRedisplayEnumTypeTransformer? _instance;
}


/// Status of a card based on the card issuer.
class ExternalAccountRegulatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const ExternalAccountRegulatedStatusEnum._(this.value);
  ...
  static const regulated = ExternalAccountRegulatedStatusEnum._(r'regulated');
  static const unregulated = ExternalAccountRegulatedStatusEnum._(r'unregulated');

  /// List of all possible values in this [enum][ExternalAccountRegulatedStatusEnum].
  static const values = <ExternalAccountRegulatedStatusEnum>[
    regulated,
    unregulated,
  ];

  static ExternalAccountRegulatedStatusEnum? fromJson(dynamic value) => ExternalAccountRegulatedStatusEnumTypeTransformer().decode(value);

  static List<ExternalAccountRegulatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ExternalAccountRegulatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ExternalAccountRegulatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ExternalAccountRegulatedStatusEnum] to String,
/// and [decode] dynamic data back to [ExternalAccountRegulatedStatusEnum].
class ExternalAccountRegulatedStatusEnumTypeTransformer {
  factory ExternalAccountRegulatedStatusEnumTypeTransformer() => _instance ??= const ExternalAccountRegulatedStatusEnumTypeTransformer._();

  const ExternalAccountRegulatedStatusEnumTypeTransformer._();

  String encode(ExternalAccountRegulatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ExternalAccountRegulatedStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ExternalAccountRegulatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'regulated': return ExternalAccountRegulatedStatusEnum.regulated;
        case r'unregulated': return ExternalAccountRegulatedStatusEnum.unregulated;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ExternalAccountRegulatedStatusEnumTypeTransformer] instance.
  static ExternalAccountRegulatedStatusEnumTypeTransformer? _instance;
}
