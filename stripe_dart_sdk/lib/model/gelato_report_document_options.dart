...
class GelatoReportDocumentOptions {
  /// Returns a new [GelatoReportDocumentOptions] instance.
  ...
  List<GelatoReportDocumentOptionsAllowedTypesEnum> allowedTypes;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GelatoReportDocumentOptions &&
  ...
  @override
  String toString() => 'GelatoReportDocumentOptions[allowedTypes=$allowedTypes, requireIdNumber=$requireIdNumber, requireLiveCapture=$requireLiveCapture, requireMatchingSelfie=$requireMatchingSelfie]';
  ...
  /// Returns a new [GelatoReportDocumentOptions] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GelatoReportDocumentOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GelatoReportDocumentOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GelatoReportDocumentOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GelatoReportDocumentOptions> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GelatoReportDocumentOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GelatoReportDocumentOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GelatoReportDocumentOptions> mapFromJson(dynamic json) {
    final map = <String, GelatoReportDocumentOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GelatoReportDocumentOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GelatoReportDocumentOptions-objects as value to a dart map
  static Map<String, List<GelatoReportDocumentOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GelatoReportDocumentOptions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GelatoReportDocumentOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
