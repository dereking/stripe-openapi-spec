...
class BusinessProfileUpdateSpecs {
  /// Returns a new [BusinessProfileUpdateSpecs] instance.
  BusinessProfileUpdateSpecs({
    this.annualRevenue,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BusinessProfileUpdateSpecs &&
  ...
  /// Returns a new [BusinessProfileUpdateSpecs] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static BusinessProfileUpdateSpecs? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "BusinessProfileUpdateSpecs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "BusinessProfileUpdateSpecs[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return BusinessProfileUpdateSpecs(
  ...
  static List<BusinessProfileUpdateSpecs> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <BusinessProfileUpdateSpecs>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = BusinessProfileUpdateSpecs.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, BusinessProfileUpdateSpecs> mapFromJson(dynamic json) {
    final map = <String, BusinessProfileUpdateSpecs>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = BusinessProfileUpdateSpecs.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of BusinessProfileUpdateSpecs-objects as value to a dart map
  static Map<String, List<BusinessProfileUpdateSpecs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<BusinessProfileUpdateSpecs>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = BusinessProfileUpdateSpecs.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
