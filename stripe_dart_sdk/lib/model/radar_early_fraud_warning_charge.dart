...
class RadarEarlyFraudWarningCharge {
  /// Returns a new [RadarEarlyFraudWarningCharge] instance.
  ...
  RadarEarlyFraudWarningChargeObjectEnum object;
  ...
  RadarEarlyFraudWarningChargeStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RadarEarlyFraudWarningCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [RadarEarlyFraudWarningCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RadarEarlyFraudWarningCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RadarEarlyFraudWarningCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RadarEarlyFraudWarningCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return RadarEarlyFraudWarningCharge(
        ...
        object: RadarEarlyFraudWarningChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: RadarEarlyFraudWarningChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<RadarEarlyFraudWarningCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RadarEarlyFraudWarningCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RadarEarlyFraudWarningCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RadarEarlyFraudWarningCharge> mapFromJson(dynamic json) {
    final map = <String, RadarEarlyFraudWarningCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RadarEarlyFraudWarningCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RadarEarlyFraudWarningCharge-objects as value to a dart map
  static Map<String, List<RadarEarlyFraudWarningCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RadarEarlyFraudWarningCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RadarEarlyFraudWarningCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class RadarEarlyFraudWarningChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const RadarEarlyFraudWarningChargeObjectEnum._(this.value);
  ...
  static const charge = RadarEarlyFraudWarningChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][RadarEarlyFraudWarningChargeObjectEnum].
  static const values = <RadarEarlyFraudWarningChargeObjectEnum>[
    charge,
  ];

  static RadarEarlyFraudWarningChargeObjectEnum? fromJson(dynamic value) => RadarEarlyFraudWarningChargeObjectEnumTypeTransformer().decode(value);

  static List<RadarEarlyFraudWarningChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RadarEarlyFraudWarningChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RadarEarlyFraudWarningChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [RadarEarlyFraudWarningChargeObjectEnum] to String,
/// and [decode] dynamic data back to [RadarEarlyFraudWarningChargeObjectEnum].
class RadarEarlyFraudWarningChargeObjectEnumTypeTransformer {
  factory RadarEarlyFraudWarningChargeObjectEnumTypeTransformer() => _instance ??= const RadarEarlyFraudWarningChargeObjectEnumTypeTransformer._();

  const RadarEarlyFraudWarningChargeObjectEnumTypeTransformer._();

  String encode(RadarEarlyFraudWarningChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a RadarEarlyFraudWarningChargeObjectEnum.
  ///
  ...
  RadarEarlyFraudWarningChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return RadarEarlyFraudWarningChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [RadarEarlyFraudWarningChargeObjectEnumTypeTransformer] instance.
  static RadarEarlyFraudWarningChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class RadarEarlyFraudWarningChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const RadarEarlyFraudWarningChargeStatusEnum._(this.value);
  ...
  static const failed = RadarEarlyFraudWarningChargeStatusEnum._(r'failed');
  static const pending = RadarEarlyFraudWarningChargeStatusEnum._(r'pending');
  static const succeeded = RadarEarlyFraudWarningChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][RadarEarlyFraudWarningChargeStatusEnum].
  static const values = <RadarEarlyFraudWarningChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static RadarEarlyFraudWarningChargeStatusEnum? fromJson(dynamic value) => RadarEarlyFraudWarningChargeStatusEnumTypeTransformer().decode(value);

  static List<RadarEarlyFraudWarningChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RadarEarlyFraudWarningChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RadarEarlyFraudWarningChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [RadarEarlyFraudWarningChargeStatusEnum] to String,
/// and [decode] dynamic data back to [RadarEarlyFraudWarningChargeStatusEnum].
class RadarEarlyFraudWarningChargeStatusEnumTypeTransformer {
  factory RadarEarlyFraudWarningChargeStatusEnumTypeTransformer() => _instance ??= const RadarEarlyFraudWarningChargeStatusEnumTypeTransformer._();

  const RadarEarlyFraudWarningChargeStatusEnumTypeTransformer._();

  String encode(RadarEarlyFraudWarningChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a RadarEarlyFraudWarningChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  RadarEarlyFraudWarningChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return RadarEarlyFraudWarningChargeStatusEnum.failed;
        case r'pending': return RadarEarlyFraudWarningChargeStatusEnum.pending;
        case r'succeeded': return RadarEarlyFraudWarningChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [RadarEarlyFraudWarningChargeStatusEnumTypeTransformer] instance.
  static RadarEarlyFraudWarningChargeStatusEnumTypeTransformer? _instance;
}
