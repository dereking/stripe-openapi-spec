...
class SubscriptionScheduleSubscription {
  /// Returns a new [SubscriptionScheduleSubscription] instance.
  ...
  SubscriptionScheduleSubscriptionCollectionMethodEnum collectionMethod;
  ...
  SubscriptionScheduleSubscriptionObjectEnum object;
  ...
  SubscriptionScheduleSubscriptionStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SubscriptionScheduleSubscription &&
  ...
  /// Returns a new [SubscriptionScheduleSubscription] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SubscriptionScheduleSubscription? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SubscriptionScheduleSubscription[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SubscriptionScheduleSubscription[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SubscriptionScheduleSubscription(
        ...
        collectionMethod: SubscriptionScheduleSubscriptionCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        object: SubscriptionScheduleSubscriptionObjectEnum.fromJson(json[r'object'])!,
        ...
        status: SubscriptionScheduleSubscriptionStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<SubscriptionScheduleSubscription> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionScheduleSubscription>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionScheduleSubscription.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SubscriptionScheduleSubscription> mapFromJson(dynamic json) {
    final map = <String, SubscriptionScheduleSubscription>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SubscriptionScheduleSubscription.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SubscriptionScheduleSubscription-objects as value to a dart map
  static Map<String, List<SubscriptionScheduleSubscription>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SubscriptionScheduleSubscription>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SubscriptionScheduleSubscription.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this subscription at the end of the cycle using the default source attached to the customer. When sending an invoice, Stripe will email your customer an invoice with payment instructions and mark the subscription as `active`.
class SubscriptionScheduleSubscriptionCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionScheduleSubscriptionCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = SubscriptionScheduleSubscriptionCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = SubscriptionScheduleSubscriptionCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][SubscriptionScheduleSubscriptionCollectionMethodEnum].
  static const values = <SubscriptionScheduleSubscriptionCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static SubscriptionScheduleSubscriptionCollectionMethodEnum? fromJson(dynamic value) => SubscriptionScheduleSubscriptionCollectionMethodEnumTypeTransformer().decode(value);

  static List<SubscriptionScheduleSubscriptionCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionScheduleSubscriptionCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionScheduleSubscriptionCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionScheduleSubscriptionCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [SubscriptionScheduleSubscriptionCollectionMethodEnum].
class SubscriptionScheduleSubscriptionCollectionMethodEnumTypeTransformer {
  factory SubscriptionScheduleSubscriptionCollectionMethodEnumTypeTransformer() => _instance ??= const SubscriptionScheduleSubscriptionCollectionMethodEnumTypeTransformer._();

  const SubscriptionScheduleSubscriptionCollectionMethodEnumTypeTransformer._();

  String encode(SubscriptionScheduleSubscriptionCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionScheduleSubscriptionCollectionMethodEnum.
  ///
  ...
  SubscriptionScheduleSubscriptionCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return SubscriptionScheduleSubscriptionCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return SubscriptionScheduleSubscriptionCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
  ...
  /// Singleton [SubscriptionScheduleSubscriptionCollectionMethodEnumTypeTransformer] instance.
  static SubscriptionScheduleSubscriptionCollectionMethodEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class SubscriptionScheduleSubscriptionObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionScheduleSubscriptionObjectEnum._(this.value);
  ...
  static const subscription = SubscriptionScheduleSubscriptionObjectEnum._(r'subscription');

  /// List of all possible values in this [enum][SubscriptionScheduleSubscriptionObjectEnum].
  static const values = <SubscriptionScheduleSubscriptionObjectEnum>[
    subscription,
  ];

  static SubscriptionScheduleSubscriptionObjectEnum? fromJson(dynamic value) => SubscriptionScheduleSubscriptionObjectEnumTypeTransformer().decode(value);

  static List<SubscriptionScheduleSubscriptionObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionScheduleSubscriptionObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionScheduleSubscriptionObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionScheduleSubscriptionObjectEnum] to String,
/// and [decode] dynamic data back to [SubscriptionScheduleSubscriptionObjectEnum].
class SubscriptionScheduleSubscriptionObjectEnumTypeTransformer {
  factory SubscriptionScheduleSubscriptionObjectEnumTypeTransformer() => _instance ??= const SubscriptionScheduleSubscriptionObjectEnumTypeTransformer._();

  const SubscriptionScheduleSubscriptionObjectEnumTypeTransformer._();

  String encode(SubscriptionScheduleSubscriptionObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionScheduleSubscriptionObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionScheduleSubscriptionObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'subscription': return SubscriptionScheduleSubscriptionObjectEnum.subscription;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionScheduleSubscriptionObjectEnumTypeTransformer] instance.
  static SubscriptionScheduleSubscriptionObjectEnumTypeTransformer? _instance;
}


/// Possible values are `incomplete`, `incomplete_expired`, `trialing`, `active`, `past_due`, `canceled`, `unpaid`, or `paused`.   For `collection_method=charge_automatically` a subscription moves into `incomplete` if the initial payment attempt fails. A subscription in this status can only have metadata and default_source updated. Once the first invoice is paid, the subscription moves into an `active` status. If the first invoice is not paid within 23 hours, the subscription transitions to `incomplete_expired`. This is a terminal status, the open invoice will be voided and no further invoices will be generated.   A subscription that is currently in a trial period is `trialing` and moves to `active` when the trial period is over.   A subscription can only enter a `paused` status [when a trial ends without a payment method](https://stripe.com/docs/billing/subscriptions/trials#create-free-trials-without-payment). A `paused` subscription doesn't generate invoices and can be resumed after your customer adds their payment method. The `paused` status is different from [pausing collection](https://stripe.com/docs/billing/subscriptions/pause-payment), which still generates invoices and leaves the subscription's status unchanged.   If subscription `collection_method=charge_automatically`, it becomes `past_due` when payment is required but cannot be paid (due to failed payment or awaiting additional user actions). Once Stripe has exhausted all payment retry attempts, the subscription will become `canceled` or `unpaid` (depending on your subscriptions settings).   If subscription `collection_method=send_invoice` it becomes `past_due` when its invoice is not paid by the due date, and `canceled` or `unpaid` if it is still not paid by an additional deadline after that. Note that when a subscription has a status of `unpaid`, no subsequent invoices will be attempted (invoices will be created, but then immediately automatically closed). After receiving updated payment information from a customer, you may choose to reopen and pay their closed invoices.
class SubscriptionScheduleSubscriptionStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionScheduleSubscriptionStatusEnum._(this.value);
  ...
  static const active = SubscriptionScheduleSubscriptionStatusEnum._(r'active');
  static const canceled = SubscriptionScheduleSubscriptionStatusEnum._(r'canceled');
  static const incomplete = SubscriptionScheduleSubscriptionStatusEnum._(r'incomplete');
  static const incompleteExpired = SubscriptionScheduleSubscriptionStatusEnum._(r'incomplete_expired');
  static const pastDue = SubscriptionScheduleSubscriptionStatusEnum._(r'past_due');
  static const paused = SubscriptionScheduleSubscriptionStatusEnum._(r'paused');
  static const trialing = SubscriptionScheduleSubscriptionStatusEnum._(r'trialing');
  static const unpaid = SubscriptionScheduleSubscriptionStatusEnum._(r'unpaid');

  /// List of all possible values in this [enum][SubscriptionScheduleSubscriptionStatusEnum].
  static const values = <SubscriptionScheduleSubscriptionStatusEnum>[
    active,
    canceled,
    incomplete,
    incompleteExpired,
  ...
  static SubscriptionScheduleSubscriptionStatusEnum? fromJson(dynamic value) => SubscriptionScheduleSubscriptionStatusEnumTypeTransformer().decode(value);

  static List<SubscriptionScheduleSubscriptionStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionScheduleSubscriptionStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionScheduleSubscriptionStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionScheduleSubscriptionStatusEnum] to String,
/// and [decode] dynamic data back to [SubscriptionScheduleSubscriptionStatusEnum].
class SubscriptionScheduleSubscriptionStatusEnumTypeTransformer {
  factory SubscriptionScheduleSubscriptionStatusEnumTypeTransformer() => _instance ??= const SubscriptionScheduleSubscriptionStatusEnumTypeTransformer._();

  const SubscriptionScheduleSubscriptionStatusEnumTypeTransformer._();

  String encode(SubscriptionScheduleSubscriptionStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionScheduleSubscriptionStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionScheduleSubscriptionStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return SubscriptionScheduleSubscriptionStatusEnum.active;
        case r'canceled': return SubscriptionScheduleSubscriptionStatusEnum.canceled;
        case r'incomplete': return SubscriptionScheduleSubscriptionStatusEnum.incomplete;
        case r'incomplete_expired': return SubscriptionScheduleSubscriptionStatusEnum.incompleteExpired;
        case r'past_due': return SubscriptionScheduleSubscriptionStatusEnum.pastDue;
        case r'paused': return SubscriptionScheduleSubscriptionStatusEnum.paused;
        case r'trialing': return SubscriptionScheduleSubscriptionStatusEnum.trialing;
        case r'unpaid': return SubscriptionScheduleSubscriptionStatusEnum.unpaid;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionScheduleSubscriptionStatusEnumTypeTransformer] instance.
  static SubscriptionScheduleSubscriptionStatusEnumTypeTransformer? _instance;
}
