...
class InvoiceLatestRevision {
  /// Returns a new [InvoiceLatestRevision] instance.
  ...
  InvoiceLatestRevisionBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  InvoiceLatestRevisionCollectionMethodEnum collectionMethod;
  ...
  InvoiceLatestRevisionCustomerTaxExemptEnum? customerTaxExempt;
  ...
  InvoiceLatestRevisionObjectEnum object;
  ...
  InvoiceLatestRevisionStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoiceLatestRevision &&
  ...
  /// Returns a new [InvoiceLatestRevision] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoiceLatestRevision? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoiceLatestRevision[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoiceLatestRevision[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InvoiceLatestRevision(
        ...
        billingReason: InvoiceLatestRevisionBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: InvoiceLatestRevisionCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: InvoiceLatestRevisionCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: InvoiceLatestRevisionObjectEnum.fromJson(json[r'object'])!,
        ...
        status: InvoiceLatestRevisionStatusEnum.fromJson(json[r'status']),
  ...
  static List<InvoiceLatestRevision> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceLatestRevision>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceLatestRevision.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoiceLatestRevision> mapFromJson(dynamic json) {
    final map = <String, InvoiceLatestRevision>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoiceLatestRevision.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoiceLatestRevision-objects as value to a dart map
  static Map<String, List<InvoiceLatestRevision>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoiceLatestRevision>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoiceLatestRevision.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class InvoiceLatestRevisionBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceLatestRevisionBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = InvoiceLatestRevisionBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = InvoiceLatestRevisionBillingReasonEnum._(r'manual');
  static const quoteAccept = InvoiceLatestRevisionBillingReasonEnum._(r'quote_accept');
  static const subscription = InvoiceLatestRevisionBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = InvoiceLatestRevisionBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = InvoiceLatestRevisionBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = InvoiceLatestRevisionBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = InvoiceLatestRevisionBillingReasonEnum._(r'subscription_update');
  static const upcoming = InvoiceLatestRevisionBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][InvoiceLatestRevisionBillingReasonEnum].
  static const values = <InvoiceLatestRevisionBillingReasonEnum>[
  ...
  static InvoiceLatestRevisionBillingReasonEnum? fromJson(dynamic value) => InvoiceLatestRevisionBillingReasonEnumTypeTransformer().decode(value);

  static List<InvoiceLatestRevisionBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceLatestRevisionBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceLatestRevisionBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceLatestRevisionBillingReasonEnum] to String,
/// and [decode] dynamic data back to [InvoiceLatestRevisionBillingReasonEnum].
class InvoiceLatestRevisionBillingReasonEnumTypeTransformer {
  factory InvoiceLatestRevisionBillingReasonEnumTypeTransformer() => _instance ??= const InvoiceLatestRevisionBillingReasonEnumTypeTransformer._();

  const InvoiceLatestRevisionBillingReasonEnumTypeTransformer._();

  String encode(InvoiceLatestRevisionBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceLatestRevisionBillingReasonEnum.
  ///
  ...
  InvoiceLatestRevisionBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return InvoiceLatestRevisionBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return InvoiceLatestRevisionBillingReasonEnum.manual;
        case r'quote_accept': return InvoiceLatestRevisionBillingReasonEnum.quoteAccept;
        case r'subscription': return InvoiceLatestRevisionBillingReasonEnum.subscription;
        case r'subscription_create': return InvoiceLatestRevisionBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return InvoiceLatestRevisionBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return InvoiceLatestRevisionBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return InvoiceLatestRevisionBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return InvoiceLatestRevisionBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [InvoiceLatestRevisionBillingReasonEnumTypeTransformer] instance.
  static InvoiceLatestRevisionBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class InvoiceLatestRevisionCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceLatestRevisionCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = InvoiceLatestRevisionCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = InvoiceLatestRevisionCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][InvoiceLatestRevisionCollectionMethodEnum].
  static const values = <InvoiceLatestRevisionCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static InvoiceLatestRevisionCollectionMethodEnum? fromJson(dynamic value) => InvoiceLatestRevisionCollectionMethodEnumTypeTransformer().decode(value);

  static List<InvoiceLatestRevisionCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceLatestRevisionCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceLatestRevisionCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceLatestRevisionCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [InvoiceLatestRevisionCollectionMethodEnum].
class InvoiceLatestRevisionCollectionMethodEnumTypeTransformer {
  factory InvoiceLatestRevisionCollectionMethodEnumTypeTransformer() => _instance ??= const InvoiceLatestRevisionCollectionMethodEnumTypeTransformer._();

  const InvoiceLatestRevisionCollectionMethodEnumTypeTransformer._();

  String encode(InvoiceLatestRevisionCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceLatestRevisionCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceLatestRevisionCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return InvoiceLatestRevisionCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return InvoiceLatestRevisionCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceLatestRevisionCollectionMethodEnumTypeTransformer] instance.
  static InvoiceLatestRevisionCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class InvoiceLatestRevisionCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceLatestRevisionCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = InvoiceLatestRevisionCustomerTaxExemptEnum._(r'exempt');
  static const none = InvoiceLatestRevisionCustomerTaxExemptEnum._(r'none');
  static const reverse = InvoiceLatestRevisionCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][InvoiceLatestRevisionCustomerTaxExemptEnum].
  static const values = <InvoiceLatestRevisionCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static InvoiceLatestRevisionCustomerTaxExemptEnum? fromJson(dynamic value) => InvoiceLatestRevisionCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<InvoiceLatestRevisionCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceLatestRevisionCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceLatestRevisionCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceLatestRevisionCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [InvoiceLatestRevisionCustomerTaxExemptEnum].
class InvoiceLatestRevisionCustomerTaxExemptEnumTypeTransformer {
  factory InvoiceLatestRevisionCustomerTaxExemptEnumTypeTransformer() => _instance ??= const InvoiceLatestRevisionCustomerTaxExemptEnumTypeTransformer._();

  const InvoiceLatestRevisionCustomerTaxExemptEnumTypeTransformer._();

  String encode(InvoiceLatestRevisionCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceLatestRevisionCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceLatestRevisionCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return InvoiceLatestRevisionCustomerTaxExemptEnum.exempt;
        case r'none': return InvoiceLatestRevisionCustomerTaxExemptEnum.none;
        case r'reverse': return InvoiceLatestRevisionCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceLatestRevisionCustomerTaxExemptEnumTypeTransformer] instance.
  static InvoiceLatestRevisionCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class InvoiceLatestRevisionObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceLatestRevisionObjectEnum._(this.value);
  ...
  static const invoice = InvoiceLatestRevisionObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][InvoiceLatestRevisionObjectEnum].
  static const values = <InvoiceLatestRevisionObjectEnum>[
    invoice,
  ];

  static InvoiceLatestRevisionObjectEnum? fromJson(dynamic value) => InvoiceLatestRevisionObjectEnumTypeTransformer().decode(value);

  static List<InvoiceLatestRevisionObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceLatestRevisionObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceLatestRevisionObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceLatestRevisionObjectEnum] to String,
/// and [decode] dynamic data back to [InvoiceLatestRevisionObjectEnum].
class InvoiceLatestRevisionObjectEnumTypeTransformer {
  factory InvoiceLatestRevisionObjectEnumTypeTransformer() => _instance ??= const InvoiceLatestRevisionObjectEnumTypeTransformer._();

  const InvoiceLatestRevisionObjectEnumTypeTransformer._();

  String encode(InvoiceLatestRevisionObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceLatestRevisionObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceLatestRevisionObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return InvoiceLatestRevisionObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceLatestRevisionObjectEnumTypeTransformer] instance.
  static InvoiceLatestRevisionObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class InvoiceLatestRevisionStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceLatestRevisionStatusEnum._(this.value);
  ...
  static const draft = InvoiceLatestRevisionStatusEnum._(r'draft');
  static const open = InvoiceLatestRevisionStatusEnum._(r'open');
  static const paid = InvoiceLatestRevisionStatusEnum._(r'paid');
  static const uncollectible = InvoiceLatestRevisionStatusEnum._(r'uncollectible');
  static const void_ = InvoiceLatestRevisionStatusEnum._(r'void');

  /// List of all possible values in this [enum][InvoiceLatestRevisionStatusEnum].
  static const values = <InvoiceLatestRevisionStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static InvoiceLatestRevisionStatusEnum? fromJson(dynamic value) => InvoiceLatestRevisionStatusEnumTypeTransformer().decode(value);

  static List<InvoiceLatestRevisionStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceLatestRevisionStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceLatestRevisionStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceLatestRevisionStatusEnum] to String,
/// and [decode] dynamic data back to [InvoiceLatestRevisionStatusEnum].
class InvoiceLatestRevisionStatusEnumTypeTransformer {
  factory InvoiceLatestRevisionStatusEnumTypeTransformer() => _instance ??= const InvoiceLatestRevisionStatusEnumTypeTransformer._();

  const InvoiceLatestRevisionStatusEnumTypeTransformer._();

  String encode(InvoiceLatestRevisionStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceLatestRevisionStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceLatestRevisionStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return InvoiceLatestRevisionStatusEnum.draft;
        case r'open': return InvoiceLatestRevisionStatusEnum.open;
        case r'paid': return InvoiceLatestRevisionStatusEnum.paid;
        case r'uncollectible': return InvoiceLatestRevisionStatusEnum.uncollectible;
        case r'void': return InvoiceLatestRevisionStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceLatestRevisionStatusEnumTypeTransformer] instance.
  static InvoiceLatestRevisionStatusEnumTypeTransformer? _instance;
}
