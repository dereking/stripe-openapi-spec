...
class Invoice {
  ...
  InvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  InvoiceCollectionMethodEnum collectionMethod;
  ...
  InvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  static Invoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Invoice(
        ...
        billingReason: InvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: InvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: InvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: InvoiceObjectEnum.fromJson(json[r'object'])!,
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class InvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = InvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = InvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = InvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = InvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = InvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = InvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = InvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = InvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = InvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][InvoiceBillingReasonEnum].
  static const values = <InvoiceBillingReasonEnum>[
  ...
  static InvoiceBillingReasonEnum? fromJson(dynamic value) => InvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<InvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [InvoiceBillingReasonEnum].
class InvoiceBillingReasonEnumTypeTransformer {
  factory InvoiceBillingReasonEnumTypeTransformer() => _instance ??= const InvoiceBillingReasonEnumTypeTransformer._();

  const InvoiceBillingReasonEnumTypeTransformer._();

  String encode(InvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceBillingReasonEnum.
  ///
  ...
  InvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return InvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return InvoiceBillingReasonEnum.manual;
        case r'quote_accept': return InvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return InvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return InvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return InvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return InvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return InvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return InvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [InvoiceBillingReasonEnumTypeTransformer] instance.
  static InvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class InvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = InvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = InvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][InvoiceCollectionMethodEnum].
  static const values = <InvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static InvoiceCollectionMethodEnum? fromJson(dynamic value) => InvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<InvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [InvoiceCollectionMethodEnum].
class InvoiceCollectionMethodEnumTypeTransformer {
  factory InvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const InvoiceCollectionMethodEnumTypeTransformer._();

  const InvoiceCollectionMethodEnumTypeTransformer._();

  String encode(InvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return InvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return InvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceCollectionMethodEnumTypeTransformer] instance.
  static InvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class InvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = InvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = InvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = InvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][InvoiceCustomerTaxExemptEnum].
  static const values = <InvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static InvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => InvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<InvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [InvoiceCustomerTaxExemptEnum].
class InvoiceCustomerTaxExemptEnumTypeTransformer {
  factory InvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const InvoiceCustomerTaxExemptEnumTypeTransformer._();

  const InvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(InvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return InvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return InvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return InvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static InvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class InvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceObjectEnum._(this.value);
  ...
  static const invoice = InvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][InvoiceObjectEnum].
  static const values = <InvoiceObjectEnum>[
    invoice,
  ];

  static InvoiceObjectEnum? fromJson(dynamic value) => InvoiceObjectEnumTypeTransformer().decode(value);

  static List<InvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [InvoiceObjectEnum].
class InvoiceObjectEnumTypeTransformer {
  factory InvoiceObjectEnumTypeTransformer() => _instance ??= const InvoiceObjectEnumTypeTransformer._();

  const InvoiceObjectEnumTypeTransformer._();

  String encode(InvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return InvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceObjectEnumTypeTransformer] instance.
  static InvoiceObjectEnumTypeTransformer? _instance;
}
...
class InvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceStatusEnum._(this.value);
  ...
  static const draft = InvoiceStatusEnum._(r'draft');
  static const open = InvoiceStatusEnum._(r'open');
  static const paid = InvoiceStatusEnum._(r'paid');
  static const uncollectible = InvoiceStatusEnum._(r'uncollectible');
  static const void_ = InvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][InvoiceStatusEnum].
  static const values = <InvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
...
class InvoiceStatusEnumTypeTransformer {
  ...
  String encode(InvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  InvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return InvoiceStatusEnum.draft;
        case r'open': return InvoiceStatusEnum.open;
        case r'paid': return InvoiceStatusEnum.paid;
        case r'uncollectible': return InvoiceStatusEnum.uncollectible;
  ...
  /// Singleton [InvoiceStatusEnumTypeTransformer] instance.
