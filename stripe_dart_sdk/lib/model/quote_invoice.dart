...
class QuoteInvoice {
  /// Returns a new [QuoteInvoice] instance.
  QuoteInvoice({
    this.accountCountry,
    this.accountName,
  ...
  QuoteInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  QuoteInvoiceCollectionMethodEnum collectionMethod;
  ...
  QuoteInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is QuoteInvoice &&
  ...
  /// Returns a new [QuoteInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static QuoteInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "QuoteInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "QuoteInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return QuoteInvoice(
        ...
        billingReason: QuoteInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: QuoteInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: QuoteInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: QuoteInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: QuoteInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<QuoteInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QuoteInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QuoteInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, QuoteInvoice> mapFromJson(dynamic json) {
    final map = <String, QuoteInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = QuoteInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of QuoteInvoice-objects as value to a dart map
  static Map<String, List<QuoteInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<QuoteInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = QuoteInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class QuoteInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const QuoteInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = QuoteInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = QuoteInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = QuoteInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = QuoteInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = QuoteInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = QuoteInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = QuoteInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = QuoteInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = QuoteInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][QuoteInvoiceBillingReasonEnum].
  static const values = <QuoteInvoiceBillingReasonEnum>[
  ...
  static QuoteInvoiceBillingReasonEnum? fromJson(dynamic value) => QuoteInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<QuoteInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QuoteInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QuoteInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [QuoteInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [QuoteInvoiceBillingReasonEnum].
class QuoteInvoiceBillingReasonEnumTypeTransformer {
  factory QuoteInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const QuoteInvoiceBillingReasonEnumTypeTransformer._();

  const QuoteInvoiceBillingReasonEnumTypeTransformer._();

  String encode(QuoteInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a QuoteInvoiceBillingReasonEnum.
  ///
  ...
  QuoteInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return QuoteInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return QuoteInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return QuoteInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return QuoteInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return QuoteInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return QuoteInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return QuoteInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return QuoteInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return QuoteInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [QuoteInvoiceBillingReasonEnumTypeTransformer] instance.
  static QuoteInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class QuoteInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const QuoteInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = QuoteInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = QuoteInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][QuoteInvoiceCollectionMethodEnum].
  static const values = <QuoteInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static QuoteInvoiceCollectionMethodEnum? fromJson(dynamic value) => QuoteInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<QuoteInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QuoteInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QuoteInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [QuoteInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [QuoteInvoiceCollectionMethodEnum].
class QuoteInvoiceCollectionMethodEnumTypeTransformer {
  factory QuoteInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const QuoteInvoiceCollectionMethodEnumTypeTransformer._();

  const QuoteInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(QuoteInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a QuoteInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  QuoteInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return QuoteInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return QuoteInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [QuoteInvoiceCollectionMethodEnumTypeTransformer] instance.
  static QuoteInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class QuoteInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const QuoteInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = QuoteInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = QuoteInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = QuoteInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][QuoteInvoiceCustomerTaxExemptEnum].
  static const values = <QuoteInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static QuoteInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => QuoteInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<QuoteInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QuoteInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QuoteInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [QuoteInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [QuoteInvoiceCustomerTaxExemptEnum].
class QuoteInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory QuoteInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const QuoteInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const QuoteInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(QuoteInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a QuoteInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  QuoteInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return QuoteInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return QuoteInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return QuoteInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [QuoteInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static QuoteInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class QuoteInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const QuoteInvoiceObjectEnum._(this.value);
  ...
  static const invoice = QuoteInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][QuoteInvoiceObjectEnum].
  static const values = <QuoteInvoiceObjectEnum>[
    invoice,
  ];

  static QuoteInvoiceObjectEnum? fromJson(dynamic value) => QuoteInvoiceObjectEnumTypeTransformer().decode(value);

  static List<QuoteInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QuoteInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QuoteInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [QuoteInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [QuoteInvoiceObjectEnum].
class QuoteInvoiceObjectEnumTypeTransformer {
  factory QuoteInvoiceObjectEnumTypeTransformer() => _instance ??= const QuoteInvoiceObjectEnumTypeTransformer._();

  const QuoteInvoiceObjectEnumTypeTransformer._();

  String encode(QuoteInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a QuoteInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  QuoteInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return QuoteInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [QuoteInvoiceObjectEnumTypeTransformer] instance.
  static QuoteInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class QuoteInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const QuoteInvoiceStatusEnum._(this.value);
  ...
  static const draft = QuoteInvoiceStatusEnum._(r'draft');
  static const open = QuoteInvoiceStatusEnum._(r'open');
  static const paid = QuoteInvoiceStatusEnum._(r'paid');
  static const uncollectible = QuoteInvoiceStatusEnum._(r'uncollectible');
  static const void_ = QuoteInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][QuoteInvoiceStatusEnum].
  static const values = <QuoteInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static QuoteInvoiceStatusEnum? fromJson(dynamic value) => QuoteInvoiceStatusEnumTypeTransformer().decode(value);

  static List<QuoteInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QuoteInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QuoteInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [QuoteInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [QuoteInvoiceStatusEnum].
class QuoteInvoiceStatusEnumTypeTransformer {
  factory QuoteInvoiceStatusEnumTypeTransformer() => _instance ??= const QuoteInvoiceStatusEnumTypeTransformer._();

  const QuoteInvoiceStatusEnumTypeTransformer._();

  String encode(QuoteInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a QuoteInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  QuoteInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return QuoteInvoiceStatusEnum.draft;
        case r'open': return QuoteInvoiceStatusEnum.open;
        case r'paid': return QuoteInvoiceStatusEnum.paid;
        case r'uncollectible': return QuoteInvoiceStatusEnum.uncollectible;
        case r'void': return QuoteInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [QuoteInvoiceStatusEnumTypeTransformer] instance.
  static QuoteInvoiceStatusEnumTypeTransformer? _instance;
}
