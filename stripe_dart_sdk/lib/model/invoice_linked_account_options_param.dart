...
class InvoiceLinkedAccountOptionsParam {
  /// Returns a new [InvoiceLinkedAccountOptionsParam] instance.
  ...
  ///
  InvoiceLinkedAccountOptionsFiltersParam? filters;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoiceLinkedAccountOptionsParam &&
  ...
  @override
  String toString() => 'InvoiceLinkedAccountOptionsParam[filters=$filters, permissions=$permissions, prefetch=$prefetch]';
  ...
  /// Returns a new [InvoiceLinkedAccountOptionsParam] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoiceLinkedAccountOptionsParam? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoiceLinkedAccountOptionsParam[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoiceLinkedAccountOptionsParam[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return InvoiceLinkedAccountOptionsParam(
        filters: InvoiceLinkedAccountOptionsFiltersParam.fromJson(json[r'filters']),
  ...
  static List<InvoiceLinkedAccountOptionsParam> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceLinkedAccountOptionsParam>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceLinkedAccountOptionsParam.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoiceLinkedAccountOptionsParam> mapFromJson(dynamic json) {
    final map = <String, InvoiceLinkedAccountOptionsParam>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoiceLinkedAccountOptionsParam.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoiceLinkedAccountOptionsParam-objects as value to a dart map
  static Map<String, List<InvoiceLinkedAccountOptionsParam>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoiceLinkedAccountOptionsParam>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoiceLinkedAccountOptionsParam.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
