...
class InvoiceDefaultSource {
  /// Returns a new [InvoiceDefaultSource] instance.
  ...
  InvoiceDefaultSourceObjectEnum object;
  ...
  InvoiceDefaultSourceAllowRedisplayEnum? allowRedisplay;
  ...
  InvoiceDefaultSourceRegulatedStatusEnum? regulatedStatus;
  ...
  InvoiceDefaultSourceTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoiceDefaultSource &&
  ...
  /// Returns a new [InvoiceDefaultSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoiceDefaultSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InvoiceDefaultSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InvoiceDefaultSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InvoiceDefaultSource(
        ...
        object: InvoiceDefaultSourceObjectEnum.fromJson(json[r'object'])!,
        ...
        allowRedisplay: InvoiceDefaultSourceAllowRedisplayEnum.fromJson(json[r'allow_redisplay']),
        ...
        regulatedStatus: InvoiceDefaultSourceRegulatedStatusEnum.fromJson(json[r'regulated_status']),
        ...
        type: InvoiceDefaultSourceTypeEnum.fromJson(json[r'type'])!,
  ...
  static List<InvoiceDefaultSource> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceDefaultSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceDefaultSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoiceDefaultSource> mapFromJson(dynamic json) {
    final map = <String, InvoiceDefaultSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoiceDefaultSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoiceDefaultSource-objects as value to a dart map
  static Map<String, List<InvoiceDefaultSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoiceDefaultSource>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoiceDefaultSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class InvoiceDefaultSourceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceDefaultSourceObjectEnum._(this.value);
  ...
  static const source_ = InvoiceDefaultSourceObjectEnum._(r'source');

  /// List of all possible values in this [enum][InvoiceDefaultSourceObjectEnum].
  static const values = <InvoiceDefaultSourceObjectEnum>[
    source_,
  ];

  static InvoiceDefaultSourceObjectEnum? fromJson(dynamic value) => InvoiceDefaultSourceObjectEnumTypeTransformer().decode(value);

  static List<InvoiceDefaultSourceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceDefaultSourceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceDefaultSourceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceDefaultSourceObjectEnum] to String,
/// and [decode] dynamic data back to [InvoiceDefaultSourceObjectEnum].
class InvoiceDefaultSourceObjectEnumTypeTransformer {
  factory InvoiceDefaultSourceObjectEnumTypeTransformer() => _instance ??= const InvoiceDefaultSourceObjectEnumTypeTransformer._();

  const InvoiceDefaultSourceObjectEnumTypeTransformer._();

  String encode(InvoiceDefaultSourceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceDefaultSourceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceDefaultSourceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'source': return InvoiceDefaultSourceObjectEnum.source_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceDefaultSourceObjectEnumTypeTransformer] instance.
  static InvoiceDefaultSourceObjectEnumTypeTransformer? _instance;
}


/// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
class InvoiceDefaultSourceAllowRedisplayEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceDefaultSourceAllowRedisplayEnum._(this.value);
  ...
  static const always = InvoiceDefaultSourceAllowRedisplayEnum._(r'always');
  static const limited = InvoiceDefaultSourceAllowRedisplayEnum._(r'limited');
  static const unspecified = InvoiceDefaultSourceAllowRedisplayEnum._(r'unspecified');

  /// List of all possible values in this [enum][InvoiceDefaultSourceAllowRedisplayEnum].
  static const values = <InvoiceDefaultSourceAllowRedisplayEnum>[
    always,
    limited,
    unspecified,
  ];

  static InvoiceDefaultSourceAllowRedisplayEnum? fromJson(dynamic value) => InvoiceDefaultSourceAllowRedisplayEnumTypeTransformer().decode(value);

  static List<InvoiceDefaultSourceAllowRedisplayEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceDefaultSourceAllowRedisplayEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceDefaultSourceAllowRedisplayEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceDefaultSourceAllowRedisplayEnum] to String,
/// and [decode] dynamic data back to [InvoiceDefaultSourceAllowRedisplayEnum].
class InvoiceDefaultSourceAllowRedisplayEnumTypeTransformer {
  factory InvoiceDefaultSourceAllowRedisplayEnumTypeTransformer() => _instance ??= const InvoiceDefaultSourceAllowRedisplayEnumTypeTransformer._();

  const InvoiceDefaultSourceAllowRedisplayEnumTypeTransformer._();

  String encode(InvoiceDefaultSourceAllowRedisplayEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceDefaultSourceAllowRedisplayEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceDefaultSourceAllowRedisplayEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'always': return InvoiceDefaultSourceAllowRedisplayEnum.always;
        case r'limited': return InvoiceDefaultSourceAllowRedisplayEnum.limited;
        case r'unspecified': return InvoiceDefaultSourceAllowRedisplayEnum.unspecified;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceDefaultSourceAllowRedisplayEnumTypeTransformer] instance.
  static InvoiceDefaultSourceAllowRedisplayEnumTypeTransformer? _instance;
}


/// Status of a card based on the card issuer.
class InvoiceDefaultSourceRegulatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceDefaultSourceRegulatedStatusEnum._(this.value);
  ...
  static const regulated = InvoiceDefaultSourceRegulatedStatusEnum._(r'regulated');
  static const unregulated = InvoiceDefaultSourceRegulatedStatusEnum._(r'unregulated');

  /// List of all possible values in this [enum][InvoiceDefaultSourceRegulatedStatusEnum].
  static const values = <InvoiceDefaultSourceRegulatedStatusEnum>[
    regulated,
    unregulated,
  ];

  static InvoiceDefaultSourceRegulatedStatusEnum? fromJson(dynamic value) => InvoiceDefaultSourceRegulatedStatusEnumTypeTransformer().decode(value);

  static List<InvoiceDefaultSourceRegulatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceDefaultSourceRegulatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceDefaultSourceRegulatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceDefaultSourceRegulatedStatusEnum] to String,
/// and [decode] dynamic data back to [InvoiceDefaultSourceRegulatedStatusEnum].
class InvoiceDefaultSourceRegulatedStatusEnumTypeTransformer {
  factory InvoiceDefaultSourceRegulatedStatusEnumTypeTransformer() => _instance ??= const InvoiceDefaultSourceRegulatedStatusEnumTypeTransformer._();

  const InvoiceDefaultSourceRegulatedStatusEnumTypeTransformer._();

  String encode(InvoiceDefaultSourceRegulatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceDefaultSourceRegulatedStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceDefaultSourceRegulatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'regulated': return InvoiceDefaultSourceRegulatedStatusEnum.regulated;
        case r'unregulated': return InvoiceDefaultSourceRegulatedStatusEnum.unregulated;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceDefaultSourceRegulatedStatusEnumTypeTransformer] instance.
  static InvoiceDefaultSourceRegulatedStatusEnumTypeTransformer? _instance;
}


/// The `type` of the source. The `type` is a payment method, one of `ach_credit_transfer`, `ach_debit`, `alipay`, `bancontact`, `card`, `card_present`, `eps`, `giropay`, `ideal`, `multibanco`, `klarna`, `p24`, `sepa_debit`, `sofort`, `three_d_secure`, or `wechat`. An additional hash is included on the source with a name matching this value. It contains additional information specific to the [payment method](https://stripe.com/docs/sources) used.
class InvoiceDefaultSourceTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const InvoiceDefaultSourceTypeEnum._(this.value);
  ...
  static const achCreditTransfer = InvoiceDefaultSourceTypeEnum._(r'ach_credit_transfer');
  static const achDebit = InvoiceDefaultSourceTypeEnum._(r'ach_debit');
  static const acssDebit = InvoiceDefaultSourceTypeEnum._(r'acss_debit');
  static const alipay = InvoiceDefaultSourceTypeEnum._(r'alipay');
  static const auBecsDebit = InvoiceDefaultSourceTypeEnum._(r'au_becs_debit');
  static const bancontact = InvoiceDefaultSourceTypeEnum._(r'bancontact');
  static const card = InvoiceDefaultSourceTypeEnum._(r'card');
  static const cardPresent = InvoiceDefaultSourceTypeEnum._(r'card_present');
  static const eps = InvoiceDefaultSourceTypeEnum._(r'eps');
  static const giropay = InvoiceDefaultSourceTypeEnum._(r'giropay');
  static const ideal = InvoiceDefaultSourceTypeEnum._(r'ideal');
  static const klarna = InvoiceDefaultSourceTypeEnum._(r'klarna');
  static const multibanco = InvoiceDefaultSourceTypeEnum._(r'multibanco');
  static const p24 = InvoiceDefaultSourceTypeEnum._(r'p24');
  static const sepaDebit = InvoiceDefaultSourceTypeEnum._(r'sepa_debit');
  static const sofort = InvoiceDefaultSourceTypeEnum._(r'sofort');
  static const threeDSecure = InvoiceDefaultSourceTypeEnum._(r'three_d_secure');
  static const wechat = InvoiceDefaultSourceTypeEnum._(r'wechat');

  /// List of all possible values in this [enum][InvoiceDefaultSourceTypeEnum].
  static const values = <InvoiceDefaultSourceTypeEnum>[
    achCreditTransfer,
    achDebit,
    acssDebit,
    alipay,
  ...
  static InvoiceDefaultSourceTypeEnum? fromJson(dynamic value) => InvoiceDefaultSourceTypeEnumTypeTransformer().decode(value);

  static List<InvoiceDefaultSourceTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceDefaultSourceTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceDefaultSourceTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [InvoiceDefaultSourceTypeEnum] to String,
/// and [decode] dynamic data back to [InvoiceDefaultSourceTypeEnum].
class InvoiceDefaultSourceTypeEnumTypeTransformer {
  factory InvoiceDefaultSourceTypeEnumTypeTransformer() => _instance ??= const InvoiceDefaultSourceTypeEnumTypeTransformer._();

  const InvoiceDefaultSourceTypeEnumTypeTransformer._();

  String encode(InvoiceDefaultSourceTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a InvoiceDefaultSourceTypeEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  InvoiceDefaultSourceTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ach_credit_transfer': return InvoiceDefaultSourceTypeEnum.achCreditTransfer;
        case r'ach_debit': return InvoiceDefaultSourceTypeEnum.achDebit;
        case r'acss_debit': return InvoiceDefaultSourceTypeEnum.acssDebit;
        case r'alipay': return InvoiceDefaultSourceTypeEnum.alipay;
        case r'au_becs_debit': return InvoiceDefaultSourceTypeEnum.auBecsDebit;
        case r'bancontact': return InvoiceDefaultSourceTypeEnum.bancontact;
        case r'card': return InvoiceDefaultSourceTypeEnum.card;
        case r'card_present': return InvoiceDefaultSourceTypeEnum.cardPresent;
        case r'eps': return InvoiceDefaultSourceTypeEnum.eps;
        case r'giropay': return InvoiceDefaultSourceTypeEnum.giropay;
        case r'ideal': return InvoiceDefaultSourceTypeEnum.ideal;
        case r'klarna': return InvoiceDefaultSourceTypeEnum.klarna;
        case r'multibanco': return InvoiceDefaultSourceTypeEnum.multibanco;
        case r'p24': return InvoiceDefaultSourceTypeEnum.p24;
        case r'sepa_debit': return InvoiceDefaultSourceTypeEnum.sepaDebit;
        case r'sofort': return InvoiceDefaultSourceTypeEnum.sofort;
        case r'three_d_secure': return InvoiceDefaultSourceTypeEnum.threeDSecure;
        case r'wechat': return InvoiceDefaultSourceTypeEnum.wechat;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [InvoiceDefaultSourceTypeEnumTypeTransformer] instance.
  static InvoiceDefaultSourceTypeEnumTypeTransformer? _instance;
}
