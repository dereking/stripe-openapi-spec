...
class IssuingCardsListFeaturesParam {
  /// Returns a new [IssuingCardsListFeaturesParam] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IssuingCardsListFeaturesParam &&
  ...
  @override
  String toString() => 'IssuingCardsListFeaturesParam[cardManagement=$cardManagement, cardSpendDisputeManagement=$cardSpendDisputeManagement, cardholderManagement=$cardholderManagement, disableStripeUserAuthentication=$disableStripeUserAuthentication, spendControlManagement=$spendControlManagement]';
  ...
  /// Returns a new [IssuingCardsListFeaturesParam] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IssuingCardsListFeaturesParam? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IssuingCardsListFeaturesParam[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IssuingCardsListFeaturesParam[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IssuingCardsListFeaturesParam(
  ...
  static List<IssuingCardsListFeaturesParam> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IssuingCardsListFeaturesParam>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IssuingCardsListFeaturesParam.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IssuingCardsListFeaturesParam> mapFromJson(dynamic json) {
    final map = <String, IssuingCardsListFeaturesParam>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IssuingCardsListFeaturesParam.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IssuingCardsListFeaturesParam-objects as value to a dart map
  static Map<String, List<IssuingCardsListFeaturesParam>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IssuingCardsListFeaturesParam>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IssuingCardsListFeaturesParam.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
