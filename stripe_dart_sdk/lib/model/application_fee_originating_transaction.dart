...
class ApplicationFeeOriginatingTransaction {
  /// Returns a new [ApplicationFeeOriginatingTransaction] instance.
  ...
  ApplicationFeeOriginatingTransactionObjectEnum object;
  ...
  ApplicationFeeOriginatingTransactionStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApplicationFeeOriginatingTransaction &&
    other.amount == amount &&
  ...
  /// Returns a new [ApplicationFeeOriginatingTransaction] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApplicationFeeOriginatingTransaction? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApplicationFeeOriginatingTransaction[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApplicationFeeOriginatingTransaction[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ApplicationFeeOriginatingTransaction(
        ...
        object: ApplicationFeeOriginatingTransactionObjectEnum.fromJson(json[r'object'])!,
        ...
        status: ApplicationFeeOriginatingTransactionStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<ApplicationFeeOriginatingTransaction> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFeeOriginatingTransaction>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationFeeOriginatingTransaction.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApplicationFeeOriginatingTransaction> mapFromJson(dynamic json) {
    final map = <String, ApplicationFeeOriginatingTransaction>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApplicationFeeOriginatingTransaction.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ApplicationFeeOriginatingTransaction-objects as value to a dart map
  static Map<String, List<ApplicationFeeOriginatingTransaction>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApplicationFeeOriginatingTransaction>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApplicationFeeOriginatingTransaction.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class ApplicationFeeOriginatingTransactionObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const ApplicationFeeOriginatingTransactionObjectEnum._(this.value);
  ...
  static const charge = ApplicationFeeOriginatingTransactionObjectEnum._(r'charge');

  /// List of all possible values in this [enum][ApplicationFeeOriginatingTransactionObjectEnum].
  static const values = <ApplicationFeeOriginatingTransactionObjectEnum>[
    charge,
  ];

  static ApplicationFeeOriginatingTransactionObjectEnum? fromJson(dynamic value) => ApplicationFeeOriginatingTransactionObjectEnumTypeTransformer().decode(value);

  static List<ApplicationFeeOriginatingTransactionObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFeeOriginatingTransactionObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationFeeOriginatingTransactionObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApplicationFeeOriginatingTransactionObjectEnum] to String,
/// and [decode] dynamic data back to [ApplicationFeeOriginatingTransactionObjectEnum].
class ApplicationFeeOriginatingTransactionObjectEnumTypeTransformer {
  factory ApplicationFeeOriginatingTransactionObjectEnumTypeTransformer() => _instance ??= const ApplicationFeeOriginatingTransactionObjectEnumTypeTransformer._();

  const ApplicationFeeOriginatingTransactionObjectEnumTypeTransformer._();

  String encode(ApplicationFeeOriginatingTransactionObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApplicationFeeOriginatingTransactionObjectEnum.
  ///
  ...
  ApplicationFeeOriginatingTransactionObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return ApplicationFeeOriginatingTransactionObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [ApplicationFeeOriginatingTransactionObjectEnumTypeTransformer] instance.
  static ApplicationFeeOriginatingTransactionObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class ApplicationFeeOriginatingTransactionStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const ApplicationFeeOriginatingTransactionStatusEnum._(this.value);
  ...
  static const failed = ApplicationFeeOriginatingTransactionStatusEnum._(r'failed');
  static const pending = ApplicationFeeOriginatingTransactionStatusEnum._(r'pending');
  static const succeeded = ApplicationFeeOriginatingTransactionStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][ApplicationFeeOriginatingTransactionStatusEnum].
  static const values = <ApplicationFeeOriginatingTransactionStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static ApplicationFeeOriginatingTransactionStatusEnum? fromJson(dynamic value) => ApplicationFeeOriginatingTransactionStatusEnumTypeTransformer().decode(value);

  static List<ApplicationFeeOriginatingTransactionStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFeeOriginatingTransactionStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationFeeOriginatingTransactionStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ApplicationFeeOriginatingTransactionStatusEnum] to String,
/// and [decode] dynamic data back to [ApplicationFeeOriginatingTransactionStatusEnum].
class ApplicationFeeOriginatingTransactionStatusEnumTypeTransformer {
  factory ApplicationFeeOriginatingTransactionStatusEnumTypeTransformer() => _instance ??= const ApplicationFeeOriginatingTransactionStatusEnumTypeTransformer._();

  const ApplicationFeeOriginatingTransactionStatusEnumTypeTransformer._();

  String encode(ApplicationFeeOriginatingTransactionStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ApplicationFeeOriginatingTransactionStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ApplicationFeeOriginatingTransactionStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return ApplicationFeeOriginatingTransactionStatusEnum.failed;
        case r'pending': return ApplicationFeeOriginatingTransactionStatusEnum.pending;
        case r'succeeded': return ApplicationFeeOriginatingTransactionStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ApplicationFeeOriginatingTransactionStatusEnumTypeTransformer] instance.
  static ApplicationFeeOriginatingTransactionStatusEnumTypeTransformer? _instance;
}
