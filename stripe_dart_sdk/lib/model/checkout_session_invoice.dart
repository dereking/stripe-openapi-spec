...
class CheckoutSessionInvoice {
  /// Returns a new [CheckoutSessionInvoice] instance.
  ...
  CheckoutSessionInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  CheckoutSessionInvoiceCollectionMethodEnum collectionMethod;
  ...
  CheckoutSessionInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  CheckoutSessionInvoiceObjectEnum object;
  ...
  CheckoutSessionInvoiceStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CheckoutSessionInvoice &&
  ...
  /// Returns a new [CheckoutSessionInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CheckoutSessionInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CheckoutSessionInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CheckoutSessionInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CheckoutSessionInvoice(
        ...
        billingReason: CheckoutSessionInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: CheckoutSessionInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: CheckoutSessionInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: CheckoutSessionInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: CheckoutSessionInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<CheckoutSessionInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckoutSessionInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckoutSessionInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CheckoutSessionInvoice> mapFromJson(dynamic json) {
    final map = <String, CheckoutSessionInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CheckoutSessionInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CheckoutSessionInvoice-objects as value to a dart map
  static Map<String, List<CheckoutSessionInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CheckoutSessionInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CheckoutSessionInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class CheckoutSessionInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const CheckoutSessionInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = CheckoutSessionInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = CheckoutSessionInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = CheckoutSessionInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = CheckoutSessionInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = CheckoutSessionInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = CheckoutSessionInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = CheckoutSessionInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = CheckoutSessionInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = CheckoutSessionInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][CheckoutSessionInvoiceBillingReasonEnum].
  static const values = <CheckoutSessionInvoiceBillingReasonEnum>[
  ...
  static CheckoutSessionInvoiceBillingReasonEnum? fromJson(dynamic value) => CheckoutSessionInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<CheckoutSessionInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckoutSessionInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckoutSessionInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CheckoutSessionInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [CheckoutSessionInvoiceBillingReasonEnum].
class CheckoutSessionInvoiceBillingReasonEnumTypeTransformer {
  factory CheckoutSessionInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const CheckoutSessionInvoiceBillingReasonEnumTypeTransformer._();

  const CheckoutSessionInvoiceBillingReasonEnumTypeTransformer._();

  String encode(CheckoutSessionInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CheckoutSessionInvoiceBillingReasonEnum.
  ///
  ...
  CheckoutSessionInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return CheckoutSessionInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return CheckoutSessionInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return CheckoutSessionInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return CheckoutSessionInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return CheckoutSessionInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return CheckoutSessionInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return CheckoutSessionInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return CheckoutSessionInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return CheckoutSessionInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [CheckoutSessionInvoiceBillingReasonEnumTypeTransformer] instance.
  static CheckoutSessionInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class CheckoutSessionInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const CheckoutSessionInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = CheckoutSessionInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = CheckoutSessionInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][CheckoutSessionInvoiceCollectionMethodEnum].
  static const values = <CheckoutSessionInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static CheckoutSessionInvoiceCollectionMethodEnum? fromJson(dynamic value) => CheckoutSessionInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<CheckoutSessionInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckoutSessionInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckoutSessionInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CheckoutSessionInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [CheckoutSessionInvoiceCollectionMethodEnum].
class CheckoutSessionInvoiceCollectionMethodEnumTypeTransformer {
  factory CheckoutSessionInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const CheckoutSessionInvoiceCollectionMethodEnumTypeTransformer._();

  const CheckoutSessionInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(CheckoutSessionInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CheckoutSessionInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CheckoutSessionInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return CheckoutSessionInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return CheckoutSessionInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CheckoutSessionInvoiceCollectionMethodEnumTypeTransformer] instance.
  static CheckoutSessionInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class CheckoutSessionInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const CheckoutSessionInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = CheckoutSessionInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = CheckoutSessionInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = CheckoutSessionInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][CheckoutSessionInvoiceCustomerTaxExemptEnum].
  static const values = <CheckoutSessionInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static CheckoutSessionInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => CheckoutSessionInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<CheckoutSessionInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckoutSessionInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckoutSessionInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CheckoutSessionInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [CheckoutSessionInvoiceCustomerTaxExemptEnum].
class CheckoutSessionInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory CheckoutSessionInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const CheckoutSessionInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const CheckoutSessionInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(CheckoutSessionInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CheckoutSessionInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CheckoutSessionInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return CheckoutSessionInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return CheckoutSessionInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return CheckoutSessionInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CheckoutSessionInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static CheckoutSessionInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class CheckoutSessionInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const CheckoutSessionInvoiceObjectEnum._(this.value);
  ...
  static const invoice = CheckoutSessionInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][CheckoutSessionInvoiceObjectEnum].
  static const values = <CheckoutSessionInvoiceObjectEnum>[
    invoice,
  ];

  static CheckoutSessionInvoiceObjectEnum? fromJson(dynamic value) => CheckoutSessionInvoiceObjectEnumTypeTransformer().decode(value);

  static List<CheckoutSessionInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckoutSessionInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckoutSessionInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CheckoutSessionInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [CheckoutSessionInvoiceObjectEnum].
class CheckoutSessionInvoiceObjectEnumTypeTransformer {
  factory CheckoutSessionInvoiceObjectEnumTypeTransformer() => _instance ??= const CheckoutSessionInvoiceObjectEnumTypeTransformer._();

  const CheckoutSessionInvoiceObjectEnumTypeTransformer._();

  String encode(CheckoutSessionInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CheckoutSessionInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CheckoutSessionInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return CheckoutSessionInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CheckoutSessionInvoiceObjectEnumTypeTransformer] instance.
  static CheckoutSessionInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class CheckoutSessionInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const CheckoutSessionInvoiceStatusEnum._(this.value);
  ...
  static const draft = CheckoutSessionInvoiceStatusEnum._(r'draft');
  static const open = CheckoutSessionInvoiceStatusEnum._(r'open');
  static const paid = CheckoutSessionInvoiceStatusEnum._(r'paid');
  static const uncollectible = CheckoutSessionInvoiceStatusEnum._(r'uncollectible');
  static const void_ = CheckoutSessionInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][CheckoutSessionInvoiceStatusEnum].
  static const values = <CheckoutSessionInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static CheckoutSessionInvoiceStatusEnum? fromJson(dynamic value) => CheckoutSessionInvoiceStatusEnumTypeTransformer().decode(value);

  static List<CheckoutSessionInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CheckoutSessionInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CheckoutSessionInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CheckoutSessionInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [CheckoutSessionInvoiceStatusEnum].
class CheckoutSessionInvoiceStatusEnumTypeTransformer {
  factory CheckoutSessionInvoiceStatusEnumTypeTransformer() => _instance ??= const CheckoutSessionInvoiceStatusEnumTypeTransformer._();

  const CheckoutSessionInvoiceStatusEnumTypeTransformer._();

  String encode(CheckoutSessionInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CheckoutSessionInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CheckoutSessionInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return CheckoutSessionInvoiceStatusEnum.draft;
        case r'open': return CheckoutSessionInvoiceStatusEnum.open;
        case r'paid': return CheckoutSessionInvoiceStatusEnum.paid;
        case r'uncollectible': return CheckoutSessionInvoiceStatusEnum.uncollectible;
        case r'void': return CheckoutSessionInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CheckoutSessionInvoiceStatusEnumTypeTransformer] instance.
  static CheckoutSessionInvoiceStatusEnumTypeTransformer? _instance;
}
