...
class SubscriptionsResourcePaymentMethodOptions {
  /// Returns a new [SubscriptionsResourcePaymentMethodOptions] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SubscriptionsResourcePaymentMethodOptions &&
  ...
  @override
  String toString() => 'SubscriptionsResourcePaymentMethodOptions[acssDebit=$acssDebit, bancontact=$bancontact, card=$card, customerBalance=$customerBalance, konbini=$konbini, sepaDebit=$sepaDebit, usBankAccount=$usBankAccount]';
  ...
  /// Returns a new [SubscriptionsResourcePaymentMethodOptions] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SubscriptionsResourcePaymentMethodOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SubscriptionsResourcePaymentMethodOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SubscriptionsResourcePaymentMethodOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SubscriptionsResourcePaymentMethodOptions(
        ...
        card: SubscriptionPaymentMethodOptionsCard.fromJson(json[r'card']),
  ...
  static List<SubscriptionsResourcePaymentMethodOptions> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionsResourcePaymentMethodOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionsResourcePaymentMethodOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SubscriptionsResourcePaymentMethodOptions> mapFromJson(dynamic json) {
    final map = <String, SubscriptionsResourcePaymentMethodOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SubscriptionsResourcePaymentMethodOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SubscriptionsResourcePaymentMethodOptions-objects as value to a dart map
  static Map<String, List<SubscriptionsResourcePaymentMethodOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SubscriptionsResourcePaymentMethodOptions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SubscriptionsResourcePaymentMethodOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
