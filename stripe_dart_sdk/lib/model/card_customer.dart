...
class CardCustomer {
  /// Returns a new [CardCustomer] instance.
  CardCustomer({
    this.address,
    this.balance,
    this.cashBalance,
  ...
  CardCustomerTaxExemptEnum? taxExempt;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CardCustomer &&
  ...
  /// Returns a new [CardCustomer] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CardCustomer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CardCustomer[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CardCustomer[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CardCustomer(
        ...
        object: CardCustomerObjectEnum.fromJson(json[r'object'])!,
        ...
        taxExempt: CardCustomerTaxExemptEnum.fromJson(json[r'tax_exempt']),
  ...
  static List<CardCustomer> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CardCustomer>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CardCustomer.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CardCustomer> mapFromJson(dynamic json) {
    final map = <String, CardCustomer>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CardCustomer.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CardCustomer-objects as value to a dart map
  static Map<String, List<CardCustomer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CardCustomer>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CardCustomer.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class CardCustomerObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const CardCustomerObjectEnum._(this.value);
  ...
  static const customer = CardCustomerObjectEnum._(r'customer');

  /// List of all possible values in this [enum][CardCustomerObjectEnum].
  static const values = <CardCustomerObjectEnum>[
    customer,
  ];

  static CardCustomerObjectEnum? fromJson(dynamic value) => CardCustomerObjectEnumTypeTransformer().decode(value);

  static List<CardCustomerObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CardCustomerObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CardCustomerObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CardCustomerObjectEnum] to String,
/// and [decode] dynamic data back to [CardCustomerObjectEnum].
class CardCustomerObjectEnumTypeTransformer {
  factory CardCustomerObjectEnumTypeTransformer() => _instance ??= const CardCustomerObjectEnumTypeTransformer._();

  const CardCustomerObjectEnumTypeTransformer._();

  String encode(CardCustomerObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CardCustomerObjectEnum.
  ///
  ...
  CardCustomerObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'customer': return CardCustomerObjectEnum.customer;
        default:
          if (!allowNull) {
  ...
  /// Singleton [CardCustomerObjectEnumTypeTransformer] instance.
  static CardCustomerObjectEnumTypeTransformer? _instance;
}


/// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
class CardCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const CardCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = CardCustomerTaxExemptEnum._(r'exempt');
  static const none = CardCustomerTaxExemptEnum._(r'none');
  static const reverse = CardCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][CardCustomerTaxExemptEnum].
  static const values = <CardCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static CardCustomerTaxExemptEnum? fromJson(dynamic value) => CardCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<CardCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CardCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CardCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CardCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [CardCustomerTaxExemptEnum].
class CardCustomerTaxExemptEnumTypeTransformer {
  factory CardCustomerTaxExemptEnumTypeTransformer() => _instance ??= const CardCustomerTaxExemptEnumTypeTransformer._();

  const CardCustomerTaxExemptEnumTypeTransformer._();

  String encode(CardCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CardCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CardCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return CardCustomerTaxExemptEnum.exempt;
        case r'none': return CardCustomerTaxExemptEnum.none;
        case r'reverse': return CardCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CardCustomerTaxExemptEnumTypeTransformer] instance.
  static CardCustomerTaxExemptEnumTypeTransformer? _instance;
}
