...
class CustomerBalanceTransactionInvoice {
  /// Returns a new [CustomerBalanceTransactionInvoice] instance.
  ...
  CustomerBalanceTransactionInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  CustomerBalanceTransactionInvoiceCollectionMethodEnum collectionMethod;
  ...
  CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  CustomerBalanceTransactionInvoiceObjectEnum object;
  ...
  CustomerBalanceTransactionInvoiceStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomerBalanceTransactionInvoice &&
  ...
  /// Returns a new [CustomerBalanceTransactionInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CustomerBalanceTransactionInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CustomerBalanceTransactionInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CustomerBalanceTransactionInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CustomerBalanceTransactionInvoice(
        ...
        billingReason: CustomerBalanceTransactionInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: CustomerBalanceTransactionInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: CustomerBalanceTransactionInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: CustomerBalanceTransactionInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<CustomerBalanceTransactionInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerBalanceTransactionInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerBalanceTransactionInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CustomerBalanceTransactionInvoice> mapFromJson(dynamic json) {
    final map = <String, CustomerBalanceTransactionInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CustomerBalanceTransactionInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CustomerBalanceTransactionInvoice-objects as value to a dart map
  static Map<String, List<CustomerBalanceTransactionInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CustomerBalanceTransactionInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CustomerBalanceTransactionInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class CustomerBalanceTransactionInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const CustomerBalanceTransactionInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = CustomerBalanceTransactionInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][CustomerBalanceTransactionInvoiceBillingReasonEnum].
  static const values = <CustomerBalanceTransactionInvoiceBillingReasonEnum>[
  ...
  static CustomerBalanceTransactionInvoiceBillingReasonEnum? fromJson(dynamic value) => CustomerBalanceTransactionInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<CustomerBalanceTransactionInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerBalanceTransactionInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerBalanceTransactionInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CustomerBalanceTransactionInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [CustomerBalanceTransactionInvoiceBillingReasonEnum].
class CustomerBalanceTransactionInvoiceBillingReasonEnumTypeTransformer {
  factory CustomerBalanceTransactionInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const CustomerBalanceTransactionInvoiceBillingReasonEnumTypeTransformer._();

  const CustomerBalanceTransactionInvoiceBillingReasonEnumTypeTransformer._();

  String encode(CustomerBalanceTransactionInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CustomerBalanceTransactionInvoiceBillingReasonEnum.
  ///
  ...
  CustomerBalanceTransactionInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return CustomerBalanceTransactionInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return CustomerBalanceTransactionInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return CustomerBalanceTransactionInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return CustomerBalanceTransactionInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return CustomerBalanceTransactionInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return CustomerBalanceTransactionInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return CustomerBalanceTransactionInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return CustomerBalanceTransactionInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return CustomerBalanceTransactionInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [CustomerBalanceTransactionInvoiceBillingReasonEnumTypeTransformer] instance.
  static CustomerBalanceTransactionInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class CustomerBalanceTransactionInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const CustomerBalanceTransactionInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = CustomerBalanceTransactionInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = CustomerBalanceTransactionInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][CustomerBalanceTransactionInvoiceCollectionMethodEnum].
  static const values = <CustomerBalanceTransactionInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static CustomerBalanceTransactionInvoiceCollectionMethodEnum? fromJson(dynamic value) => CustomerBalanceTransactionInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<CustomerBalanceTransactionInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerBalanceTransactionInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerBalanceTransactionInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CustomerBalanceTransactionInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [CustomerBalanceTransactionInvoiceCollectionMethodEnum].
class CustomerBalanceTransactionInvoiceCollectionMethodEnumTypeTransformer {
  factory CustomerBalanceTransactionInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const CustomerBalanceTransactionInvoiceCollectionMethodEnumTypeTransformer._();

  const CustomerBalanceTransactionInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(CustomerBalanceTransactionInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CustomerBalanceTransactionInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CustomerBalanceTransactionInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return CustomerBalanceTransactionInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return CustomerBalanceTransactionInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CustomerBalanceTransactionInvoiceCollectionMethodEnumTypeTransformer] instance.
  static CustomerBalanceTransactionInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum].
  static const values = <CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => CustomerBalanceTransactionInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum].
class CustomerBalanceTransactionInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory CustomerBalanceTransactionInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const CustomerBalanceTransactionInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const CustomerBalanceTransactionInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CustomerBalanceTransactionInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static CustomerBalanceTransactionInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class CustomerBalanceTransactionInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const CustomerBalanceTransactionInvoiceObjectEnum._(this.value);
  ...
  static const invoice = CustomerBalanceTransactionInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][CustomerBalanceTransactionInvoiceObjectEnum].
  static const values = <CustomerBalanceTransactionInvoiceObjectEnum>[
    invoice,
  ];

  static CustomerBalanceTransactionInvoiceObjectEnum? fromJson(dynamic value) => CustomerBalanceTransactionInvoiceObjectEnumTypeTransformer().decode(value);

  static List<CustomerBalanceTransactionInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerBalanceTransactionInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerBalanceTransactionInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CustomerBalanceTransactionInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [CustomerBalanceTransactionInvoiceObjectEnum].
class CustomerBalanceTransactionInvoiceObjectEnumTypeTransformer {
  factory CustomerBalanceTransactionInvoiceObjectEnumTypeTransformer() => _instance ??= const CustomerBalanceTransactionInvoiceObjectEnumTypeTransformer._();

  const CustomerBalanceTransactionInvoiceObjectEnumTypeTransformer._();

  String encode(CustomerBalanceTransactionInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CustomerBalanceTransactionInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CustomerBalanceTransactionInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return CustomerBalanceTransactionInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CustomerBalanceTransactionInvoiceObjectEnumTypeTransformer] instance.
  static CustomerBalanceTransactionInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class CustomerBalanceTransactionInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const CustomerBalanceTransactionInvoiceStatusEnum._(this.value);
  ...
  static const draft = CustomerBalanceTransactionInvoiceStatusEnum._(r'draft');
  static const open = CustomerBalanceTransactionInvoiceStatusEnum._(r'open');
  static const paid = CustomerBalanceTransactionInvoiceStatusEnum._(r'paid');
  static const uncollectible = CustomerBalanceTransactionInvoiceStatusEnum._(r'uncollectible');
  static const void_ = CustomerBalanceTransactionInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][CustomerBalanceTransactionInvoiceStatusEnum].
  static const values = <CustomerBalanceTransactionInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static CustomerBalanceTransactionInvoiceStatusEnum? fromJson(dynamic value) => CustomerBalanceTransactionInvoiceStatusEnumTypeTransformer().decode(value);

  static List<CustomerBalanceTransactionInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CustomerBalanceTransactionInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CustomerBalanceTransactionInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CustomerBalanceTransactionInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [CustomerBalanceTransactionInvoiceStatusEnum].
class CustomerBalanceTransactionInvoiceStatusEnumTypeTransformer {
  factory CustomerBalanceTransactionInvoiceStatusEnumTypeTransformer() => _instance ??= const CustomerBalanceTransactionInvoiceStatusEnumTypeTransformer._();

  const CustomerBalanceTransactionInvoiceStatusEnumTypeTransformer._();

  String encode(CustomerBalanceTransactionInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CustomerBalanceTransactionInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  CustomerBalanceTransactionInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return CustomerBalanceTransactionInvoiceStatusEnum.draft;
        case r'open': return CustomerBalanceTransactionInvoiceStatusEnum.open;
        case r'paid': return CustomerBalanceTransactionInvoiceStatusEnum.paid;
        case r'uncollectible': return CustomerBalanceTransactionInvoiceStatusEnum.uncollectible;
        case r'void': return CustomerBalanceTransactionInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [CustomerBalanceTransactionInvoiceStatusEnumTypeTransformer] instance.
  static CustomerBalanceTransactionInvoiceStatusEnumTypeTransformer? _instance;
}
