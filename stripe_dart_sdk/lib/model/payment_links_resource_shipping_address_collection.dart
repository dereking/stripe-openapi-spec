...
class PaymentLinksResourceShippingAddressCollection {
  /// Returns a new [PaymentLinksResourceShippingAddressCollection] instance.
  PaymentLinksResourceShippingAddressCollection({
    this.allowedCountries = const [],
  });

  /// An array of two-letter ISO country codes representing which countries Checkout should provide as options for shipping locations. Unsupported country codes: `AS, CX, CC, CU, HM, IR, KP, MH, FM, NF, MP, PW, SD, SY, UM, VI`.
  List<PaymentLinksResourceShippingAddressCollectionAllowedCountriesEnum> allowedCountries;

  @override
  bool operator ==(Object other) => identical(this, other) || other is PaymentLinksResourceShippingAddressCollection &&
  ...
  @override
  String toString() => 'PaymentLinksResourceShippingAddressCollection[allowedCountries=$allowedCountries]';
  ...
  /// Returns a new [PaymentLinksResourceShippingAddressCollection] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PaymentLinksResourceShippingAddressCollection? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PaymentLinksResourceShippingAddressCollection[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PaymentLinksResourceShippingAddressCollection[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PaymentLinksResourceShippingAddressCollection> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentLinksResourceShippingAddressCollection>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentLinksResourceShippingAddressCollection.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PaymentLinksResourceShippingAddressCollection> mapFromJson(dynamic json) {
    final map = <String, PaymentLinksResourceShippingAddressCollection>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaymentLinksResourceShippingAddressCollection.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PaymentLinksResourceShippingAddressCollection-objects as value to a dart map
  static Map<String, List<PaymentLinksResourceShippingAddressCollection>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaymentLinksResourceShippingAddressCollection>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PaymentLinksResourceShippingAddressCollection.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
