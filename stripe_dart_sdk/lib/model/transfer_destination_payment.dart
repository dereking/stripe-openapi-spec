...
class TransferDestinationPayment {
  /// Returns a new [TransferDestinationPayment] instance.
  ...
  TransferDestinationPaymentObjectEnum object;
  ...
  TransferDestinationPaymentStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TransferDestinationPayment &&
    other.amount == amount &&
  ...
  /// Returns a new [TransferDestinationPayment] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TransferDestinationPayment? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TransferDestinationPayment[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TransferDestinationPayment[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return TransferDestinationPayment(
        ...
        object: TransferDestinationPaymentObjectEnum.fromJson(json[r'object'])!,
        ...
        status: TransferDestinationPaymentStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<TransferDestinationPayment> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TransferDestinationPayment>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TransferDestinationPayment.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TransferDestinationPayment> mapFromJson(dynamic json) {
    final map = <String, TransferDestinationPayment>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TransferDestinationPayment.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TransferDestinationPayment-objects as value to a dart map
  static Map<String, List<TransferDestinationPayment>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TransferDestinationPayment>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TransferDestinationPayment.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class TransferDestinationPaymentObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const TransferDestinationPaymentObjectEnum._(this.value);
  ...
  static const charge = TransferDestinationPaymentObjectEnum._(r'charge');

  /// List of all possible values in this [enum][TransferDestinationPaymentObjectEnum].
  static const values = <TransferDestinationPaymentObjectEnum>[
    charge,
  ];

  static TransferDestinationPaymentObjectEnum? fromJson(dynamic value) => TransferDestinationPaymentObjectEnumTypeTransformer().decode(value);

  static List<TransferDestinationPaymentObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TransferDestinationPaymentObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TransferDestinationPaymentObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TransferDestinationPaymentObjectEnum] to String,
/// and [decode] dynamic data back to [TransferDestinationPaymentObjectEnum].
class TransferDestinationPaymentObjectEnumTypeTransformer {
  factory TransferDestinationPaymentObjectEnumTypeTransformer() => _instance ??= const TransferDestinationPaymentObjectEnumTypeTransformer._();

  const TransferDestinationPaymentObjectEnumTypeTransformer._();

  String encode(TransferDestinationPaymentObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TransferDestinationPaymentObjectEnum.
  ///
  ...
  TransferDestinationPaymentObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return TransferDestinationPaymentObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [TransferDestinationPaymentObjectEnumTypeTransformer] instance.
  static TransferDestinationPaymentObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class TransferDestinationPaymentStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const TransferDestinationPaymentStatusEnum._(this.value);
  ...
  static const failed = TransferDestinationPaymentStatusEnum._(r'failed');
  static const pending = TransferDestinationPaymentStatusEnum._(r'pending');
  static const succeeded = TransferDestinationPaymentStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][TransferDestinationPaymentStatusEnum].
  static const values = <TransferDestinationPaymentStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static TransferDestinationPaymentStatusEnum? fromJson(dynamic value) => TransferDestinationPaymentStatusEnumTypeTransformer().decode(value);

  static List<TransferDestinationPaymentStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TransferDestinationPaymentStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TransferDestinationPaymentStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TransferDestinationPaymentStatusEnum] to String,
/// and [decode] dynamic data back to [TransferDestinationPaymentStatusEnum].
class TransferDestinationPaymentStatusEnumTypeTransformer {
  factory TransferDestinationPaymentStatusEnumTypeTransformer() => _instance ??= const TransferDestinationPaymentStatusEnumTypeTransformer._();

  const TransferDestinationPaymentStatusEnumTypeTransformer._();

  String encode(TransferDestinationPaymentStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TransferDestinationPaymentStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  TransferDestinationPaymentStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return TransferDestinationPaymentStatusEnum.failed;
        case r'pending': return TransferDestinationPaymentStatusEnum.pending;
        case r'succeeded': return TransferDestinationPaymentStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [TransferDestinationPaymentStatusEnumTypeTransformer] instance.
  static TransferDestinationPaymentStatusEnumTypeTransformer? _instance;
}
