...
class SubscriptionLatestInvoice {
  /// Returns a new [SubscriptionLatestInvoice] instance.
  ...
  SubscriptionLatestInvoiceBillingReasonEnum? billingReason;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  SubscriptionLatestInvoiceCollectionMethodEnum collectionMethod;
  ...
  SubscriptionLatestInvoiceCustomerTaxExemptEnum? customerTaxExempt;
  ...
  SubscriptionLatestInvoiceObjectEnum object;
  ...
  SubscriptionLatestInvoiceStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SubscriptionLatestInvoice &&
  ...
  /// Returns a new [SubscriptionLatestInvoice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SubscriptionLatestInvoice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SubscriptionLatestInvoice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SubscriptionLatestInvoice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return SubscriptionLatestInvoice(
        ...
        billingReason: SubscriptionLatestInvoiceBillingReasonEnum.fromJson(json[r'billing_reason']),
        collectionMethod: SubscriptionLatestInvoiceCollectionMethodEnum.fromJson(json[r'collection_method'])!,
        ...
        customerTaxExempt: SubscriptionLatestInvoiceCustomerTaxExemptEnum.fromJson(json[r'customer_tax_exempt']),
        ...
        object: SubscriptionLatestInvoiceObjectEnum.fromJson(json[r'object'])!,
        ...
        status: SubscriptionLatestInvoiceStatusEnum.fromJson(json[r'status']),
  ...
  static List<SubscriptionLatestInvoice> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionLatestInvoice>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionLatestInvoice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SubscriptionLatestInvoice> mapFromJson(dynamic json) {
    final map = <String, SubscriptionLatestInvoice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SubscriptionLatestInvoice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SubscriptionLatestInvoice-objects as value to a dart map
  static Map<String, List<SubscriptionLatestInvoice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SubscriptionLatestInvoice>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SubscriptionLatestInvoice.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
class SubscriptionLatestInvoiceBillingReasonEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionLatestInvoiceBillingReasonEnum._(this.value);
  ...
  static const automaticPendingInvoiceItemInvoice = SubscriptionLatestInvoiceBillingReasonEnum._(r'automatic_pending_invoice_item_invoice');
  static const manual = SubscriptionLatestInvoiceBillingReasonEnum._(r'manual');
  static const quoteAccept = SubscriptionLatestInvoiceBillingReasonEnum._(r'quote_accept');
  static const subscription = SubscriptionLatestInvoiceBillingReasonEnum._(r'subscription');
  static const subscriptionCreate = SubscriptionLatestInvoiceBillingReasonEnum._(r'subscription_create');
  static const subscriptionCycle = SubscriptionLatestInvoiceBillingReasonEnum._(r'subscription_cycle');
  static const subscriptionThreshold = SubscriptionLatestInvoiceBillingReasonEnum._(r'subscription_threshold');
  static const subscriptionUpdate = SubscriptionLatestInvoiceBillingReasonEnum._(r'subscription_update');
  static const upcoming = SubscriptionLatestInvoiceBillingReasonEnum._(r'upcoming');

  /// List of all possible values in this [enum][SubscriptionLatestInvoiceBillingReasonEnum].
  static const values = <SubscriptionLatestInvoiceBillingReasonEnum>[
  ...
  static SubscriptionLatestInvoiceBillingReasonEnum? fromJson(dynamic value) => SubscriptionLatestInvoiceBillingReasonEnumTypeTransformer().decode(value);

  static List<SubscriptionLatestInvoiceBillingReasonEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionLatestInvoiceBillingReasonEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionLatestInvoiceBillingReasonEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionLatestInvoiceBillingReasonEnum] to String,
/// and [decode] dynamic data back to [SubscriptionLatestInvoiceBillingReasonEnum].
class SubscriptionLatestInvoiceBillingReasonEnumTypeTransformer {
  factory SubscriptionLatestInvoiceBillingReasonEnumTypeTransformer() => _instance ??= const SubscriptionLatestInvoiceBillingReasonEnumTypeTransformer._();

  const SubscriptionLatestInvoiceBillingReasonEnumTypeTransformer._();

  String encode(SubscriptionLatestInvoiceBillingReasonEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionLatestInvoiceBillingReasonEnum.
  ///
  ...
  SubscriptionLatestInvoiceBillingReasonEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'automatic_pending_invoice_item_invoice': return SubscriptionLatestInvoiceBillingReasonEnum.automaticPendingInvoiceItemInvoice;
        case r'manual': return SubscriptionLatestInvoiceBillingReasonEnum.manual;
        case r'quote_accept': return SubscriptionLatestInvoiceBillingReasonEnum.quoteAccept;
        case r'subscription': return SubscriptionLatestInvoiceBillingReasonEnum.subscription;
        case r'subscription_create': return SubscriptionLatestInvoiceBillingReasonEnum.subscriptionCreate;
        case r'subscription_cycle': return SubscriptionLatestInvoiceBillingReasonEnum.subscriptionCycle;
        case r'subscription_threshold': return SubscriptionLatestInvoiceBillingReasonEnum.subscriptionThreshold;
        case r'subscription_update': return SubscriptionLatestInvoiceBillingReasonEnum.subscriptionUpdate;
        case r'upcoming': return SubscriptionLatestInvoiceBillingReasonEnum.upcoming;
        default:
          if (!allowNull) {
  ...
  /// Singleton [SubscriptionLatestInvoiceBillingReasonEnumTypeTransformer] instance.
  static SubscriptionLatestInvoiceBillingReasonEnumTypeTransformer? _instance;
}


/// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
class SubscriptionLatestInvoiceCollectionMethodEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionLatestInvoiceCollectionMethodEnum._(this.value);
  ...
  static const chargeAutomatically = SubscriptionLatestInvoiceCollectionMethodEnum._(r'charge_automatically');
  static const sendInvoice = SubscriptionLatestInvoiceCollectionMethodEnum._(r'send_invoice');

  /// List of all possible values in this [enum][SubscriptionLatestInvoiceCollectionMethodEnum].
  static const values = <SubscriptionLatestInvoiceCollectionMethodEnum>[
    chargeAutomatically,
    sendInvoice,
  ];

  static SubscriptionLatestInvoiceCollectionMethodEnum? fromJson(dynamic value) => SubscriptionLatestInvoiceCollectionMethodEnumTypeTransformer().decode(value);

  static List<SubscriptionLatestInvoiceCollectionMethodEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionLatestInvoiceCollectionMethodEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionLatestInvoiceCollectionMethodEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionLatestInvoiceCollectionMethodEnum] to String,
/// and [decode] dynamic data back to [SubscriptionLatestInvoiceCollectionMethodEnum].
class SubscriptionLatestInvoiceCollectionMethodEnumTypeTransformer {
  factory SubscriptionLatestInvoiceCollectionMethodEnumTypeTransformer() => _instance ??= const SubscriptionLatestInvoiceCollectionMethodEnumTypeTransformer._();

  const SubscriptionLatestInvoiceCollectionMethodEnumTypeTransformer._();

  String encode(SubscriptionLatestInvoiceCollectionMethodEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionLatestInvoiceCollectionMethodEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionLatestInvoiceCollectionMethodEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge_automatically': return SubscriptionLatestInvoiceCollectionMethodEnum.chargeAutomatically;
        case r'send_invoice': return SubscriptionLatestInvoiceCollectionMethodEnum.sendInvoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionLatestInvoiceCollectionMethodEnumTypeTransformer] instance.
  static SubscriptionLatestInvoiceCollectionMethodEnumTypeTransformer? _instance;
}


/// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
class SubscriptionLatestInvoiceCustomerTaxExemptEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionLatestInvoiceCustomerTaxExemptEnum._(this.value);
  ...
  static const exempt = SubscriptionLatestInvoiceCustomerTaxExemptEnum._(r'exempt');
  static const none = SubscriptionLatestInvoiceCustomerTaxExemptEnum._(r'none');
  static const reverse = SubscriptionLatestInvoiceCustomerTaxExemptEnum._(r'reverse');

  /// List of all possible values in this [enum][SubscriptionLatestInvoiceCustomerTaxExemptEnum].
  static const values = <SubscriptionLatestInvoiceCustomerTaxExemptEnum>[
    exempt,
    none,
    reverse,
  ];

  static SubscriptionLatestInvoiceCustomerTaxExemptEnum? fromJson(dynamic value) => SubscriptionLatestInvoiceCustomerTaxExemptEnumTypeTransformer().decode(value);

  static List<SubscriptionLatestInvoiceCustomerTaxExemptEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionLatestInvoiceCustomerTaxExemptEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionLatestInvoiceCustomerTaxExemptEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionLatestInvoiceCustomerTaxExemptEnum] to String,
/// and [decode] dynamic data back to [SubscriptionLatestInvoiceCustomerTaxExemptEnum].
class SubscriptionLatestInvoiceCustomerTaxExemptEnumTypeTransformer {
  factory SubscriptionLatestInvoiceCustomerTaxExemptEnumTypeTransformer() => _instance ??= const SubscriptionLatestInvoiceCustomerTaxExemptEnumTypeTransformer._();

  const SubscriptionLatestInvoiceCustomerTaxExemptEnumTypeTransformer._();

  String encode(SubscriptionLatestInvoiceCustomerTaxExemptEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionLatestInvoiceCustomerTaxExemptEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionLatestInvoiceCustomerTaxExemptEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'exempt': return SubscriptionLatestInvoiceCustomerTaxExemptEnum.exempt;
        case r'none': return SubscriptionLatestInvoiceCustomerTaxExemptEnum.none;
        case r'reverse': return SubscriptionLatestInvoiceCustomerTaxExemptEnum.reverse;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionLatestInvoiceCustomerTaxExemptEnumTypeTransformer] instance.
  static SubscriptionLatestInvoiceCustomerTaxExemptEnumTypeTransformer? _instance;
}


/// String representing the object's type. Objects of the same type share the same value.
class SubscriptionLatestInvoiceObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionLatestInvoiceObjectEnum._(this.value);
  ...
  static const invoice = SubscriptionLatestInvoiceObjectEnum._(r'invoice');

  /// List of all possible values in this [enum][SubscriptionLatestInvoiceObjectEnum].
  static const values = <SubscriptionLatestInvoiceObjectEnum>[
    invoice,
  ];

  static SubscriptionLatestInvoiceObjectEnum? fromJson(dynamic value) => SubscriptionLatestInvoiceObjectEnumTypeTransformer().decode(value);

  static List<SubscriptionLatestInvoiceObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionLatestInvoiceObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionLatestInvoiceObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionLatestInvoiceObjectEnum] to String,
/// and [decode] dynamic data back to [SubscriptionLatestInvoiceObjectEnum].
class SubscriptionLatestInvoiceObjectEnumTypeTransformer {
  factory SubscriptionLatestInvoiceObjectEnumTypeTransformer() => _instance ??= const SubscriptionLatestInvoiceObjectEnumTypeTransformer._();

  const SubscriptionLatestInvoiceObjectEnumTypeTransformer._();

  String encode(SubscriptionLatestInvoiceObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionLatestInvoiceObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionLatestInvoiceObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'invoice': return SubscriptionLatestInvoiceObjectEnum.invoice;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionLatestInvoiceObjectEnumTypeTransformer] instance.
  static SubscriptionLatestInvoiceObjectEnumTypeTransformer? _instance;
}


/// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
class SubscriptionLatestInvoiceStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const SubscriptionLatestInvoiceStatusEnum._(this.value);
  ...
  static const draft = SubscriptionLatestInvoiceStatusEnum._(r'draft');
  static const open = SubscriptionLatestInvoiceStatusEnum._(r'open');
  static const paid = SubscriptionLatestInvoiceStatusEnum._(r'paid');
  static const uncollectible = SubscriptionLatestInvoiceStatusEnum._(r'uncollectible');
  static const void_ = SubscriptionLatestInvoiceStatusEnum._(r'void');

  /// List of all possible values in this [enum][SubscriptionLatestInvoiceStatusEnum].
  static const values = <SubscriptionLatestInvoiceStatusEnum>[
    draft,
    open,
    paid,
    uncollectible,
  ...
  static SubscriptionLatestInvoiceStatusEnum? fromJson(dynamic value) => SubscriptionLatestInvoiceStatusEnumTypeTransformer().decode(value);

  static List<SubscriptionLatestInvoiceStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionLatestInvoiceStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionLatestInvoiceStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [SubscriptionLatestInvoiceStatusEnum] to String,
/// and [decode] dynamic data back to [SubscriptionLatestInvoiceStatusEnum].
class SubscriptionLatestInvoiceStatusEnumTypeTransformer {
  factory SubscriptionLatestInvoiceStatusEnumTypeTransformer() => _instance ??= const SubscriptionLatestInvoiceStatusEnumTypeTransformer._();

  const SubscriptionLatestInvoiceStatusEnumTypeTransformer._();

  String encode(SubscriptionLatestInvoiceStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a SubscriptionLatestInvoiceStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  SubscriptionLatestInvoiceStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'draft': return SubscriptionLatestInvoiceStatusEnum.draft;
        case r'open': return SubscriptionLatestInvoiceStatusEnum.open;
        case r'paid': return SubscriptionLatestInvoiceStatusEnum.paid;
        case r'uncollectible': return SubscriptionLatestInvoiceStatusEnum.uncollectible;
        case r'void': return SubscriptionLatestInvoiceStatusEnum.void_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [SubscriptionLatestInvoiceStatusEnumTypeTransformer] instance.
  static SubscriptionLatestInvoiceStatusEnumTypeTransformer? _instance;
}
