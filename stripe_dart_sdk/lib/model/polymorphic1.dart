...
class Polymorphic1 {
  /// Returns a new [Polymorphic1] instance.
  Polymorphic1({
    this.account,
  ...
  Polymorphic1AllowRedisplayEnum? allowRedisplay;
  ...
  Polymorphic1RegulatedStatusEnum? regulatedStatus;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Polymorphic1 &&
  ...
  /// Returns a new [Polymorphic1] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Polymorphic1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Polymorphic1[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Polymorphic1[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Polymorphic1(
        ...
        object: Polymorphic1ObjectEnum.fromJson(json[r'object'])!,
        ...
        allowRedisplay: Polymorphic1AllowRedisplayEnum.fromJson(json[r'allow_redisplay']),
        ...
        regulatedStatus: Polymorphic1RegulatedStatusEnum.fromJson(json[r'regulated_status']),
        ...
        type: Polymorphic1TypeEnum.fromJson(json[r'type'])!,
  ...
  static List<Polymorphic1> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Polymorphic1>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Polymorphic1.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Polymorphic1> mapFromJson(dynamic json) {
    final map = <String, Polymorphic1>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Polymorphic1.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Polymorphic1-objects as value to a dart map
  static Map<String, List<Polymorphic1>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Polymorphic1>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Polymorphic1.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class Polymorphic1ObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const Polymorphic1ObjectEnum._(this.value);
  ...
  static const source_ = Polymorphic1ObjectEnum._(r'source');

  /// List of all possible values in this [enum][Polymorphic1ObjectEnum].
  static const values = <Polymorphic1ObjectEnum>[
    source_,
  ];

  static Polymorphic1ObjectEnum? fromJson(dynamic value) => Polymorphic1ObjectEnumTypeTransformer().decode(value);

  static List<Polymorphic1ObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Polymorphic1ObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Polymorphic1ObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [Polymorphic1ObjectEnum] to String,
/// and [decode] dynamic data back to [Polymorphic1ObjectEnum].
class Polymorphic1ObjectEnumTypeTransformer {
  factory Polymorphic1ObjectEnumTypeTransformer() => _instance ??= const Polymorphic1ObjectEnumTypeTransformer._();

  const Polymorphic1ObjectEnumTypeTransformer._();

  String encode(Polymorphic1ObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a Polymorphic1ObjectEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  Polymorphic1ObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'source': return Polymorphic1ObjectEnum.source_;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [Polymorphic1ObjectEnumTypeTransformer] instance.
  static Polymorphic1ObjectEnumTypeTransformer? _instance;
}


/// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
class Polymorphic1AllowRedisplayEnum {
  /// Instantiate a new enum with the provided [value].
  const Polymorphic1AllowRedisplayEnum._(this.value);
  ...
  static const always = Polymorphic1AllowRedisplayEnum._(r'always');
  static const limited = Polymorphic1AllowRedisplayEnum._(r'limited');
  static const unspecified = Polymorphic1AllowRedisplayEnum._(r'unspecified');

  /// List of all possible values in this [enum][Polymorphic1AllowRedisplayEnum].
  static const values = <Polymorphic1AllowRedisplayEnum>[
    always,
    limited,
    unspecified,
  ];

  static Polymorphic1AllowRedisplayEnum? fromJson(dynamic value) => Polymorphic1AllowRedisplayEnumTypeTransformer().decode(value);

  static List<Polymorphic1AllowRedisplayEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Polymorphic1AllowRedisplayEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Polymorphic1AllowRedisplayEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [Polymorphic1AllowRedisplayEnum] to String,
/// and [decode] dynamic data back to [Polymorphic1AllowRedisplayEnum].
class Polymorphic1AllowRedisplayEnumTypeTransformer {
  factory Polymorphic1AllowRedisplayEnumTypeTransformer() => _instance ??= const Polymorphic1AllowRedisplayEnumTypeTransformer._();

  const Polymorphic1AllowRedisplayEnumTypeTransformer._();

  String encode(Polymorphic1AllowRedisplayEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a Polymorphic1AllowRedisplayEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  Polymorphic1AllowRedisplayEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'always': return Polymorphic1AllowRedisplayEnum.always;
        case r'limited': return Polymorphic1AllowRedisplayEnum.limited;
        case r'unspecified': return Polymorphic1AllowRedisplayEnum.unspecified;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [Polymorphic1AllowRedisplayEnumTypeTransformer] instance.
  static Polymorphic1AllowRedisplayEnumTypeTransformer? _instance;
}


/// Status of a card based on the card issuer.
class Polymorphic1RegulatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const Polymorphic1RegulatedStatusEnum._(this.value);
  ...
  static const regulated = Polymorphic1RegulatedStatusEnum._(r'regulated');
  static const unregulated = Polymorphic1RegulatedStatusEnum._(r'unregulated');

  /// List of all possible values in this [enum][Polymorphic1RegulatedStatusEnum].
  static const values = <Polymorphic1RegulatedStatusEnum>[
    regulated,
    unregulated,
  ];

  static Polymorphic1RegulatedStatusEnum? fromJson(dynamic value) => Polymorphic1RegulatedStatusEnumTypeTransformer().decode(value);

  static List<Polymorphic1RegulatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Polymorphic1RegulatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Polymorphic1RegulatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [Polymorphic1RegulatedStatusEnum] to String,
/// and [decode] dynamic data back to [Polymorphic1RegulatedStatusEnum].
class Polymorphic1RegulatedStatusEnumTypeTransformer {
  factory Polymorphic1RegulatedStatusEnumTypeTransformer() => _instance ??= const Polymorphic1RegulatedStatusEnumTypeTransformer._();

  const Polymorphic1RegulatedStatusEnumTypeTransformer._();

  String encode(Polymorphic1RegulatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a Polymorphic1RegulatedStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  Polymorphic1RegulatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'regulated': return Polymorphic1RegulatedStatusEnum.regulated;
        case r'unregulated': return Polymorphic1RegulatedStatusEnum.unregulated;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [Polymorphic1RegulatedStatusEnumTypeTransformer] instance.
  static Polymorphic1RegulatedStatusEnumTypeTransformer? _instance;
}


/// The `type` of the source. The `type` is a payment method, one of `ach_credit_transfer`, `ach_debit`, `alipay`, `bancontact`, `card`, `card_present`, `eps`, `giropay`, `ideal`, `multibanco`, `klarna`, `p24`, `sepa_debit`, `sofort`, `three_d_secure`, or `wechat`. An additional hash is included on the source with a name matching this value. It contains additional information specific to the [payment method](https://stripe.com/docs/sources) used.
class Polymorphic1TypeEnum {
  /// Instantiate a new enum with the provided [value].
  const Polymorphic1TypeEnum._(this.value);
  ...
  static const achCreditTransfer = Polymorphic1TypeEnum._(r'ach_credit_transfer');
  static const achDebit = Polymorphic1TypeEnum._(r'ach_debit');
  static const acssDebit = Polymorphic1TypeEnum._(r'acss_debit');
  static const alipay = Polymorphic1TypeEnum._(r'alipay');
  static const auBecsDebit = Polymorphic1TypeEnum._(r'au_becs_debit');
  static const bancontact = Polymorphic1TypeEnum._(r'bancontact');
  static const card = Polymorphic1TypeEnum._(r'card');
  static const cardPresent = Polymorphic1TypeEnum._(r'card_present');
  static const eps = Polymorphic1TypeEnum._(r'eps');
  static const giropay = Polymorphic1TypeEnum._(r'giropay');
  static const ideal = Polymorphic1TypeEnum._(r'ideal');
  static const klarna = Polymorphic1TypeEnum._(r'klarna');
  static const multibanco = Polymorphic1TypeEnum._(r'multibanco');
  static const p24 = Polymorphic1TypeEnum._(r'p24');
  static const sepaDebit = Polymorphic1TypeEnum._(r'sepa_debit');
  static const sofort = Polymorphic1TypeEnum._(r'sofort');
  static const threeDSecure = Polymorphic1TypeEnum._(r'three_d_secure');
  static const wechat = Polymorphic1TypeEnum._(r'wechat');

  /// List of all possible values in this [enum][Polymorphic1TypeEnum].
  static const values = <Polymorphic1TypeEnum>[
    achCreditTransfer,
    achDebit,
    acssDebit,
    alipay,
  ...
  static Polymorphic1TypeEnum? fromJson(dynamic value) => Polymorphic1TypeEnumTypeTransformer().decode(value);

  static List<Polymorphic1TypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Polymorphic1TypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Polymorphic1TypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [Polymorphic1TypeEnum] to String,
/// and [decode] dynamic data back to [Polymorphic1TypeEnum].
class Polymorphic1TypeEnumTypeTransformer {
  factory Polymorphic1TypeEnumTypeTransformer() => _instance ??= const Polymorphic1TypeEnumTypeTransformer._();

  const Polymorphic1TypeEnumTypeTransformer._();

  String encode(Polymorphic1TypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a Polymorphic1TypeEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  Polymorphic1TypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ach_credit_transfer': return Polymorphic1TypeEnum.achCreditTransfer;
        case r'ach_debit': return Polymorphic1TypeEnum.achDebit;
        case r'acss_debit': return Polymorphic1TypeEnum.acssDebit;
        case r'alipay': return Polymorphic1TypeEnum.alipay;
        case r'au_becs_debit': return Polymorphic1TypeEnum.auBecsDebit;
        case r'bancontact': return Polymorphic1TypeEnum.bancontact;
        case r'card': return Polymorphic1TypeEnum.card;
        case r'card_present': return Polymorphic1TypeEnum.cardPresent;
        case r'eps': return Polymorphic1TypeEnum.eps;
        case r'giropay': return Polymorphic1TypeEnum.giropay;
        case r'ideal': return Polymorphic1TypeEnum.ideal;
        case r'klarna': return Polymorphic1TypeEnum.klarna;
        case r'multibanco': return Polymorphic1TypeEnum.multibanco;
        case r'p24': return Polymorphic1TypeEnum.p24;
        case r'sepa_debit': return Polymorphic1TypeEnum.sepaDebit;
        case r'sofort': return Polymorphic1TypeEnum.sofort;
        case r'three_d_secure': return Polymorphic1TypeEnum.threeDSecure;
        case r'wechat': return Polymorphic1TypeEnum.wechat;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [Polymorphic1TypeEnumTypeTransformer] instance.
  static Polymorphic1TypeEnumTypeTransformer? _instance;
}
