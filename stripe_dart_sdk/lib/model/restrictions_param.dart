...
class RestrictionsParam {
  /// Returns a new [RestrictionsParam] instance.
  RestrictionsParam({
    this.brandsBlocked = const [],
  });

  List<BrandsBlockedEnum> brandsBlocked;

  @override
  bool operator ==(Object other) => identical(this, other) || other is RestrictionsParam &&
  ...
  @override
  String toString() => 'RestrictionsParam[brandsBlocked=$brandsBlocked]';
  ...
  /// Returns a new [RestrictionsParam] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RestrictionsParam? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RestrictionsParam[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RestrictionsParam[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RestrictionsParam(
  ...
  static List<RestrictionsParam> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RestrictionsParam>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RestrictionsParam.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RestrictionsParam> mapFromJson(dynamic json) {
    final map = <String, RestrictionsParam>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RestrictionsParam.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RestrictionsParam-objects as value to a dart map
  static Map<String, List<RestrictionsParam>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RestrictionsParam>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RestrictionsParam.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
