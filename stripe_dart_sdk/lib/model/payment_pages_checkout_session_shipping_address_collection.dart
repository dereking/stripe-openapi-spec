...
class PaymentPagesCheckoutSessionShippingAddressCollection {
  /// Returns a new [PaymentPagesCheckoutSessionShippingAddressCollection] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaymentPagesCheckoutSessionShippingAddressCollection &&
  ...
  @override
  String toString() => 'PaymentPagesCheckoutSessionShippingAddressCollection[allowedCountries=$allowedCountries]';
  ...
  /// Returns a new [PaymentPagesCheckoutSessionShippingAddressCollection] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PaymentPagesCheckoutSessionShippingAddressCollection? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PaymentPagesCheckoutSessionShippingAddressCollection[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PaymentPagesCheckoutSessionShippingAddressCollection[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PaymentPagesCheckoutSessionShippingAddressCollection> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentPagesCheckoutSessionShippingAddressCollection>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentPagesCheckoutSessionShippingAddressCollection.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PaymentPagesCheckoutSessionShippingAddressCollection> mapFromJson(dynamic json) {
    final map = <String, PaymentPagesCheckoutSessionShippingAddressCollection>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaymentPagesCheckoutSessionShippingAddressCollection.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PaymentPagesCheckoutSessionShippingAddressCollection-objects as value to a dart map
  static Map<String, List<PaymentPagesCheckoutSessionShippingAddressCollection>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaymentPagesCheckoutSessionShippingAddressCollection>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PaymentPagesCheckoutSessionShippingAddressCollection.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
