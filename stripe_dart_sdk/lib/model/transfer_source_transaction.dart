...
class TransferSourceTransaction {
  /// Returns a new [TransferSourceTransaction] instance.
  ...
  TransferSourceTransactionObjectEnum object;
  ...
  TransferSourceTransactionStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TransferSourceTransaction &&
    other.amount == amount &&
  ...
  /// Returns a new [TransferSourceTransaction] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TransferSourceTransaction? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TransferSourceTransaction[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TransferSourceTransaction[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return TransferSourceTransaction(
        ...
        object: TransferSourceTransactionObjectEnum.fromJson(json[r'object'])!,
        ...
        status: TransferSourceTransactionStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<TransferSourceTransaction> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TransferSourceTransaction>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TransferSourceTransaction.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TransferSourceTransaction> mapFromJson(dynamic json) {
    final map = <String, TransferSourceTransaction>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TransferSourceTransaction.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TransferSourceTransaction-objects as value to a dart map
  static Map<String, List<TransferSourceTransaction>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TransferSourceTransaction>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TransferSourceTransaction.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class TransferSourceTransactionObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const TransferSourceTransactionObjectEnum._(this.value);
  ...
  static const charge = TransferSourceTransactionObjectEnum._(r'charge');

  /// List of all possible values in this [enum][TransferSourceTransactionObjectEnum].
  static const values = <TransferSourceTransactionObjectEnum>[
    charge,
  ];

  static TransferSourceTransactionObjectEnum? fromJson(dynamic value) => TransferSourceTransactionObjectEnumTypeTransformer().decode(value);

  static List<TransferSourceTransactionObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TransferSourceTransactionObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TransferSourceTransactionObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TransferSourceTransactionObjectEnum] to String,
/// and [decode] dynamic data back to [TransferSourceTransactionObjectEnum].
class TransferSourceTransactionObjectEnumTypeTransformer {
  factory TransferSourceTransactionObjectEnumTypeTransformer() => _instance ??= const TransferSourceTransactionObjectEnumTypeTransformer._();

  const TransferSourceTransactionObjectEnumTypeTransformer._();

  String encode(TransferSourceTransactionObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TransferSourceTransactionObjectEnum.
  ///
  ...
  TransferSourceTransactionObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return TransferSourceTransactionObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [TransferSourceTransactionObjectEnumTypeTransformer] instance.
  static TransferSourceTransactionObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class TransferSourceTransactionStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const TransferSourceTransactionStatusEnum._(this.value);
  ...
  static const failed = TransferSourceTransactionStatusEnum._(r'failed');
  static const pending = TransferSourceTransactionStatusEnum._(r'pending');
  static const succeeded = TransferSourceTransactionStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][TransferSourceTransactionStatusEnum].
  static const values = <TransferSourceTransactionStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static TransferSourceTransactionStatusEnum? fromJson(dynamic value) => TransferSourceTransactionStatusEnumTypeTransformer().decode(value);

  static List<TransferSourceTransactionStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TransferSourceTransactionStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TransferSourceTransactionStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [TransferSourceTransactionStatusEnum] to String,
/// and [decode] dynamic data back to [TransferSourceTransactionStatusEnum].
class TransferSourceTransactionStatusEnumTypeTransformer {
  factory TransferSourceTransactionStatusEnumTypeTransformer() => _instance ??= const TransferSourceTransactionStatusEnumTypeTransformer._();

  const TransferSourceTransactionStatusEnumTypeTransformer._();

  String encode(TransferSourceTransactionStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a TransferSourceTransactionStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  TransferSourceTransactionStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return TransferSourceTransactionStatusEnum.failed;
        case r'pending': return TransferSourceTransactionStatusEnum.pending;
        case r'succeeded': return TransferSourceTransactionStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [TransferSourceTransactionStatusEnumTypeTransformer] instance.
  static TransferSourceTransactionStatusEnumTypeTransformer? _instance;
}
