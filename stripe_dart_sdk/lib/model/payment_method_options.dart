...
class PaymentMethodOptions {
  /// Returns a new [PaymentMethodOptions] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaymentMethodOptions &&
  ...
  @override
  String toString() => 'PaymentMethodOptions[acssDebit=$acssDebit, bancontact=$bancontact, card=$card, customerBalance=$customerBalance, konbini=$konbini, sepaDebit=$sepaDebit, usBankAccount=$usBankAccount]';
  ...
  /// Returns a new [PaymentMethodOptions] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PaymentMethodOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PaymentMethodOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PaymentMethodOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PaymentMethodOptions(
        ...
        card: PaymentMethodOptionsCard.fromJson(json[r'card']),
  ...
  static List<PaymentMethodOptions> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentMethodOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentMethodOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PaymentMethodOptions> mapFromJson(dynamic json) {
    final map = <String, PaymentMethodOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaymentMethodOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PaymentMethodOptions-objects as value to a dart map
  static Map<String, List<PaymentMethodOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaymentMethodOptions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PaymentMethodOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
