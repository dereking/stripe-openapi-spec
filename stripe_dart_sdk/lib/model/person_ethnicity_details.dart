...
class PersonEthnicityDetails {
  /// Returns a new [PersonEthnicityDetails] instance.
  ...
  List<PersonEthnicityDetailsEthnicityEnum>? ethnicity;

  /// Please specify your origin, when other is selected.
  String? ethnicityOther;

  @override
  bool operator ==(Object other) => identical(this, other) || other is PersonEthnicityDetails &&
  ...
  @override
  String toString() => 'PersonEthnicityDetails[ethnicity=$ethnicity, ethnicityOther=$ethnicityOther]';
  ...
  /// Returns a new [PersonEthnicityDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PersonEthnicityDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PersonEthnicityDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PersonEthnicityDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PersonEthnicityDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PersonEthnicityDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PersonEthnicityDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PersonEthnicityDetails> mapFromJson(dynamic json) {
    final map = <String, PersonEthnicityDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PersonEthnicityDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PersonEthnicityDetails-objects as value to a dart map
  static Map<String, List<PersonEthnicityDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PersonEthnicityDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PersonEthnicityDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
