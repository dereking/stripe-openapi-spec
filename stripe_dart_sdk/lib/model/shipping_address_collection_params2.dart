...
class ShippingAddressCollectionParams2 {
  /// Returns a new [ShippingAddressCollectionParams2] instance.
  ShippingAddressCollectionParams2({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShippingAddressCollectionParams2 &&
  ...
  @override
  String toString() => 'ShippingAddressCollectionParams2[allowedCountries=$allowedCountries]';
  ...
  /// Returns a new [ShippingAddressCollectionParams2] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShippingAddressCollectionParams2? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShippingAddressCollectionParams2[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShippingAddressCollectionParams2[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShippingAddressCollectionParams2(
  ...
  static List<ShippingAddressCollectionParams2> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShippingAddressCollectionParams2>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShippingAddressCollectionParams2.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShippingAddressCollectionParams2> mapFromJson(dynamic json) {
    final map = <String, ShippingAddressCollectionParams2>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShippingAddressCollectionParams2.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShippingAddressCollectionParams2-objects as value to a dart map
  static Map<String, List<ShippingAddressCollectionParams2>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShippingAddressCollectionParams2>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShippingAddressCollectionParams2.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
