...
class PersonRaceDetails {
  /// Returns a new [PersonRaceDetails] instance.
  PersonRaceDetails({
    this.race = const [],
    this.raceOther,
  });
  ...
  /// The persons race.
  List<PersonRaceDetailsRaceEnum>? race;

  /// Please specify your race, when other is selected.
  String? raceOther;

  @override
  bool operator ==(Object other) => identical(this, other) || other is PersonRaceDetails &&
  ...
  @override
  String toString() => 'PersonRaceDetails[race=$race, raceOther=$raceOther]';
  ...
  /// Returns a new [PersonRaceDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PersonRaceDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PersonRaceDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PersonRaceDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PersonRaceDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PersonRaceDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PersonRaceDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PersonRaceDetails> mapFromJson(dynamic json) {
    final map = <String, PersonRaceDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PersonRaceDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PersonRaceDetails-objects as value to a dart map
  static Map<String, List<PersonRaceDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PersonRaceDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PersonRaceDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
