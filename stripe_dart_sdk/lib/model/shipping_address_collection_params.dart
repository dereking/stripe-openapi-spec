...
class ShippingAddressCollectionParams {
  /// Returns a new [ShippingAddressCollectionParams] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShippingAddressCollectionParams &&
  ...
  @override
  String toString() => 'ShippingAddressCollectionParams[allowedCountries=$allowedCountries]';
  ...
  /// Returns a new [ShippingAddressCollectionParams] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ShippingAddressCollectionParams? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ShippingAddressCollectionParams[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ShippingAddressCollectionParams[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ShippingAddressCollectionParams(
  ...
  static List<ShippingAddressCollectionParams> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ShippingAddressCollectionParams>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ShippingAddressCollectionParams.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ShippingAddressCollectionParams> mapFromJson(dynamic json) {
    final map = <String, ShippingAddressCollectionParams>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ShippingAddressCollectionParams.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ShippingAddressCollectionParams-objects as value to a dart map
  static Map<String, List<ShippingAddressCollectionParams>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ShippingAddressCollectionParams>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ShippingAddressCollectionParams.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
