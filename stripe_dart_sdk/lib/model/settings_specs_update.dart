...
class SettingsSpecsUpdate {
  /// Returns a new [SettingsSpecsUpdate] instance.
  SettingsSpecsUpdate({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SettingsSpecsUpdate &&
  ...
  @override
  String toString() => 'SettingsSpecsUpdate[bacsDebitPayments=$bacsDebitPayments, branding=$branding, cardIssuing=$cardIssuing, cardPayments=$cardPayments, invoices=$invoices, payments=$payments, payouts=$payouts, treasury=$treasury]';
  ...
  /// Returns a new [SettingsSpecsUpdate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SettingsSpecsUpdate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SettingsSpecsUpdate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SettingsSpecsUpdate[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SettingsSpecsUpdate(
        ...
        invoices: InvoicesSettingsSpecs.fromJson(json[r'invoices']),
  ...
  static List<SettingsSpecsUpdate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SettingsSpecsUpdate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SettingsSpecsUpdate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SettingsSpecsUpdate> mapFromJson(dynamic json) {
    final map = <String, SettingsSpecsUpdate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SettingsSpecsUpdate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SettingsSpecsUpdate-objects as value to a dart map
  static Map<String, List<SettingsSpecsUpdate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SettingsSpecsUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SettingsSpecsUpdate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
