...
class DisputeCharge {
  /// Returns a new [DisputeCharge] instance.
  DisputeCharge({
  ...
  DisputeChargeObjectEnum object;
  ...
  DisputeChargeStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DisputeCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [DisputeCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DisputeCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DisputeCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DisputeCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return DisputeCharge(
        ...
        object: DisputeChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: DisputeChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<DisputeCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DisputeCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DisputeCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DisputeCharge> mapFromJson(dynamic json) {
    final map = <String, DisputeCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DisputeCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DisputeCharge-objects as value to a dart map
  static Map<String, List<DisputeCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DisputeCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DisputeCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class DisputeChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const DisputeChargeObjectEnum._(this.value);
  ...
  static const charge = DisputeChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][DisputeChargeObjectEnum].
  static const values = <DisputeChargeObjectEnum>[
    charge,
  ];

  static DisputeChargeObjectEnum? fromJson(dynamic value) => DisputeChargeObjectEnumTypeTransformer().decode(value);

  static List<DisputeChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DisputeChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DisputeChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [DisputeChargeObjectEnum] to String,
/// and [decode] dynamic data back to [DisputeChargeObjectEnum].
class DisputeChargeObjectEnumTypeTransformer {
  factory DisputeChargeObjectEnumTypeTransformer() => _instance ??= const DisputeChargeObjectEnumTypeTransformer._();

  const DisputeChargeObjectEnumTypeTransformer._();

  String encode(DisputeChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a DisputeChargeObjectEnum.
  ///
  ...
  DisputeChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return DisputeChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [DisputeChargeObjectEnumTypeTransformer] instance.
  static DisputeChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class DisputeChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const DisputeChargeStatusEnum._(this.value);
  ...
  static const failed = DisputeChargeStatusEnum._(r'failed');
  static const pending = DisputeChargeStatusEnum._(r'pending');
  static const succeeded = DisputeChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][DisputeChargeStatusEnum].
  static const values = <DisputeChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static DisputeChargeStatusEnum? fromJson(dynamic value) => DisputeChargeStatusEnumTypeTransformer().decode(value);

  static List<DisputeChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DisputeChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DisputeChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [DisputeChargeStatusEnum] to String,
/// and [decode] dynamic data back to [DisputeChargeStatusEnum].
class DisputeChargeStatusEnumTypeTransformer {
  factory DisputeChargeStatusEnumTypeTransformer() => _instance ??= const DisputeChargeStatusEnumTypeTransformer._();

  const DisputeChargeStatusEnumTypeTransformer._();

  String encode(DisputeChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a DisputeChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  DisputeChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return DisputeChargeStatusEnum.failed;
        case r'pending': return DisputeChargeStatusEnum.pending;
        case r'succeeded': return DisputeChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [DisputeChargeStatusEnumTypeTransformer] instance.
  static DisputeChargeStatusEnumTypeTransformer? _instance;
}
