  ...
  static Charge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Charge(
        ...
        object: ChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: ChargeStatusEnum.fromJson(json[r'status'])!,
...
/// String representing the object's type. Objects of the same type share the same value.
class ChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const ChargeObjectEnum._(this.value);
  ...
  static const charge = ChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][ChargeObjectEnum].
  static const values = <ChargeObjectEnum>[
    charge,
  ];

  static ChargeObjectEnum? fromJson(dynamic value) => ChargeObjectEnumTypeTransformer().decode(value);

  static List<ChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ChargeObjectEnum] to String,
/// and [decode] dynamic data back to [ChargeObjectEnum].
class ChargeObjectEnumTypeTransformer {
  factory ChargeObjectEnumTypeTransformer() => _instance ??= const ChargeObjectEnumTypeTransformer._();

  const ChargeObjectEnumTypeTransformer._();

  String encode(ChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ChargeObjectEnum.
  ///
  ...
  ChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return ChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [ChargeObjectEnumTypeTransformer] instance.
  static ChargeObjectEnumTypeTransformer? _instance;
}
...
class ChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const ChargeStatusEnum._(this.value);
  ...
  static const failed = ChargeStatusEnum._(r'failed');
  static const pending = ChargeStatusEnum._(r'pending');
  static const succeeded = ChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][ChargeStatusEnum].
  static const values = <ChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static ChargeStatusEnum? fromJson(dynamic value) => ChargeStatusEnumTypeTransformer().decode(value);

  static List<ChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [ChargeStatusEnum] to String,
/// and [decode] dynamic data back to [ChargeStatusEnum].
class ChargeStatusEnumTypeTransformer {
  factory ChargeStatusEnumTypeTransformer() => _instance ??= const ChargeStatusEnumTypeTransformer._();

  const ChargeStatusEnumTypeTransformer._();

  String encode(ChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a ChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  ChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return ChargeStatusEnum.failed;
        case r'pending': return ChargeStatusEnum.pending;
        case r'succeeded': return ChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [ChargeStatusEnumTypeTransformer] instance.
  static ChargeStatusEnumTypeTransformer? _instance;
}
