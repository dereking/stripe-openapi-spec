...
class PaymentIntentLatestCharge {
  /// Returns a new [PaymentIntentLatestCharge] instance.
  ...
  PaymentIntentLatestChargeObjectEnum object;
  ...
  PaymentIntentLatestChargeStatusEnum status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaymentIntentLatestCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [PaymentIntentLatestCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PaymentIntentLatestCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PaymentIntentLatestCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PaymentIntentLatestCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PaymentIntentLatestCharge(
        ...
        object: PaymentIntentLatestChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: PaymentIntentLatestChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<PaymentIntentLatestCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentIntentLatestCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentIntentLatestCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PaymentIntentLatestCharge> mapFromJson(dynamic json) {
    final map = <String, PaymentIntentLatestCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaymentIntentLatestCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PaymentIntentLatestCharge-objects as value to a dart map
  static Map<String, List<PaymentIntentLatestCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaymentIntentLatestCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PaymentIntentLatestCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class PaymentIntentLatestChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const PaymentIntentLatestChargeObjectEnum._(this.value);
  ...
  static const charge = PaymentIntentLatestChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][PaymentIntentLatestChargeObjectEnum].
  static const values = <PaymentIntentLatestChargeObjectEnum>[
    charge,
  ];

  static PaymentIntentLatestChargeObjectEnum? fromJson(dynamic value) => PaymentIntentLatestChargeObjectEnumTypeTransformer().decode(value);

  static List<PaymentIntentLatestChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentIntentLatestChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentIntentLatestChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [PaymentIntentLatestChargeObjectEnum] to String,
/// and [decode] dynamic data back to [PaymentIntentLatestChargeObjectEnum].
class PaymentIntentLatestChargeObjectEnumTypeTransformer {
  factory PaymentIntentLatestChargeObjectEnumTypeTransformer() => _instance ??= const PaymentIntentLatestChargeObjectEnumTypeTransformer._();

  const PaymentIntentLatestChargeObjectEnumTypeTransformer._();

  String encode(PaymentIntentLatestChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a PaymentIntentLatestChargeObjectEnum.
  ///
  ...
  PaymentIntentLatestChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return PaymentIntentLatestChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [PaymentIntentLatestChargeObjectEnumTypeTransformer] instance.
  static PaymentIntentLatestChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class PaymentIntentLatestChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const PaymentIntentLatestChargeStatusEnum._(this.value);
  ...
  static const failed = PaymentIntentLatestChargeStatusEnum._(r'failed');
  static const pending = PaymentIntentLatestChargeStatusEnum._(r'pending');
  static const succeeded = PaymentIntentLatestChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][PaymentIntentLatestChargeStatusEnum].
  static const values = <PaymentIntentLatestChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static PaymentIntentLatestChargeStatusEnum? fromJson(dynamic value) => PaymentIntentLatestChargeStatusEnumTypeTransformer().decode(value);

  static List<PaymentIntentLatestChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PaymentIntentLatestChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PaymentIntentLatestChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [PaymentIntentLatestChargeStatusEnum] to String,
/// and [decode] dynamic data back to [PaymentIntentLatestChargeStatusEnum].
class PaymentIntentLatestChargeStatusEnumTypeTransformer {
  factory PaymentIntentLatestChargeStatusEnumTypeTransformer() => _instance ??= const PaymentIntentLatestChargeStatusEnumTypeTransformer._();

  const PaymentIntentLatestChargeStatusEnumTypeTransformer._();

  String encode(PaymentIntentLatestChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a PaymentIntentLatestChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  PaymentIntentLatestChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return PaymentIntentLatestChargeStatusEnum.failed;
        case r'pending': return PaymentIntentLatestChargeStatusEnum.pending;
        case r'succeeded': return PaymentIntentLatestChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [PaymentIntentLatestChargeStatusEnumTypeTransformer] instance.
  static PaymentIntentLatestChargeStatusEnumTypeTransformer? _instance;
}
