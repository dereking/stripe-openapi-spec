...
class RefundCharge {
  /// Returns a new [RefundCharge] instance.
  RefundCharge({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RefundCharge &&
    other.amount == amount &&
  ...
  /// Returns a new [RefundCharge] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RefundCharge? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RefundCharge[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RefundCharge[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return RefundCharge(
        ...
        object: RefundChargeObjectEnum.fromJson(json[r'object'])!,
        ...
        status: RefundChargeStatusEnum.fromJson(json[r'status'])!,
  ...
  static List<RefundCharge> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RefundCharge>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RefundCharge.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RefundCharge> mapFromJson(dynamic json) {
    final map = <String, RefundCharge>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RefundCharge.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RefundCharge-objects as value to a dart map
  static Map<String, List<RefundCharge>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RefundCharge>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RefundCharge.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// String representing the object's type. Objects of the same type share the same value.
class RefundChargeObjectEnum {
  /// Instantiate a new enum with the provided [value].
  const RefundChargeObjectEnum._(this.value);
  ...
  static const charge = RefundChargeObjectEnum._(r'charge');

  /// List of all possible values in this [enum][RefundChargeObjectEnum].
  static const values = <RefundChargeObjectEnum>[
    charge,
  ];

  static RefundChargeObjectEnum? fromJson(dynamic value) => RefundChargeObjectEnumTypeTransformer().decode(value);

  static List<RefundChargeObjectEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RefundChargeObjectEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RefundChargeObjectEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [RefundChargeObjectEnum] to String,
/// and [decode] dynamic data back to [RefundChargeObjectEnum].
class RefundChargeObjectEnumTypeTransformer {
  factory RefundChargeObjectEnumTypeTransformer() => _instance ??= const RefundChargeObjectEnumTypeTransformer._();

  const RefundChargeObjectEnumTypeTransformer._();

  String encode(RefundChargeObjectEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a RefundChargeObjectEnum.
  ///
  ...
  RefundChargeObjectEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'charge': return RefundChargeObjectEnum.charge;
        default:
          if (!allowNull) {
  ...
  /// Singleton [RefundChargeObjectEnumTypeTransformer] instance.
  static RefundChargeObjectEnumTypeTransformer? _instance;
}


/// The status of the payment is either `succeeded`, `pending`, or `failed`.
class RefundChargeStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const RefundChargeStatusEnum._(this.value);
  ...
  static const failed = RefundChargeStatusEnum._(r'failed');
  static const pending = RefundChargeStatusEnum._(r'pending');
  static const succeeded = RefundChargeStatusEnum._(r'succeeded');

  /// List of all possible values in this [enum][RefundChargeStatusEnum].
  static const values = <RefundChargeStatusEnum>[
    failed,
    pending,
    succeeded,
  ];

  static RefundChargeStatusEnum? fromJson(dynamic value) => RefundChargeStatusEnumTypeTransformer().decode(value);

  static List<RefundChargeStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RefundChargeStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RefundChargeStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [RefundChargeStatusEnum] to String,
/// and [decode] dynamic data back to [RefundChargeStatusEnum].
class RefundChargeStatusEnumTypeTransformer {
  factory RefundChargeStatusEnumTypeTransformer() => _instance ??= const RefundChargeStatusEnumTypeTransformer._();

  const RefundChargeStatusEnumTypeTransformer._();

  String encode(RefundChargeStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a RefundChargeStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  RefundChargeStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'failed': return RefundChargeStatusEnum.failed;
        case r'pending': return RefundChargeStatusEnum.pending;
        case r'succeeded': return RefundChargeStatusEnum.succeeded;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [RefundChargeStatusEnumTypeTransformer] instance.
  static RefundChargeStatusEnumTypeTransformer? _instance;
}
