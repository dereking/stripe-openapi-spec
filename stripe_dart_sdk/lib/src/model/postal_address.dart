...
/// * [state] 
@BuiltValue()
abstract class PostalAddress implements Built<PostalAddress, PostalAddressBuilder> {
  ...
  factory PostalAddress([void updates(PostalAddressBuilder b)]) = _$PostalAddress;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PostalAddressBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PostalAddress> get serializer => _$PostalAddressSerializer();
}

class _$PostalAddressSerializer implements PrimitiveSerializer<PostalAddress> {
  @override
  final Iterable<Type> types = const [PostalAddress, _$PostalAddress];

  @override
  final String wireName = r'PostalAddress';
  ...
  void _deserializeProperties(
    ...
    required PostalAddressBuilder result,
  ...
  @override
  PostalAddress deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PostalAddressBuilder();
