...
part 'subscription_latest_invoice.g.dart';
...
@BuiltValue()
abstract class SubscriptionLatestInvoice implements Built<SubscriptionLatestInvoice, SubscriptionLatestInvoiceBuilder> {
  /// Any Of [Invoice], [String]
  AnyOf get anyOf;

  SubscriptionLatestInvoice._();

  factory SubscriptionLatestInvoice([void updates(SubscriptionLatestInvoiceBuilder b)]) = _$SubscriptionLatestInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SubscriptionLatestInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubscriptionLatestInvoice> get serializer => _$SubscriptionLatestInvoiceSerializer();
}

class _$SubscriptionLatestInvoiceSerializer implements PrimitiveSerializer<SubscriptionLatestInvoice> {
  @override
  final Iterable<Type> types = const [SubscriptionLatestInvoice, _$SubscriptionLatestInvoice];

  @override
  final String wireName = r'SubscriptionLatestInvoice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SubscriptionLatestInvoice object, {
  ...
  @override
  SubscriptionLatestInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SubscriptionLatestInvoiceBuilder();
    Object? anyOfDataSrc;
...
class SubscriptionLatestInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const SubscriptionLatestInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$subscriptionLatestInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const SubscriptionLatestInvoiceBillingReasonEnum manual = _$subscriptionLatestInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const SubscriptionLatestInvoiceBillingReasonEnum quoteAccept = _$subscriptionLatestInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const SubscriptionLatestInvoiceBillingReasonEnum subscription = _$subscriptionLatestInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const SubscriptionLatestInvoiceBillingReasonEnum subscriptionCreate = _$subscriptionLatestInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const SubscriptionLatestInvoiceBillingReasonEnum subscriptionCycle = _$subscriptionLatestInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const SubscriptionLatestInvoiceBillingReasonEnum subscriptionThreshold = _$subscriptionLatestInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const SubscriptionLatestInvoiceBillingReasonEnum subscriptionUpdate = _$subscriptionLatestInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const SubscriptionLatestInvoiceBillingReasonEnum upcoming = _$subscriptionLatestInvoiceBillingReasonEnum_upcoming;

  static Serializer<SubscriptionLatestInvoiceBillingReasonEnum> get serializer => _$subscriptionLatestInvoiceBillingReasonEnumSerializer;

  const SubscriptionLatestInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<SubscriptionLatestInvoiceBillingReasonEnum> get values => _$subscriptionLatestInvoiceBillingReasonEnumValues;
  static SubscriptionLatestInvoiceBillingReasonEnum valueOf(String name) => _$subscriptionLatestInvoiceBillingReasonEnumValueOf(name);
}

class SubscriptionLatestInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const SubscriptionLatestInvoiceCollectionMethodEnum chargeAutomatically = _$subscriptionLatestInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const SubscriptionLatestInvoiceCollectionMethodEnum sendInvoice = _$subscriptionLatestInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<SubscriptionLatestInvoiceCollectionMethodEnum> get serializer => _$subscriptionLatestInvoiceCollectionMethodEnumSerializer;

  const SubscriptionLatestInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<SubscriptionLatestInvoiceCollectionMethodEnum> get values => _$subscriptionLatestInvoiceCollectionMethodEnumValues;
  static SubscriptionLatestInvoiceCollectionMethodEnum valueOf(String name) => _$subscriptionLatestInvoiceCollectionMethodEnumValueOf(name);
}

class SubscriptionLatestInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const SubscriptionLatestInvoiceCustomerTaxExemptEnum exempt = _$subscriptionLatestInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const SubscriptionLatestInvoiceCustomerTaxExemptEnum none = _$subscriptionLatestInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const SubscriptionLatestInvoiceCustomerTaxExemptEnum reverse = _$subscriptionLatestInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<SubscriptionLatestInvoiceCustomerTaxExemptEnum> get serializer => _$subscriptionLatestInvoiceCustomerTaxExemptEnumSerializer;

  const SubscriptionLatestInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<SubscriptionLatestInvoiceCustomerTaxExemptEnum> get values => _$subscriptionLatestInvoiceCustomerTaxExemptEnumValues;
  static SubscriptionLatestInvoiceCustomerTaxExemptEnum valueOf(String name) => _$subscriptionLatestInvoiceCustomerTaxExemptEnumValueOf(name);
}

class SubscriptionLatestInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const SubscriptionLatestInvoiceObjectEnum invoice = _$subscriptionLatestInvoiceObjectEnum_invoice;

  static Serializer<SubscriptionLatestInvoiceObjectEnum> get serializer => _$subscriptionLatestInvoiceObjectEnumSerializer;

  const SubscriptionLatestInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<SubscriptionLatestInvoiceObjectEnum> get values => _$subscriptionLatestInvoiceObjectEnumValues;
  static SubscriptionLatestInvoiceObjectEnum valueOf(String name) => _$subscriptionLatestInvoiceObjectEnumValueOf(name);
}

class SubscriptionLatestInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const SubscriptionLatestInvoiceStatusEnum draft = _$subscriptionLatestInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const SubscriptionLatestInvoiceStatusEnum open = _$subscriptionLatestInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const SubscriptionLatestInvoiceStatusEnum paid = _$subscriptionLatestInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const SubscriptionLatestInvoiceStatusEnum uncollectible = _$subscriptionLatestInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const SubscriptionLatestInvoiceStatusEnum void_ = _$subscriptionLatestInvoiceStatusEnum_void_;

  static Serializer<SubscriptionLatestInvoiceStatusEnum> get serializer => _$subscriptionLatestInvoiceStatusEnumSerializer;

  const SubscriptionLatestInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<SubscriptionLatestInvoiceStatusEnum> get values => _$subscriptionLatestInvoiceStatusEnumValues;
  static SubscriptionLatestInvoiceStatusEnum valueOf(String name) => _$subscriptionLatestInvoiceStatusEnumValueOf(name);
}
