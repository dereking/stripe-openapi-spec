...
part 'checkout_session_invoice.g.dart';
...
@BuiltValue()
abstract class CheckoutSessionInvoice implements Built<CheckoutSessionInvoice, CheckoutSessionInvoiceBuilder> {
  /// Any Of [Invoice], [String]
  AnyOf get anyOf;

  CheckoutSessionInvoice._();

  factory CheckoutSessionInvoice([void updates(CheckoutSessionInvoiceBuilder b)]) = _$CheckoutSessionInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutSessionInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutSessionInvoice> get serializer => _$CheckoutSessionInvoiceSerializer();
}

class _$CheckoutSessionInvoiceSerializer implements PrimitiveSerializer<CheckoutSessionInvoice> {
  @override
  final Iterable<Type> types = const [CheckoutSessionInvoice, _$CheckoutSessionInvoice];

  @override
  final String wireName = r'CheckoutSessionInvoice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CheckoutSessionInvoice object, {
  ...
  @override
  CheckoutSessionInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CheckoutSessionInvoiceBuilder();
    Object? anyOfDataSrc;
...
class CheckoutSessionInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const CheckoutSessionInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$checkoutSessionInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const CheckoutSessionInvoiceBillingReasonEnum manual = _$checkoutSessionInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const CheckoutSessionInvoiceBillingReasonEnum quoteAccept = _$checkoutSessionInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const CheckoutSessionInvoiceBillingReasonEnum subscription = _$checkoutSessionInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const CheckoutSessionInvoiceBillingReasonEnum subscriptionCreate = _$checkoutSessionInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const CheckoutSessionInvoiceBillingReasonEnum subscriptionCycle = _$checkoutSessionInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const CheckoutSessionInvoiceBillingReasonEnum subscriptionThreshold = _$checkoutSessionInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const CheckoutSessionInvoiceBillingReasonEnum subscriptionUpdate = _$checkoutSessionInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const CheckoutSessionInvoiceBillingReasonEnum upcoming = _$checkoutSessionInvoiceBillingReasonEnum_upcoming;

  static Serializer<CheckoutSessionInvoiceBillingReasonEnum> get serializer => _$checkoutSessionInvoiceBillingReasonEnumSerializer;

  const CheckoutSessionInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<CheckoutSessionInvoiceBillingReasonEnum> get values => _$checkoutSessionInvoiceBillingReasonEnumValues;
  static CheckoutSessionInvoiceBillingReasonEnum valueOf(String name) => _$checkoutSessionInvoiceBillingReasonEnumValueOf(name);
}

class CheckoutSessionInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const CheckoutSessionInvoiceCollectionMethodEnum chargeAutomatically = _$checkoutSessionInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const CheckoutSessionInvoiceCollectionMethodEnum sendInvoice = _$checkoutSessionInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<CheckoutSessionInvoiceCollectionMethodEnum> get serializer => _$checkoutSessionInvoiceCollectionMethodEnumSerializer;

  const CheckoutSessionInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<CheckoutSessionInvoiceCollectionMethodEnum> get values => _$checkoutSessionInvoiceCollectionMethodEnumValues;
  static CheckoutSessionInvoiceCollectionMethodEnum valueOf(String name) => _$checkoutSessionInvoiceCollectionMethodEnumValueOf(name);
}

class CheckoutSessionInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const CheckoutSessionInvoiceCustomerTaxExemptEnum exempt = _$checkoutSessionInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const CheckoutSessionInvoiceCustomerTaxExemptEnum none = _$checkoutSessionInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const CheckoutSessionInvoiceCustomerTaxExemptEnum reverse = _$checkoutSessionInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<CheckoutSessionInvoiceCustomerTaxExemptEnum> get serializer => _$checkoutSessionInvoiceCustomerTaxExemptEnumSerializer;

  const CheckoutSessionInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<CheckoutSessionInvoiceCustomerTaxExemptEnum> get values => _$checkoutSessionInvoiceCustomerTaxExemptEnumValues;
  static CheckoutSessionInvoiceCustomerTaxExemptEnum valueOf(String name) => _$checkoutSessionInvoiceCustomerTaxExemptEnumValueOf(name);
}

class CheckoutSessionInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const CheckoutSessionInvoiceObjectEnum invoice = _$checkoutSessionInvoiceObjectEnum_invoice;

  static Serializer<CheckoutSessionInvoiceObjectEnum> get serializer => _$checkoutSessionInvoiceObjectEnumSerializer;

  const CheckoutSessionInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<CheckoutSessionInvoiceObjectEnum> get values => _$checkoutSessionInvoiceObjectEnumValues;
  static CheckoutSessionInvoiceObjectEnum valueOf(String name) => _$checkoutSessionInvoiceObjectEnumValueOf(name);
}

class CheckoutSessionInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const CheckoutSessionInvoiceStatusEnum draft = _$checkoutSessionInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const CheckoutSessionInvoiceStatusEnum open = _$checkoutSessionInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const CheckoutSessionInvoiceStatusEnum paid = _$checkoutSessionInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const CheckoutSessionInvoiceStatusEnum uncollectible = _$checkoutSessionInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const CheckoutSessionInvoiceStatusEnum void_ = _$checkoutSessionInvoiceStatusEnum_void_;

  static Serializer<CheckoutSessionInvoiceStatusEnum> get serializer => _$checkoutSessionInvoiceStatusEnumSerializer;

  const CheckoutSessionInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<CheckoutSessionInvoiceStatusEnum> get values => _$checkoutSessionInvoiceStatusEnumValues;
  static CheckoutSessionInvoiceStatusEnum valueOf(String name) => _$checkoutSessionInvoiceStatusEnumValueOf(name);
}
