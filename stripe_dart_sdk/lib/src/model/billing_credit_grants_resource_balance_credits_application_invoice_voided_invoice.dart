...
part 'billing_credit_grants_resource_balance_credits_application_invoice_voided_invoice.g.dart';
...
@BuiltValue()
abstract class BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice implements Built<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice, BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBuilder> {
  /// Any Of [Invoice], [String]
  AnyOf get anyOf;

  BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice._();

  factory BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice([void updates(BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBuilder b)]) = _$BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice> get serializer => _$BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceSerializer();
}

class _$BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceSerializer implements PrimitiveSerializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice> {
  @override
  final Iterable<Type> types = const [BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice, _$BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice];

  @override
  final String wireName = r'BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice object, {
  ...
  @override
  BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBuilder();
    Object? anyOfDataSrc;
...
class BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum manual = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum quoteAccept = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum subscription = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum subscriptionCreate = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum subscriptionCycle = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum subscriptionThreshold = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum subscriptionUpdate = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum upcoming = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum_upcoming;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum> get values => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBillingReasonEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum chargeAutomatically = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum sendInvoice = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum> get values => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCollectionMethodEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum exempt = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum none = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum reverse = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum> get values => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceCustomerTaxExemptEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnum invoice = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnum_invoice;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnum> get values => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceObjectEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum draft = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum open = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum paid = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum uncollectible = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum void_ = _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum_void_;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum> get values => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceStatusEnumValueOf(name);
}
