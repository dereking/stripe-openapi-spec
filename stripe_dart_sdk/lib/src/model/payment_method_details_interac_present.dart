...
import 'package:stripe_dart_sdk/src/model/payment_method_details_interac_present_receipt.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'payment_method_details_interac_present.g.dart';
...
/// * [receipt] 
@BuiltValue()
abstract class PaymentMethodDetailsInteracPresent implements Built<PaymentMethodDetailsInteracPresent, PaymentMethodDetailsInteracPresentBuilder> {
  ...
  PaymentMethodDetailsInteracPresentReadMethodEnum? get readMethod;
  ...
  PaymentMethodDetailsInteracPresentReceipt? get receipt;

  PaymentMethodDetailsInteracPresent._();

  factory PaymentMethodDetailsInteracPresent([void updates(PaymentMethodDetailsInteracPresentBuilder b)]) = _$PaymentMethodDetailsInteracPresent;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentMethodDetailsInteracPresentBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentMethodDetailsInteracPresent> get serializer => _$PaymentMethodDetailsInteracPresentSerializer();
}

class _$PaymentMethodDetailsInteracPresentSerializer implements PrimitiveSerializer<PaymentMethodDetailsInteracPresent> {
  @override
  final Iterable<Type> types = const [PaymentMethodDetailsInteracPresent, _$PaymentMethodDetailsInteracPresent];

  @override
  final String wireName = r'PaymentMethodDetailsInteracPresent';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.readMethod != null) {
      ...
      yield serializers.serialize(
        object.readMethod,
        specifiedType: const FullType.nullable(PaymentMethodDetailsInteracPresentReadMethodEnum),
      );
    }
    if (object.receipt != null) {
      ...
      yield serializers.serialize(
        object.receipt,
        specifiedType: const FullType.nullable(PaymentMethodDetailsInteracPresentReceipt),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required PaymentMethodDetailsInteracPresentBuilder result,
      ...
      switch (key) {
        ...
        case r'read_method':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(PaymentMethodDetailsInteracPresentReadMethodEnum),
          ) as PaymentMethodDetailsInteracPresentReadMethodEnum?;
          if (valueDes == null) continue;
        ...
        case r'receipt':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(PaymentMethodDetailsInteracPresentReceipt),
          ) as PaymentMethodDetailsInteracPresentReceipt?;
          if (valueDes == null) continue;
  ...
  @override
  PaymentMethodDetailsInteracPresent deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentMethodDetailsInteracPresentBuilder();
...
class PaymentMethodDetailsInteracPresentReadMethodEnum extends EnumClass {

  /// How card details were read in this transaction.
  @BuiltValueEnumConst(wireName: r'contact_emv')
  static const PaymentMethodDetailsInteracPresentReadMethodEnum contactEmv = _$paymentMethodDetailsInteracPresentReadMethodEnum_contactEmv;
  /// How card details were read in this transaction.
  @BuiltValueEnumConst(wireName: r'contactless_emv')
  static const PaymentMethodDetailsInteracPresentReadMethodEnum contactlessEmv = _$paymentMethodDetailsInteracPresentReadMethodEnum_contactlessEmv;
  /// How card details were read in this transaction.
  @BuiltValueEnumConst(wireName: r'contactless_magstripe_mode')
  static const PaymentMethodDetailsInteracPresentReadMethodEnum contactlessMagstripeMode = _$paymentMethodDetailsInteracPresentReadMethodEnum_contactlessMagstripeMode;
  /// How card details were read in this transaction.
  @BuiltValueEnumConst(wireName: r'magnetic_stripe_fallback')
  static const PaymentMethodDetailsInteracPresentReadMethodEnum magneticStripeFallback = _$paymentMethodDetailsInteracPresentReadMethodEnum_magneticStripeFallback;
  /// How card details were read in this transaction.
  @BuiltValueEnumConst(wireName: r'magnetic_stripe_track2')
  static const PaymentMethodDetailsInteracPresentReadMethodEnum magneticStripeTrack2 = _$paymentMethodDetailsInteracPresentReadMethodEnum_magneticStripeTrack2;

  static Serializer<PaymentMethodDetailsInteracPresentReadMethodEnum> get serializer => _$paymentMethodDetailsInteracPresentReadMethodEnumSerializer;

  const PaymentMethodDetailsInteracPresentReadMethodEnum._(String name): super(name);

  static BuiltSet<PaymentMethodDetailsInteracPresentReadMethodEnum> get values => _$paymentMethodDetailsInteracPresentReadMethodEnumValues;
  static PaymentMethodDetailsInteracPresentReadMethodEnum valueOf(String name) => _$paymentMethodDetailsInteracPresentReadMethodEnumValueOf(name);
}
