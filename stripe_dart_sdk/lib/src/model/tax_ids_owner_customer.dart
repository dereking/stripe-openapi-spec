...
part 'tax_ids_owner_customer.g.dart';
...
/// * [testClock] 
@BuiltValue()
abstract class TaxIDsOwnerCustomer implements Built<TaxIDsOwnerCustomer, TaxIDsOwnerCustomerBuilder> {
  /// Any Of [Customer], [String]
  AnyOf get anyOf;

  TaxIDsOwnerCustomer._();

  factory TaxIDsOwnerCustomer([void updates(TaxIDsOwnerCustomerBuilder b)]) = _$TaxIDsOwnerCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TaxIDsOwnerCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TaxIDsOwnerCustomer> get serializer => _$TaxIDsOwnerCustomerSerializer();
}

class _$TaxIDsOwnerCustomerSerializer implements PrimitiveSerializer<TaxIDsOwnerCustomer> {
  @override
  final Iterable<Type> types = const [TaxIDsOwnerCustomer, _$TaxIDsOwnerCustomer];

  @override
  final String wireName = r'TaxIDsOwnerCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TaxIDsOwnerCustomer object, {
  ...
  @override
  TaxIDsOwnerCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TaxIDsOwnerCustomerBuilder();
    Object? anyOfDataSrc;
...
class TaxIDsOwnerCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const TaxIDsOwnerCustomerObjectEnum customer = _$taxIDsOwnerCustomerObjectEnum_customer;

  static Serializer<TaxIDsOwnerCustomerObjectEnum> get serializer => _$taxIDsOwnerCustomerObjectEnumSerializer;

  const TaxIDsOwnerCustomerObjectEnum._(String name): super(name);

  static BuiltSet<TaxIDsOwnerCustomerObjectEnum> get values => _$taxIDsOwnerCustomerObjectEnumValues;
  static TaxIDsOwnerCustomerObjectEnum valueOf(String name) => _$taxIDsOwnerCustomerObjectEnumValueOf(name);
}

class TaxIDsOwnerCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const TaxIDsOwnerCustomerTaxExemptEnum exempt = _$taxIDsOwnerCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const TaxIDsOwnerCustomerTaxExemptEnum none = _$taxIDsOwnerCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const TaxIDsOwnerCustomerTaxExemptEnum reverse = _$taxIDsOwnerCustomerTaxExemptEnum_reverse;

  static Serializer<TaxIDsOwnerCustomerTaxExemptEnum> get serializer => _$taxIDsOwnerCustomerTaxExemptEnumSerializer;

  const TaxIDsOwnerCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<TaxIDsOwnerCustomerTaxExemptEnum> get values => _$taxIDsOwnerCustomerTaxExemptEnumValues;
  static TaxIDsOwnerCustomerTaxExemptEnum valueOf(String name) => _$taxIDsOwnerCustomerTaxExemptEnumValueOf(name);
}
