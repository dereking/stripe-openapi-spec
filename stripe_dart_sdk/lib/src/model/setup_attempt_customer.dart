...
part 'setup_attempt_customer.g.dart';
...
@BuiltValue()
abstract class SetupAttemptCustomer implements Built<SetupAttemptCustomer, SetupAttemptCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  SetupAttemptCustomer._();

  factory SetupAttemptCustomer([void updates(SetupAttemptCustomerBuilder b)]) = _$SetupAttemptCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SetupAttemptCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SetupAttemptCustomer> get serializer => _$SetupAttemptCustomerSerializer();
}

class _$SetupAttemptCustomerSerializer implements PrimitiveSerializer<SetupAttemptCustomer> {
  @override
  final Iterable<Type> types = const [SetupAttemptCustomer, _$SetupAttemptCustomer];

  @override
  final String wireName = r'SetupAttemptCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SetupAttemptCustomer object, {
  ...
  @override
  SetupAttemptCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SetupAttemptCustomerBuilder();
    Object? anyOfDataSrc;
...
class SetupAttemptCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const SetupAttemptCustomerObjectEnum customer = _$setupAttemptCustomerObjectEnum_customer;

  static Serializer<SetupAttemptCustomerObjectEnum> get serializer => _$setupAttemptCustomerObjectEnumSerializer;

  const SetupAttemptCustomerObjectEnum._(String name): super(name);

  static BuiltSet<SetupAttemptCustomerObjectEnum> get values => _$setupAttemptCustomerObjectEnumValues;
  static SetupAttemptCustomerObjectEnum valueOf(String name) => _$setupAttemptCustomerObjectEnumValueOf(name);
}

class SetupAttemptCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const SetupAttemptCustomerTaxExemptEnum exempt = _$setupAttemptCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const SetupAttemptCustomerTaxExemptEnum none = _$setupAttemptCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const SetupAttemptCustomerTaxExemptEnum reverse = _$setupAttemptCustomerTaxExemptEnum_reverse;

  static Serializer<SetupAttemptCustomerTaxExemptEnum> get serializer => _$setupAttemptCustomerTaxExemptEnumSerializer;

  const SetupAttemptCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<SetupAttemptCustomerTaxExemptEnum> get values => _$setupAttemptCustomerTaxExemptEnumValues;
  static SetupAttemptCustomerTaxExemptEnum valueOf(String name) => _$setupAttemptCustomerTaxExemptEnumValueOf(name);
}
