...
part 'transfer_source_transaction.g.dart';
...
@BuiltValue()
abstract class TransferSourceTransaction implements Built<TransferSourceTransaction, TransferSourceTransactionBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  TransferSourceTransaction._();

  factory TransferSourceTransaction([void updates(TransferSourceTransactionBuilder b)]) = _$TransferSourceTransaction;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TransferSourceTransactionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TransferSourceTransaction> get serializer => _$TransferSourceTransactionSerializer();
}

class _$TransferSourceTransactionSerializer implements PrimitiveSerializer<TransferSourceTransaction> {
  @override
  final Iterable<Type> types = const [TransferSourceTransaction, _$TransferSourceTransaction];

  @override
  final String wireName = r'TransferSourceTransaction';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TransferSourceTransaction object, {
  ...
  @override
  TransferSourceTransaction deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TransferSourceTransactionBuilder();
    Object? anyOfDataSrc;
...
class TransferSourceTransactionObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const TransferSourceTransactionObjectEnum charge = _$transferSourceTransactionObjectEnum_charge;

  static Serializer<TransferSourceTransactionObjectEnum> get serializer => _$transferSourceTransactionObjectEnumSerializer;

  const TransferSourceTransactionObjectEnum._(String name): super(name);

  static BuiltSet<TransferSourceTransactionObjectEnum> get values => _$transferSourceTransactionObjectEnumValues;
  static TransferSourceTransactionObjectEnum valueOf(String name) => _$transferSourceTransactionObjectEnumValueOf(name);
}

class TransferSourceTransactionStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const TransferSourceTransactionStatusEnum failed = _$transferSourceTransactionStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const TransferSourceTransactionStatusEnum pending = _$transferSourceTransactionStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const TransferSourceTransactionStatusEnum succeeded = _$transferSourceTransactionStatusEnum_succeeded;

  static Serializer<TransferSourceTransactionStatusEnum> get serializer => _$transferSourceTransactionStatusEnumSerializer;

  const TransferSourceTransactionStatusEnum._(String name): super(name);

  static BuiltSet<TransferSourceTransactionStatusEnum> get values => _$transferSourceTransactionStatusEnumValues;
  static TransferSourceTransactionStatusEnum valueOf(String name) => _$transferSourceTransactionStatusEnumValueOf(name);
}
