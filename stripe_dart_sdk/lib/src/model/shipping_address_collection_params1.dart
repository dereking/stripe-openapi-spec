...
part 'shipping_address_collection_params1.g.dart';
...
/// * [allowedCountries] 
@BuiltValue()
abstract class ShippingAddressCollectionParams1 implements Built<ShippingAddressCollectionParams1, ShippingAddressCollectionParams1Builder> {
  ...
  ShippingAddressCollectionParams1._();

  factory ShippingAddressCollectionParams1([void updates(ShippingAddressCollectionParams1Builder b)]) = _$ShippingAddressCollectionParams1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ShippingAddressCollectionParams1Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ShippingAddressCollectionParams1> get serializer => _$ShippingAddressCollectionParams1Serializer();
}

class _$ShippingAddressCollectionParams1Serializer implements PrimitiveSerializer<ShippingAddressCollectionParams1> {
  @override
  final Iterable<Type> types = const [ShippingAddressCollectionParams1, _$ShippingAddressCollectionParams1];

  @override
  final String wireName = r'ShippingAddressCollectionParams1';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ShippingAddressCollectionParams1 object, {
  ...
  void _deserializeProperties(
    ...
    required ShippingAddressCollectionParams1Builder result,
  ...
  @override
  ShippingAddressCollectionParams1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ShippingAddressCollectionParams1Builder();
