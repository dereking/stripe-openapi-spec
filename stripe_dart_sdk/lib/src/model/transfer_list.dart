...
abstract class TransferList implements Built<TransferList, TransferListBuilder> {
  ...
  TransferListObjectEnum get object;
...
class _$TransferListSerializer implements PrimitiveSerializer<TransferList> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.object,
      specifiedType: const FullType(TransferListObjectEnum),
    );
    yield r'url';
    yield serializers.serialize(
      object.url,
...
class TransferListObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value. Always has the value `list`.
  @BuiltValueEnumConst(wireName: r'list')
  static const TransferListObjectEnum list = _$transferListObjectEnum_list;

  static Serializer<TransferListObjectEnum> get serializer => _$transferListObjectEnumSerializer;

  const TransferListObjectEnum._(String name): super(name);

  static BuiltSet<TransferListObjectEnum> get values => _$transferListObjectEnumValues;
  static TransferListObjectEnum valueOf(String name) => _$transferListObjectEnumValueOf(name);
}
