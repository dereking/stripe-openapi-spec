...
part 'setup_intent_customer.g.dart';
...
@BuiltValue()
abstract class SetupIntentCustomer implements Built<SetupIntentCustomer, SetupIntentCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  SetupIntentCustomer._();

  factory SetupIntentCustomer([void updates(SetupIntentCustomerBuilder b)]) = _$SetupIntentCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SetupIntentCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SetupIntentCustomer> get serializer => _$SetupIntentCustomerSerializer();
}

class _$SetupIntentCustomerSerializer implements PrimitiveSerializer<SetupIntentCustomer> {
  @override
  final Iterable<Type> types = const [SetupIntentCustomer, _$SetupIntentCustomer];

  @override
  final String wireName = r'SetupIntentCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SetupIntentCustomer object, {
  ...
  @override
  SetupIntentCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SetupIntentCustomerBuilder();
    Object? anyOfDataSrc;
...
class SetupIntentCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const SetupIntentCustomerObjectEnum customer = _$setupIntentCustomerObjectEnum_customer;

  static Serializer<SetupIntentCustomerObjectEnum> get serializer => _$setupIntentCustomerObjectEnumSerializer;

  const SetupIntentCustomerObjectEnum._(String name): super(name);

  static BuiltSet<SetupIntentCustomerObjectEnum> get values => _$setupIntentCustomerObjectEnumValues;
  static SetupIntentCustomerObjectEnum valueOf(String name) => _$setupIntentCustomerObjectEnumValueOf(name);
}

class SetupIntentCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const SetupIntentCustomerTaxExemptEnum exempt = _$setupIntentCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const SetupIntentCustomerTaxExemptEnum none = _$setupIntentCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const SetupIntentCustomerTaxExemptEnum reverse = _$setupIntentCustomerTaxExemptEnum_reverse;

  static Serializer<SetupIntentCustomerTaxExemptEnum> get serializer => _$setupIntentCustomerTaxExemptEnumSerializer;

  const SetupIntentCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<SetupIntentCustomerTaxExemptEnum> get values => _$setupIntentCustomerTaxExemptEnumValues;
  static SetupIntentCustomerTaxExemptEnum valueOf(String name) => _$setupIntentCustomerTaxExemptEnumValueOf(name);
}
