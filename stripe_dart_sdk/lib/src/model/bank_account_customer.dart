...
part 'bank_account_customer.g.dart';
...
@BuiltValue()
abstract class BankAccountCustomer implements Built<BankAccountCustomer, BankAccountCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  BankAccountCustomer._();

  factory BankAccountCustomer([void updates(BankAccountCustomerBuilder b)]) = _$BankAccountCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BankAccountCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BankAccountCustomer> get serializer => _$BankAccountCustomerSerializer();
}

class _$BankAccountCustomerSerializer implements PrimitiveSerializer<BankAccountCustomer> {
  @override
  final Iterable<Type> types = const [BankAccountCustomer, _$BankAccountCustomer];

  @override
  final String wireName = r'BankAccountCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BankAccountCustomer object, {
  ...
  @override
  BankAccountCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BankAccountCustomerBuilder();
    Object? anyOfDataSrc;
...
class BankAccountCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const BankAccountCustomerObjectEnum customer = _$bankAccountCustomerObjectEnum_customer;

  static Serializer<BankAccountCustomerObjectEnum> get serializer => _$bankAccountCustomerObjectEnumSerializer;

  const BankAccountCustomerObjectEnum._(String name): super(name);

  static BuiltSet<BankAccountCustomerObjectEnum> get values => _$bankAccountCustomerObjectEnumValues;
  static BankAccountCustomerObjectEnum valueOf(String name) => _$bankAccountCustomerObjectEnumValueOf(name);
}

class BankAccountCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const BankAccountCustomerTaxExemptEnum exempt = _$bankAccountCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const BankAccountCustomerTaxExemptEnum none = _$bankAccountCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const BankAccountCustomerTaxExemptEnum reverse = _$bankAccountCustomerTaxExemptEnum_reverse;

  static Serializer<BankAccountCustomerTaxExemptEnum> get serializer => _$bankAccountCustomerTaxExemptEnumSerializer;

  const BankAccountCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<BankAccountCustomerTaxExemptEnum> get values => _$bankAccountCustomerTaxExemptEnumValues;
  static BankAccountCustomerTaxExemptEnum valueOf(String name) => _$bankAccountCustomerTaxExemptEnumValueOf(name);
}
