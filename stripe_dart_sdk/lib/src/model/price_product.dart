...
@BuiltValue()
abstract class PriceProduct implements Built<PriceProduct, PriceProductBuilder> {
  /// Any Of [DeletedProduct], [Product], [String]
  AnyOf get anyOf;

  PriceProduct._();

  factory PriceProduct([void updates(PriceProductBuilder b)]) = _$PriceProduct;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PriceProductBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PriceProduct> get serializer => _$PriceProductSerializer();
}

class _$PriceProductSerializer implements PrimitiveSerializer<PriceProduct> {
  @override
  final Iterable<Type> types = const [PriceProduct, _$PriceProduct];

  @override
  final String wireName = r'PriceProduct';
  ...
  @override
  PriceProduct deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PriceProductBuilder();
    Object? anyOfDataSrc;
...
class PriceProductObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'product')
  static const PriceProductObjectEnum product = _$priceProductObjectEnum_product;

  static Serializer<PriceProductObjectEnum> get serializer => _$priceProductObjectEnumSerializer;

  const PriceProductObjectEnum._(String name): super(name);

  static BuiltSet<PriceProductObjectEnum> get values => _$priceProductObjectEnumValues;
  static PriceProductObjectEnum valueOf(String name) => _$priceProductObjectEnumValueOf(name);
}
