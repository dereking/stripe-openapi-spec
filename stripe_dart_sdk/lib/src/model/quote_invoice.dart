...
@BuiltValue()
abstract class QuoteInvoice implements Built<QuoteInvoice, QuoteInvoiceBuilder> {
  /// Any Of [DeletedInvoice], [Invoice], [String]
  AnyOf get anyOf;

  QuoteInvoice._();

  factory QuoteInvoice([void updates(QuoteInvoiceBuilder b)]) = _$QuoteInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(QuoteInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<QuoteInvoice> get serializer => _$QuoteInvoiceSerializer();
}

class _$QuoteInvoiceSerializer implements PrimitiveSerializer<QuoteInvoice> {
  @override
  final Iterable<Type> types = const [QuoteInvoice, _$QuoteInvoice];

  @override
  final String wireName = r'QuoteInvoice';
  ...
  @override
  QuoteInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = QuoteInvoiceBuilder();
    Object? anyOfDataSrc;
...
class QuoteInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const QuoteInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$quoteInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const QuoteInvoiceBillingReasonEnum manual = _$quoteInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const QuoteInvoiceBillingReasonEnum quoteAccept = _$quoteInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const QuoteInvoiceBillingReasonEnum subscription = _$quoteInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const QuoteInvoiceBillingReasonEnum subscriptionCreate = _$quoteInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const QuoteInvoiceBillingReasonEnum subscriptionCycle = _$quoteInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const QuoteInvoiceBillingReasonEnum subscriptionThreshold = _$quoteInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const QuoteInvoiceBillingReasonEnum subscriptionUpdate = _$quoteInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const QuoteInvoiceBillingReasonEnum upcoming = _$quoteInvoiceBillingReasonEnum_upcoming;

  static Serializer<QuoteInvoiceBillingReasonEnum> get serializer => _$quoteInvoiceBillingReasonEnumSerializer;

  const QuoteInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<QuoteInvoiceBillingReasonEnum> get values => _$quoteInvoiceBillingReasonEnumValues;
  static QuoteInvoiceBillingReasonEnum valueOf(String name) => _$quoteInvoiceBillingReasonEnumValueOf(name);
}

class QuoteInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const QuoteInvoiceCollectionMethodEnum chargeAutomatically = _$quoteInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const QuoteInvoiceCollectionMethodEnum sendInvoice = _$quoteInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<QuoteInvoiceCollectionMethodEnum> get serializer => _$quoteInvoiceCollectionMethodEnumSerializer;

  const QuoteInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<QuoteInvoiceCollectionMethodEnum> get values => _$quoteInvoiceCollectionMethodEnumValues;
  static QuoteInvoiceCollectionMethodEnum valueOf(String name) => _$quoteInvoiceCollectionMethodEnumValueOf(name);
}

class QuoteInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const QuoteInvoiceCustomerTaxExemptEnum exempt = _$quoteInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const QuoteInvoiceCustomerTaxExemptEnum none = _$quoteInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const QuoteInvoiceCustomerTaxExemptEnum reverse = _$quoteInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<QuoteInvoiceCustomerTaxExemptEnum> get serializer => _$quoteInvoiceCustomerTaxExemptEnumSerializer;

  const QuoteInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<QuoteInvoiceCustomerTaxExemptEnum> get values => _$quoteInvoiceCustomerTaxExemptEnumValues;
  static QuoteInvoiceCustomerTaxExemptEnum valueOf(String name) => _$quoteInvoiceCustomerTaxExemptEnumValueOf(name);
}

class QuoteInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const QuoteInvoiceObjectEnum invoice = _$quoteInvoiceObjectEnum_invoice;

  static Serializer<QuoteInvoiceObjectEnum> get serializer => _$quoteInvoiceObjectEnumSerializer;

  const QuoteInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<QuoteInvoiceObjectEnum> get values => _$quoteInvoiceObjectEnumValues;
  static QuoteInvoiceObjectEnum valueOf(String name) => _$quoteInvoiceObjectEnumValueOf(name);
}

class QuoteInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const QuoteInvoiceStatusEnum draft = _$quoteInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const QuoteInvoiceStatusEnum open = _$quoteInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const QuoteInvoiceStatusEnum paid = _$quoteInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const QuoteInvoiceStatusEnum uncollectible = _$quoteInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const QuoteInvoiceStatusEnum void_ = _$quoteInvoiceStatusEnum_void_;

  static Serializer<QuoteInvoiceStatusEnum> get serializer => _$quoteInvoiceStatusEnumSerializer;

  const QuoteInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<QuoteInvoiceStatusEnum> get values => _$quoteInvoiceStatusEnumValues;
  static QuoteInvoiceStatusEnum valueOf(String name) => _$quoteInvoiceStatusEnumValueOf(name);
}
