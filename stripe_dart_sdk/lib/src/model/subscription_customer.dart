...
@BuiltValue()
abstract class SubscriptionCustomer implements Built<SubscriptionCustomer, SubscriptionCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  SubscriptionCustomer._();

  factory SubscriptionCustomer([void updates(SubscriptionCustomerBuilder b)]) = _$SubscriptionCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SubscriptionCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubscriptionCustomer> get serializer => _$SubscriptionCustomerSerializer();
}

class _$SubscriptionCustomerSerializer implements PrimitiveSerializer<SubscriptionCustomer> {
  @override
  final Iterable<Type> types = const [SubscriptionCustomer, _$SubscriptionCustomer];

  @override
  final String wireName = r'SubscriptionCustomer';
  ...
  @override
  SubscriptionCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SubscriptionCustomerBuilder();
    Object? anyOfDataSrc;
...
class SubscriptionCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const SubscriptionCustomerObjectEnum customer = _$subscriptionCustomerObjectEnum_customer;

  static Serializer<SubscriptionCustomerObjectEnum> get serializer => _$subscriptionCustomerObjectEnumSerializer;

  const SubscriptionCustomerObjectEnum._(String name): super(name);

  static BuiltSet<SubscriptionCustomerObjectEnum> get values => _$subscriptionCustomerObjectEnumValues;
  static SubscriptionCustomerObjectEnum valueOf(String name) => _$subscriptionCustomerObjectEnumValueOf(name);
}

class SubscriptionCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const SubscriptionCustomerTaxExemptEnum exempt = _$subscriptionCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const SubscriptionCustomerTaxExemptEnum none = _$subscriptionCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const SubscriptionCustomerTaxExemptEnum reverse = _$subscriptionCustomerTaxExemptEnum_reverse;

  static Serializer<SubscriptionCustomerTaxExemptEnum> get serializer => _$subscriptionCustomerTaxExemptEnumSerializer;

  const SubscriptionCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<SubscriptionCustomerTaxExemptEnum> get values => _$subscriptionCustomerTaxExemptEnumValues;
  static SubscriptionCustomerTaxExemptEnum valueOf(String name) => _$subscriptionCustomerTaxExemptEnumValueOf(name);
}
