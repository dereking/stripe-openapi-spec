...
abstract class ProductList implements Built<ProductList, ProductListBuilder> {
  ...
  ProductListObjectEnum get object;
...
class _$ProductListSerializer implements PrimitiveSerializer<ProductList> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.object,
      specifiedType: const FullType(ProductListObjectEnum),
    );
    yield r'url';
    yield serializers.serialize(
      object.url,
...
class ProductListObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value. Always has the value `list`.
  @BuiltValueEnumConst(wireName: r'list')
  static const ProductListObjectEnum list = _$productListObjectEnum_list;

  static Serializer<ProductListObjectEnum> get serializer => _$productListObjectEnumSerializer;

  const ProductListObjectEnum._(String name): super(name);

  static BuiltSet<ProductListObjectEnum> get values => _$productListObjectEnumValues;
  static ProductListObjectEnum valueOf(String name) => _$productListObjectEnumValueOf(name);
}
