...
part 'billing_details_inner_params.g.dart';
...
/// * [taxId] 
@BuiltValue()
abstract class BillingDetailsInnerParams implements Built<BillingDetailsInnerParams, BillingDetailsInnerParamsBuilder> {
  ...
  BillingDetailsInnerParams._();

  factory BillingDetailsInnerParams([void updates(BillingDetailsInnerParamsBuilder b)]) = _$BillingDetailsInnerParams;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BillingDetailsInnerParamsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BillingDetailsInnerParams> get serializer => _$BillingDetailsInnerParamsSerializer();
}

class _$BillingDetailsInnerParamsSerializer implements PrimitiveSerializer<BillingDetailsInnerParams> {
  @override
  final Iterable<Type> types = const [BillingDetailsInnerParams, _$BillingDetailsInnerParams];

  @override
  final String wireName = r'BillingDetailsInnerParams';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BillingDetailsInnerParams object, {
  ...
  void _deserializeProperties(
    ...
    required BillingDetailsInnerParamsBuilder result,
  ...
  @override
  BillingDetailsInnerParams deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BillingDetailsInnerParamsBuilder();
