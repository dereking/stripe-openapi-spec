...
part 'gelato_session_document_options.g.dart';
...
@BuiltValue()
abstract class GelatoSessionDocumentOptions implements Built<GelatoSessionDocumentOptions, GelatoSessionDocumentOptionsBuilder> {
  ...
  GelatoSessionDocumentOptions._();

  factory GelatoSessionDocumentOptions([void updates(GelatoSessionDocumentOptionsBuilder b)]) = _$GelatoSessionDocumentOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GelatoSessionDocumentOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GelatoSessionDocumentOptions> get serializer => _$GelatoSessionDocumentOptionsSerializer();
}

class _$GelatoSessionDocumentOptionsSerializer implements PrimitiveSerializer<GelatoSessionDocumentOptions> {
  @override
  final Iterable<Type> types = const [GelatoSessionDocumentOptions, _$GelatoSessionDocumentOptions];

  @override
  final String wireName = r'GelatoSessionDocumentOptions';
  ...
  void _deserializeProperties(
    ...
    required GelatoSessionDocumentOptionsBuilder result,
  ...
  @override
  GelatoSessionDocumentOptions deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GelatoSessionDocumentOptionsBuilder();
