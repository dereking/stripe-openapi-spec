...
part 'invoiceitem_invoice.g.dart';
...
@BuiltValue()
abstract class InvoiceitemInvoice implements Built<InvoiceitemInvoice, InvoiceitemInvoiceBuilder> {
  /// Any Of [Invoice], [String]
  AnyOf get anyOf;

  InvoiceitemInvoice._();

  factory InvoiceitemInvoice([void updates(InvoiceitemInvoiceBuilder b)]) = _$InvoiceitemInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoiceitemInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoiceitemInvoice> get serializer => _$InvoiceitemInvoiceSerializer();
}

class _$InvoiceitemInvoiceSerializer implements PrimitiveSerializer<InvoiceitemInvoice> {
  @override
  final Iterable<Type> types = const [InvoiceitemInvoice, _$InvoiceitemInvoice];

  @override
  final String wireName = r'InvoiceitemInvoice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InvoiceitemInvoice object, {
  ...
  @override
  InvoiceitemInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoiceitemInvoiceBuilder();
    Object? anyOfDataSrc;
...
class InvoiceitemInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const InvoiceitemInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$invoiceitemInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const InvoiceitemInvoiceBillingReasonEnum manual = _$invoiceitemInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const InvoiceitemInvoiceBillingReasonEnum quoteAccept = _$invoiceitemInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const InvoiceitemInvoiceBillingReasonEnum subscription = _$invoiceitemInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const InvoiceitemInvoiceBillingReasonEnum subscriptionCreate = _$invoiceitemInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const InvoiceitemInvoiceBillingReasonEnum subscriptionCycle = _$invoiceitemInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const InvoiceitemInvoiceBillingReasonEnum subscriptionThreshold = _$invoiceitemInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const InvoiceitemInvoiceBillingReasonEnum subscriptionUpdate = _$invoiceitemInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const InvoiceitemInvoiceBillingReasonEnum upcoming = _$invoiceitemInvoiceBillingReasonEnum_upcoming;

  static Serializer<InvoiceitemInvoiceBillingReasonEnum> get serializer => _$invoiceitemInvoiceBillingReasonEnumSerializer;

  const InvoiceitemInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<InvoiceitemInvoiceBillingReasonEnum> get values => _$invoiceitemInvoiceBillingReasonEnumValues;
  static InvoiceitemInvoiceBillingReasonEnum valueOf(String name) => _$invoiceitemInvoiceBillingReasonEnumValueOf(name);
}

class InvoiceitemInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const InvoiceitemInvoiceCollectionMethodEnum chargeAutomatically = _$invoiceitemInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const InvoiceitemInvoiceCollectionMethodEnum sendInvoice = _$invoiceitemInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<InvoiceitemInvoiceCollectionMethodEnum> get serializer => _$invoiceitemInvoiceCollectionMethodEnumSerializer;

  const InvoiceitemInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<InvoiceitemInvoiceCollectionMethodEnum> get values => _$invoiceitemInvoiceCollectionMethodEnumValues;
  static InvoiceitemInvoiceCollectionMethodEnum valueOf(String name) => _$invoiceitemInvoiceCollectionMethodEnumValueOf(name);
}

class InvoiceitemInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const InvoiceitemInvoiceCustomerTaxExemptEnum exempt = _$invoiceitemInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const InvoiceitemInvoiceCustomerTaxExemptEnum none = _$invoiceitemInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const InvoiceitemInvoiceCustomerTaxExemptEnum reverse = _$invoiceitemInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<InvoiceitemInvoiceCustomerTaxExemptEnum> get serializer => _$invoiceitemInvoiceCustomerTaxExemptEnumSerializer;

  const InvoiceitemInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<InvoiceitemInvoiceCustomerTaxExemptEnum> get values => _$invoiceitemInvoiceCustomerTaxExemptEnumValues;
  static InvoiceitemInvoiceCustomerTaxExemptEnum valueOf(String name) => _$invoiceitemInvoiceCustomerTaxExemptEnumValueOf(name);
}

class InvoiceitemInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const InvoiceitemInvoiceObjectEnum invoice = _$invoiceitemInvoiceObjectEnum_invoice;

  static Serializer<InvoiceitemInvoiceObjectEnum> get serializer => _$invoiceitemInvoiceObjectEnumSerializer;

  const InvoiceitemInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<InvoiceitemInvoiceObjectEnum> get values => _$invoiceitemInvoiceObjectEnumValues;
  static InvoiceitemInvoiceObjectEnum valueOf(String name) => _$invoiceitemInvoiceObjectEnumValueOf(name);
}

class InvoiceitemInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const InvoiceitemInvoiceStatusEnum draft = _$invoiceitemInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const InvoiceitemInvoiceStatusEnum open = _$invoiceitemInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const InvoiceitemInvoiceStatusEnum paid = _$invoiceitemInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const InvoiceitemInvoiceStatusEnum uncollectible = _$invoiceitemInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const InvoiceitemInvoiceStatusEnum void_ = _$invoiceitemInvoiceStatusEnum_void_;

  static Serializer<InvoiceitemInvoiceStatusEnum> get serializer => _$invoiceitemInvoiceStatusEnumSerializer;

  const InvoiceitemInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<InvoiceitemInvoiceStatusEnum> get values => _$invoiceitemInvoiceStatusEnumValues;
  static InvoiceitemInvoiceStatusEnum valueOf(String name) => _$invoiceitemInvoiceStatusEnumValueOf(name);
}
