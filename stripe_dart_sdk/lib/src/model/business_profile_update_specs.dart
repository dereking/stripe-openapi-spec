...
part 'business_profile_update_specs.g.dart';
...
/// * [url] 
@BuiltValue()
abstract class BusinessProfileUpdateSpecs implements Built<BusinessProfileUpdateSpecs, BusinessProfileUpdateSpecsBuilder> {
  ...
  BusinessProfileUpdateSpecs._();

  factory BusinessProfileUpdateSpecs([void updates(BusinessProfileUpdateSpecsBuilder b)]) = _$BusinessProfileUpdateSpecs;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BusinessProfileUpdateSpecsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BusinessProfileUpdateSpecs> get serializer => _$BusinessProfileUpdateSpecsSerializer();
}

class _$BusinessProfileUpdateSpecsSerializer implements PrimitiveSerializer<BusinessProfileUpdateSpecs> {
  @override
  final Iterable<Type> types = const [BusinessProfileUpdateSpecs, _$BusinessProfileUpdateSpecs];

  @override
  final String wireName = r'BusinessProfileUpdateSpecs';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BusinessProfileUpdateSpecs object, {
  ...
  void _deserializeProperties(
    ...
    required BusinessProfileUpdateSpecsBuilder result,
  ...
  @override
  BusinessProfileUpdateSpecs deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BusinessProfileUpdateSpecsBuilder();
