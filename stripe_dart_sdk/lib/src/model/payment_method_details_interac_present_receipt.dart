...
part 'payment_method_details_interac_present_receipt.g.dart';
...
@BuiltValue()
abstract class PaymentMethodDetailsInteracPresentReceipt implements Built<PaymentMethodDetailsInteracPresentReceipt, PaymentMethodDetailsInteracPresentReceiptBuilder> {
  /// The type of account being debited or credited
  @BuiltValueField(wireName: r'account_type')
  PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum? get accountType;
  // enum accountTypeEnum {  checking,  savings,  unknown,  };
  ...
  PaymentMethodDetailsInteracPresentReceipt._();

  factory PaymentMethodDetailsInteracPresentReceipt([void updates(PaymentMethodDetailsInteracPresentReceiptBuilder b)]) = _$PaymentMethodDetailsInteracPresentReceipt;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentMethodDetailsInteracPresentReceiptBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentMethodDetailsInteracPresentReceipt> get serializer => _$PaymentMethodDetailsInteracPresentReceiptSerializer();
}

class _$PaymentMethodDetailsInteracPresentReceiptSerializer implements PrimitiveSerializer<PaymentMethodDetailsInteracPresentReceipt> {
  @override
  final Iterable<Type> types = const [PaymentMethodDetailsInteracPresentReceipt, _$PaymentMethodDetailsInteracPresentReceipt];

  @override
  final String wireName = r'PaymentMethodDetailsInteracPresentReceipt';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.accountType != null) {
      ...
      yield serializers.serialize(
        object.accountType,
        specifiedType: const FullType(PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PaymentMethodDetailsInteracPresentReceiptBuilder result,
      ...
      switch (key) {
        case r'account_type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum),
          ) as PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum;
  ...
  @override
  PaymentMethodDetailsInteracPresentReceipt deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentMethodDetailsInteracPresentReceiptBuilder();
...
class PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum extends EnumClass {

  /// The type of account being debited or credited
  @BuiltValueEnumConst(wireName: r'checking')
  static const PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum checking = _$paymentMethodDetailsInteracPresentReceiptAccountTypeEnum_checking;
  /// The type of account being debited or credited
  @BuiltValueEnumConst(wireName: r'savings')
  static const PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum savings = _$paymentMethodDetailsInteracPresentReceiptAccountTypeEnum_savings;
  /// The type of account being debited or credited
  @BuiltValueEnumConst(wireName: r'unknown')
  static const PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum unknown = _$paymentMethodDetailsInteracPresentReceiptAccountTypeEnum_unknown;

  static Serializer<PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum> get serializer => _$paymentMethodDetailsInteracPresentReceiptAccountTypeEnumSerializer;

  const PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum._(String name): super(name);

  static BuiltSet<PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum> get values => _$paymentMethodDetailsInteracPresentReceiptAccountTypeEnumValues;
  static PaymentMethodDetailsInteracPresentReceiptAccountTypeEnum valueOf(String name) => _$paymentMethodDetailsInteracPresentReceiptAccountTypeEnumValueOf(name);
}
