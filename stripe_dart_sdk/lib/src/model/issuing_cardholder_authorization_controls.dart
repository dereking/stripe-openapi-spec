...
import 'package:stripe_dart_sdk/src/model/issuing_cardholder_spending_limit.dart';
import 'package:built_collection/built_collection.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'issuing_cardholder_authorization_controls.g.dart';
...
/// * [spendingLimits] - Limit spending with amount-based rules that apply across this cardholder's cards.
/// * [spendingLimitsCurrency] - Currency of the amounts within `spending_limits`.
@BuiltValue()
abstract class IssuingCardholderAuthorizationControls implements Built<IssuingCardholderAuthorizationControls, IssuingCardholderAuthorizationControlsBuilder> {
  ...
  BuiltList<IssuingCardholderSpendingLimit>? get spendingLimits;

  /// Currency of the amounts within `spending_limits`.
  @BuiltValueField(wireName: r'spending_limits_currency')
  String? get spendingLimitsCurrency;

  IssuingCardholderAuthorizationControls._();

  factory IssuingCardholderAuthorizationControls([void updates(IssuingCardholderAuthorizationControlsBuilder b)]) = _$IssuingCardholderAuthorizationControls;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IssuingCardholderAuthorizationControlsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IssuingCardholderAuthorizationControls> get serializer => _$IssuingCardholderAuthorizationControlsSerializer();
}

class _$IssuingCardholderAuthorizationControlsSerializer implements PrimitiveSerializer<IssuingCardholderAuthorizationControls> {
  @override
  final Iterable<Type> types = const [IssuingCardholderAuthorizationControls, _$IssuingCardholderAuthorizationControls];

  @override
  final String wireName = r'IssuingCardholderAuthorizationControls';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.spendingLimits != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(BuiltList, [FullType(IssuingCardholderSpendingLimit)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required IssuingCardholderAuthorizationControlsBuilder result,
      ...
      switch (key) {
        ...
        case r'spending_limits':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(IssuingCardholderSpendingLimit)]),
          ) as BuiltList<IssuingCardholderSpendingLimit>?;
          if (valueDes == null) continue;
  ...
  @override
  IssuingCardholderAuthorizationControls deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IssuingCardholderAuthorizationControlsBuilder();
