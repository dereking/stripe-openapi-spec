...
part 'payment_pages_checkout_session_shipping_address_collection.g.dart';

/// 
///
/// Properties:
/// * [allowedCountries] - An array of two-letter ISO country codes representing which countries Checkout should provide as options for shipping locations. Unsupported country codes: `AS, CX, CC, CU, HM, IR, KP, MH, FM, NF, MP, PW, SY, UM, VI`.
@BuiltValue()
abstract class PaymentPagesCheckoutSessionShippingAddressCollection implements Built<PaymentPagesCheckoutSessionShippingAddressCollection, PaymentPagesCheckoutSessionShippingAddressCollectionBuilder> {
  ...
  PaymentPagesCheckoutSessionShippingAddressCollection._();

  factory PaymentPagesCheckoutSessionShippingAddressCollection([void updates(PaymentPagesCheckoutSessionShippingAddressCollectionBuilder b)]) = _$PaymentPagesCheckoutSessionShippingAddressCollection;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentPagesCheckoutSessionShippingAddressCollectionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentPagesCheckoutSessionShippingAddressCollection> get serializer => _$PaymentPagesCheckoutSessionShippingAddressCollectionSerializer();
}

class _$PaymentPagesCheckoutSessionShippingAddressCollectionSerializer implements PrimitiveSerializer<PaymentPagesCheckoutSessionShippingAddressCollection> {
  @override
  final Iterable<Type> types = const [PaymentPagesCheckoutSessionShippingAddressCollection, _$PaymentPagesCheckoutSessionShippingAddressCollection];

  @override
  final String wireName = r'PaymentPagesCheckoutSessionShippingAddressCollection';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaymentPagesCheckoutSessionShippingAddressCollection object, {
  ...
  void _deserializeProperties(
    ...
    required PaymentPagesCheckoutSessionShippingAddressCollectionBuilder result,
  ...
  @override
  PaymentPagesCheckoutSessionShippingAddressCollection deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentPagesCheckoutSessionShippingAddressCollectionBuilder();
