...
@BuiltValue()
abstract class DisputeCharge implements Built<DisputeCharge, DisputeChargeBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  DisputeCharge._();

  factory DisputeCharge([void updates(DisputeChargeBuilder b)]) = _$DisputeCharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DisputeChargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DisputeCharge> get serializer => _$DisputeChargeSerializer();
}

class _$DisputeChargeSerializer implements PrimitiveSerializer<DisputeCharge> {
  @override
  final Iterable<Type> types = const [DisputeCharge, _$DisputeCharge];

  @override
  final String wireName = r'DisputeCharge';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DisputeCharge object, {
  ...
  @override
  DisputeCharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DisputeChargeBuilder();
    Object? anyOfDataSrc;
...
class DisputeChargeObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const DisputeChargeObjectEnum charge = _$disputeChargeObjectEnum_charge;

  static Serializer<DisputeChargeObjectEnum> get serializer => _$disputeChargeObjectEnumSerializer;

  const DisputeChargeObjectEnum._(String name): super(name);

  static BuiltSet<DisputeChargeObjectEnum> get values => _$disputeChargeObjectEnumValues;
  static DisputeChargeObjectEnum valueOf(String name) => _$disputeChargeObjectEnumValueOf(name);
}

class DisputeChargeStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const DisputeChargeStatusEnum failed = _$disputeChargeStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const DisputeChargeStatusEnum pending = _$disputeChargeStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const DisputeChargeStatusEnum succeeded = _$disputeChargeStatusEnum_succeeded;

  static Serializer<DisputeChargeStatusEnum> get serializer => _$disputeChargeStatusEnumSerializer;

  const DisputeChargeStatusEnum._(String name): super(name);

  static BuiltSet<DisputeChargeStatusEnum> get values => _$disputeChargeStatusEnumValues;
  static DisputeChargeStatusEnum valueOf(String name) => _$disputeChargeStatusEnumValueOf(name);
}
