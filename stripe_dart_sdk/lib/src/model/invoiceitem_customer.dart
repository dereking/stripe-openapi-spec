...
part 'invoiceitem_customer.g.dart';
...
@BuiltValue()
abstract class InvoiceitemCustomer implements Built<InvoiceitemCustomer, InvoiceitemCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  InvoiceitemCustomer._();

  factory InvoiceitemCustomer([void updates(InvoiceitemCustomerBuilder b)]) = _$InvoiceitemCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoiceitemCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoiceitemCustomer> get serializer => _$InvoiceitemCustomerSerializer();
}

class _$InvoiceitemCustomerSerializer implements PrimitiveSerializer<InvoiceitemCustomer> {
  @override
  final Iterable<Type> types = const [InvoiceitemCustomer, _$InvoiceitemCustomer];

  @override
  final String wireName = r'InvoiceitemCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InvoiceitemCustomer object, {
  ...
  @override
  InvoiceitemCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoiceitemCustomerBuilder();
    Object? anyOfDataSrc;
...
class InvoiceitemCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const InvoiceitemCustomerObjectEnum customer = _$invoiceitemCustomerObjectEnum_customer;

  static Serializer<InvoiceitemCustomerObjectEnum> get serializer => _$invoiceitemCustomerObjectEnumSerializer;

  const InvoiceitemCustomerObjectEnum._(String name): super(name);

  static BuiltSet<InvoiceitemCustomerObjectEnum> get values => _$invoiceitemCustomerObjectEnumValues;
  static InvoiceitemCustomerObjectEnum valueOf(String name) => _$invoiceitemCustomerObjectEnumValueOf(name);
}

class InvoiceitemCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const InvoiceitemCustomerTaxExemptEnum exempt = _$invoiceitemCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const InvoiceitemCustomerTaxExemptEnum none = _$invoiceitemCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const InvoiceitemCustomerTaxExemptEnum reverse = _$invoiceitemCustomerTaxExemptEnum_reverse;

  static Serializer<InvoiceitemCustomerTaxExemptEnum> get serializer => _$invoiceitemCustomerTaxExemptEnumSerializer;

  const InvoiceitemCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<InvoiceitemCustomerTaxExemptEnum> get values => _$invoiceitemCustomerTaxExemptEnumValues;
  static InvoiceitemCustomerTaxExemptEnum valueOf(String name) => _$invoiceitemCustomerTaxExemptEnumValueOf(name);
}
