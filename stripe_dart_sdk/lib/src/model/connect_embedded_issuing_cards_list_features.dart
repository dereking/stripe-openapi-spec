...
part 'connect_embedded_issuing_cards_list_features.g.dart';
...
@BuiltValue()
abstract class ConnectEmbeddedIssuingCardsListFeatures implements Built<ConnectEmbeddedIssuingCardsListFeatures, ConnectEmbeddedIssuingCardsListFeaturesBuilder> {
  ...
  ConnectEmbeddedIssuingCardsListFeatures._();

  factory ConnectEmbeddedIssuingCardsListFeatures([void updates(ConnectEmbeddedIssuingCardsListFeaturesBuilder b)]) = _$ConnectEmbeddedIssuingCardsListFeatures;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ConnectEmbeddedIssuingCardsListFeaturesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ConnectEmbeddedIssuingCardsListFeatures> get serializer => _$ConnectEmbeddedIssuingCardsListFeaturesSerializer();
}

class _$ConnectEmbeddedIssuingCardsListFeaturesSerializer implements PrimitiveSerializer<ConnectEmbeddedIssuingCardsListFeatures> {
  @override
  final Iterable<Type> types = const [ConnectEmbeddedIssuingCardsListFeatures, _$ConnectEmbeddedIssuingCardsListFeatures];

  @override
  final String wireName = r'ConnectEmbeddedIssuingCardsListFeatures';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ConnectEmbeddedIssuingCardsListFeatures object, {
  ...
  void _deserializeProperties(
    ...
    required ConnectEmbeddedIssuingCardsListFeaturesBuilder result,
  ...
  @override
  ConnectEmbeddedIssuingCardsListFeatures deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ConnectEmbeddedIssuingCardsListFeaturesBuilder();
