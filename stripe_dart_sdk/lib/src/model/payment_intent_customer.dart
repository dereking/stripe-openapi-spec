...
part 'payment_intent_customer.g.dart';
...
@BuiltValue()
abstract class PaymentIntentCustomer implements Built<PaymentIntentCustomer, PaymentIntentCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  PaymentIntentCustomer._();

  factory PaymentIntentCustomer([void updates(PaymentIntentCustomerBuilder b)]) = _$PaymentIntentCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentIntentCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentIntentCustomer> get serializer => _$PaymentIntentCustomerSerializer();
}

class _$PaymentIntentCustomerSerializer implements PrimitiveSerializer<PaymentIntentCustomer> {
  @override
  final Iterable<Type> types = const [PaymentIntentCustomer, _$PaymentIntentCustomer];

  @override
  final String wireName = r'PaymentIntentCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaymentIntentCustomer object, {
  ...
  @override
  PaymentIntentCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentIntentCustomerBuilder();
    Object? anyOfDataSrc;
...
class PaymentIntentCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const PaymentIntentCustomerObjectEnum customer = _$paymentIntentCustomerObjectEnum_customer;

  static Serializer<PaymentIntentCustomerObjectEnum> get serializer => _$paymentIntentCustomerObjectEnumSerializer;

  const PaymentIntentCustomerObjectEnum._(String name): super(name);

  static BuiltSet<PaymentIntentCustomerObjectEnum> get values => _$paymentIntentCustomerObjectEnumValues;
  static PaymentIntentCustomerObjectEnum valueOf(String name) => _$paymentIntentCustomerObjectEnumValueOf(name);
}

class PaymentIntentCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const PaymentIntentCustomerTaxExemptEnum exempt = _$paymentIntentCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const PaymentIntentCustomerTaxExemptEnum none = _$paymentIntentCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const PaymentIntentCustomerTaxExemptEnum reverse = _$paymentIntentCustomerTaxExemptEnum_reverse;

  static Serializer<PaymentIntentCustomerTaxExemptEnum> get serializer => _$paymentIntentCustomerTaxExemptEnumSerializer;

  const PaymentIntentCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<PaymentIntentCustomerTaxExemptEnum> get values => _$paymentIntentCustomerTaxExemptEnumValues;
  static PaymentIntentCustomerTaxExemptEnum valueOf(String name) => _$paymentIntentCustomerTaxExemptEnumValueOf(name);
}
