...
part 'transfer_destination_payment.g.dart';
...
@BuiltValue()
abstract class TransferDestinationPayment implements Built<TransferDestinationPayment, TransferDestinationPaymentBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  TransferDestinationPayment._();

  factory TransferDestinationPayment([void updates(TransferDestinationPaymentBuilder b)]) = _$TransferDestinationPayment;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TransferDestinationPaymentBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TransferDestinationPayment> get serializer => _$TransferDestinationPaymentSerializer();
}

class _$TransferDestinationPaymentSerializer implements PrimitiveSerializer<TransferDestinationPayment> {
  @override
  final Iterable<Type> types = const [TransferDestinationPayment, _$TransferDestinationPayment];

  @override
  final String wireName = r'TransferDestinationPayment';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TransferDestinationPayment object, {
  ...
  @override
  TransferDestinationPayment deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TransferDestinationPaymentBuilder();
    Object? anyOfDataSrc;
...
class TransferDestinationPaymentObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const TransferDestinationPaymentObjectEnum charge = _$transferDestinationPaymentObjectEnum_charge;

  static Serializer<TransferDestinationPaymentObjectEnum> get serializer => _$transferDestinationPaymentObjectEnumSerializer;

  const TransferDestinationPaymentObjectEnum._(String name): super(name);

  static BuiltSet<TransferDestinationPaymentObjectEnum> get values => _$transferDestinationPaymentObjectEnumValues;
  static TransferDestinationPaymentObjectEnum valueOf(String name) => _$transferDestinationPaymentObjectEnumValueOf(name);
}

class TransferDestinationPaymentStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const TransferDestinationPaymentStatusEnum failed = _$transferDestinationPaymentStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const TransferDestinationPaymentStatusEnum pending = _$transferDestinationPaymentStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const TransferDestinationPaymentStatusEnum succeeded = _$transferDestinationPaymentStatusEnum_succeeded;

  static Serializer<TransferDestinationPaymentStatusEnum> get serializer => _$transferDestinationPaymentStatusEnumSerializer;

  const TransferDestinationPaymentStatusEnum._(String name): super(name);

  static BuiltSet<TransferDestinationPaymentStatusEnum> get values => _$transferDestinationPaymentStatusEnumValues;
  static TransferDestinationPaymentStatusEnum valueOf(String name) => _$transferDestinationPaymentStatusEnumValueOf(name);
}
