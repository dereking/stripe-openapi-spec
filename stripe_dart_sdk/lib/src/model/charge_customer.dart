...
@BuiltValue()
abstract class ChargeCustomer implements Built<ChargeCustomer, ChargeCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  ChargeCustomer._();

  factory ChargeCustomer([void updates(ChargeCustomerBuilder b)]) = _$ChargeCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ChargeCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ChargeCustomer> get serializer => _$ChargeCustomerSerializer();
}

class _$ChargeCustomerSerializer implements PrimitiveSerializer<ChargeCustomer> {
  @override
  final Iterable<Type> types = const [ChargeCustomer, _$ChargeCustomer];

  @override
  final String wireName = r'ChargeCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ChargeCustomer object, {
  ...
  @override
  ChargeCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ChargeCustomerBuilder();
    Object? anyOfDataSrc;
...
class ChargeCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const ChargeCustomerObjectEnum customer = _$chargeCustomerObjectEnum_customer;

  static Serializer<ChargeCustomerObjectEnum> get serializer => _$chargeCustomerObjectEnumSerializer;

  const ChargeCustomerObjectEnum._(String name): super(name);

  static BuiltSet<ChargeCustomerObjectEnum> get values => _$chargeCustomerObjectEnumValues;
  static ChargeCustomerObjectEnum valueOf(String name) => _$chargeCustomerObjectEnumValueOf(name);
}

class ChargeCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const ChargeCustomerTaxExemptEnum exempt = _$chargeCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const ChargeCustomerTaxExemptEnum none = _$chargeCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const ChargeCustomerTaxExemptEnum reverse = _$chargeCustomerTaxExemptEnum_reverse;

  static Serializer<ChargeCustomerTaxExemptEnum> get serializer => _$chargeCustomerTaxExemptEnumSerializer;

  const ChargeCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<ChargeCustomerTaxExemptEnum> get values => _$chargeCustomerTaxExemptEnumValues;
  static ChargeCustomerTaxExemptEnum valueOf(String name) => _$chargeCustomerTaxExemptEnumValueOf(name);
}
