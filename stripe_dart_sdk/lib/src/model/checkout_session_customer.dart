...
part 'checkout_session_customer.g.dart';
...
@BuiltValue()
abstract class CheckoutSessionCustomer implements Built<CheckoutSessionCustomer, CheckoutSessionCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  CheckoutSessionCustomer._();

  factory CheckoutSessionCustomer([void updates(CheckoutSessionCustomerBuilder b)]) = _$CheckoutSessionCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutSessionCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutSessionCustomer> get serializer => _$CheckoutSessionCustomerSerializer();
}

class _$CheckoutSessionCustomerSerializer implements PrimitiveSerializer<CheckoutSessionCustomer> {
  @override
  final Iterable<Type> types = const [CheckoutSessionCustomer, _$CheckoutSessionCustomer];

  @override
  final String wireName = r'CheckoutSessionCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CheckoutSessionCustomer object, {
  ...
  @override
  CheckoutSessionCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CheckoutSessionCustomerBuilder();
    Object? anyOfDataSrc;
...
class CheckoutSessionCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const CheckoutSessionCustomerObjectEnum customer = _$checkoutSessionCustomerObjectEnum_customer;

  static Serializer<CheckoutSessionCustomerObjectEnum> get serializer => _$checkoutSessionCustomerObjectEnumSerializer;

  const CheckoutSessionCustomerObjectEnum._(String name): super(name);

  static BuiltSet<CheckoutSessionCustomerObjectEnum> get values => _$checkoutSessionCustomerObjectEnumValues;
  static CheckoutSessionCustomerObjectEnum valueOf(String name) => _$checkoutSessionCustomerObjectEnumValueOf(name);
}

class CheckoutSessionCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const CheckoutSessionCustomerTaxExemptEnum exempt = _$checkoutSessionCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const CheckoutSessionCustomerTaxExemptEnum none = _$checkoutSessionCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const CheckoutSessionCustomerTaxExemptEnum reverse = _$checkoutSessionCustomerTaxExemptEnum_reverse;

  static Serializer<CheckoutSessionCustomerTaxExemptEnum> get serializer => _$checkoutSessionCustomerTaxExemptEnumSerializer;

  const CheckoutSessionCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<CheckoutSessionCustomerTaxExemptEnum> get values => _$checkoutSessionCustomerTaxExemptEnumValues;
  static CheckoutSessionCustomerTaxExemptEnum valueOf(String name) => _$checkoutSessionCustomerTaxExemptEnumValueOf(name);
}
