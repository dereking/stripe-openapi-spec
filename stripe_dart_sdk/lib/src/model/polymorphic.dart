...
@BuiltValue()
abstract class Polymorphic implements Built<Polymorphic, PolymorphicBuilder> {
  /// Any Of [BankAccount], [Card]
  AnyOf get anyOf;

  Polymorphic._();

  factory Polymorphic([void updates(PolymorphicBuilder b)]) = _$Polymorphic;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PolymorphicBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Polymorphic> get serializer => _$PolymorphicSerializer();
}

class _$PolymorphicSerializer implements PrimitiveSerializer<Polymorphic> {
  @override
  final Iterable<Type> types = const [Polymorphic, _$Polymorphic];

  @override
  final String wireName = r'Polymorphic';
  ...
  Polymorphic deserialize(
    ...
    final result = PolymorphicBuilder();
    Object? anyOfDataSrc;
...
class PolymorphicObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'card')
  static const PolymorphicObjectEnum card = _$polymorphicObjectEnum_card;

  static Serializer<PolymorphicObjectEnum> get serializer => _$polymorphicObjectEnumSerializer;

  const PolymorphicObjectEnum._(String name): super(name);

  static BuiltSet<PolymorphicObjectEnum> get values => _$polymorphicObjectEnumValues;
  static PolymorphicObjectEnum valueOf(String name) => _$polymorphicObjectEnumValueOf(name);
}

class PolymorphicAllowRedisplayEnum extends EnumClass {

  /// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
  @BuiltValueEnumConst(wireName: r'always')
  static const PolymorphicAllowRedisplayEnum always = _$polymorphicAllowRedisplayEnum_always;
  /// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
  @BuiltValueEnumConst(wireName: r'limited')
  static const PolymorphicAllowRedisplayEnum limited = _$polymorphicAllowRedisplayEnum_limited;
  /// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
  @BuiltValueEnumConst(wireName: r'unspecified')
  static const PolymorphicAllowRedisplayEnum unspecified = _$polymorphicAllowRedisplayEnum_unspecified;

  static Serializer<PolymorphicAllowRedisplayEnum> get serializer => _$polymorphicAllowRedisplayEnumSerializer;

  const PolymorphicAllowRedisplayEnum._(String name): super(name);

  static BuiltSet<PolymorphicAllowRedisplayEnum> get values => _$polymorphicAllowRedisplayEnumValues;
  static PolymorphicAllowRedisplayEnum valueOf(String name) => _$polymorphicAllowRedisplayEnumValueOf(name);
}

class PolymorphicRegulatedStatusEnum extends EnumClass {

  /// Status of a card based on the card issuer.
  @BuiltValueEnumConst(wireName: r'regulated')
  static const PolymorphicRegulatedStatusEnum regulated = _$polymorphicRegulatedStatusEnum_regulated;
  /// Status of a card based on the card issuer.
  @BuiltValueEnumConst(wireName: r'unregulated')
  static const PolymorphicRegulatedStatusEnum unregulated = _$polymorphicRegulatedStatusEnum_unregulated;

  static Serializer<PolymorphicRegulatedStatusEnum> get serializer => _$polymorphicRegulatedStatusEnumSerializer;

  const PolymorphicRegulatedStatusEnum._(String name): super(name);

  static BuiltSet<PolymorphicRegulatedStatusEnum> get values => _$polymorphicRegulatedStatusEnumValues;
  static PolymorphicRegulatedStatusEnum valueOf(String name) => _$polymorphicRegulatedStatusEnumValueOf(name);
}
