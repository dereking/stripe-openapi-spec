...
/// * [testClock] 
@BuiltValue()
abstract class TaxIdCustomer implements Built<TaxIdCustomer, TaxIdCustomerBuilder> {
  /// Any Of [Customer], [String]
  AnyOf get anyOf;

  TaxIdCustomer._();

  factory TaxIdCustomer([void updates(TaxIdCustomerBuilder b)]) = _$TaxIdCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TaxIdCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TaxIdCustomer> get serializer => _$TaxIdCustomerSerializer();
}

class _$TaxIdCustomerSerializer implements PrimitiveSerializer<TaxIdCustomer> {
  @override
  final Iterable<Type> types = const [TaxIdCustomer, _$TaxIdCustomer];

  @override
  final String wireName = r'TaxIdCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TaxIdCustomer object, {
  ...
  @override
  TaxIdCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TaxIdCustomerBuilder();
    Object? anyOfDataSrc;
...
class TaxIdCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const TaxIdCustomerObjectEnum customer = _$taxIdCustomerObjectEnum_customer;

  static Serializer<TaxIdCustomerObjectEnum> get serializer => _$taxIdCustomerObjectEnumSerializer;

  const TaxIdCustomerObjectEnum._(String name): super(name);

  static BuiltSet<TaxIdCustomerObjectEnum> get values => _$taxIdCustomerObjectEnumValues;
  static TaxIdCustomerObjectEnum valueOf(String name) => _$taxIdCustomerObjectEnumValueOf(name);
}

class TaxIdCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const TaxIdCustomerTaxExemptEnum exempt = _$taxIdCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const TaxIdCustomerTaxExemptEnum none = _$taxIdCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const TaxIdCustomerTaxExemptEnum reverse = _$taxIdCustomerTaxExemptEnum_reverse;

  static Serializer<TaxIdCustomerTaxExemptEnum> get serializer => _$taxIdCustomerTaxExemptEnumSerializer;

  const TaxIdCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<TaxIdCustomerTaxExemptEnum> get values => _$taxIdCustomerTaxExemptEnumValues;
  static TaxIdCustomerTaxExemptEnum valueOf(String name) => _$taxIdCustomerTaxExemptEnumValueOf(name);
}
