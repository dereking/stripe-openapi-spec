...
part 'deleted_discount_customer.g.dart';
...
@BuiltValue()
abstract class DeletedDiscountCustomer implements Built<DeletedDiscountCustomer, DeletedDiscountCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  DeletedDiscountCustomer._();

  factory DeletedDiscountCustomer([void updates(DeletedDiscountCustomerBuilder b)]) = _$DeletedDiscountCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeletedDiscountCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeletedDiscountCustomer> get serializer => _$DeletedDiscountCustomerSerializer();
}

class _$DeletedDiscountCustomerSerializer implements PrimitiveSerializer<DeletedDiscountCustomer> {
  @override
  final Iterable<Type> types = const [DeletedDiscountCustomer, _$DeletedDiscountCustomer];

  @override
  final String wireName = r'DeletedDiscountCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DeletedDiscountCustomer object, {
  ...
  @override
  DeletedDiscountCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DeletedDiscountCustomerBuilder();
    Object? anyOfDataSrc;
...
class DeletedDiscountCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const DeletedDiscountCustomerObjectEnum customer = _$deletedDiscountCustomerObjectEnum_customer;

  static Serializer<DeletedDiscountCustomerObjectEnum> get serializer => _$deletedDiscountCustomerObjectEnumSerializer;

  const DeletedDiscountCustomerObjectEnum._(String name): super(name);

  static BuiltSet<DeletedDiscountCustomerObjectEnum> get values => _$deletedDiscountCustomerObjectEnumValues;
  static DeletedDiscountCustomerObjectEnum valueOf(String name) => _$deletedDiscountCustomerObjectEnumValueOf(name);
}

class DeletedDiscountCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const DeletedDiscountCustomerTaxExemptEnum exempt = _$deletedDiscountCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const DeletedDiscountCustomerTaxExemptEnum none = _$deletedDiscountCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const DeletedDiscountCustomerTaxExemptEnum reverse = _$deletedDiscountCustomerTaxExemptEnum_reverse;

  static Serializer<DeletedDiscountCustomerTaxExemptEnum> get serializer => _$deletedDiscountCustomerTaxExemptEnumSerializer;

  const DeletedDiscountCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<DeletedDiscountCustomerTaxExemptEnum> get values => _$deletedDiscountCustomerTaxExemptEnumValues;
  static DeletedDiscountCustomerTaxExemptEnum valueOf(String name) => _$deletedDiscountCustomerTaxExemptEnumValueOf(name);
}
