...
part 'invoice_payment_invoice.g.dart';
...
@BuiltValue()
abstract class InvoicePaymentInvoice implements Built<InvoicePaymentInvoice, InvoicePaymentInvoiceBuilder> {
  /// Any Of [DeletedInvoice], [Invoice], [String]
  AnyOf get anyOf;

  InvoicePaymentInvoice._();

  factory InvoicePaymentInvoice([void updates(InvoicePaymentInvoiceBuilder b)]) = _$InvoicePaymentInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoicePaymentInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoicePaymentInvoice> get serializer => _$InvoicePaymentInvoiceSerializer();
}

class _$InvoicePaymentInvoiceSerializer implements PrimitiveSerializer<InvoicePaymentInvoice> {
  @override
  final Iterable<Type> types = const [InvoicePaymentInvoice, _$InvoicePaymentInvoice];

  @override
  final String wireName = r'InvoicePaymentInvoice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InvoicePaymentInvoice object, {
  ...
  @override
  InvoicePaymentInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoicePaymentInvoiceBuilder();
    Object? anyOfDataSrc;
    final targetType = const FullType(AnyOf, [FullType(String), FullType(Invoice), FullType(DeletedInvoice), ]);
...
class InvoicePaymentInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const InvoicePaymentInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$invoicePaymentInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const InvoicePaymentInvoiceBillingReasonEnum manual = _$invoicePaymentInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const InvoicePaymentInvoiceBillingReasonEnum quoteAccept = _$invoicePaymentInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const InvoicePaymentInvoiceBillingReasonEnum subscription = _$invoicePaymentInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const InvoicePaymentInvoiceBillingReasonEnum subscriptionCreate = _$invoicePaymentInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const InvoicePaymentInvoiceBillingReasonEnum subscriptionCycle = _$invoicePaymentInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const InvoicePaymentInvoiceBillingReasonEnum subscriptionThreshold = _$invoicePaymentInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const InvoicePaymentInvoiceBillingReasonEnum subscriptionUpdate = _$invoicePaymentInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const InvoicePaymentInvoiceBillingReasonEnum upcoming = _$invoicePaymentInvoiceBillingReasonEnum_upcoming;

  static Serializer<InvoicePaymentInvoiceBillingReasonEnum> get serializer => _$invoicePaymentInvoiceBillingReasonEnumSerializer;

  const InvoicePaymentInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<InvoicePaymentInvoiceBillingReasonEnum> get values => _$invoicePaymentInvoiceBillingReasonEnumValues;
  static InvoicePaymentInvoiceBillingReasonEnum valueOf(String name) => _$invoicePaymentInvoiceBillingReasonEnumValueOf(name);
}

class InvoicePaymentInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const InvoicePaymentInvoiceCollectionMethodEnum chargeAutomatically = _$invoicePaymentInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const InvoicePaymentInvoiceCollectionMethodEnum sendInvoice = _$invoicePaymentInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<InvoicePaymentInvoiceCollectionMethodEnum> get serializer => _$invoicePaymentInvoiceCollectionMethodEnumSerializer;

  const InvoicePaymentInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<InvoicePaymentInvoiceCollectionMethodEnum> get values => _$invoicePaymentInvoiceCollectionMethodEnumValues;
  static InvoicePaymentInvoiceCollectionMethodEnum valueOf(String name) => _$invoicePaymentInvoiceCollectionMethodEnumValueOf(name);
}

class InvoicePaymentInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const InvoicePaymentInvoiceCustomerTaxExemptEnum exempt = _$invoicePaymentInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const InvoicePaymentInvoiceCustomerTaxExemptEnum none = _$invoicePaymentInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const InvoicePaymentInvoiceCustomerTaxExemptEnum reverse = _$invoicePaymentInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<InvoicePaymentInvoiceCustomerTaxExemptEnum> get serializer => _$invoicePaymentInvoiceCustomerTaxExemptEnumSerializer;

  const InvoicePaymentInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<InvoicePaymentInvoiceCustomerTaxExemptEnum> get values => _$invoicePaymentInvoiceCustomerTaxExemptEnumValues;
  static InvoicePaymentInvoiceCustomerTaxExemptEnum valueOf(String name) => _$invoicePaymentInvoiceCustomerTaxExemptEnumValueOf(name);
}

class InvoicePaymentInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const InvoicePaymentInvoiceObjectEnum invoice = _$invoicePaymentInvoiceObjectEnum_invoice;

  static Serializer<InvoicePaymentInvoiceObjectEnum> get serializer => _$invoicePaymentInvoiceObjectEnumSerializer;

  const InvoicePaymentInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<InvoicePaymentInvoiceObjectEnum> get values => _$invoicePaymentInvoiceObjectEnumValues;
  static InvoicePaymentInvoiceObjectEnum valueOf(String name) => _$invoicePaymentInvoiceObjectEnumValueOf(name);
}

class InvoicePaymentInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const InvoicePaymentInvoiceStatusEnum draft = _$invoicePaymentInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const InvoicePaymentInvoiceStatusEnum open = _$invoicePaymentInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const InvoicePaymentInvoiceStatusEnum paid = _$invoicePaymentInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const InvoicePaymentInvoiceStatusEnum uncollectible = _$invoicePaymentInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const InvoicePaymentInvoiceStatusEnum void_ = _$invoicePaymentInvoiceStatusEnum_void_;

  static Serializer<InvoicePaymentInvoiceStatusEnum> get serializer => _$invoicePaymentInvoiceStatusEnumSerializer;

  const InvoicePaymentInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<InvoicePaymentInvoiceStatusEnum> get values => _$invoicePaymentInvoiceStatusEnumValues;
  static InvoicePaymentInvoiceStatusEnum valueOf(String name) => _$invoicePaymentInvoiceStatusEnumValueOf(name);
}
