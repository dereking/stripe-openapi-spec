...
part 'invoices_payments_invoice_payment_associated_payment_charge.g.dart';
...
@BuiltValue()
abstract class InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge implements Built<InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge, InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge._();

  factory InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge([void updates(InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeBuilder b)]) = _$InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge> get serializer => _$InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeSerializer();
}

class _$InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeSerializer implements PrimitiveSerializer<InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge> {
  @override
  final Iterable<Type> types = const [InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge, _$InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge];

  @override
  final String wireName = r'InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge object, {
  ...
  @override
  InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeBuilder();
    Object? anyOfDataSrc;
...
class InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum charge = _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum_charge;

  static Serializer<InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum> get serializer => _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumSerializer;

  const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum._(String name): super(name);

  static BuiltSet<InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum> get values => _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumValues;
  static InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnum valueOf(String name) => _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeObjectEnumValueOf(name);
}

class InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum failed = _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum pending = _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum succeeded = _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum_succeeded;

  static Serializer<InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum> get serializer => _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumSerializer;

  const InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum._(String name): super(name);

  static BuiltSet<InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum> get values => _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumValues;
  static InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnum valueOf(String name) => _$invoicesPaymentsInvoicePaymentAssociatedPaymentChargeStatusEnumValueOf(name);
}
