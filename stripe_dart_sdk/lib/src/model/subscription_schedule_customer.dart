...
part 'subscription_schedule_customer.g.dart';
...
@BuiltValue()
abstract class SubscriptionScheduleCustomer implements Built<SubscriptionScheduleCustomer, SubscriptionScheduleCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  SubscriptionScheduleCustomer._();

  factory SubscriptionScheduleCustomer([void updates(SubscriptionScheduleCustomerBuilder b)]) = _$SubscriptionScheduleCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SubscriptionScheduleCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubscriptionScheduleCustomer> get serializer => _$SubscriptionScheduleCustomerSerializer();
}

class _$SubscriptionScheduleCustomerSerializer implements PrimitiveSerializer<SubscriptionScheduleCustomer> {
  @override
  final Iterable<Type> types = const [SubscriptionScheduleCustomer, _$SubscriptionScheduleCustomer];

  @override
  final String wireName = r'SubscriptionScheduleCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SubscriptionScheduleCustomer object, {
  ...
  @override
  SubscriptionScheduleCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SubscriptionScheduleCustomerBuilder();
    Object? anyOfDataSrc;
...
class SubscriptionScheduleCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const SubscriptionScheduleCustomerObjectEnum customer = _$subscriptionScheduleCustomerObjectEnum_customer;

  static Serializer<SubscriptionScheduleCustomerObjectEnum> get serializer => _$subscriptionScheduleCustomerObjectEnumSerializer;

  const SubscriptionScheduleCustomerObjectEnum._(String name): super(name);

  static BuiltSet<SubscriptionScheduleCustomerObjectEnum> get values => _$subscriptionScheduleCustomerObjectEnumValues;
  static SubscriptionScheduleCustomerObjectEnum valueOf(String name) => _$subscriptionScheduleCustomerObjectEnumValueOf(name);
}

class SubscriptionScheduleCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const SubscriptionScheduleCustomerTaxExemptEnum exempt = _$subscriptionScheduleCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const SubscriptionScheduleCustomerTaxExemptEnum none = _$subscriptionScheduleCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const SubscriptionScheduleCustomerTaxExemptEnum reverse = _$subscriptionScheduleCustomerTaxExemptEnum_reverse;

  static Serializer<SubscriptionScheduleCustomerTaxExemptEnum> get serializer => _$subscriptionScheduleCustomerTaxExemptEnumSerializer;

  const SubscriptionScheduleCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<SubscriptionScheduleCustomerTaxExemptEnum> get values => _$subscriptionScheduleCustomerTaxExemptEnumValues;
  static SubscriptionScheduleCustomerTaxExemptEnum valueOf(String name) => _$subscriptionScheduleCustomerTaxExemptEnumValueOf(name);
}
