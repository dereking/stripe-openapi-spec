...
part 'line_item_create_params.g.dart';
...
/// * [taxRates] 
@BuiltValue()
abstract class LineItemCreateParams implements Built<LineItemCreateParams, LineItemCreateParamsBuilder> {
  ...
  LineItemCreateParams._();

  factory LineItemCreateParams([void updates(LineItemCreateParamsBuilder b)]) = _$LineItemCreateParams;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LineItemCreateParamsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LineItemCreateParams> get serializer => _$LineItemCreateParamsSerializer();
}

class _$LineItemCreateParamsSerializer implements PrimitiveSerializer<LineItemCreateParams> {
  @override
  final Iterable<Type> types = const [LineItemCreateParams, _$LineItemCreateParams];

  @override
  final String wireName = r'LineItemCreateParams';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LineItemCreateParams object, {
  ...
  void _deserializeProperties(
    ...
    required LineItemCreateParamsBuilder result,
  ...
  @override
  LineItemCreateParams deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LineItemCreateParamsBuilder();
