...
@BuiltValue()
abstract class InvoiceCustomer implements Built<InvoiceCustomer, InvoiceCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  InvoiceCustomer._();

  factory InvoiceCustomer([void updates(InvoiceCustomerBuilder b)]) = _$InvoiceCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoiceCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoiceCustomer> get serializer => _$InvoiceCustomerSerializer();
}

class _$InvoiceCustomerSerializer implements PrimitiveSerializer<InvoiceCustomer> {
  @override
  final Iterable<Type> types = const [InvoiceCustomer, _$InvoiceCustomer];

  @override
  final String wireName = r'InvoiceCustomer';
  ...
  @override
  InvoiceCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoiceCustomerBuilder();
    Object? anyOfDataSrc;
...
class InvoiceCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const InvoiceCustomerObjectEnum customer = _$invoiceCustomerObjectEnum_customer;

  static Serializer<InvoiceCustomerObjectEnum> get serializer => _$invoiceCustomerObjectEnumSerializer;

  const InvoiceCustomerObjectEnum._(String name): super(name);

  static BuiltSet<InvoiceCustomerObjectEnum> get values => _$invoiceCustomerObjectEnumValues;
  static InvoiceCustomerObjectEnum valueOf(String name) => _$invoiceCustomerObjectEnumValueOf(name);
}
