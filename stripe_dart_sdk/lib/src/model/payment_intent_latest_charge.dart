...
part 'payment_intent_latest_charge.g.dart';
...
@BuiltValue()
abstract class PaymentIntentLatestCharge implements Built<PaymentIntentLatestCharge, PaymentIntentLatestChargeBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  PaymentIntentLatestCharge._();

  factory PaymentIntentLatestCharge([void updates(PaymentIntentLatestChargeBuilder b)]) = _$PaymentIntentLatestCharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentIntentLatestChargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentIntentLatestCharge> get serializer => _$PaymentIntentLatestChargeSerializer();
}

class _$PaymentIntentLatestChargeSerializer implements PrimitiveSerializer<PaymentIntentLatestCharge> {
  @override
  final Iterable<Type> types = const [PaymentIntentLatestCharge, _$PaymentIntentLatestCharge];

  @override
  final String wireName = r'PaymentIntentLatestCharge';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaymentIntentLatestCharge object, {
  ...
  @override
  PaymentIntentLatestCharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentIntentLatestChargeBuilder();
    Object? anyOfDataSrc;
...
class PaymentIntentLatestChargeObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const PaymentIntentLatestChargeObjectEnum charge = _$paymentIntentLatestChargeObjectEnum_charge;

  static Serializer<PaymentIntentLatestChargeObjectEnum> get serializer => _$paymentIntentLatestChargeObjectEnumSerializer;

  const PaymentIntentLatestChargeObjectEnum._(String name): super(name);

  static BuiltSet<PaymentIntentLatestChargeObjectEnum> get values => _$paymentIntentLatestChargeObjectEnumValues;
  static PaymentIntentLatestChargeObjectEnum valueOf(String name) => _$paymentIntentLatestChargeObjectEnumValueOf(name);
}

class PaymentIntentLatestChargeStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const PaymentIntentLatestChargeStatusEnum failed = _$paymentIntentLatestChargeStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const PaymentIntentLatestChargeStatusEnum pending = _$paymentIntentLatestChargeStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const PaymentIntentLatestChargeStatusEnum succeeded = _$paymentIntentLatestChargeStatusEnum_succeeded;

  static Serializer<PaymentIntentLatestChargeStatusEnum> get serializer => _$paymentIntentLatestChargeStatusEnumSerializer;

  const PaymentIntentLatestChargeStatusEnum._(String name): super(name);

  static BuiltSet<PaymentIntentLatestChargeStatusEnum> get values => _$paymentIntentLatestChargeStatusEnumValues;
  static PaymentIntentLatestChargeStatusEnum valueOf(String name) => _$paymentIntentLatestChargeStatusEnumValueOf(name);
}
