...
part 'subscription_item_create_params.g.dart';
...
/// * [taxRates] 
@BuiltValue()
abstract class SubscriptionItemCreateParams implements Built<SubscriptionItemCreateParams, SubscriptionItemCreateParamsBuilder> {
  ...
  SubscriptionItemCreateParams._();

  factory SubscriptionItemCreateParams([void updates(SubscriptionItemCreateParamsBuilder b)]) = _$SubscriptionItemCreateParams;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SubscriptionItemCreateParamsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SubscriptionItemCreateParams> get serializer => _$SubscriptionItemCreateParamsSerializer();
}

class _$SubscriptionItemCreateParamsSerializer implements PrimitiveSerializer<SubscriptionItemCreateParams> {
  @override
  final Iterable<Type> types = const [SubscriptionItemCreateParams, _$SubscriptionItemCreateParams];

  @override
  final String wireName = r'SubscriptionItemCreateParams';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SubscriptionItemCreateParams object, {
  ...
  void _deserializeProperties(
    ...
    required SubscriptionItemCreateParamsBuilder result,
  ...
  @override
  SubscriptionItemCreateParams deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SubscriptionItemCreateParamsBuilder();
