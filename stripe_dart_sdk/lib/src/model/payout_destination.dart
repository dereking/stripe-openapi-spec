...
part 'payout_destination.g.dart';
...
@BuiltValue()
abstract class PayoutDestination implements Built<PayoutDestination, PayoutDestinationBuilder> {
  /// Any Of [BankAccount], [Card], [DeletedBankAccount], [DeletedCard], [String]
  AnyOf get anyOf;

  PayoutDestination._();

  factory PayoutDestination([void updates(PayoutDestinationBuilder b)]) = _$PayoutDestination;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PayoutDestinationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PayoutDestination> get serializer => _$PayoutDestinationSerializer();
}

class _$PayoutDestinationSerializer implements PrimitiveSerializer<PayoutDestination> {
  @override
  final Iterable<Type> types = const [PayoutDestination, _$PayoutDestination];

  @override
  final String wireName = r'PayoutDestination';
  ...
  @override
  PayoutDestination deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PayoutDestinationBuilder();
    Object? anyOfDataSrc;
    final targetType = const FullType(AnyOf, [FullType(String), FullType(BankAccount), FullType(Card), FullType(DeletedBankAccount), FullType(DeletedCard), ]);
...
class PayoutDestinationObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'card')
  static const PayoutDestinationObjectEnum card = _$payoutDestinationObjectEnum_card;

  static Serializer<PayoutDestinationObjectEnum> get serializer => _$payoutDestinationObjectEnumSerializer;

  const PayoutDestinationObjectEnum._(String name): super(name);

  static BuiltSet<PayoutDestinationObjectEnum> get values => _$payoutDestinationObjectEnumValues;
  static PayoutDestinationObjectEnum valueOf(String name) => _$payoutDestinationObjectEnumValueOf(name);
}

class PayoutDestinationAllowRedisplayEnum extends EnumClass {

  /// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
  @BuiltValueEnumConst(wireName: r'always')
  static const PayoutDestinationAllowRedisplayEnum always = _$payoutDestinationAllowRedisplayEnum_always;
  /// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
  @BuiltValueEnumConst(wireName: r'limited')
  static const PayoutDestinationAllowRedisplayEnum limited = _$payoutDestinationAllowRedisplayEnum_limited;
  /// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
  @BuiltValueEnumConst(wireName: r'unspecified')
  static const PayoutDestinationAllowRedisplayEnum unspecified = _$payoutDestinationAllowRedisplayEnum_unspecified;

  static Serializer<PayoutDestinationAllowRedisplayEnum> get serializer => _$payoutDestinationAllowRedisplayEnumSerializer;

  const PayoutDestinationAllowRedisplayEnum._(String name): super(name);

  static BuiltSet<PayoutDestinationAllowRedisplayEnum> get values => _$payoutDestinationAllowRedisplayEnumValues;
  static PayoutDestinationAllowRedisplayEnum valueOf(String name) => _$payoutDestinationAllowRedisplayEnumValueOf(name);
}

class PayoutDestinationRegulatedStatusEnum extends EnumClass {

  /// Status of a card based on the card issuer.
  @BuiltValueEnumConst(wireName: r'regulated')
  static const PayoutDestinationRegulatedStatusEnum regulated = _$payoutDestinationRegulatedStatusEnum_regulated;
  /// Status of a card based on the card issuer.
  @BuiltValueEnumConst(wireName: r'unregulated')
  static const PayoutDestinationRegulatedStatusEnum unregulated = _$payoutDestinationRegulatedStatusEnum_unregulated;

  static Serializer<PayoutDestinationRegulatedStatusEnum> get serializer => _$payoutDestinationRegulatedStatusEnumSerializer;

  const PayoutDestinationRegulatedStatusEnum._(String name): super(name);

  static BuiltSet<PayoutDestinationRegulatedStatusEnum> get values => _$payoutDestinationRegulatedStatusEnumValues;
  static PayoutDestinationRegulatedStatusEnum valueOf(String name) => _$payoutDestinationRegulatedStatusEnumValueOf(name);
}
