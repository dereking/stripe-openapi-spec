...
@BuiltValue()
abstract class CardCustomer implements Built<CardCustomer, CardCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  CardCustomer._();

  factory CardCustomer([void updates(CardCustomerBuilder b)]) = _$CardCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CardCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CardCustomer> get serializer => _$CardCustomerSerializer();
}

class _$CardCustomerSerializer implements PrimitiveSerializer<CardCustomer> {
  @override
  final Iterable<Type> types = const [CardCustomer, _$CardCustomer];

  @override
  final String wireName = r'CardCustomer';
  ...
  @override
  CardCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CardCustomerBuilder();
    Object? anyOfDataSrc;
...
class CardCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const CardCustomerObjectEnum customer = _$cardCustomerObjectEnum_customer;

  static Serializer<CardCustomerObjectEnum> get serializer => _$cardCustomerObjectEnumSerializer;

  const CardCustomerObjectEnum._(String name): super(name);

  static BuiltSet<CardCustomerObjectEnum> get values => _$cardCustomerObjectEnumValues;
  static CardCustomerObjectEnum valueOf(String name) => _$cardCustomerObjectEnumValueOf(name);
}

class CardCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const CardCustomerTaxExemptEnum exempt = _$cardCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const CardCustomerTaxExemptEnum none = _$cardCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const CardCustomerTaxExemptEnum reverse = _$cardCustomerTaxExemptEnum_reverse;

  static Serializer<CardCustomerTaxExemptEnum> get serializer => _$cardCustomerTaxExemptEnumSerializer;

  const CardCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<CardCustomerTaxExemptEnum> get values => _$cardCustomerTaxExemptEnumValues;
  static CardCustomerTaxExemptEnum valueOf(String name) => _$cardCustomerTaxExemptEnumValueOf(name);
}
