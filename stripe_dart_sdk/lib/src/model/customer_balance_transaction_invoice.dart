...
part 'customer_balance_transaction_invoice.g.dart';
...
@BuiltValue()
abstract class CustomerBalanceTransactionInvoice implements Built<CustomerBalanceTransactionInvoice, CustomerBalanceTransactionInvoiceBuilder> {
  /// Any Of [Invoice], [String]
  AnyOf get anyOf;

  CustomerBalanceTransactionInvoice._();

  factory CustomerBalanceTransactionInvoice([void updates(CustomerBalanceTransactionInvoiceBuilder b)]) = _$CustomerBalanceTransactionInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CustomerBalanceTransactionInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CustomerBalanceTransactionInvoice> get serializer => _$CustomerBalanceTransactionInvoiceSerializer();
}

class _$CustomerBalanceTransactionInvoiceSerializer implements PrimitiveSerializer<CustomerBalanceTransactionInvoice> {
  @override
  final Iterable<Type> types = const [CustomerBalanceTransactionInvoice, _$CustomerBalanceTransactionInvoice];

  @override
  final String wireName = r'CustomerBalanceTransactionInvoice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CustomerBalanceTransactionInvoice object, {
  ...
  @override
  CustomerBalanceTransactionInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CustomerBalanceTransactionInvoiceBuilder();
    Object? anyOfDataSrc;
...
class CustomerBalanceTransactionInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$customerBalanceTransactionInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum manual = _$customerBalanceTransactionInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum quoteAccept = _$customerBalanceTransactionInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum subscription = _$customerBalanceTransactionInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum subscriptionCreate = _$customerBalanceTransactionInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum subscriptionCycle = _$customerBalanceTransactionInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum subscriptionThreshold = _$customerBalanceTransactionInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum subscriptionUpdate = _$customerBalanceTransactionInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const CustomerBalanceTransactionInvoiceBillingReasonEnum upcoming = _$customerBalanceTransactionInvoiceBillingReasonEnum_upcoming;

  static Serializer<CustomerBalanceTransactionInvoiceBillingReasonEnum> get serializer => _$customerBalanceTransactionInvoiceBillingReasonEnumSerializer;

  const CustomerBalanceTransactionInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<CustomerBalanceTransactionInvoiceBillingReasonEnum> get values => _$customerBalanceTransactionInvoiceBillingReasonEnumValues;
  static CustomerBalanceTransactionInvoiceBillingReasonEnum valueOf(String name) => _$customerBalanceTransactionInvoiceBillingReasonEnumValueOf(name);
}

class CustomerBalanceTransactionInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const CustomerBalanceTransactionInvoiceCollectionMethodEnum chargeAutomatically = _$customerBalanceTransactionInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const CustomerBalanceTransactionInvoiceCollectionMethodEnum sendInvoice = _$customerBalanceTransactionInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<CustomerBalanceTransactionInvoiceCollectionMethodEnum> get serializer => _$customerBalanceTransactionInvoiceCollectionMethodEnumSerializer;

  const CustomerBalanceTransactionInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<CustomerBalanceTransactionInvoiceCollectionMethodEnum> get values => _$customerBalanceTransactionInvoiceCollectionMethodEnumValues;
  static CustomerBalanceTransactionInvoiceCollectionMethodEnum valueOf(String name) => _$customerBalanceTransactionInvoiceCollectionMethodEnumValueOf(name);
}

class CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum exempt = _$customerBalanceTransactionInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum none = _$customerBalanceTransactionInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum reverse = _$customerBalanceTransactionInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum> get serializer => _$customerBalanceTransactionInvoiceCustomerTaxExemptEnumSerializer;

  const CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum> get values => _$customerBalanceTransactionInvoiceCustomerTaxExemptEnumValues;
  static CustomerBalanceTransactionInvoiceCustomerTaxExemptEnum valueOf(String name) => _$customerBalanceTransactionInvoiceCustomerTaxExemptEnumValueOf(name);
}

class CustomerBalanceTransactionInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const CustomerBalanceTransactionInvoiceObjectEnum invoice = _$customerBalanceTransactionInvoiceObjectEnum_invoice;

  static Serializer<CustomerBalanceTransactionInvoiceObjectEnum> get serializer => _$customerBalanceTransactionInvoiceObjectEnumSerializer;

  const CustomerBalanceTransactionInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<CustomerBalanceTransactionInvoiceObjectEnum> get values => _$customerBalanceTransactionInvoiceObjectEnumValues;
  static CustomerBalanceTransactionInvoiceObjectEnum valueOf(String name) => _$customerBalanceTransactionInvoiceObjectEnumValueOf(name);
}

class CustomerBalanceTransactionInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const CustomerBalanceTransactionInvoiceStatusEnum draft = _$customerBalanceTransactionInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const CustomerBalanceTransactionInvoiceStatusEnum open = _$customerBalanceTransactionInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const CustomerBalanceTransactionInvoiceStatusEnum paid = _$customerBalanceTransactionInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const CustomerBalanceTransactionInvoiceStatusEnum uncollectible = _$customerBalanceTransactionInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const CustomerBalanceTransactionInvoiceStatusEnum void_ = _$customerBalanceTransactionInvoiceStatusEnum_void_;

  static Serializer<CustomerBalanceTransactionInvoiceStatusEnum> get serializer => _$customerBalanceTransactionInvoiceStatusEnumSerializer;

  const CustomerBalanceTransactionInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<CustomerBalanceTransactionInvoiceStatusEnum> get values => _$customerBalanceTransactionInvoiceStatusEnumValues;
  static CustomerBalanceTransactionInvoiceStatusEnum valueOf(String name) => _$customerBalanceTransactionInvoiceStatusEnumValueOf(name);
}
