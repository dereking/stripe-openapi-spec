...
part 'customer_session_customer.g.dart';
...
/// * [testClock] 
@BuiltValue()
abstract class CustomerSessionCustomer implements Built<CustomerSessionCustomer, CustomerSessionCustomerBuilder> {
  /// Any Of [Customer], [String]
  AnyOf get anyOf;

  CustomerSessionCustomer._();

  factory CustomerSessionCustomer([void updates(CustomerSessionCustomerBuilder b)]) = _$CustomerSessionCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CustomerSessionCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CustomerSessionCustomer> get serializer => _$CustomerSessionCustomerSerializer();
}

class _$CustomerSessionCustomerSerializer implements PrimitiveSerializer<CustomerSessionCustomer> {
  @override
  final Iterable<Type> types = const [CustomerSessionCustomer, _$CustomerSessionCustomer];

  @override
  final String wireName = r'CustomerSessionCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CustomerSessionCustomer object, {
  ...
  @override
  CustomerSessionCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CustomerSessionCustomerBuilder();
    Object? anyOfDataSrc;
...
class CustomerSessionCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const CustomerSessionCustomerObjectEnum customer = _$customerSessionCustomerObjectEnum_customer;

  static Serializer<CustomerSessionCustomerObjectEnum> get serializer => _$customerSessionCustomerObjectEnumSerializer;

  const CustomerSessionCustomerObjectEnum._(String name): super(name);

  static BuiltSet<CustomerSessionCustomerObjectEnum> get values => _$customerSessionCustomerObjectEnumValues;
  static CustomerSessionCustomerObjectEnum valueOf(String name) => _$customerSessionCustomerObjectEnumValueOf(name);
}

class CustomerSessionCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const CustomerSessionCustomerTaxExemptEnum exempt = _$customerSessionCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const CustomerSessionCustomerTaxExemptEnum none = _$customerSessionCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const CustomerSessionCustomerTaxExemptEnum reverse = _$customerSessionCustomerTaxExemptEnum_reverse;

  static Serializer<CustomerSessionCustomerTaxExemptEnum> get serializer => _$customerSessionCustomerTaxExemptEnumSerializer;

  const CustomerSessionCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<CustomerSessionCustomerTaxExemptEnum> get values => _$customerSessionCustomerTaxExemptEnumValues;
  static CustomerSessionCustomerTaxExemptEnum valueOf(String name) => _$customerSessionCustomerTaxExemptEnumValueOf(name);
}
