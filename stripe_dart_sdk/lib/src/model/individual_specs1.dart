...
/// * [verification] 
@BuiltValue()
abstract class IndividualSpecs1 implements Built<IndividualSpecs1, IndividualSpecs1Builder> {
  ...
  IndividualSpecs1PoliticalExposureEnum? get politicalExposure;
  ...
  factory IndividualSpecs1([void updates(IndividualSpecs1Builder b)]) = _$IndividualSpecs1;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IndividualSpecs1Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IndividualSpecs1> get serializer => _$IndividualSpecs1Serializer();
}

class _$IndividualSpecs1Serializer implements PrimitiveSerializer<IndividualSpecs1> {
  @override
  final Iterable<Type> types = const [IndividualSpecs1, _$IndividualSpecs1];

  @override
  final String wireName = r'IndividualSpecs1';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IndividualSpecs1 object, {
    ...
    if (object.politicalExposure != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(IndividualSpecs1PoliticalExposureEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required IndividualSpecs1Builder result,
      ...
      switch (key) {
        ...
        case r'political_exposure':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(IndividualSpecs1PoliticalExposureEnum),
          ) as IndividualSpecs1PoliticalExposureEnum;
  ...
  @override
  IndividualSpecs1 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IndividualSpecs1Builder();
...
class IndividualSpecs1PoliticalExposureEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'existing')
  static const IndividualSpecs1PoliticalExposureEnum existing = _$individualSpecs1PoliticalExposureEnum_existing;
  @BuiltValueEnumConst(wireName: r'none')
  static const IndividualSpecs1PoliticalExposureEnum none = _$individualSpecs1PoliticalExposureEnum_none;

  static Serializer<IndividualSpecs1PoliticalExposureEnum> get serializer => _$individualSpecs1PoliticalExposureEnumSerializer;

  const IndividualSpecs1PoliticalExposureEnum._(String name): super(name);

  static BuiltSet<IndividualSpecs1PoliticalExposureEnum> get values => _$individualSpecs1PoliticalExposureEnumValues;
  static IndividualSpecs1PoliticalExposureEnum valueOf(String name) => _$individualSpecs1PoliticalExposureEnumValueOf(name);
}
