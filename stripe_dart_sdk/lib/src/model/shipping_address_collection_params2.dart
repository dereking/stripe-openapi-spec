...
part 'shipping_address_collection_params2.g.dart';
...
/// * [allowedCountries] 
@BuiltValue()
abstract class ShippingAddressCollectionParams2 implements Built<ShippingAddressCollectionParams2, ShippingAddressCollectionParams2Builder> {
  ...
  ShippingAddressCollectionParams2._();

  factory ShippingAddressCollectionParams2([void updates(ShippingAddressCollectionParams2Builder b)]) = _$ShippingAddressCollectionParams2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ShippingAddressCollectionParams2Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ShippingAddressCollectionParams2> get serializer => _$ShippingAddressCollectionParams2Serializer();
}

class _$ShippingAddressCollectionParams2Serializer implements PrimitiveSerializer<ShippingAddressCollectionParams2> {
  @override
  final Iterable<Type> types = const [ShippingAddressCollectionParams2, _$ShippingAddressCollectionParams2];

  @override
  final String wireName = r'ShippingAddressCollectionParams2';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ShippingAddressCollectionParams2 object, {
  ...
  void _deserializeProperties(
    ...
    required ShippingAddressCollectionParams2Builder result,
  ...
  @override
  ShippingAddressCollectionParams2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ShippingAddressCollectionParams2Builder();
