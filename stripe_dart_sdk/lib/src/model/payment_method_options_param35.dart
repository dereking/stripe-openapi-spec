...
part 'payment_method_options_param35.g.dart';
...
/// * [zip] 
@BuiltValue()
abstract class PaymentMethodOptionsParam35 implements Built<PaymentMethodOptionsParam35, PaymentMethodOptionsParam35Builder> {
  ...
  PaymentMethodOptionsParam35._();

  factory PaymentMethodOptionsParam35([void updates(PaymentMethodOptionsParam35Builder b)]) = _$PaymentMethodOptionsParam35;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentMethodOptionsParam35Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentMethodOptionsParam35> get serializer => _$PaymentMethodOptionsParam35Serializer();
}

class _$PaymentMethodOptionsParam35Serializer implements PrimitiveSerializer<PaymentMethodOptionsParam35> {
  @override
  final Iterable<Type> types = const [PaymentMethodOptionsParam35, _$PaymentMethodOptionsParam35];

  @override
  final String wireName = r'PaymentMethodOptionsParam35';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaymentMethodOptionsParam35 object, {
  ...
  void _deserializeProperties(
    ...
    required PaymentMethodOptionsParam35Builder result,
  ...
  @override
  PaymentMethodOptionsParam35 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentMethodOptionsParam35Builder();
