...
@BuiltValue()
abstract class QuoteCustomer implements Built<QuoteCustomer, QuoteCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  QuoteCustomer._();

  factory QuoteCustomer([void updates(QuoteCustomerBuilder b)]) = _$QuoteCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(QuoteCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<QuoteCustomer> get serializer => _$QuoteCustomerSerializer();
}

class _$QuoteCustomerSerializer implements PrimitiveSerializer<QuoteCustomer> {
  @override
  final Iterable<Type> types = const [QuoteCustomer, _$QuoteCustomer];

  @override
  final String wireName = r'QuoteCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    QuoteCustomer object, {
  ...
  @override
  QuoteCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = QuoteCustomerBuilder();
    Object? anyOfDataSrc;
...
class QuoteCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const QuoteCustomerObjectEnum customer = _$quoteCustomerObjectEnum_customer;

  static Serializer<QuoteCustomerObjectEnum> get serializer => _$quoteCustomerObjectEnumSerializer;

  const QuoteCustomerObjectEnum._(String name): super(name);

  static BuiltSet<QuoteCustomerObjectEnum> get values => _$quoteCustomerObjectEnumValues;
  static QuoteCustomerObjectEnum valueOf(String name) => _$quoteCustomerObjectEnumValueOf(name);
}

class QuoteCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const QuoteCustomerTaxExemptEnum exempt = _$quoteCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const QuoteCustomerTaxExemptEnum none = _$quoteCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const QuoteCustomerTaxExemptEnum reverse = _$quoteCustomerTaxExemptEnum_reverse;

  static Serializer<QuoteCustomerTaxExemptEnum> get serializer => _$quoteCustomerTaxExemptEnumSerializer;

  const QuoteCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<QuoteCustomerTaxExemptEnum> get values => _$quoteCustomerTaxExemptEnumValues;
  static QuoteCustomerTaxExemptEnum valueOf(String name) => _$quoteCustomerTaxExemptEnumValueOf(name);
}
