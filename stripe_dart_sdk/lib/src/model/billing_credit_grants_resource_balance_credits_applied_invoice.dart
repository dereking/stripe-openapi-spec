...
part 'billing_credit_grants_resource_balance_credits_applied_invoice.g.dart';
...
@BuiltValue()
abstract class BillingCreditGrantsResourceBalanceCreditsAppliedInvoice implements Built<BillingCreditGrantsResourceBalanceCreditsAppliedInvoice, BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBuilder> {
  /// Any Of [Invoice], [String]
  AnyOf get anyOf;

  BillingCreditGrantsResourceBalanceCreditsAppliedInvoice._();

  factory BillingCreditGrantsResourceBalanceCreditsAppliedInvoice([void updates(BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBuilder b)]) = _$BillingCreditGrantsResourceBalanceCreditsAppliedInvoice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BillingCreditGrantsResourceBalanceCreditsAppliedInvoice> get serializer => _$BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceSerializer();
}

class _$BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceSerializer implements PrimitiveSerializer<BillingCreditGrantsResourceBalanceCreditsAppliedInvoice> {
  @override
  final Iterable<Type> types = const [BillingCreditGrantsResourceBalanceCreditsAppliedInvoice, _$BillingCreditGrantsResourceBalanceCreditsAppliedInvoice];

  @override
  final String wireName = r'BillingCreditGrantsResourceBalanceCreditsAppliedInvoice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BillingCreditGrantsResourceBalanceCreditsAppliedInvoice object, {
  ...
  @override
  BillingCreditGrantsResourceBalanceCreditsAppliedInvoice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBuilder();
    Object? anyOfDataSrc;
...
class BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum extends EnumClass {
  ...
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum automaticPendingInvoiceItemInvoice = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum manual = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum quoteAccept = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum subscription = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum subscriptionCreate = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum subscriptionCycle = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum subscriptionThreshold = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum subscriptionUpdate = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum upcoming = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum_upcoming;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum> get values => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceBillingReasonEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum chargeAutomatically = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum sendInvoice = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum_sendInvoice;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum> get values => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCollectionMethodEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum exempt = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum none = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum reverse = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum_reverse;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum> get values => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceCustomerTaxExemptEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnum invoice = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnum_invoice;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnum> get values => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceObjectEnumValueOf(name);
}

class BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum draft = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum open = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum paid = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum uncollectible = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum void_ = _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum_void_;

  static Serializer<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum> get serializer => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnumSerializer;

  const BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum> get values => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnumValues;
  static BillingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnum valueOf(String name) => _$billingCreditGrantsResourceBalanceCreditsAppliedInvoiceStatusEnumValueOf(name);
}
