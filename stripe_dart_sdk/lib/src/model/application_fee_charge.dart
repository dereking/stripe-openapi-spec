...
part 'application_fee_charge.g.dart';
...
@BuiltValue()
abstract class ApplicationFeeCharge implements Built<ApplicationFeeCharge, ApplicationFeeChargeBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  ApplicationFeeCharge._();

  factory ApplicationFeeCharge([void updates(ApplicationFeeChargeBuilder b)]) = _$ApplicationFeeCharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApplicationFeeChargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApplicationFeeCharge> get serializer => _$ApplicationFeeChargeSerializer();
}

class _$ApplicationFeeChargeSerializer implements PrimitiveSerializer<ApplicationFeeCharge> {
  @override
  final Iterable<Type> types = const [ApplicationFeeCharge, _$ApplicationFeeCharge];

  @override
  final String wireName = r'ApplicationFeeCharge';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApplicationFeeCharge object, {
  ...
  @override
  ApplicationFeeCharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApplicationFeeChargeBuilder();
    Object? anyOfDataSrc;
...
class ApplicationFeeChargeObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const ApplicationFeeChargeObjectEnum charge = _$applicationFeeChargeObjectEnum_charge;

  static Serializer<ApplicationFeeChargeObjectEnum> get serializer => _$applicationFeeChargeObjectEnumSerializer;

  const ApplicationFeeChargeObjectEnum._(String name): super(name);

  static BuiltSet<ApplicationFeeChargeObjectEnum> get values => _$applicationFeeChargeObjectEnumValues;
  static ApplicationFeeChargeObjectEnum valueOf(String name) => _$applicationFeeChargeObjectEnumValueOf(name);
}

class ApplicationFeeChargeStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const ApplicationFeeChargeStatusEnum failed = _$applicationFeeChargeStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const ApplicationFeeChargeStatusEnum pending = _$applicationFeeChargeStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const ApplicationFeeChargeStatusEnum succeeded = _$applicationFeeChargeStatusEnum_succeeded;

  static Serializer<ApplicationFeeChargeStatusEnum> get serializer => _$applicationFeeChargeStatusEnumSerializer;

  const ApplicationFeeChargeStatusEnum._(String name): super(name);

  static BuiltSet<ApplicationFeeChargeStatusEnum> get values => _$applicationFeeChargeStatusEnumValues;
  static ApplicationFeeChargeStatusEnum valueOf(String name) => _$applicationFeeChargeStatusEnumValueOf(name);
}
