...
part 'application_fee_originating_transaction.g.dart';
...
@BuiltValue()
abstract class ApplicationFeeOriginatingTransaction implements Built<ApplicationFeeOriginatingTransaction, ApplicationFeeOriginatingTransactionBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  ApplicationFeeOriginatingTransaction._();

  factory ApplicationFeeOriginatingTransaction([void updates(ApplicationFeeOriginatingTransactionBuilder b)]) = _$ApplicationFeeOriginatingTransaction;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ApplicationFeeOriginatingTransactionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ApplicationFeeOriginatingTransaction> get serializer => _$ApplicationFeeOriginatingTransactionSerializer();
}

class _$ApplicationFeeOriginatingTransactionSerializer implements PrimitiveSerializer<ApplicationFeeOriginatingTransaction> {
  @override
  final Iterable<Type> types = const [ApplicationFeeOriginatingTransaction, _$ApplicationFeeOriginatingTransaction];

  @override
  final String wireName = r'ApplicationFeeOriginatingTransaction';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ApplicationFeeOriginatingTransaction object, {
  ...
  @override
  ApplicationFeeOriginatingTransaction deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ApplicationFeeOriginatingTransactionBuilder();
    Object? anyOfDataSrc;
...
class ApplicationFeeOriginatingTransactionObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const ApplicationFeeOriginatingTransactionObjectEnum charge = _$applicationFeeOriginatingTransactionObjectEnum_charge;

  static Serializer<ApplicationFeeOriginatingTransactionObjectEnum> get serializer => _$applicationFeeOriginatingTransactionObjectEnumSerializer;

  const ApplicationFeeOriginatingTransactionObjectEnum._(String name): super(name);

  static BuiltSet<ApplicationFeeOriginatingTransactionObjectEnum> get values => _$applicationFeeOriginatingTransactionObjectEnumValues;
  static ApplicationFeeOriginatingTransactionObjectEnum valueOf(String name) => _$applicationFeeOriginatingTransactionObjectEnumValueOf(name);
}

class ApplicationFeeOriginatingTransactionStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const ApplicationFeeOriginatingTransactionStatusEnum failed = _$applicationFeeOriginatingTransactionStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const ApplicationFeeOriginatingTransactionStatusEnum pending = _$applicationFeeOriginatingTransactionStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const ApplicationFeeOriginatingTransactionStatusEnum succeeded = _$applicationFeeOriginatingTransactionStatusEnum_succeeded;

  static Serializer<ApplicationFeeOriginatingTransactionStatusEnum> get serializer => _$applicationFeeOriginatingTransactionStatusEnumSerializer;

  const ApplicationFeeOriginatingTransactionStatusEnum._(String name): super(name);

  static BuiltSet<ApplicationFeeOriginatingTransactionStatusEnum> get values => _$applicationFeeOriginatingTransactionStatusEnumValues;
  static ApplicationFeeOriginatingTransactionStatusEnum valueOf(String name) => _$applicationFeeOriginatingTransactionStatusEnumValueOf(name);
}
