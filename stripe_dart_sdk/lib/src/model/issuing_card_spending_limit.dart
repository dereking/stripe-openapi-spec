...
part 'issuing_card_spending_limit.g.dart';
...
@BuiltValue()
abstract class IssuingCardSpendingLimit implements Built<IssuingCardSpendingLimit, IssuingCardSpendingLimitBuilder> {
  ...
  IssuingCardSpendingLimitIntervalEnum get interval;
  // enum intervalEnum {  all_time,  daily,  monthly,  per_authorization,  weekly,  yearly,  };

  IssuingCardSpendingLimit._();

  factory IssuingCardSpendingLimit([void updates(IssuingCardSpendingLimitBuilder b)]) = _$IssuingCardSpendingLimit;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IssuingCardSpendingLimitBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IssuingCardSpendingLimit> get serializer => _$IssuingCardSpendingLimitSerializer();
}

class _$IssuingCardSpendingLimitSerializer implements PrimitiveSerializer<IssuingCardSpendingLimit> {
  @override
  final Iterable<Type> types = const [IssuingCardSpendingLimit, _$IssuingCardSpendingLimit];

  @override
  final String wireName = r'IssuingCardSpendingLimit';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.interval,
      specifiedType: const FullType(IssuingCardSpendingLimitIntervalEnum),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required IssuingCardSpendingLimitBuilder result,
      ...
      switch (key) {
        ...
        case r'interval':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(IssuingCardSpendingLimitIntervalEnum),
          ) as IssuingCardSpendingLimitIntervalEnum;
  ...
  @override
  IssuingCardSpendingLimit deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IssuingCardSpendingLimitBuilder();
...
class IssuingCardSpendingLimitIntervalEnum extends EnumClass {

  /// Interval (or event) to which the amount applies.
  @BuiltValueEnumConst(wireName: r'all_time')
  static const IssuingCardSpendingLimitIntervalEnum allTime = _$issuingCardSpendingLimitIntervalEnum_allTime;
  /// Interval (or event) to which the amount applies.
  @BuiltValueEnumConst(wireName: r'daily')
  static const IssuingCardSpendingLimitIntervalEnum daily = _$issuingCardSpendingLimitIntervalEnum_daily;
  /// Interval (or event) to which the amount applies.
  @BuiltValueEnumConst(wireName: r'monthly')
  static const IssuingCardSpendingLimitIntervalEnum monthly = _$issuingCardSpendingLimitIntervalEnum_monthly;
  /// Interval (or event) to which the amount applies.
  @BuiltValueEnumConst(wireName: r'per_authorization')
  static const IssuingCardSpendingLimitIntervalEnum perAuthorization = _$issuingCardSpendingLimitIntervalEnum_perAuthorization;
  /// Interval (or event) to which the amount applies.
  @BuiltValueEnumConst(wireName: r'weekly')
  static const IssuingCardSpendingLimitIntervalEnum weekly = _$issuingCardSpendingLimitIntervalEnum_weekly;
  /// Interval (or event) to which the amount applies.
  @BuiltValueEnumConst(wireName: r'yearly')
  static const IssuingCardSpendingLimitIntervalEnum yearly = _$issuingCardSpendingLimitIntervalEnum_yearly;

  static Serializer<IssuingCardSpendingLimitIntervalEnum> get serializer => _$issuingCardSpendingLimitIntervalEnumSerializer;

  const IssuingCardSpendingLimitIntervalEnum._(String name): super(name);

  static BuiltSet<IssuingCardSpendingLimitIntervalEnum> get values => _$issuingCardSpendingLimitIntervalEnumValues;
  static IssuingCardSpendingLimitIntervalEnum valueOf(String name) => _$issuingCardSpendingLimitIntervalEnumValueOf(name);
}
