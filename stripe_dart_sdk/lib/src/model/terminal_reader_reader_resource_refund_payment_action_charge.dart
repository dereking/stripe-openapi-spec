...
part 'terminal_reader_reader_resource_refund_payment_action_charge.g.dart';
...
@BuiltValue()
abstract class TerminalReaderReaderResourceRefundPaymentActionCharge implements Built<TerminalReaderReaderResourceRefundPaymentActionCharge, TerminalReaderReaderResourceRefundPaymentActionChargeBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  TerminalReaderReaderResourceRefundPaymentActionCharge._();

  factory TerminalReaderReaderResourceRefundPaymentActionCharge([void updates(TerminalReaderReaderResourceRefundPaymentActionChargeBuilder b)]) = _$TerminalReaderReaderResourceRefundPaymentActionCharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TerminalReaderReaderResourceRefundPaymentActionChargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TerminalReaderReaderResourceRefundPaymentActionCharge> get serializer => _$TerminalReaderReaderResourceRefundPaymentActionChargeSerializer();
}

class _$TerminalReaderReaderResourceRefundPaymentActionChargeSerializer implements PrimitiveSerializer<TerminalReaderReaderResourceRefundPaymentActionCharge> {
  @override
  final Iterable<Type> types = const [TerminalReaderReaderResourceRefundPaymentActionCharge, _$TerminalReaderReaderResourceRefundPaymentActionCharge];

  @override
  final String wireName = r'TerminalReaderReaderResourceRefundPaymentActionCharge';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    TerminalReaderReaderResourceRefundPaymentActionCharge object, {
  ...
  @override
  TerminalReaderReaderResourceRefundPaymentActionCharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TerminalReaderReaderResourceRefundPaymentActionChargeBuilder();
    Object? anyOfDataSrc;
...
class TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum charge = _$terminalReaderReaderResourceRefundPaymentActionChargeObjectEnum_charge;

  static Serializer<TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum> get serializer => _$terminalReaderReaderResourceRefundPaymentActionChargeObjectEnumSerializer;

  const TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum._(String name): super(name);

  static BuiltSet<TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum> get values => _$terminalReaderReaderResourceRefundPaymentActionChargeObjectEnumValues;
  static TerminalReaderReaderResourceRefundPaymentActionChargeObjectEnum valueOf(String name) => _$terminalReaderReaderResourceRefundPaymentActionChargeObjectEnumValueOf(name);
}

class TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum failed = _$terminalReaderReaderResourceRefundPaymentActionChargeStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum pending = _$terminalReaderReaderResourceRefundPaymentActionChargeStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum succeeded = _$terminalReaderReaderResourceRefundPaymentActionChargeStatusEnum_succeeded;

  static Serializer<TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum> get serializer => _$terminalReaderReaderResourceRefundPaymentActionChargeStatusEnumSerializer;

  const TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum._(String name): super(name);

  static BuiltSet<TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum> get values => _$terminalReaderReaderResourceRefundPaymentActionChargeStatusEnumValues;
  static TerminalReaderReaderResourceRefundPaymentActionChargeStatusEnum valueOf(String name) => _$terminalReaderReaderResourceRefundPaymentActionChargeStatusEnumValueOf(name);
}
