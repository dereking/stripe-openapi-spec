...
part 'billing_credit_grant_customer.g.dart';
...
@BuiltValue()
abstract class BillingCreditGrantCustomer implements Built<BillingCreditGrantCustomer, BillingCreditGrantCustomerBuilder> {
  /// Any Of [Customer], [DeletedCustomer], [String]
  AnyOf get anyOf;

  BillingCreditGrantCustomer._();

  factory BillingCreditGrantCustomer([void updates(BillingCreditGrantCustomerBuilder b)]) = _$BillingCreditGrantCustomer;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BillingCreditGrantCustomerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BillingCreditGrantCustomer> get serializer => _$BillingCreditGrantCustomerSerializer();
}

class _$BillingCreditGrantCustomerSerializer implements PrimitiveSerializer<BillingCreditGrantCustomer> {
  @override
  final Iterable<Type> types = const [BillingCreditGrantCustomer, _$BillingCreditGrantCustomer];

  @override
  final String wireName = r'BillingCreditGrantCustomer';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BillingCreditGrantCustomer object, {
  ...
  @override
  BillingCreditGrantCustomer deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BillingCreditGrantCustomerBuilder();
    Object? anyOfDataSrc;
...
class BillingCreditGrantCustomerObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'customer')
  static const BillingCreditGrantCustomerObjectEnum customer = _$billingCreditGrantCustomerObjectEnum_customer;

  static Serializer<BillingCreditGrantCustomerObjectEnum> get serializer => _$billingCreditGrantCustomerObjectEnumSerializer;

  const BillingCreditGrantCustomerObjectEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantCustomerObjectEnum> get values => _$billingCreditGrantCustomerObjectEnumValues;
  static BillingCreditGrantCustomerObjectEnum valueOf(String name) => _$billingCreditGrantCustomerObjectEnumValueOf(name);
}

class BillingCreditGrantCustomerTaxExemptEnum extends EnumClass {

  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const BillingCreditGrantCustomerTaxExemptEnum exempt = _$billingCreditGrantCustomerTaxExemptEnum_exempt;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'none')
  static const BillingCreditGrantCustomerTaxExemptEnum none = _$billingCreditGrantCustomerTaxExemptEnum_none;
  /// Describes the customer's tax exemption status, which is `none`, `exempt`, or `reverse`. When set to `reverse`, invoice and receipt PDFs include the following text: **\"Reverse charge\"**.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const BillingCreditGrantCustomerTaxExemptEnum reverse = _$billingCreditGrantCustomerTaxExemptEnum_reverse;

  static Serializer<BillingCreditGrantCustomerTaxExemptEnum> get serializer => _$billingCreditGrantCustomerTaxExemptEnumSerializer;

  const BillingCreditGrantCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<BillingCreditGrantCustomerTaxExemptEnum> get values => _$billingCreditGrantCustomerTaxExemptEnumValues;
  static BillingCreditGrantCustomerTaxExemptEnum valueOf(String name) => _$billingCreditGrantCustomerTaxExemptEnumValueOf(name);
}
