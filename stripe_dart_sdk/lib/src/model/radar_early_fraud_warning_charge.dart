...
part 'radar_early_fraud_warning_charge.g.dart';
...
@BuiltValue()
abstract class RadarEarlyFraudWarningCharge implements Built<RadarEarlyFraudWarningCharge, RadarEarlyFraudWarningChargeBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  RadarEarlyFraudWarningCharge._();

  factory RadarEarlyFraudWarningCharge([void updates(RadarEarlyFraudWarningChargeBuilder b)]) = _$RadarEarlyFraudWarningCharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RadarEarlyFraudWarningChargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RadarEarlyFraudWarningCharge> get serializer => _$RadarEarlyFraudWarningChargeSerializer();
}

class _$RadarEarlyFraudWarningChargeSerializer implements PrimitiveSerializer<RadarEarlyFraudWarningCharge> {
  @override
  final Iterable<Type> types = const [RadarEarlyFraudWarningCharge, _$RadarEarlyFraudWarningCharge];

  @override
  final String wireName = r'RadarEarlyFraudWarningCharge';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    RadarEarlyFraudWarningCharge object, {
  ...
  @override
  RadarEarlyFraudWarningCharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RadarEarlyFraudWarningChargeBuilder();
    Object? anyOfDataSrc;
...
class RadarEarlyFraudWarningChargeObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const RadarEarlyFraudWarningChargeObjectEnum charge = _$radarEarlyFraudWarningChargeObjectEnum_charge;

  static Serializer<RadarEarlyFraudWarningChargeObjectEnum> get serializer => _$radarEarlyFraudWarningChargeObjectEnumSerializer;

  const RadarEarlyFraudWarningChargeObjectEnum._(String name): super(name);

  static BuiltSet<RadarEarlyFraudWarningChargeObjectEnum> get values => _$radarEarlyFraudWarningChargeObjectEnumValues;
  static RadarEarlyFraudWarningChargeObjectEnum valueOf(String name) => _$radarEarlyFraudWarningChargeObjectEnumValueOf(name);
}

class RadarEarlyFraudWarningChargeStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const RadarEarlyFraudWarningChargeStatusEnum failed = _$radarEarlyFraudWarningChargeStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const RadarEarlyFraudWarningChargeStatusEnum pending = _$radarEarlyFraudWarningChargeStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const RadarEarlyFraudWarningChargeStatusEnum succeeded = _$radarEarlyFraudWarningChargeStatusEnum_succeeded;

  static Serializer<RadarEarlyFraudWarningChargeStatusEnum> get serializer => _$radarEarlyFraudWarningChargeStatusEnumSerializer;

  const RadarEarlyFraudWarningChargeStatusEnum._(String name): super(name);

  static BuiltSet<RadarEarlyFraudWarningChargeStatusEnum> get values => _$radarEarlyFraudWarningChargeStatusEnumValues;
  static RadarEarlyFraudWarningChargeStatusEnum valueOf(String name) => _$radarEarlyFraudWarningChargeStatusEnumValueOf(name);
}
