...
@BuiltValue()
abstract class RefundCharge implements Built<RefundCharge, RefundChargeBuilder> {
  /// Any Of [Charge], [String]
  AnyOf get anyOf;

  RefundCharge._();

  factory RefundCharge([void updates(RefundChargeBuilder b)]) = _$RefundCharge;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RefundChargeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RefundCharge> get serializer => _$RefundChargeSerializer();
}

class _$RefundChargeSerializer implements PrimitiveSerializer<RefundCharge> {
  @override
  final Iterable<Type> types = const [RefundCharge, _$RefundCharge];

  @override
  final String wireName = r'RefundCharge';
  ...
  @override
  RefundCharge deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RefundChargeBuilder();
    Object? anyOfDataSrc;
...
class RefundChargeObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'charge')
  static const RefundChargeObjectEnum charge = _$refundChargeObjectEnum_charge;

  static Serializer<RefundChargeObjectEnum> get serializer => _$refundChargeObjectEnumSerializer;

  const RefundChargeObjectEnum._(String name): super(name);

  static BuiltSet<RefundChargeObjectEnum> get values => _$refundChargeObjectEnumValues;
  static RefundChargeObjectEnum valueOf(String name) => _$refundChargeObjectEnumValueOf(name);
}

class RefundChargeStatusEnum extends EnumClass {

  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'failed')
  static const RefundChargeStatusEnum failed = _$refundChargeStatusEnum_failed;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'pending')
  static const RefundChargeStatusEnum pending = _$refundChargeStatusEnum_pending;
  /// The status of the payment is either `succeeded`, `pending`, or `failed`.
  @BuiltValueEnumConst(wireName: r'succeeded')
  static const RefundChargeStatusEnum succeeded = _$refundChargeStatusEnum_succeeded;

  static Serializer<RefundChargeStatusEnum> get serializer => _$refundChargeStatusEnumSerializer;

  const RefundChargeStatusEnum._(String name): super(name);

  static BuiltSet<RefundChargeStatusEnum> get values => _$refundChargeStatusEnumValues;
  static RefundChargeStatusEnum valueOf(String name) => _$refundChargeStatusEnumValueOf(name);
}
