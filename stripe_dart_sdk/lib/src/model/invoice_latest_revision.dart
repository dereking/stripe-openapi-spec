...
part 'invoice_latest_revision.g.dart';
...
@BuiltValue()
abstract class InvoiceLatestRevision implements Built<InvoiceLatestRevision, InvoiceLatestRevisionBuilder> {
  /// Any Of [Invoice], [String]
  AnyOf get anyOf;

  InvoiceLatestRevision._();

  factory InvoiceLatestRevision([void updates(InvoiceLatestRevisionBuilder b)]) = _$InvoiceLatestRevision;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoiceLatestRevisionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoiceLatestRevision> get serializer => _$InvoiceLatestRevisionSerializer();
}

class _$InvoiceLatestRevisionSerializer implements PrimitiveSerializer<InvoiceLatestRevision> {
  @override
  final Iterable<Type> types = const [InvoiceLatestRevision, _$InvoiceLatestRevision];

  @override
  final String wireName = r'InvoiceLatestRevision';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InvoiceLatestRevision object, {
  ...
  @override
  InvoiceLatestRevision deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoiceLatestRevisionBuilder();
    Object? anyOfDataSrc;
...
class InvoiceLatestRevisionBillingReasonEnum extends EnumClass {
  ...
  static const InvoiceLatestRevisionBillingReasonEnum automaticPendingInvoiceItemInvoice = _$invoiceLatestRevisionBillingReasonEnum_automaticPendingInvoiceItemInvoice;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'manual')
  static const InvoiceLatestRevisionBillingReasonEnum manual = _$invoiceLatestRevisionBillingReasonEnum_manual;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'quote_accept')
  static const InvoiceLatestRevisionBillingReasonEnum quoteAccept = _$invoiceLatestRevisionBillingReasonEnum_quoteAccept;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription')
  static const InvoiceLatestRevisionBillingReasonEnum subscription = _$invoiceLatestRevisionBillingReasonEnum_subscription;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_create')
  static const InvoiceLatestRevisionBillingReasonEnum subscriptionCreate = _$invoiceLatestRevisionBillingReasonEnum_subscriptionCreate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_cycle')
  static const InvoiceLatestRevisionBillingReasonEnum subscriptionCycle = _$invoiceLatestRevisionBillingReasonEnum_subscriptionCycle;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_threshold')
  static const InvoiceLatestRevisionBillingReasonEnum subscriptionThreshold = _$invoiceLatestRevisionBillingReasonEnum_subscriptionThreshold;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'subscription_update')
  static const InvoiceLatestRevisionBillingReasonEnum subscriptionUpdate = _$invoiceLatestRevisionBillingReasonEnum_subscriptionUpdate;
  /// Indicates the reason why the invoice was created.  * `manual`: Unrelated to a subscription, for example, created via the invoice editor. * `subscription`: No longer in use. Applies to subscriptions from before May 2018 where no distinction was made between updates, cycles, and thresholds. * `subscription_create`: A new subscription was created. * `subscription_cycle`: A subscription advanced into a new period. * `subscription_threshold`: A subscription reached a billing threshold. * `subscription_update`: A subscription was updated. * `upcoming`: Reserved for simulated invoices, per the upcoming invoice endpoint.
  @BuiltValueEnumConst(wireName: r'upcoming')
  static const InvoiceLatestRevisionBillingReasonEnum upcoming = _$invoiceLatestRevisionBillingReasonEnum_upcoming;

  static Serializer<InvoiceLatestRevisionBillingReasonEnum> get serializer => _$invoiceLatestRevisionBillingReasonEnumSerializer;

  const InvoiceLatestRevisionBillingReasonEnum._(String name): super(name);

  static BuiltSet<InvoiceLatestRevisionBillingReasonEnum> get values => _$invoiceLatestRevisionBillingReasonEnumValues;
  static InvoiceLatestRevisionBillingReasonEnum valueOf(String name) => _$invoiceLatestRevisionBillingReasonEnumValueOf(name);
}

class InvoiceLatestRevisionCollectionMethodEnum extends EnumClass {

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'charge_automatically')
  static const InvoiceLatestRevisionCollectionMethodEnum chargeAutomatically = _$invoiceLatestRevisionCollectionMethodEnum_chargeAutomatically;
  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Stripe will email this invoice to the customer with payment instructions.
  @BuiltValueEnumConst(wireName: r'send_invoice')
  static const InvoiceLatestRevisionCollectionMethodEnum sendInvoice = _$invoiceLatestRevisionCollectionMethodEnum_sendInvoice;

  static Serializer<InvoiceLatestRevisionCollectionMethodEnum> get serializer => _$invoiceLatestRevisionCollectionMethodEnumSerializer;

  const InvoiceLatestRevisionCollectionMethodEnum._(String name): super(name);

  static BuiltSet<InvoiceLatestRevisionCollectionMethodEnum> get values => _$invoiceLatestRevisionCollectionMethodEnumValues;
  static InvoiceLatestRevisionCollectionMethodEnum valueOf(String name) => _$invoiceLatestRevisionCollectionMethodEnumValueOf(name);
}

class InvoiceLatestRevisionCustomerTaxExemptEnum extends EnumClass {

  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'exempt')
  static const InvoiceLatestRevisionCustomerTaxExemptEnum exempt = _$invoiceLatestRevisionCustomerTaxExemptEnum_exempt;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'none')
  static const InvoiceLatestRevisionCustomerTaxExemptEnum none = _$invoiceLatestRevisionCustomerTaxExemptEnum_none;
  /// The customer's tax exempt status. Until the invoice is finalized, this field will equal `customer.tax_exempt`. Once the invoice is finalized, this field will no longer be updated.
  @BuiltValueEnumConst(wireName: r'reverse')
  static const InvoiceLatestRevisionCustomerTaxExemptEnum reverse = _$invoiceLatestRevisionCustomerTaxExemptEnum_reverse;

  static Serializer<InvoiceLatestRevisionCustomerTaxExemptEnum> get serializer => _$invoiceLatestRevisionCustomerTaxExemptEnumSerializer;

  const InvoiceLatestRevisionCustomerTaxExemptEnum._(String name): super(name);

  static BuiltSet<InvoiceLatestRevisionCustomerTaxExemptEnum> get values => _$invoiceLatestRevisionCustomerTaxExemptEnumValues;
  static InvoiceLatestRevisionCustomerTaxExemptEnum valueOf(String name) => _$invoiceLatestRevisionCustomerTaxExemptEnumValueOf(name);
}

class InvoiceLatestRevisionObjectEnum extends EnumClass {

  /// String representing the object's type. Objects of the same type share the same value.
  @BuiltValueEnumConst(wireName: r'invoice')
  static const InvoiceLatestRevisionObjectEnum invoice = _$invoiceLatestRevisionObjectEnum_invoice;

  static Serializer<InvoiceLatestRevisionObjectEnum> get serializer => _$invoiceLatestRevisionObjectEnumSerializer;

  const InvoiceLatestRevisionObjectEnum._(String name): super(name);

  static BuiltSet<InvoiceLatestRevisionObjectEnum> get values => _$invoiceLatestRevisionObjectEnumValues;
  static InvoiceLatestRevisionObjectEnum valueOf(String name) => _$invoiceLatestRevisionObjectEnumValueOf(name);
}

class InvoiceLatestRevisionStatusEnum extends EnumClass {

  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'draft')
  static const InvoiceLatestRevisionStatusEnum draft = _$invoiceLatestRevisionStatusEnum_draft;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'open')
  static const InvoiceLatestRevisionStatusEnum open = _$invoiceLatestRevisionStatusEnum_open;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'paid')
  static const InvoiceLatestRevisionStatusEnum paid = _$invoiceLatestRevisionStatusEnum_paid;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'uncollectible')
  static const InvoiceLatestRevisionStatusEnum uncollectible = _$invoiceLatestRevisionStatusEnum_uncollectible;
  /// The status of the invoice, one of `draft`, `open`, `paid`, `uncollectible`, or `void`. [Learn more](https://stripe.com/docs/billing/invoices/workflow#workflow-overview)
  @BuiltValueEnumConst(wireName: r'void')
  static const InvoiceLatestRevisionStatusEnum void_ = _$invoiceLatestRevisionStatusEnum_void_;

  static Serializer<InvoiceLatestRevisionStatusEnum> get serializer => _$invoiceLatestRevisionStatusEnumSerializer;

  const InvoiceLatestRevisionStatusEnum._(String name): super(name);

  static BuiltSet<InvoiceLatestRevisionStatusEnum> get values => _$invoiceLatestRevisionStatusEnumValues;
  static InvoiceLatestRevisionStatusEnum valueOf(String name) => _$invoiceLatestRevisionStatusEnumValueOf(name);
}
