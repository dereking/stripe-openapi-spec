...
// tests for SetupIntentPaymentMethodOptionsAcssDebit
void main() {
  // final instance = SetupIntentPaymentMethodOptionsAcssDebit();

  group('test SetupIntentPaymentMethodOptionsAcssDebit', () {
