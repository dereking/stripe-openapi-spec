...
// tests for PaymentIntentPaymentMethodOptionsUsBankAccount1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsUsBankAccount1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsUsBankAccount1, () {
    // LinkedAccountOptionsCommon financialConnections
    test('to test the property `financialConnections`', () async {
      // TODO
    });
    ...
    test('to test the property `preferredSettlementSpeed`', () async {
      // TODO
    });
