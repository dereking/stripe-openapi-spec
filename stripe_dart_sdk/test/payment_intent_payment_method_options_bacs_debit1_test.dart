...
// tests for PaymentIntentPaymentMethodOptionsBacsDebit1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsBacsDebit1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsBacsDebit1, () {
