...
// tests for PriceProduct
void main() {
  // final instance = PriceProduct();

  group('test PriceProduct', () {
    ...
    // List<ProductMarketingFeature> marketingFeatures (default value: const [])
    test('to test the property `marketingFeatures`', () async {
      // TODO
    });
    ...
    // bool shippable
    test('to test the property `shippable`', () async {
      // TODO
    });
    ...
    // String unitLabel
    test('to test the property `unitLabel`', () async {
      // TODO
    });
