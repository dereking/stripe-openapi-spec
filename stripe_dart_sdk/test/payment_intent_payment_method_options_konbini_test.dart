...
// tests for PaymentIntentPaymentMethodOptionsKonbini
void main() {
  final instance = PaymentIntentPaymentMethodOptionsKonbiniBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsKonbini, () {
