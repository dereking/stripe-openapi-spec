...
// tests for PaymentIntentPaymentMethodOptionsUsBankAccount
void main() {
  final instance = PaymentIntentPaymentMethodOptionsUsBankAccountBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsUsBankAccount, () {
