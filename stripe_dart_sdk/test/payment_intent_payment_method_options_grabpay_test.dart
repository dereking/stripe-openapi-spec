...
// tests for PaymentIntentPaymentMethodOptionsGrabpay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsGrabpayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsGrabpay, () {
