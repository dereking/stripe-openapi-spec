...
// tests for PaymentIntentPaymentMethodOptionsAfterpayClearpay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsAfterpayClearpayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsAfterpayClearpay, () {
