...
// tests for PaymentIntentPaymentMethodOptionsPaynow
void main() {
  final instance = PaymentIntentPaymentMethodOptionsPaynowBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsPaynow, () {
