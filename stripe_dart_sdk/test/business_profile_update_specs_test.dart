...
// tests for BusinessProfileUpdateSpecs
void main() {
  // final instance = BusinessProfileUpdateSpecs();

  group('test BusinessProfileUpdateSpecs', () {
    ...
    // List<String> minorityOwnedBusinessDesignation (default value: const [])
