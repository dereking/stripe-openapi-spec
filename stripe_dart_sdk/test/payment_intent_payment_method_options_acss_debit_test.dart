...
// tests for PaymentIntentPaymentMethodOptionsAcssDebit
void main() {
  final instance = PaymentIntentPaymentMethodOptionsAcssDebitBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsAcssDebit, () {
