...
// tests for EvidenceParamMerchandiseNotAsDescribed
void main() {
  // final instance = EvidenceParamMerchandiseNotAsDescribed();

  group('test EvidenceParamMerchandiseNotAsDescribed', () {
