...
// tests for SubscriptionSchedulePhaseConfigurationOnBehalfOf
void main() {
  final instance = SubscriptionSchedulePhaseConfigurationOnBehalfOfBuilder();
  // TODO add properties to the builder and call build()

  group(SubscriptionSchedulePhaseConfigurationOnBehalfOf, () {
