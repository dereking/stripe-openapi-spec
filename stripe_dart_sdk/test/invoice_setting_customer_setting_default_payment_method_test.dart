...
// tests for InvoiceSettingCustomerSettingDefaultPaymentMethod
void main() {
  final instance = InvoiceSettingCustomerSettingDefaultPaymentMethodBuilder();
  // TODO add properties to the builder and call build()

  group(InvoiceSettingCustomerSettingDefaultPaymentMethod, () {
