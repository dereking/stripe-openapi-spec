...
// tests for PaymentIntentPaymentMethodOptionsBancontact
void main() {
  final instance = PaymentIntentPaymentMethodOptionsBancontactBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsBancontact, () {
