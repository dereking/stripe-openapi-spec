...
void main() {
  final instance = CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesBuilder();
  // TODO add properties to the builder and call build()

  group(CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures, () {
    ...
    // BuiltList<String> paymentMethodAllowRedisplayFilters
