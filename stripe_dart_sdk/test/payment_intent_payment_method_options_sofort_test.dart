...
// tests for PaymentIntentPaymentMethodOptionsSofort
void main() {
  final instance = PaymentIntentPaymentMethodOptionsSofortBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsSofort, () {
