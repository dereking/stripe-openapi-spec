...
void main() {
  // final instance = IssuingCardholderAuthorizationControls();

  group('test IssuingCardholderAuthorizationControls', () {
    ...
    // List<IssuingCardholderSpendingLimit> spendingLimits (default value: const [])
