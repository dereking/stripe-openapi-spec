...
// tests for CreditNotesPretaxCreditAmountCreditBalanceTransaction
void main() {
  // final instance = CreditNotesPretaxCreditAmountCreditBalanceTransaction();

  group('test CreditNotesPretaxCreditAmountCreditBalanceTransaction', () {
