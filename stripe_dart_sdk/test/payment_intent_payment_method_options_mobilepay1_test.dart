...
// tests for PaymentIntentPaymentMethodOptionsMobilepay1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsMobilepay1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsMobilepay1, () {
