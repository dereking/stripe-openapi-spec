...
// tests for PaymentIntentPaymentMethodOptionsPaypal
void main() {
  final instance = PaymentIntentPaymentMethodOptionsPaypalBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsPaypal, () {
