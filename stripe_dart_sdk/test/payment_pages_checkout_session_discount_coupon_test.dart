...
// tests for PaymentPagesCheckoutSessionDiscountCoupon
void main() {
  final instance = PaymentPagesCheckoutSessionDiscountCouponBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentPagesCheckoutSessionDiscountCoupon, () {
    ...
    // BuiltMap<String, CouponCurrencyOption> currencyOptions
