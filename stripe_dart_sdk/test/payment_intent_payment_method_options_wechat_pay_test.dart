...
// tests for PaymentIntentPaymentMethodOptionsWechatPay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsWechatPayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsWechatPay, () {
