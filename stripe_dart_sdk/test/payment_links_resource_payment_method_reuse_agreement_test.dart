...
// tests for PaymentLinksResourcePaymentMethodReuseAgreement
void main() {
  // final instance = PaymentLinksResourcePaymentMethodReuseAgreement();

  group('test PaymentLinksResourcePaymentMethodReuseAgreement', () {
