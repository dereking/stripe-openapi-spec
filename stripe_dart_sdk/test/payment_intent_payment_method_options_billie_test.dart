...
// tests for PaymentIntentPaymentMethodOptionsBillie
void main() {
  final instance = PaymentIntentPaymentMethodOptionsBillieBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsBillie, () {
