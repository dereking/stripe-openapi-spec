...
// tests for PaymentIntentPaymentMethodOptionsIdeal
void main() {
  final instance = PaymentIntentPaymentMethodOptionsIdealBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsIdeal, () {
