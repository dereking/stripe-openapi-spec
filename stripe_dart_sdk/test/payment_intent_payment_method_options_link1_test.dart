...
// tests for PaymentIntentPaymentMethodOptionsLink1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsLink1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsLink1, () {
