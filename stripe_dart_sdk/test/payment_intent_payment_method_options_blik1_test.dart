...
// tests for PaymentIntentPaymentMethodOptionsBlik1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsBlik1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsBlik1, () {
