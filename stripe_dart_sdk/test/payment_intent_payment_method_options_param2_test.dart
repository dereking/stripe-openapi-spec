...
// tests for PaymentIntentPaymentMethodOptionsParam2
void main() {
  // final instance = PaymentIntentPaymentMethodOptionsParam2();

  group('test PaymentIntentPaymentMethodOptionsParam2', () {
