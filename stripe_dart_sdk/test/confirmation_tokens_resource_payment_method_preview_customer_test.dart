...
// tests for ConfirmationTokensResourcePaymentMethodPreviewCustomer
void main() {
  // final instance = ConfirmationTokensResourcePaymentMethodPreviewCustomer();

  group('test ConfirmationTokensResourcePaymentMethodPreviewCustomer', () {
    // Address address
    ...
    // Map<String, int> invoiceCreditBalance (default value: const {})
