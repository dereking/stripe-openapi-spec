...
// tests for PaymentIntentPaymentMethodOptionsSwish1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsSwish1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsSwish1, () {
