...
// tests for PaymentIntentPaymentMethodOptionsAffirm
void main() {
  final instance = PaymentIntentPaymentMethodOptionsAffirmBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsAffirm, () {
