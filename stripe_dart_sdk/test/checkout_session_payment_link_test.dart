...
// tests for CheckoutSessionPaymentLink
void main() {
  // final instance = CheckoutSessionPaymentLink();

  group('test CheckoutSessionPaymentLink', () {
    ...
    // List<PaymentLinksResourceCustomFields> customFields (default value: const [])
    ...
    // List<PaymentLinksResourceOptionalItem> optionalItems (default value: const [])
    ...
    // List<PaymentLinksResourceShippingOption> shippingOptions (default value: const [])
