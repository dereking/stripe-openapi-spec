...
// tests for CheckoutCustomerBalancePaymentMethodOptions
void main() {
  final instance = CheckoutCustomerBalancePaymentMethodOptionsBuilder();
  // TODO add properties to the builder and call build()

  group(CheckoutCustomerBalancePaymentMethodOptions, () {
