...
// tests for PaymentIntentPaymentMethodOptionsPayByBank
void main() {
  final instance = PaymentIntentPaymentMethodOptionsPayByBankBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsPayByBank, () {
