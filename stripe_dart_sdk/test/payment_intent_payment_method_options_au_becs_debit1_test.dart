...
// tests for PaymentIntentPaymentMethodOptionsAuBecsDebit1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsAuBecsDebit1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsAuBecsDebit1, () {
