...
// tests for PaymentIntentPaymentMethodOptionsTwint
void main() {
  final instance = PaymentIntentPaymentMethodOptionsTwintBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsTwint, () {
