...
// tests for InvoicesResourceShippingCostShippingRate
void main() {
  final instance = InvoicesResourceShippingCostShippingRateBuilder();
  // TODO add properties to the builder and call build()

  group(InvoicesResourceShippingCostShippingRate, () {
