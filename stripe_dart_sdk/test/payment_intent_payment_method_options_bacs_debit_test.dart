...
// tests for PaymentIntentPaymentMethodOptionsBacsDebit
void main() {
  final instance = PaymentIntentPaymentMethodOptionsBacsDebitBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsBacsDebit, () {
