...
// tests for SubscriptionScheduleDefaultSettingsParam
void main() {
  // final instance = SubscriptionScheduleDefaultSettingsParam();

  group('test SubscriptionScheduleDefaultSettingsParam', () {
