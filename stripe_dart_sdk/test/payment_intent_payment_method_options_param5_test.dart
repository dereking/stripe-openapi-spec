...
// tests for PaymentIntentPaymentMethodOptionsParam5
void main() {
  // final instance = PaymentIntentPaymentMethodOptionsParam5();

  group('test PaymentIntentPaymentMethodOptionsParam5', () {
