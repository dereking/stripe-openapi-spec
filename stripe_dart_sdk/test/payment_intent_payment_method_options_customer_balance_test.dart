...
// tests for PaymentIntentPaymentMethodOptionsCustomerBalance
void main() {
  final instance = PaymentIntentPaymentMethodOptionsCustomerBalanceBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsCustomerBalance, () {
