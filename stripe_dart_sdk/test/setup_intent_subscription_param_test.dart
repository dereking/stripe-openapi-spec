...
// tests for SetupIntentSubscriptionParam
void main() {
  final instance = SetupIntentSubscriptionParamBuilder();
  // TODO add properties to the builder and call build()

  group(SetupIntentSubscriptionParam, () {
    // String interval
    ...
    test('to test the property `nextBilling`', () async {
      // TODO
    });
