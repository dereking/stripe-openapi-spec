...
void main() {
  final instance = BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoiceBuilder();
  // TODO add properties to the builder and call build()

  group(BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice, () {
