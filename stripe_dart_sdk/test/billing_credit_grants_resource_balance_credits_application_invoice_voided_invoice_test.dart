...
// tests for BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice
void main() {
  // final instance = BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice();

  group('test BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice', () {
    ...
    // List<InvoiceSettingCustomField> customFields (default value: const [])
    ...
    // List<InvoicesResourceInvoiceTaxId> customerTaxIds (default value: const [])
    ...
    // List<InvoiceDiscountsInner> discounts (default value: const [])
    ...
    // List<DiscountsResourceDiscountAmount> totalDiscountAmounts (default value: const [])
    ...
    // List<InvoicesResourcePretaxCreditAmount> totalPretaxCreditAmounts (default value: const [])
    test('to test the property `totalPretaxCreditAmounts`', () async {
      // TODO
    });

    // The aggregate tax information of all line items.
    // List<BillingBillResourceInvoicingTaxesTax> totalTaxes (default value: const [])
