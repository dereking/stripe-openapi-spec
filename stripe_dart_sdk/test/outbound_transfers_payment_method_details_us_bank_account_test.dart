...
// tests for OutboundTransfersPaymentMethodDetailsUsBankAccount
void main() {
  final instance = OutboundTransfersPaymentMethodDetailsUsBankAccountBuilder();
  // TODO add properties to the builder and call build()

  group(OutboundTransfersPaymentMethodDetailsUsBankAccount, () {
