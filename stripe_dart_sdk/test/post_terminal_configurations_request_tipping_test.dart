...
// tests for PostTerminalConfigurationsRequestTipping
void main() {
  final instance = PostTerminalConfigurationsRequestTippingBuilder();
  // TODO add properties to the builder and call build()

  group(PostTerminalConfigurationsRequestTipping, () {
