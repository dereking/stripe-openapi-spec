...
void main() {
  final instance = SubscriptionSchedulePhaseConfigurationBuilder();
  // TODO add properties to the builder and call build()

  group(SubscriptionSchedulePhaseConfiguration, () {
    // A list of prices and quantities that will generate invoice items appended to the next invoice for this phase.
    // BuiltList<SubscriptionScheduleAddInvoiceItem> addInvoiceItems
    ...
    // BuiltList<SubscriptionScheduleConfigurationItem> items
