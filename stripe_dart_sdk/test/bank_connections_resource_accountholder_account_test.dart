...
// tests for BankConnectionsResourceAccountholderAccount
void main() {
  final instance = BankConnectionsResourceAccountholderAccountBuilder();
  // TODO add properties to the builder and call build()

  group(BankConnectionsResourceAccountholderAccount, () {
