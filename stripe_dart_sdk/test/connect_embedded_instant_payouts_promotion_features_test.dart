...
// tests for ConnectEmbeddedInstantPayoutsPromotionFeatures
void main() {
  final instance = ConnectEmbeddedInstantPayoutsPromotionFeaturesBuilder();
  // TODO add properties to the builder and call build()

  group(ConnectEmbeddedInstantPayoutsPromotionFeatures, () {
