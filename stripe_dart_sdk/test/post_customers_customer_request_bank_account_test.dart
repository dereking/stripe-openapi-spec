...
// tests for PostCustomersCustomerRequestBankAccount
void main() {
  // final instance = PostCustomersCustomerRequestBankAccount();

  group('test PostCustomersCustomerRequestBankAccount', () {
