...
// tests for PaymentIntentPaymentMethodOptionsKakaoPay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsKakaoPayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsKakaoPay, () {
