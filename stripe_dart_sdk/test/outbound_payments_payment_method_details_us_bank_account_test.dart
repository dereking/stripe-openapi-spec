...
// tests for OutboundPaymentsPaymentMethodDetailsUsBankAccount
void main() {
  final instance = OutboundPaymentsPaymentMethodDetailsUsBankAccountBuilder();
  // TODO add properties to the builder and call build()

  group(OutboundPaymentsPaymentMethodDetailsUsBankAccount, () {
