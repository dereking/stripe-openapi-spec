...
// tests for CustomerCashBalanceTransactionCustomer
void main() {
  // final instance = CustomerCashBalanceTransactionCustomer();

  group('test CustomerCashBalanceTransactionCustomer', () {
    // Address address
