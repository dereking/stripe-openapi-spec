...
// tests for SetupAttemptPaymentMethodDetailsSofort
void main() {
  final instance = SetupAttemptPaymentMethodDetailsSofortBuilder();
  // TODO add properties to the builder and call build()

  group(SetupAttemptPaymentMethodDetailsSofort, () {
