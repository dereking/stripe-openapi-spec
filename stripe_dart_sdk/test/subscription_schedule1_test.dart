...
// tests for SubscriptionSchedule1
void main() {
  final instance = SubscriptionSchedule1Builder();
  // TODO add properties to the builder and call build()

  group(SubscriptionSchedule1, () {
    ...
    // BuiltList<SubscriptionSchedulePhaseConfiguration> phases
