...
// tests for PaymentIntentPaymentMethodOptionsCashapp
void main() {
  final instance = PaymentIntentPaymentMethodOptionsCashappBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsCashapp, () {
