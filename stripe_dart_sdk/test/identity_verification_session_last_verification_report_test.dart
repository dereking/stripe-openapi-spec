...
// tests for IdentityVerificationSessionLastVerificationReport
void main() {
  final instance = IdentityVerificationSessionLastVerificationReportBuilder();
  // TODO add properties to the builder and call build()

  group(IdentityVerificationSessionLastVerificationReport, () {
    ...
    test('to test the property `verificationSession`', () async {
      // TODO
    });
