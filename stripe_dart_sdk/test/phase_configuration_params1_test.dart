...
// tests for PhaseConfigurationParams1
void main() {
  final instance = PhaseConfigurationParams1Builder();
  // TODO add properties to the builder and call build()

  group(PhaseConfigurationParams1, () {
    ...
    // BuiltList<ConfigurationItemParams> items
