...
// tests for DisputeVisaCompellingEvidence3DisputedTransaction
void main() {
  final instance = DisputeVisaCompellingEvidence3DisputedTransactionBuilder();
  // TODO add properties to the builder and call build()

  group(DisputeVisaCompellingEvidence3DisputedTransaction, () {
    ...
    test('to test the property `merchandiseOrServices`', () async {
      // TODO
    });
