...
// tests for SetupAttemptPaymentMethodDetailsBancontactGeneratedSepaDebit
void main() {
  final instance = SetupAttemptPaymentMethodDetailsBancontactGeneratedSepaDebitBuilder();
  // TODO add properties to the builder and call build()

  group(SetupAttemptPaymentMethodDetailsBancontactGeneratedSepaDebit, () {
