...
// tests for PaymentIntentPaymentMethodOptionsGiropay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsGiropayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsGiropay, () {
