...
// tests for PaymentMethodOptionsParam19UsBankAccount
void main() {
  // final instance = PaymentMethodOptionsParam19UsBankAccount();

  group('test PaymentMethodOptionsParam19UsBankAccount', () {
