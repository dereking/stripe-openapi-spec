...
void main() {
  // final instance = FinancialConnectionsAccount();

  group('test FinancialConnectionsAccount', () {
    ...
    // List<String> subscriptions (default value: const [])
    test('to test the property `subscriptions`', () async {
      // TODO
    });

    // The [PaymentMethod type](https://stripe.com/docs/api/payment_methods/object#payment_method_object-type)(s) that can be created from this account.
    // List<String> supportedPaymentMethodTypes (default value: const [])
