...
// tests for ConnectJsAccountTokenCompanySpecs
void main() {
  final instance = ConnectJsAccountTokenCompanySpecsBuilder();
  // TODO add properties to the builder and call build()

  group(ConnectJsAccountTokenCompanySpecs, () {
    ...
    // CompanyDirectorshipDeclaration directorshipDeclaration
    ...
    test('to test the property `ownershipDeclarationShownAndSigned`', () async {
      // TODO
    });
    ...
    // CompanySpecsRegistrationDate registrationDate
