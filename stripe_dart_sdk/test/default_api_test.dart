...
void main() {
  final instance = StripeDartSdk().getDefaultApi();
  ...
  group(DefaultApi, () {
    ...
    //
    //Future<DeleteCustomersCustomerBankAccountsId200Response> deleteCustomersCustomerBankAccountsId(String customer, String id, { BuiltList<String> expand }) async
    ...
    // <p>Delete a specified source for a given customer.</p>
    //
    //Future<DeleteCustomersCustomerBankAccountsId200Response> deleteCustomersCustomerCardsId(String customer, String id, { BuiltList<String> expand }) async
    ...
    // <p>Delete a specified source for a given customer.</p>
    //
    //Future<DeleteCustomersCustomerBankAccountsId200Response> deleteCustomersCustomerSourcesId(String customer, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<Subscription> deleteCustomersCustomerSubscriptionsSubscriptionExposedId(String customer, String subscriptionExposedId, { BuiltList<String> expand, bool invoiceNow, bool prorate }) async
    ...
    //
    //Future<EphemeralKey> deleteEphemeralKeysKey(String key, { BuiltList<String> expand }) async
    ...
    //
    //Future<Subscription> deleteSubscriptionsSubscriptionExposedId(String subscriptionExposedId, { CancellationDetailsParam cancellationDetails, BuiltList<String> expand, bool invoiceNow, bool prorate }) async
    ...
    //
    //Future<Account> getAccount({ BuiltList<String> expand }) async
    ...
    //
    //Future<AccountList> getAccounts({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    // <p>Retrieves the details of an account.</p>
    //
    //Future<Account> getAccountsAccount(String account, { BuiltList<String> expand }) async
    ...
    //
    //Future<ExternalAccount> getAccountsAccountBankAccountsId(String account, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<ListAccountCapability> getAccountsAccountCapabilities(String account, { BuiltList<String> expand }) async
    ...
    //
    //Future<Capability> getAccountsAccountCapabilitiesCapability(String account, String capability, { BuiltList<String> expand }) async
    ...
    //
    //Future<ExternalAccountList> getAccountsAccountExternalAccounts(String account, { String endingBefore, BuiltList<String> expand, int limit, String object, String startingAfter }) async
    ...
    // <p>Retrieve a specified external account for a given account.</p>
    //
    //Future<ExternalAccount> getAccountsAccountExternalAccountsId(String account, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<PersonList> getAccountsAccountPeople(String account, { String endingBefore, BuiltList<String> expand, int limit, AllPeopleRelationshipSpecs relationship, String startingAfter }) async
    ...
    //
    //Future<Person> getAccountsAccountPeoplePerson(String account, String person, { BuiltList<String> expand }) async
    ...
    // <p>Returns a list of people associated with the account’s legal entity. The people are returned sorted by creation date, with the most recent people appearing first.</p>
    //
    //Future<PersonList> getAccountsAccountPersons(String account, { String endingBefore, BuiltList<String> expand, int limit, AllPeopleRelationshipSpecs relationship, String startingAfter }) async
    ...
    // <p>Retrieves an existing person.</p>
    //
    //Future<Person> getAccountsAccountPersonsPerson(String account, String person, { BuiltList<String> expand }) async
    ...
    //
    //Future<ApplePayDomainList> getApplePayDomains({ String domainName, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ApplePayDomain> getApplePayDomainsDomain(String domain, { BuiltList<String> expand }) async
    ...
    //
    //Future<PlatformEarningList> getApplicationFees({ String charge, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<FeeRefund> getApplicationFeesFeeRefundsId(String fee, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<ApplicationFee> getApplicationFeesId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<FeeRefundList> getApplicationFeesIdRefunds(String id, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<SecretServiceResourceSecretList> getAppsSecrets(ScopeParam scope, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<AppsSecret> getAppsSecretsFind(String name, ScopeParam scope, { BuiltList<String> expand }) async
    ...
    //
    //Future<Balance> getBalance({ BuiltList<String> expand }) async
    ...
    //
    //Future<BalanceTransactionsList> getBalanceHistory({ GetAccountsCreatedParameter created, String currency, String endingBefore, BuiltList<String> expand, int limit, String payout, String source_, String startingAfter, String type }) async
    ...
    //
    //Future<BalanceTransaction> getBalanceHistoryId(String id, { BuiltList<String> expand }) async
    ...
    // <p>Returns a list of transactions that have contributed to the Stripe account balance (e.g., charges, transfers, and so forth). The transactions are returned in sorted order, with the most recent transactions appearing first.</p>  <p>Note that this endpoint was previously called “Balance history” and used the path <code>/v1/balance/history</code>.</p>
    //
    //Future<BalanceTransactionsList> getBalanceTransactions({ GetAccountsCreatedParameter created, String currency, String endingBefore, BuiltList<String> expand, int limit, String payout, String source_, String startingAfter, String type }) async
    ...
    // <p>Retrieves the balance transaction with the given ID.</p>  <p>Note that this endpoint previously used the path <code>/v1/balance/history/:id</code>.</p>
    //
    //Future<BalanceTransaction> getBalanceTransactionsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<ThresholdsResourceAlertList> getBillingAlerts({ String alertType, String endingBefore, BuiltList<String> expand, int limit, String meter, String startingAfter }) async
    ...
    //
    //Future<BillingAlert> getBillingAlertsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingCreditBalanceSummary> getBillingCreditBalanceSummary(String customer, BalanceSummaryFilterParam filter, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingCreditGrantsResourceBalanceTransactionList> getBillingCreditBalanceTransactions(String customer, { String creditGrant, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<BillingCreditBalanceTransaction> getBillingCreditBalanceTransactionsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingCreditGrantsResourceCreditGrantList> getBillingCreditGrants({ String customer, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<BillingCreditGrant> getBillingCreditGrantsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingMeterResourceBillingMeterList> getBillingMeters({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<BillingMeter> getBillingMetersId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingMeterResourceBillingMeterEventSummaryList> getBillingMetersIdEventSummaries(String customer, int endTime, String id, int startTime, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String valueGroupingWindow }) async
    ...
    //
    //Future<PortalPublicResourceConfigurationList> getBillingPortalConfigurations({ bool active, String endingBefore, BuiltList<String> expand, bool isDefault, int limit, String startingAfter }) async
    ...
    //
    //Future<BillingPortalConfiguration> getBillingPortalConfigurationsConfiguration(String configuration, { BuiltList<String> expand }) async
    ...
    //
    //Future<ChargeList> getCharges({ GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, int limit, String paymentIntent, String startingAfter, String transferGroup }) async
    ...
    //
    //Future<Charge> getChargesCharge(String charge, { BuiltList<String> expand }) async
    ...
    //
    //Future<Dispute> getChargesChargeDispute(String charge, { BuiltList<String> expand }) async
    ...
    //
    //Future<RefundList> getChargesChargeRefunds(String charge, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Refund> getChargesChargeRefundsRefund(String charge, String refund, { BuiltList<String> expand }) async
    ...
    //
    //Future<SearchResult> getChargesSearch(String query, { BuiltList<String> expand, int limit, String page }) async
    ...
    //
    //Future<PaymentPagesCheckoutSessionList> getCheckoutSessions({ GetAccountsCreatedParameter created, String customer, CustomerDetailsParams customerDetails, String endingBefore, BuiltList<String> expand, int limit, String paymentIntent, String paymentLink, String startingAfter, String status, String subscription }) async
    ...
    //
    //Future<CheckoutSession> getCheckoutSessionsSession(String session, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentPagesCheckoutSessionListLineItems> getCheckoutSessionsSessionLineItems(String session, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ClimateRemovalsOrdersList> getClimateOrders({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ClimateOrder> getClimateOrdersOrder(String order, { BuiltList<String> expand }) async
    ...
    //
    //Future<ClimateRemovalsProductsList> getClimateProducts({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ClimateProduct> getClimateProductsProduct(String product, { BuiltList<String> expand }) async
    ...
    //
    //Future<ClimateRemovalsSuppliersList> getClimateSuppliers({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ClimateSupplier> getClimateSuppliersSupplier(String supplier, { BuiltList<String> expand }) async
    ...
    //
    //Future<ConfirmationToken> getConfirmationTokensConfirmationToken(String confirmationToken, { BuiltList<String> expand }) async
    ...
    //
    //Future<CountrySpecList> getCountrySpecs({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<CountrySpec> getCountrySpecsCountry(String country, { BuiltList<String> expand }) async
    ...
    //
    //Future<CouponsResourceCouponList> getCoupons({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Coupon> getCouponsCoupon(String coupon, { BuiltList<String> expand }) async
    ...
    //
    //Future<CreditNotesList> getCreditNotes({ GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, String invoice, int limit, String startingAfter }) async
    ...
    //
    //Future<CreditNoteLinesList> getCreditNotesCreditNoteLines(String creditNote, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<CreditNote> getCreditNotesId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<CreditNote> getCreditNotesPreview(String invoice, { int amount, int creditAmount, int effectiveAt, String emailType, BuiltList<String> expand, BuiltList<CreditNoteLineItemParams> lines, String memo, BuiltMap<String, String> metadata, int outOfBandAmount, String reason, int refundAmount, BuiltList<CreditNoteRefundParams> refunds, CreditNoteShippingCost1 shippingCost }) async
    ...
    //
    //Future<CreditNoteLinesList> getCreditNotesPreviewLines(String invoice, { int amount, int creditAmount, int effectiveAt, String emailType, String endingBefore, BuiltList<String> expand, int limit, BuiltList<CreditNoteLineItemParams> lines, String memo, BuiltMap<String, String> metadata, int outOfBandAmount, String reason, int refundAmount, BuiltList<CreditNoteRefundParams> refunds, CreditNoteShippingCost1 shippingCost, String startingAfter }) async
    ...
    //
    //Future<CustomerResourceCustomerList> getCustomers({ GetAccountsCreatedParameter created, String email, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String testClock }) async
    ...
    //
    //Future<GetCustomersCustomer200Response> getCustomersCustomer(String customer, { BuiltList<String> expand }) async
    ...
    //
    //Future<CustomerBalanceTransactionList> getCustomersCustomerBalanceTransactions(String customer, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<CustomerBalanceTransaction> getCustomersCustomerBalanceTransactionsTransaction(String customer, String transaction, { BuiltList<String> expand }) async
    ...
    //
    //Future<BankAccountList> getCustomersCustomerBankAccounts(String customer, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<BankAccount> getCustomersCustomerBankAccountsId(String customer, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<CardList> getCustomersCustomerCards(String customer, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Card> getCustomersCustomerCardsId(String customer, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<CashBalance> getCustomersCustomerCashBalance(String customer, { BuiltList<String> expand }) async
    ...
    //
    //Future<CustomerCashBalanceTransactionList> getCustomersCustomerCashBalanceTransactions(String customer, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<CustomerCashBalanceTransaction> getCustomersCustomerCashBalanceTransactionsTransaction(String customer, String transaction, { BuiltList<String> expand }) async
    ...
    // 
    //
    //Future<Discount> getCustomersCustomerDiscount(String customer, { BuiltList<String> expand }) async
    ...
    //
    //Future<CustomerPaymentMethodResourceList> getCustomersCustomerPaymentMethods(String customer, { String allowRedisplay, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String type }) async
    ...
    //
    //Future<PaymentMethod> getCustomersCustomerPaymentMethodsPaymentMethod(String customer, String paymentMethod, { BuiltList<String> expand }) async
    ...
    //
    //Future<ApmsSourcesSourceList> getCustomersCustomerSources(String customer, { String endingBefore, BuiltList<String> expand, int limit, String object, String startingAfter }) async
    ...
    //
    //Future<PaymentSource> getCustomersCustomerSourcesId(String customer, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<SubscriptionList> getCustomersCustomerSubscriptions(String customer, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Subscription> getCustomersCustomerSubscriptionsSubscriptionExposedId(String customer, String subscriptionExposedId, { BuiltList<String> expand }) async
    ...
    // 
    //
    //Future<Discount> getCustomersCustomerSubscriptionsSubscriptionExposedIdDiscount(String customer, String subscriptionExposedId, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxIDsList> getCustomersCustomerTaxIds(String customer, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<TaxId> getCustomersCustomerTaxIdsId(String customer, String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<SearchResult1> getCustomersSearch(String query, { BuiltList<String> expand, int limit, String page }) async
    ...
    //
    //Future<DisputeList> getDisputes({ String charge, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String paymentIntent, String startingAfter }) async
    ...
    //
    //Future<Dispute> getDisputesDispute(String dispute, { BuiltList<String> expand }) async
    ...
    //
    //Future<EntitlementsResourceCustomerEntitlementList> getEntitlementsActiveEntitlements(String customer, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<EntitlementsActiveEntitlement> getEntitlementsActiveEntitlementsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<EntitlementsResourceFeatureList> getEntitlementsFeatures({ bool archived, String endingBefore, BuiltList<String> expand, int limit, String lookupKey, String startingAfter }) async
    ...
    //
    //Future<EntitlementsFeature> getEntitlementsFeaturesId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<NotificationEventList> getEvents({ GetAccountsCreatedParameter created, bool deliverySuccess, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String type, BuiltList<String> types }) async
    ...
    //
    //Future<Event> getEventsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<ExchangeRateList> getExchangeRates({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ExchangeRate> getExchangeRatesRateId(String rateId, { BuiltList<String> expand }) async
    ...
    //
    //Future<FileResourceFileLinkList> getFileLinks({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, bool expired, String file, int limit, String startingAfter }) async
    ...
    //
    //Future<FileLink> getFileLinksLink(String link, { BuiltList<String> expand }) async
    ...
    //
    //Future<FileResourceFileList> getFiles({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String purpose, String startingAfter }) async
    ...
    //
    //Future<Uint8List> getFilesFile(String file, { BuiltList<String> expand }) async
    ...
    //
    //Future<BankConnectionsResourceLinkedAccountList> getFinancialConnectionsAccounts({ AccountholderParams accountHolder, String endingBefore, BuiltList<String> expand, int limit, String session, String startingAfter }) async
    ...
    //
    //Future<FinancialConnectionsAccount> getFinancialConnectionsAccountsAccount(String account, { BuiltList<String> expand }) async
    ...
    //
    //Future<BankConnectionsResourceOwnerList> getFinancialConnectionsAccountsAccountOwners(String account, String ownership, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<FinancialConnectionsSession> getFinancialConnectionsSessionsSession(String session, { BuiltList<String> expand }) async
    ...
    //
    //Future<BankConnectionsResourceTransactionList> getFinancialConnectionsTransactions(String account, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter, GetAccountsCreatedParameter transactedAt, TransactionRefreshParams transactionRefresh }) async
    ...
    //
    //Future<FinancialConnectionsTransaction> getFinancialConnectionsTransactionsTransaction(String transaction, { BuiltList<String> expand }) async
    ...
    //
    //Future<ForwardingRequestList> getForwardingRequests({ CreatedParam created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ForwardingRequest> getForwardingRequestsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<GelatoVerificationReportList> getIdentityVerificationReports({ String clientReferenceId, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String type, String verificationSession }) async
    ...
    //
    //Future<IdentityVerificationReport> getIdentityVerificationReportsReport(String report, { BuiltList<String> expand }) async
    ...
    //
    //Future<GelatoVerificationSessionList> getIdentityVerificationSessions({ String clientReferenceId, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String relatedCustomer, String startingAfter, String status }) async
    ...
    //
    //Future<IdentityVerificationSession> getIdentityVerificationSessionsSession(String session, { BuiltList<String> expand }) async
    ...
    //
    //Future<InvoicesPaymentsListInvoicePayments> getInvoicePayments({ String endingBefore, BuiltList<String> expand, String invoice, int limit, PaymentParam payment, String startingAfter, String status }) async
    ...
    //
    //Future<InvoicePayment> getInvoicePaymentsInvoicePayment(String invoicePayment, { BuiltList<String> expand }) async
    ...
    //
    //Future<InvoiceRenderingTemplatesList> getInvoiceRenderingTemplates({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<InvoiceRenderingTemplate> getInvoiceRenderingTemplatesTemplate(String template, { BuiltList<String> expand, int version }) async
    ...
    //
    //Future<InvoicesItemsList> getInvoiceitems({ GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, String invoice, int limit, bool pending, String startingAfter }) async
    ...
    //
    //Future<Invoiceitem> getInvoiceitemsInvoiceitem(String invoiceitem, { BuiltList<String> expand }) async
    ...
    //
    //Future<InvoicesResourceList> getInvoices({ String collectionMethod, GetAccountsCreatedParameter created, String customer, GetAccountsCreatedParameter dueDate, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status, String subscription }) async
    ...
    //
    //Future<Invoice> getInvoicesInvoice(String invoice, { BuiltList<String> expand }) async
    ...
    //
    //Future<InvoiceLinesList> getInvoicesInvoiceLines(String invoice, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<SearchResult2> getInvoicesSearch(String query, { BuiltList<String> expand, int limit, String page }) async
    ...
    //
    //Future<IssuingAuthorizationList> getIssuingAuthorizations({ String card, String cardholder, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<IssuingAuthorization> getIssuingAuthorizationsAuthorization(String authorization, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingCardholderList> getIssuingCardholders({ GetAccountsCreatedParameter created, String email, String endingBefore, BuiltList<String> expand, int limit, String phoneNumber, String startingAfter, String status, String type }) async
    ...
    //
    //Future<IssuingCardholder> getIssuingCardholdersCardholder(String cardholder, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingCardList> getIssuingCards({ String cardholder, GetAccountsCreatedParameter created, String endingBefore, int expMonth, int expYear, BuiltList<String> expand, String last4, int limit, String personalizationDesign, String startingAfter, String status, String type }) async
    ...
    //
    //Future<IssuingCard> getIssuingCardsCard(String card, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingDisputeList> getIssuingDisputes({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status, String transaction }) async
    ...
    //
    //Future<IssuingDispute> getIssuingDisputesDispute(String dispute, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingPersonalizationDesignList> getIssuingPersonalizationDesigns({ String endingBefore, BuiltList<String> expand, int limit, BuiltList<String> lookupKeys, PreferencesListParam preferences, String startingAfter, String status }) async
    ...
    //
    //Future<IssuingPersonalizationDesign> getIssuingPersonalizationDesignsPersonalizationDesign(String personalizationDesign, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingPhysicalBundleList> getIssuingPhysicalBundles({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status, String type }) async
    ...
    //
    //Future<IssuingPhysicalBundle> getIssuingPhysicalBundlesPhysicalBundle(String physicalBundle, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingSettlement> getIssuingSettlementsSettlement(String settlement, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingNetworkTokenList> getIssuingTokens(String card, { GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<IssuingToken> getIssuingTokensToken(String token, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingTransactionList> getIssuingTransactions({ String card, String cardholder, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String type }) async
    ...
    //
    //Future<IssuingTransaction> getIssuingTransactionsTransaction(String transaction, { BuiltList<String> expand }) async
    ...
    // <p>Retrieves the details of a Financial Connections <code>Session</code></p>
    //
    //Future<FinancialConnectionsSession> getLinkAccountSessionsSession(String session, { BuiltList<String> expand }) async
    ...
    // <p>Returns a list of Financial Connections <code>Account</code> objects.</p>
    //
    //Future<BankConnectionsResourceLinkedAccountList> getLinkedAccounts({ AccountholderParams accountHolder, String endingBefore, BuiltList<String> expand, int limit, String session, String startingAfter }) async
    ...
    // <p>Retrieves the details of an Financial Connections <code>Account</code>.</p>
    //
    //Future<FinancialConnectionsAccount> getLinkedAccountsAccount(String account, { BuiltList<String> expand }) async
    ...
    // <p>Lists all owners for a given <code>Account</code></p>
    //
    //Future<BankConnectionsResourceOwnerList> getLinkedAccountsAccountOwners(String account, String ownership, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Mandate> getMandatesMandate(String mandate, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentFlowsPaymentIntentList> getPaymentIntents({ GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<PaymentIntent> getPaymentIntentsIntent(String intent, { String clientSecret, BuiltList<String> expand }) async
    ...
    //
    //Future<SearchResult3> getPaymentIntentsSearch(String query, { BuiltList<String> expand, int limit, String page }) async
    ...
    //
    //Future<PaymentLinksResourcePaymentLinkList> getPaymentLinks({ bool active, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<PaymentLink> getPaymentLinksPaymentLink(String paymentLink, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentLinksResourceListLineItems> getPaymentLinksPaymentLinkLineItems(String paymentLink, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<PaymentMethodConfigResourcePaymentMethodConfigurationsList> getPaymentMethodConfigurations({ GetPaymentMethodConfigurationsApplicationParameter application, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<PaymentMethodConfiguration> getPaymentMethodConfigurationsConfiguration(String configuration, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentMethodDomainResourcePaymentMethodDomainList> getPaymentMethodDomains({ String domainName, bool enabled, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<PaymentMethodDomain> getPaymentMethodDomainsPaymentMethodDomain(String paymentMethodDomain, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentFlowsPaymentMethodList> getPaymentMethods({ String customer, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String type }) async
    ...
    //
    //Future<PaymentMethod> getPaymentMethodsPaymentMethod(String paymentMethod, { BuiltList<String> expand }) async
    ...
    //
    //Future<PayoutList> getPayouts({ GetAccountsCreatedParameter arrivalDate, GetAccountsCreatedParameter created, String destination, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<Payout> getPayoutsPayout(String payout, { BuiltList<String> expand }) async
    ...
    //
    //Future<PlanList> getPlans({ bool active, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String product, String startingAfter }) async
    ...
    //
    //Future<Plan> getPlansPlan(String plan, { BuiltList<String> expand }) async
    ...
    //
    //Future<PriceList> getPrices({ bool active, GetAccountsCreatedParameter created, String currency, String endingBefore, BuiltList<String> expand, int limit, BuiltList<String> lookupKeys, String product, AllPricesRecurringParams recurring, String startingAfter, String type }) async
    ...
    //
    //Future<Price> getPricesPrice(String price, { BuiltList<String> expand }) async
    ...
    //
    //Future<SearchResult4> getPricesSearch(String query, { BuiltList<String> expand, int limit, String page }) async
    ...
    //
    //Future<ProductList> getProducts({ bool active, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, BuiltList<String> ids, int limit, bool shippable, String startingAfter, String url }) async
    ...
    //
    //Future<Product> getProductsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<EntitlementsResourceProductFeatureList> getProductsProductFeatures(String product, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ProductFeature> getProductsProductFeaturesId(String id, String product, { BuiltList<String> expand }) async
    ...
    //
    //Future<SearchResult5> getProductsSearch(String query, { BuiltList<String> expand, int limit, String page }) async
    ...
    //
    //Future<PromotionCodesResourcePromotionCodeList> getPromotionCodes({ bool active, String code, String coupon, GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<PromotionCode> getPromotionCodesPromotionCode(String promotionCode, { BuiltList<String> expand }) async
    ...
    //
    //Future<QuotesResourceQuoteList> getQuotes({ String customer, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status, String testClock }) async
    ...
    //
    //Future<Quote> getQuotesQuote(String quote, { BuiltList<String> expand }) async
    ...
    //
    //Future<QuotesResourceListLineItems> getQuotesQuoteComputedUpfrontLineItems(String quote, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<QuotesResourceListLineItems> getQuotesQuoteLineItems(String quote, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Uint8List> getQuotesQuotePdf(String quote, { BuiltList<String> expand }) async
    ...
    //
    //Future<RadarEarlyFraudWarningList> getRadarEarlyFraudWarnings({ String charge, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String paymentIntent, String startingAfter }) async
    ...
    //
    //Future<RadarEarlyFraudWarning> getRadarEarlyFraudWarningsEarlyFraudWarning(String earlyFraudWarning, { BuiltList<String> expand }) async
    ...
    //
    //Future<RadarListListItemList> getRadarValueListItems(String valueList, { GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String value }) async
    ...
    //
    //Future<RadarValueListItem> getRadarValueListItemsItem(String item, { BuiltList<String> expand }) async
    ...
    //
    //Future<RadarListListList> getRadarValueLists({ String alias, String contains, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<RadarValueList> getRadarValueListsValueList(String valueList, { BuiltList<String> expand }) async
    ...
    //
    //Future<APIMethodRefundList> getRefunds({ String charge, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String paymentIntent, String startingAfter }) async
    ...
    // <p>Retrieves the details of an existing refund.</p>
    //
    //Future<Refund> getRefundsRefund(String refund, { BuiltList<String> expand }) async
    ...
    //
    //Future<FinancialReportingFinanceReportRunList> getReportingReportRuns({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ReportingReportRun> getReportingReportRunsReportRun(String reportRun, { BuiltList<String> expand }) async
    ...
    //
    //Future<FinancialReportingFinanceReportTypeList> getReportingReportTypes({ BuiltList<String> expand }) async
    ...
    //
    //Future<ReportingReportType> getReportingReportTypesReportType(String reportType, { BuiltList<String> expand }) async
    ...
    //
    //Future<RadarReviewList> getReviews({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Review> getReviewsReview(String review, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentFlowsSetupIntentSetupAttemptList> getSetupAttempts(String setupIntent, { GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<PaymentFlowsSetupIntentList> getSetupIntents({ bool attachToSelf, GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, int limit, String paymentMethod, String startingAfter }) async
    ...
    //
    //Future<SetupIntent> getSetupIntentsIntent(String intent, { String clientSecret, BuiltList<String> expand }) async
    ...
    //
    //Future<ShippingResourcesShippingRateList> getShippingRates({ bool active, GetAccountsCreatedParameter created, String currency, String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ShippingRate> getShippingRatesShippingRateToken(String shippingRateToken, { BuiltList<String> expand }) async
    ...
    //
    //Future<SigmaScheduledQueryRunList> getSigmaScheduledQueryRuns({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<ScheduledQueryRun> getSigmaScheduledQueryRunsScheduledQueryRun(String scheduledQueryRun, { BuiltList<String> expand }) async
    ...
    //
    //Future<ModelSource> getSourcesSource(String source_, { String clientSecret, BuiltList<String> expand }) async
    ...
    //
    //Future<SourceMandateNotification> getSourcesSourceMandateNotificationsMandateNotification(String mandateNotification, String source_, { BuiltList<String> expand }) async
    ...
    //
    //Future<ApmsSourcesSourceTransactionList> getSourcesSourceSourceTransactions(String source_, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<SourceTransaction> getSourcesSourceSourceTransactionsSourceTransaction(String source_, String sourceTransaction, { BuiltList<String> expand }) async
    ...
    //
    //Future<SubscriptionsItemsSubscriptionItemList> getSubscriptionItems(String subscription, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<SubscriptionItem> getSubscriptionItemsItem(String item, { BuiltList<String> expand }) async
    ...
    //
    //Future<SubscriptionSchedulesResourceScheduleList> getSubscriptionSchedules({ GetAccountsCreatedParameter canceledAt, GetAccountsCreatedParameter completedAt, GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, int limit, GetAccountsCreatedParameter releasedAt, bool scheduled, String startingAfter }) async
    ...
    //
    //Future<SubscriptionSchedule> getSubscriptionSchedulesSchedule(String schedule, { BuiltList<String> expand }) async
    ...
    //
    //Future<SubscriptionsSubscriptionList> getSubscriptions({ AutomaticTaxFilterParams automaticTax, String collectionMethod, GetAccountsCreatedParameter created, GetAccountsCreatedParameter currentPeriodEnd, GetAccountsCreatedParameter currentPeriodStart, String customer, String endingBefore, BuiltList<String> expand, int limit, String price, String startingAfter, String status, String testClock }) async
    ...
    //
    //Future<SearchResult6> getSubscriptionsSearch(String query, { BuiltList<String> expand, int limit, String page }) async
    ...
    // <p>Retrieves the subscription with the given ID.</p>
    //
    //Future<Subscription> getSubscriptionsSubscriptionExposedId(String subscriptionExposedId, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxCalculation> getTaxCalculationsCalculation(String calculation, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxProductResourceTaxCalculationLineItemList> getTaxCalculationsCalculationLineItems(String calculation, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<TaxProductResourceTaxCodeList> getTaxCodes({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<TaxCode> getTaxCodesId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxIDsList> getTaxIds({ String endingBefore, BuiltList<String> expand, int limit, OwnerParams owner, String startingAfter }) async
    ...
    //
    //Future<TaxId> getTaxIdsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxRatesList> getTaxRates({ bool active, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, bool inclusive, int limit, String startingAfter }) async
    ...
    //
    //Future<TaxRate> getTaxRatesTaxRate(String taxRate, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxProductRegistrationsResourceTaxRegistrationList> getTaxRegistrations({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<TaxRegistration> getTaxRegistrationsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxSettings> getTaxSettings({ BuiltList<String> expand }) async
    ...
    //
    //Future<TaxTransaction> getTaxTransactionsTransaction(String transaction, { BuiltList<String> expand }) async
    ...
    //
    //Future<TaxProductResourceTaxTransactionLineItemList> getTaxTransactionsTransactionLineItems(String transaction, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<TerminalConfigurationConfigurationList> getTerminalConfigurations({ String endingBefore, BuiltList<String> expand, bool isAccountDefault, int limit, String startingAfter }) async
    ...
    //
    //Future<GetTerminalConfigurationsConfiguration200Response> getTerminalConfigurationsConfiguration(String configuration, { BuiltList<String> expand }) async
    ...
    //
    //Future<TerminalLocationLocationList> getTerminalLocations({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<GetTerminalLocationsLocation200Response> getTerminalLocationsLocation(String location, { BuiltList<String> expand }) async
    ...
    //
    //Future<TerminalReaderRetrieveReader> getTerminalReaders({ String deviceType, String endingBefore, BuiltList<String> expand, int limit, String location, String serialNumber, String startingAfter, String status }) async
    ...
    //
    //Future<GetTerminalReadersReader200Response> getTerminalReadersReader(String reader, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingClocksResourceBillingClockList> getTestHelpersTestClocks({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<TestHelpersTestClock> getTestHelpersTestClocksTestClock(String testClock, { BuiltList<String> expand }) async
    ...
    //
    //Future<Token> getTokensToken(String token, { BuiltList<String> expand }) async
    ...
    //
    //Future<TopupList> getTopups({ GetAccountsCreatedParameter amount, GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<Topup> getTopupsTopup(String topup, { BuiltList<String> expand }) async
    ...
    //
    //Future<TransferList> getTransfers({ GetAccountsCreatedParameter created, String destination, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String transferGroup }) async
    ...
    //
    //Future<TransferReversalList> getTransfersIdReversals(String id, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<Transfer> getTransfersTransfer(String transfer, { BuiltList<String> expand }) async
    ...
    //
    //Future<TransferReversal> getTransfersTransferReversalsId(String id, String transfer, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryReceivedCreditsResourceCreditReversalList> getTreasuryCreditReversals(String financialAccount, { String endingBefore, BuiltList<String> expand, int limit, String receivedCredit, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryCreditReversal> getTreasuryCreditReversalsCreditReversal(String creditReversal, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryReceivedDebitsResourceDebitReversalList> getTreasuryDebitReversals(String financialAccount, { String endingBefore, BuiltList<String> expand, int limit, String receivedDebit, String resolution, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryDebitReversal> getTreasuryDebitReversalsDebitReversal(String debitReversal, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryFinancialAccountsResourceFinancialAccountList> getTreasuryFinancialAccounts({ GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryFinancialAccount> getTreasuryFinancialAccountsFinancialAccount(String financialAccount, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryFinancialAccountFeatures> getTreasuryFinancialAccountsFinancialAccountFeatures(String financialAccount, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryInboundTransfersResourceInboundTransferList> getTreasuryInboundTransfers(String financialAccount, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryInboundTransfer> getTreasuryInboundTransfersId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundPaymentsResourceOutboundPaymentList> getTreasuryOutboundPayments(String financialAccount, { GetAccountsCreatedParameter created, String customer, String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryOutboundPayment> getTreasuryOutboundPaymentsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundTransfersResourceOutboundTransferList> getTreasuryOutboundTransfers(String financialAccount, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryOutboundTransfer> getTreasuryOutboundTransfersOutboundTransfer(String outboundTransfer, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryReceivedCreditsResourceReceivedCreditList> getTreasuryReceivedCredits(String financialAccount, { String endingBefore, BuiltList<String> expand, int limit, LinkedFlowsParam linkedFlows, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryReceivedCredit> getTreasuryReceivedCreditsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryReceivedDebitsResourceReceivedDebitList> getTreasuryReceivedDebits(String financialAccount, { String endingBefore, BuiltList<String> expand, int limit, String startingAfter, String status }) async
    ...
    //
    //Future<TreasuryReceivedDebit> getTreasuryReceivedDebitsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryTransactionsResourceTransactionEntryList> getTreasuryTransactionEntries(String financialAccount, { GetAccountsCreatedParameter created, GetAccountsCreatedParameter effectiveAt, String endingBefore, BuiltList<String> expand, int limit, String orderBy, String startingAfter, String transaction }) async
    ...
    //
    //Future<TreasuryTransactionEntry> getTreasuryTransactionEntriesId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryTransactionsResourceTransactionList> getTreasuryTransactions(String financialAccount, { GetAccountsCreatedParameter created, String endingBefore, BuiltList<String> expand, int limit, String orderBy, String startingAfter, String status, StatusTransitionTimestampSpecs statusTransitions }) async
    ...
    //
    //Future<TreasuryTransaction> getTreasuryTransactionsId(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<NotificationWebhookEndpointList> getWebhookEndpoints({ String endingBefore, BuiltList<String> expand, int limit, String startingAfter }) async
    ...
    //
    //Future<WebhookEndpoint> getWebhookEndpointsWebhookEndpoint(String webhookEndpoint, { BuiltList<String> expand }) async
    ...
    //
    //Future<AccountLink> postAccountLinks(String account, String type, { String collect, CollectionOptionsParams collectionOptions, BuiltList<String> expand, String refreshUrl, String returnUrl }) async
    ...
    //
    //Future<AccountSession> postAccountSessions(String account, AccountSessionCreateComponentsParam components, { BuiltList<String> expand }) async
    ...
    //
    //Future<ExternalAccount> postAccountsAccountBankAccounts(String account, { PostAccountsRequestBankAccount bankAccount, bool defaultForCurrency, BuiltList<String> expand, String externalAccount, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<Capability> postAccountsAccountCapabilitiesCapability(String account, String capability, { BuiltList<String> expand, bool requested }) async
    ...
    // <p>Create an external account for a given account.</p>
    //
    //Future<ExternalAccount> postAccountsAccountExternalAccounts(String account, { PostAccountsRequestBankAccount bankAccount, bool defaultForCurrency, BuiltList<String> expand, String externalAccount, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<LoginLink> postAccountsAccountLoginLinks(String account, { BuiltList<String> expand }) async
    ...
    //
    //Future<Person> postAccountsAccountPeople(String account, { PersonAdditionalTosAcceptancesSpecs additionalTosAcceptances, LegalEntityAndKycAddressSpecs1 address, JapanAddressKanaSpecs1 addressKana, JapanAddressKanjiSpecs1 addressKanji, PostAccountsAccountPeopleRequestDob dob, PersonDocumentsSpecs documents, String email, BuiltList<String> expand, String firstName, String firstNameKana, String firstNameKanji, PostAccountsAccountPeopleRequestFullNameAliases fullNameAliases, String gender, String idNumber, String idNumberSecondary, String lastName, String lastNameKana, String lastNameKanji, String maidenName, PostAccountsRequestMetadata metadata, String nationality, String personToken, String phone, String politicalExposure, AddressSpecs1 registeredAddress, RelationshipSpecs relationship, String ssnLast4, UsCfpbDataSpecs usCfpbData, PersonVerificationSpecs1 verification }) async
    ...
    //
    //Future<Person> postAccountsAccountPeoplePerson(String account, String person, { PersonAdditionalTosAcceptancesSpecs additionalTosAcceptances, LegalEntityAndKycAddressSpecs1 address, JapanAddressKanaSpecs1 addressKana, JapanAddressKanjiSpecs1 addressKanji, PostAccountsAccountPeopleRequestDob dob, PersonDocumentsSpecs documents, String email, BuiltList<String> expand, String firstName, String firstNameKana, String firstNameKanji, PostAccountsAccountPeopleRequestFullNameAliases fullNameAliases, String gender, String idNumber, String idNumberSecondary, String lastName, String lastNameKana, String lastNameKanji, String maidenName, PostAccountsRequestMetadata metadata, String nationality, String personToken, String phone, String politicalExposure, AddressSpecs1 registeredAddress, RelationshipSpecs relationship, String ssnLast4, UsCfpbDataSpecs usCfpbData, PersonVerificationSpecs1 verification }) async
    ...
    // <p>Creates a new person.</p>
    //
    //Future<Person> postAccountsAccountPersons(String account, { PersonAdditionalTosAcceptancesSpecs additionalTosAcceptances, LegalEntityAndKycAddressSpecs1 address, JapanAddressKanaSpecs1 addressKana, JapanAddressKanjiSpecs1 addressKanji, PostAccountsAccountPeopleRequestDob dob, PersonDocumentsSpecs documents, String email, BuiltList<String> expand, String firstName, String firstNameKana, String firstNameKanji, PostAccountsAccountPeopleRequestFullNameAliases fullNameAliases, String gender, String idNumber, String idNumberSecondary, String lastName, String lastNameKana, String lastNameKanji, String maidenName, PostAccountsRequestMetadata metadata, String nationality, String personToken, String phone, String politicalExposure, AddressSpecs1 registeredAddress, RelationshipSpecs relationship, String ssnLast4, UsCfpbDataSpecs usCfpbData, PersonVerificationSpecs1 verification }) async
    ...
    // <p>Updates an existing person.</p>
    //
    //Future<Person> postAccountsAccountPersonsPerson(String account, String person, { PersonAdditionalTosAcceptancesSpecs additionalTosAcceptances, LegalEntityAndKycAddressSpecs1 address, JapanAddressKanaSpecs1 addressKana, JapanAddressKanjiSpecs1 addressKanji, PostAccountsAccountPeopleRequestDob dob, PersonDocumentsSpecs documents, String email, BuiltList<String> expand, String firstName, String firstNameKana, String firstNameKanji, PostAccountsAccountPeopleRequestFullNameAliases fullNameAliases, String gender, String idNumber, String idNumberSecondary, String lastName, String lastNameKana, String lastNameKanji, String maidenName, PostAccountsRequestMetadata metadata, String nationality, String personToken, String phone, String politicalExposure, AddressSpecs1 registeredAddress, RelationshipSpecs relationship, String ssnLast4, UsCfpbDataSpecs usCfpbData, PersonVerificationSpecs1 verification }) async
    ...
    //
    //Future<Account> postAccountsAccountReject(String account, String reason, { BuiltList<String> expand }) async
    ...
    //
    //Future<ApplePayDomain> postApplePayDomains(String domainName, { BuiltList<String> expand }) async
    ...
    //
    //Future<FeeRefund> postApplicationFeesFeeRefundsId(String fee, String id, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    // 
    //
    //Future<ApplicationFee> postApplicationFeesIdRefund(String id, { int amount, String directive, BuiltList<String> expand }) async
    ...
    //
    //Future<FeeRefund> postApplicationFeesIdRefunds(String id, { int amount, BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<AppsSecret> postAppsSecrets(String name, String payload, ScopeParam1 scope, { BuiltList<String> expand, int expiresAt }) async
    ...
    //
    //Future<AppsSecret> postAppsSecretsDelete(String name, ScopeParam1 scope, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingAlert> postBillingAlerts(String alertType, String title, { BuiltList<String> expand, UsageThresholdConfig usageThreshold }) async
    ...
    //
    //Future<BillingAlert> postBillingAlertsIdActivate(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingAlert> postBillingAlertsIdArchive(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingAlert> postBillingAlertsIdDeactivate(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingCreditGrant> postBillingCreditGrants(AmountParam amount, ApplicabilityConfigParam applicabilityConfig, String category, String customer, { int effectiveAt, BuiltList<String> expand, int expiresAt, BuiltMap<String, String> metadata, String name, int priority }) async
    ...
    //
    //Future<BillingCreditGrant> postBillingCreditGrantsId(String id, { BuiltList<String> expand, PostBillingCreditGrantsIdRequestExpiresAt expiresAt, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<BillingCreditGrant> postBillingCreditGrantsIdExpire(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingCreditGrant> postBillingCreditGrantsIdVoid(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingMeterEventAdjustment> postBillingMeterEventAdjustments(String eventName, String type, { EventAdjustmentCancelSettingsParam cancel, BuiltList<String> expand }) async
    ...
    //
    //Future<BillingMeterEvent> postBillingMeterEvents(String eventName, BuiltMap<String, String> payload, { BuiltList<String> expand, String identifier, int timestamp }) async
    ...
    //
    //Future<BillingMeter> postBillingMeters(AggregationSettingsParam defaultAggregation, String displayName, String eventName, { CustomerMappingParam customerMapping, String eventTimeWindow, BuiltList<String> expand, MeterValueSettingsParam valueSettings }) async
    ...
    //
    //Future<BillingMeter> postBillingMetersId(String id, { String displayName, BuiltList<String> expand }) async
    ...
    //
    //Future<BillingMeter> postBillingMetersIdDeactivate(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingMeter> postBillingMetersIdReactivate(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<BillingPortalConfiguration> postBillingPortalConfigurations(FeaturesCreationParam features, { BusinessProfileCreateParam businessProfile, PostBillingPortalConfigurationsRequestDefaultReturnUrl defaultReturnUrl, BuiltList<String> expand, LoginPageCreateParam loginPage, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<BillingPortalSession> postBillingPortalSessions(String customer, { String configuration, BuiltList<String> expand, FlowDataParam flowData, String locale, String onBehalfOf, String returnUrl }) async
    ...
    //
    //Future<Charge> postChargesCharge(String charge, { String customer, String description, BuiltList<String> expand, FraudDetails fraudDetails, PostAccountsRequestMetadata metadata, String receiptEmail, OptionalFieldsShipping shipping, String transferGroup }) async
    ...
    //
    //Future<Charge> postChargesChargeCapture(String charge, { int amount, int applicationFee, int applicationFeeAmount, BuiltList<String> expand, String receiptEmail, String statementDescriptor, String statementDescriptorSuffix, TransferDataSpecs1 transferData, String transferGroup }) async
    ...
    // 
    //
    //Future<Dispute> postChargesChargeDispute(String charge, { DisputeEvidenceParams evidence, BuiltList<String> expand, PostAccountsRequestMetadata metadata, bool submit }) async
    ...
    // 
    //
    //Future<Dispute> postChargesChargeDisputeClose(String charge, { BuiltList<String> expand }) async
    ...
    //
    //Future<Charge> postChargesChargeRefund(String charge, { int amount, BuiltList<String> expand, String instructionsEmail, PostAccountsRequestMetadata metadata, String paymentIntent, String reason, bool refundApplicationFee, bool reverseTransfer }) async
    ...
    //
    //Future<Refund> postChargesChargeRefunds(String charge, { int amount, String currency, String customer, BuiltList<String> expand, String instructionsEmail, PostAccountsRequestMetadata metadata, String origin, String paymentIntent, String reason, bool refundApplicationFee, bool reverseTransfer }) async
    ...
    //
    //Future<Refund> postChargesChargeRefundsRefund(String charge, String refund, { BuiltList<String> expand, IndividualSpecsMetadata metadata }) async
    ...
    //
    //Future<CheckoutSession> postCheckoutSessions({ AdaptivePricingParams adaptivePricing, AfterExpirationParams afterExpiration, bool allowPromotionCodes, AutomaticTaxParams automaticTax, String billingAddressCollection, String cancelUrl, String clientReferenceId, ConsentCollectionParams consentCollection, String currency, BuiltList<CustomFieldParam> customFields, CustomTextParam customText, String customer, String customerCreation, String customerEmail, CustomerUpdateParams customerUpdate, BuiltList<DiscountParams> discounts, BuiltList<String> expand, int expiresAt, InvoiceCreationParams invoiceCreation, BuiltList<LineItemParams> lineItems, String locale, BuiltMap<String, String> metadata, String mode, BuiltList<OptionalItemParams> optionalItems, String originContext, PaymentIntentDataParams paymentIntentData, String paymentMethodCollection, String paymentMethodConfiguration, PaymentMethodDataParam paymentMethodData, PaymentMethodOptionsParam paymentMethodOptions, BuiltList<String> paymentMethodTypes, PermissionsParam permissions, PhoneNumberCollectionParams phoneNumberCollection, String redirectOnCompletion, String returnUrl, SavedPaymentMethodOptionsParam savedPaymentMethodOptions, SetupIntentDataParam setupIntentData, ShippingAddressCollectionParams shippingAddressCollection, BuiltList<ShippingOptionParams> shippingOptions, String submitType, SubscriptionDataParams subscriptionData, String successUrl, TaxIdCollectionParams taxIdCollection, String uiMode, WalletOptionsParam walletOptions }) async
    ...
    //
    //Future<CheckoutSession> postCheckoutSessionsSession(String session, { CollectedInformationParams collectedInformation, BuiltList<String> expand, PostAccountsRequestMetadata metadata, PostCheckoutSessionsSessionRequestShippingOptions shippingOptions }) async
    ...
    //
    //Future<CheckoutSession> postCheckoutSessionsSessionExpire(String session, { BuiltList<String> expand }) async
    ...
    //
    //Future<ClimateOrder> postClimateOrders(String product, { int amount, BeneficiaryParams beneficiary, String currency, BuiltList<String> expand, BuiltMap<String, String> metadata, double metricTons }) async
    ...
    //
    //Future<ClimateOrder> postClimateOrdersOrder(String order, { PostClimateOrdersOrderRequestBeneficiary beneficiary, BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<ClimateOrder> postClimateOrdersOrderCancel(String order, { BuiltList<String> expand }) async
    ...
    //
    //Future<Coupon> postCoupons({ int amountOff, AppliesToParams appliesTo, String currency, BuiltMap<String, CurrencyOption2> currencyOptions, String duration, int durationInMonths, BuiltList<String> expand, String id, int maxRedemptions, PostAccountsRequestMetadata metadata, String name, num percentOff, int redeemBy }) async
    ...
    //
    //Future<Coupon> postCouponsCoupon(String coupon, { BuiltMap<String, CurrencyOption2> currencyOptions, BuiltList<String> expand, PostAccountsRequestMetadata metadata, String name }) async
    ...
    //
    //Future<CreditNote> postCreditNotes(String invoice, { int amount, int creditAmount, int effectiveAt, String emailType, BuiltList<String> expand, BuiltList<CreditNoteLineItemParams> lines, String memo, BuiltMap<String, String> metadata, int outOfBandAmount, String reason, int refundAmount, BuiltList<CreditNoteRefundParams> refunds, CreditNoteShippingCost shippingCost }) async
    ...
    //
    //Future<CreditNote> postCreditNotesId(String id, { BuiltList<String> expand, String memo, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<CreditNote> postCreditNotesIdVoid(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<CustomerSession> postCustomerSessions(Components components, String customer, { BuiltList<String> expand }) async
    ...
    //
    //Future<Customer> postCustomers({ PostCustomersRequestAddress address, int balance, CashBalanceParam cashBalance, String description, String email, BuiltList<String> expand, String invoicePrefix, CustomerParam invoiceSettings, PostAccountsRequestMetadata metadata, String name, int nextInvoiceSequence, String paymentMethod, String phone, BuiltList<String> preferredLocales, PostCustomersRequestShipping shipping, String source_, SharedTaxCreateParam tax, String taxExempt, BuiltList<DataParams> taxIdData, String testClock }) async
    ...
    //
    //Future<CustomerBalanceTransaction> postCustomersCustomerBalanceTransactions(String customer, int amount, String currency, { String description, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<CustomerBalanceTransaction> postCustomersCustomerBalanceTransactionsTransaction(String customer, String transaction, { String description, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<PaymentSource> postCustomersCustomerBankAccounts(String customer, { String alipayAccount, PostCustomersCustomerRequestBankAccount bankAccount, PostChargesRequestCard card, BuiltList<String> expand, BuiltMap<String, String> metadata, String source_ }) async
    ...
    //
    //Future<BankAccount> postCustomersCustomerBankAccountsIdVerify(String customer, String id, { BuiltList<int> amounts, BuiltList<String> expand }) async
    ...
    // <p>When you create a new credit card, you must specify a customer or recipient on which to create it.</p>  <p>If the card’s owner has no default card, then the new card will become the default. However, if the owner already has a default, then it will not change. To change the default, you should <a href=\"/docs/api#update_customer\">update the customer</a> to have a new <code>default_source</code>.</p>
    //
    //Future<PaymentSource> postCustomersCustomerCards(String customer, { String alipayAccount, PostCustomersCustomerRequestBankAccount bankAccount, PostChargesRequestCard card, BuiltList<String> expand, BuiltMap<String, String> metadata, String source_ }) async
    ...
    //
    //Future<CashBalance> postCustomersCustomerCashBalance(String customer, { BuiltList<String> expand, BalanceSettingsParam1 settings }) async
    ...
    //
    //Future<FundingInstructions> postCustomersCustomerFundingInstructions(String customer, BankTransferParams bankTransfer, String currency, String fundingType, { BuiltList<String> expand }) async
    ...
    // <p>When you create a new credit card, you must specify a customer or recipient on which to create it.</p>  <p>If the card’s owner has no default card, then the new card will become the default. However, if the owner already has a default, then it will not change. To change the default, you should <a href=\"/docs/api#update_customer\">update the customer</a> to have a new <code>default_source</code>.</p>
    //
    //Future<PaymentSource> postCustomersCustomerSources(String customer, { String alipayAccount, PostCustomersCustomerRequestBankAccount bankAccount, PostChargesRequestCard card, BuiltList<String> expand, BuiltMap<String, String> metadata, String source_ }) async
    ...
    // <p>Verify a specified bank account for a given customer.</p>
    //
    //Future<BankAccount> postCustomersCustomerSourcesIdVerify(String customer, String id, { BuiltList<int> amounts, BuiltList<String> expand }) async
    ...
    //
    //Future<Subscription> postCustomersCustomerSubscriptionsSubscriptionExposedId(String customer, String subscriptionExposedId, { BuiltList<AddInvoiceItemEntry> addInvoiceItems, PostCustomersCustomerSubscriptionsRequestApplicationFeePercent applicationFeePercent, AutomaticTaxConfig1 automaticTax, String billingCycleAnchor, PostCustomersCustomerSubscriptionsRequestBillingThresholds billingThresholds, PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestCancelAt cancelAt, bool cancelAtPeriodEnd, CancellationDetailsParam cancellationDetails, String collectionMethod, int daysUntilDue, String defaultPaymentMethod, PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultSource defaultSource, PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultTaxRates defaultTaxRates, PostCustomersCustomerSubscriptionsRequestDiscounts discounts, BuiltList<String> expand, InvoiceSettingsParam invoiceSettings, BuiltList<SubscriptionItemUpdateParams> items, PostAccountsRequestMetadata metadata, bool offSession, PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestPauseCollection pauseCollection, String paymentBehavior, PaymentSettings paymentSettings, PostCustomersCustomerSubscriptionsRequestPendingInvoiceItemInterval pendingInvoiceItemInterval, String prorationBehavior, int prorationDate, PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestTransferData transferData, PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestTrialEnd trialEnd, bool trialFromPlan, TrialSettingsConfig1 trialSettings }) async
    ...
    //
    //Future<TaxId> postCustomersCustomerTaxIds(String customer, String type, String value, { BuiltList<String> expand }) async
    ...
    //
    //Future<Dispute> postDisputesDispute(String dispute, { DisputeEvidenceParams evidence, BuiltList<String> expand, PostAccountsRequestMetadata metadata, bool submit }) async
    ...
    //
    //Future<Dispute> postDisputesDisputeClose(String dispute, { BuiltList<String> expand }) async
    ...
    //
    //Future<EntitlementsFeature> postEntitlementsFeatures(String lookupKey, String name, { BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<EntitlementsFeature> postEntitlementsFeaturesId(String id, { bool active, BuiltList<String> expand, PostEntitlementsFeaturesIdRequestMetadata metadata, String name }) async
    ...
    //
    //Future<EphemeralKey> postEphemeralKeys({ String customer, BuiltList<String> expand, String issuingCard, String nonce, String verificationSession }) async
    ...
    //
    //Future<FileLink> postFileLinks(String file, { BuiltList<String> expand, int expiresAt, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<FileLink> postFileLinksLink(String link, { BuiltList<String> expand, PostFileLinksLinkRequestExpiresAt expiresAt, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<Uint8List> postFiles(MultipartFile file, String purpose, { BuiltList<String> expand, FileLinkCreationParams fileLinkData }) async
    ...
    //
    //Future<FinancialConnectionsAccount> postFinancialConnectionsAccountsAccountDisconnect(String account, { BuiltList<String> expand }) async
    ...
    //
    //Future<FinancialConnectionsAccount> postFinancialConnectionsAccountsAccountRefresh(String account, BuiltList<String> features, { BuiltList<String> expand }) async
    ...
    //
    //Future<FinancialConnectionsAccount> postFinancialConnectionsAccountsAccountSubscribe(String account, BuiltList<String> features, { BuiltList<String> expand }) async
    ...
    //
    //Future<FinancialConnectionsAccount> postFinancialConnectionsAccountsAccountUnsubscribe(String account, BuiltList<String> features, { BuiltList<String> expand }) async
    ...
    //
    //Future<FinancialConnectionsSession> postFinancialConnectionsSessions(AccountholderParams1 accountHolder, BuiltList<String> permissions, { BuiltList<String> expand, FiltersParams filters, BuiltList<String> prefetch, String returnUrl }) async
    ...
    //
    //Future<ForwardingRequest> postForwardingRequests(String paymentMethod, BuiltList<String> replacements, String url, { BuiltList<String> expand, BuiltMap<String, String> metadata, RequestParam request }) async
    ...
    //
    //Future<IdentityVerificationSession> postIdentityVerificationSessions({ String clientReferenceId, BuiltList<String> expand, BuiltMap<String, String> metadata, SessionOptionsParam options, ProvidedDetailsParam providedDetails, String relatedCustomer, RelatedPersonParam relatedPerson, String returnUrl, String type, String verificationFlow }) async
    ...
    //
    //Future<IdentityVerificationSession> postIdentityVerificationSessionsSession(String session, { BuiltList<String> expand, BuiltMap<String, String> metadata, SessionOptionsParam options, ProvidedDetailsParam providedDetails, String type }) async
    ...
    //
    //Future<IdentityVerificationSession> postIdentityVerificationSessionsSessionCancel(String session, { BuiltList<String> expand }) async
    ...
    //
    //Future<IdentityVerificationSession> postIdentityVerificationSessionsSessionRedact(String session, { BuiltList<String> expand }) async
    ...
    //
    //Future<InvoiceRenderingTemplate> postInvoiceRenderingTemplatesTemplateArchive(String template, { BuiltList<String> expand }) async
    ...
    //
    //Future<InvoiceRenderingTemplate> postInvoiceRenderingTemplatesTemplateUnarchive(String template, { BuiltList<String> expand }) async
    ...
    //
    //Future<Invoiceitem> postInvoiceitemsInvoiceitem(String invoiceitem, { int amount, String description, bool discountable, PostInvoiceitemsInvoiceitemRequestDiscounts discounts, BuiltList<String> expand, PostAccountsRequestMetadata metadata, Period period, OneTimePriceData priceData, PricingParam pricing, int quantity, String taxBehavior, PostInvoiceitemsRequestTaxCode taxCode, PostInvoiceitemsInvoiceitemRequestTaxRates taxRates, double unitAmountDecimal }) async
    ...
    //
    //Future<Invoice> postInvoicesCreatePreview({ AutomaticTaxParam1 automaticTax, String currency, String customer, CustomerDetailsParam customerDetails, PostInvoicesCreatePreviewRequestDiscounts discounts, BuiltList<String> expand, BuiltList<InvoiceItemPreviewParams> invoiceItems, Param1 issuer, PostInvoicesCreatePreviewRequestOnBehalfOf onBehalfOf, String previewMode, String schedule, ScheduleDetailsParams scheduleDetails, String subscription, SubscriptionDetailsParams subscriptionDetails }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceAddLines(String invoice, BuiltList<LinesDataParam> lines, { BuiltList<String> expand, PostAccountsRequestMetadata invoiceMetadata }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceAttachPayment(String invoice, { BuiltList<String> expand, String paymentIntent }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceFinalize(String invoice, { bool autoAdvance, BuiltList<String> expand }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceMarkUncollectible(String invoice, { BuiltList<String> expand }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoicePay(String invoice, { BuiltList<String> expand, bool forgive, PostInvoicesInvoicePayRequestMandate mandate, bool offSession, bool paidOutOfBand, String paymentMethod, String source_ }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceRemoveLines(String invoice, BuiltList<LinesDataParam1> lines, { BuiltList<String> expand, PostAccountsRequestMetadata invoiceMetadata }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceSend(String invoice, { BuiltList<String> expand }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceUpdateLines(String invoice, BuiltList<LinesDataParam2> lines, { BuiltList<String> expand, PostInvoicesInvoiceLinesLineItemIdRequestMetadata invoiceMetadata }) async
    ...
    //
    //Future<Invoice> postInvoicesInvoiceVoid(String invoice, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingAuthorization> postIssuingAuthorizationsAuthorization(String authorization, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<IssuingAuthorization> postIssuingAuthorizationsAuthorizationApprove(String authorization, { int amount, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<IssuingAuthorization> postIssuingAuthorizationsAuthorizationDecline(String authorization, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<IssuingCardholder> postIssuingCardholders(BillingSpecs billing, String name, { CompanyParam company, String email, BuiltList<String> expand, IndividualParam individual, BuiltMap<String, String> metadata, String phoneNumber, BuiltList<String> preferredLocales, AuthorizationControlsParamV2 spendingControls, String status, String type }) async
    ...
    //
    //Future<IssuingCardholder> postIssuingCardholdersCardholder(String cardholder, { BillingSpecs billing, CompanyParam company, String email, BuiltList<String> expand, IndividualParam individual, BuiltMap<String, String> metadata, String phoneNumber, BuiltList<String> preferredLocales, AuthorizationControlsParamV2 spendingControls, String status }) async
    ...
    //
    //Future<IssuingCard> postIssuingCards(String currency, String type, { String cardholder, BuiltList<String> expand, String financialAccount, BuiltMap<String, String> metadata, String personalizationDesign, EncryptedPinParam pin, String replacementFor, String replacementReason, PostIssuingCardsRequestSecondLine secondLine, ShippingSpecs shipping, AuthorizationControlsParam spendingControls, String status }) async
    ...
    //
    //Future<IssuingCard> postIssuingCardsCard(String card, { String cancellationReason, BuiltList<String> expand, PostAccountsRequestMetadata metadata, String personalizationDesign, EncryptedPinParam1 pin, ShippingSpecs1 shipping, AuthorizationControlsParam spendingControls, String status }) async
    ...
    //
    //Future<IssuingDispute> postIssuingDisputes({ int amount, EvidenceParam evidence, BuiltList<String> expand, BuiltMap<String, String> metadata, String transaction, TreasuryParam treasury }) async
    ...
    //
    //Future<IssuingDispute> postIssuingDisputesDispute(String dispute, { int amount, EvidenceParam evidence, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<IssuingDispute> postIssuingDisputesDisputeSubmit(String dispute, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<IssuingPersonalizationDesign> postIssuingPersonalizationDesigns(String physicalBundle, { String cardLogo, CarrierTextParam carrierText, BuiltList<String> expand, String lookupKey, BuiltMap<String, String> metadata, String name, PreferencesParam preferences, bool transferLookupKey }) async
    ...
    //
    //Future<IssuingSettlement> postIssuingSettlementsSettlement(String settlement, { BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<IssuingToken> postIssuingTokensToken(String token, String status, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingTransaction> postIssuingTransactionsTransaction(String transaction, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    // <p>To launch the Financial Connections authorization flow, create a <code>Session</code>. The session’s <code>client_secret</code> can be used to launch the flow using Stripe.js.</p>
    //
    //Future<FinancialConnectionsSession> postLinkAccountSessions(AccountholderParams1 accountHolder, BuiltList<String> permissions, { BuiltList<String> expand, FiltersParams filters, BuiltList<String> prefetch, String returnUrl }) async
    ...
    // <p>Disables your access to a Financial Connections <code>Account</code>. You will no longer be able to access data associated with the account (e.g. balances, transactions).</p>
    //
    //Future<FinancialConnectionsAccount> postLinkedAccountsAccountDisconnect(String account, { BuiltList<String> expand }) async
    ...
    // <p>Refreshes the data associated with a Financial Connections <code>Account</code>.</p>
    //
    //Future<FinancialConnectionsAccount> postLinkedAccountsAccountRefresh(String account, BuiltList<String> features, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntents(int amount, String currency, { int applicationFeeAmount, AutomaticPaymentMethodsParam automaticPaymentMethods, String captureMethod, bool confirm, String confirmationMethod, String confirmationToken, String customer, String description, bool errorOnRequiresAction, BuiltList<String> expand, String mandate, PostPaymentIntentsRequestMandateData mandateData, BuiltMap<String, String> metadata, PostPaymentIntentsRequestOffSession offSession, String onBehalfOf, String paymentMethod, String paymentMethodConfiguration, PaymentMethodDataParams paymentMethodData, PaymentMethodOptionsParam19 paymentMethodOptions, BuiltList<String> paymentMethodTypes, RadarOptionsWithHiddenOptions2 radarOptions, String receiptEmail, String returnUrl, String setupFutureUsage, OptionalFieldsShipping1 shipping, String statementDescriptor, String statementDescriptorSuffix, TransferDataCreationParams transferData, String transferGroup, bool useStripeSdk }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntentsIntent(String intent, { int amount, PostPaymentIntentsIntentRequestApplicationFeeAmount applicationFeeAmount, String captureMethod, String currency, String customer, String description, BuiltList<String> expand, PostAccountsRequestMetadata metadata, String paymentMethod, String paymentMethodConfiguration, PaymentMethodDataParams paymentMethodData, PaymentMethodOptionsParam35 paymentMethodOptions, BuiltList<String> paymentMethodTypes, PostPaymentIntentsIntentRequestReceiptEmail receiptEmail, String setupFutureUsage, PostPaymentIntentsIntentRequestShipping shipping, String statementDescriptor, String statementDescriptorSuffix, TransferDataUpdateParams transferData, String transferGroup }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntentsIntentApplyCustomerBalance(String intent, { int amount, String currency, BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntentsIntentCancel(String intent, { String cancellationReason, BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntentsIntentCapture(String intent, { int amountToCapture, int applicationFeeAmount, BuiltList<String> expand, bool finalCapture, PostAccountsRequestMetadata metadata, String statementDescriptor, String statementDescriptorSuffix, TransferDataCaptureParams transferData }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntentsIntentConfirm(String intent, { String captureMethod, String clientSecret, String confirmationToken, bool errorOnRequiresAction, BuiltList<String> expand, String mandate, PostPaymentIntentsIntentConfirmRequestMandateData mandateData, PostPaymentIntentsIntentConfirmRequestOffSession offSession, String paymentMethod, PaymentMethodDataParams paymentMethodData, PaymentMethodOptionsParam19 paymentMethodOptions, BuiltList<String> paymentMethodTypes, RadarOptionsWithHiddenOptions2 radarOptions, PostPaymentIntentsIntentRequestReceiptEmail receiptEmail, String returnUrl, String setupFutureUsage, PostPaymentIntentsIntentRequestShipping shipping, bool useStripeSdk }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntentsIntentIncrementAuthorization(String intent, int amount, { int applicationFeeAmount, String description, BuiltList<String> expand, BuiltMap<String, String> metadata, String statementDescriptor, TransferDataUpdateParams1 transferData }) async
    ...
    //
    //Future<PaymentIntent> postPaymentIntentsIntentVerifyMicrodeposits(String intent, { BuiltList<int> amounts, String clientSecret, String descriptorCode, BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentLink> postPaymentLinks(BuiltList<LineItemsCreateParams> lineItems, { AfterCompletionParams afterCompletion, bool allowPromotionCodes, int applicationFeeAmount, num applicationFeePercent, AutomaticTaxParams1 automaticTax, String billingAddressCollection, ConsentCollectionParams1 consentCollection, String currency, BuiltList<CustomFieldParam> customFields, CustomTextParam customText, String customerCreation, BuiltList<String> expand, String inactiveMessage, InvoiceCreationCreateParams invoiceCreation, BuiltMap<String, String> metadata, String onBehalfOf, BuiltList<OptionalItemParams> optionalItems, PaymentIntentDataParams1 paymentIntentData, String paymentMethodCollection, BuiltList<String> paymentMethodTypes, PhoneNumberCollectionParams1 phoneNumberCollection, RestrictionsParams restrictions, ShippingAddressCollectionParams1 shippingAddressCollection, BuiltList<ShippingOptionParams1> shippingOptions, String submitType, SubscriptionDataParams1 subscriptionData, TaxIdCollectionParams taxIdCollection, TransferDataParams1 transferData }) async
    ...
    //
    //Future<PaymentMethodDomain> postPaymentMethodDomains(String domainName, { bool enabled, BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentMethodDomain> postPaymentMethodDomainsPaymentMethodDomain(String paymentMethodDomain, { bool enabled, BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentMethodDomain> postPaymentMethodDomainsPaymentMethodDomainValidate(String paymentMethodDomain, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentMethod> postPaymentMethods({ PaymentMethodParam54 acssDebit, JsonObject affirm, JsonObject afterpayClearpay, JsonObject alipay, String allowRedisplay, JsonObject alma, JsonObject amazonPay, Param14 auBecsDebit, Param15 bacsDebit, JsonObject bancontact, JsonObject billie, BillingDetailsInnerParams1 billingDetails, JsonObject blik, Param16 boleto, PostPaymentMethodsRequestCard card, JsonObject cashapp, JsonObject crypto, String customer, JsonObject customerBalance, Param17 eps, BuiltList<String> expand, Param18 fpx, JsonObject giropay, JsonObject grabpay, Param19 ideal, JsonObject interacPresent, JsonObject kakaoPay, Param20 klarna, JsonObject konbini, JsonObject krCard, JsonObject link, BuiltMap<String, String> metadata, JsonObject mobilepay, JsonObject multibanco, Param21 naverPay, Param22 nzBankAccount, JsonObject oxxo, Param23 p24, JsonObject payByBank, JsonObject payco, String paymentMethod, JsonObject paynow, JsonObject paypal, JsonObject pix, JsonObject promptpay, RadarOptionsWithHiddenOptions radarOptions, JsonObject revolutPay, JsonObject samsungPay, JsonObject satispay, Param24 sepaDebit, Param25 sofort, JsonObject swish, JsonObject twint, String type, PaymentMethodParam55 usBankAccount, JsonObject wechatPay, JsonObject zip }) async
    ...
    //
    //Future<PaymentMethod> postPaymentMethodsPaymentMethod(String paymentMethod, { String allowRedisplay, BillingDetailsInnerParams1 billingDetails, UpdateApiParam card, BuiltList<String> expand, JsonObject link, PostAccountsRequestMetadata metadata, JsonObject payByBank, UpdateParam usBankAccount }) async
    ...
    //
    //Future<PaymentMethod> postPaymentMethodsPaymentMethodAttach(String paymentMethod, String customer, { BuiltList<String> expand }) async
    ...
    //
    //Future<PaymentMethod> postPaymentMethodsPaymentMethodDetach(String paymentMethod, { BuiltList<String> expand }) async
    ...
    //
    //Future<Payout> postPayouts(int amount, String currency, { String description, String destination, BuiltList<String> expand, BuiltMap<String, String> metadata, String method, String sourceType, String statementDescriptor }) async
    ...
    //
    //Future<Payout> postPayoutsPayout(String payout, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<Payout> postPayoutsPayoutCancel(String payout, { BuiltList<String> expand }) async
    ...
    //
    //Future<Payout> postPayoutsPayoutReverse(String payout, { BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<Plan> postPlans(String currency, String interval, { bool active, int amount, double amountDecimal, String billingScheme, BuiltList<String> expand, String id, int intervalCount, PostAccountsRequestMetadata metadata, String meter, String nickname, PostPlansRequestProduct product, BuiltList<Tier> tiers, String tiersMode, TransformUsageParam transformUsage, int trialPeriodDays, String usageType }) async
    ...
    //
    //Future<Plan> postPlansPlan(String plan, { bool active, BuiltList<String> expand, PostAccountsRequestMetadata metadata, String nickname, String product, int trialPeriodDays }) async
    ...
    //
    //Future<Price> postPrices(String currency, { bool active, String billingScheme, BuiltMap<String, CurrencyOption3> currencyOptions, CustomUnitAmount2 customUnitAmount, BuiltList<String> expand, String lookupKey, BuiltMap<String, String> metadata, String nickname, String product, InlineProductParams1 productData, Recurring1 recurring, String taxBehavior, BuiltList<Tier> tiers, String tiersMode, bool transferLookupKey, TransformUsageParam transformQuantity, int unitAmount, double unitAmountDecimal }) async
    ...
    //
    //Future<Price> postPricesPrice(String price, { bool active, PostPricesPriceRequestCurrencyOptions currencyOptions, BuiltList<String> expand, String lookupKey, PostAccountsRequestMetadata metadata, String nickname, String taxBehavior, bool transferLookupKey }) async
    ...
    //
    //Future<Product> postProducts(String name, { bool active, PriceDataWithoutProductWithMetadata defaultPriceData, String description, BuiltList<String> expand, String id, BuiltList<String> images, BuiltList<Features> marketingFeatures, BuiltMap<String, String> metadata, PackageDimensionsSpecs packageDimensions, bool shippable, String statementDescriptor, String taxCode, String unitLabel, String url }) async
    ...
    //
    //Future<ProductFeature> postProductsProductFeatures(String product, String entitlementFeature, { BuiltList<String> expand }) async
    ...
    //
    //Future<PromotionCode> postPromotionCodes(String coupon, { bool active, String code, String customer, BuiltList<String> expand, int expiresAt, int maxRedemptions, BuiltMap<String, String> metadata, RestrictionsParams2 restrictions }) async
    ...
    //
    //Future<PromotionCode> postPromotionCodesPromotionCode(String promotionCode, { bool active, BuiltList<String> expand, PostAccountsRequestMetadata metadata, RestrictionsParams3 restrictions }) async
    ...
    //
    //Future<Quote> postQuotes({ PostQuotesRequestApplicationFeeAmount applicationFeeAmount, PostQuotesRequestApplicationFeePercent applicationFeePercent, AutomaticTaxParam2 automaticTax, String collectionMethod, String customer, PostQuotesRequestDefaultTaxRates defaultTaxRates, PostQuotesRequestDescription description, PostQuotesRequestDiscounts discounts, BuiltList<String> expand, int expiresAt, PostQuotesRequestFooter footer, FromQuoteParams fromQuote, PostQuotesRequestHeader header, QuoteParam invoiceSettings, BuiltList<LineItemCreateParams> lineItems, BuiltMap<String, String> metadata, PostQuotesRequestOnBehalfOf onBehalfOf, SubscriptionDataCreateParams subscriptionData, String testClock, PostQuotesRequestTransferData transferData }) async
    ...
    //
    //Future<Quote> postQuotesQuoteAccept(String quote, { BuiltList<String> expand }) async
    ...
    //
    //Future<Quote> postQuotesQuoteCancel(String quote, { BuiltList<String> expand }) async
    ...
    //
    //Future<Quote> postQuotesQuoteFinalize(String quote, { BuiltList<String> expand, int expiresAt }) async
    ...
    //
    //Future<RadarValueListItem> postRadarValueListItems(String value, String valueList, { BuiltList<String> expand }) async
    ...
    //
    //Future<RadarValueList> postRadarValueLists(String alias, String name, { BuiltList<String> expand, String itemType, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<RadarValueList> postRadarValueListsValueList(String valueList, { String alias, BuiltList<String> expand, BuiltMap<String, String> metadata, String name }) async
    ...
    // <p>When you create a new refund, you must specify a Charge or a PaymentIntent object on which to create it.</p>  <p>Creating a new refund will refund a charge that has previously been created but not yet refunded. Funds will be refunded to the credit or debit card that was originally charged.</p>  <p>You can optionally refund only part of a charge. You can do so multiple times, until the entire charge has been refunded.</p>  <p>Once entirely refunded, a charge can’t be refunded again. This method will raise an error when called on an already-refunded charge, or when trying to refund more money than is left on a charge.</p>
    //
    //Future<Refund> postRefunds({ int amount, String charge, String currency, String customer, BuiltList<String> expand, String instructionsEmail, PostAccountsRequestMetadata metadata, String origin, String paymentIntent, String reason, bool refundApplicationFee, bool reverseTransfer }) async
    ...
    //
    //Future<Refund> postRefundsRefund(String refund, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<Refund> postRefundsRefundCancel(String refund, { BuiltList<String> expand }) async
    ...
    //
    //Future<ReportingReportRun> postReportingReportRuns(String reportType, { BuiltList<String> expand, RunParameterSpecs parameters }) async
    ...
    //
    //Future<Review> postReviewsReviewApprove(String review, { BuiltList<String> expand }) async
    ...
    //
    //Future<SetupIntent> postSetupIntents({ bool attachToSelf, AutomaticPaymentMethodsParam1 automaticPaymentMethods, bool confirm, String confirmationToken, String customer, String description, BuiltList<String> expand, BuiltList<String> flowDirections, PostSetupIntentsRequestMandateData mandateData, BuiltMap<String, String> metadata, String onBehalfOf, String paymentMethod, String paymentMethodConfiguration, PaymentMethodDataParams1 paymentMethodData, PaymentMethodOptionsParam36 paymentMethodOptions, BuiltList<String> paymentMethodTypes, String returnUrl, SetupIntentSingleUseParams singleUse, String usage, bool useStripeSdk }) async
    ...
    //
    //Future<SetupIntent> postSetupIntentsIntent(String intent, { bool attachToSelf, String customer, String description, BuiltList<String> expand, BuiltList<String> flowDirections, PostAccountsRequestMetadata metadata, String paymentMethod, String paymentMethodConfiguration, PaymentMethodDataParams1 paymentMethodData, PaymentMethodOptionsParam36 paymentMethodOptions, BuiltList<String> paymentMethodTypes }) async
    ...
    //
    //Future<SetupIntent> postSetupIntentsIntentCancel(String intent, { String cancellationReason, BuiltList<String> expand }) async
    ...
    //
    //Future<SetupIntent> postSetupIntentsIntentConfirm(String intent, { String clientSecret, String confirmationToken, BuiltList<String> expand, PostPaymentIntentsIntentConfirmRequestMandateData mandateData, String paymentMethod, PaymentMethodDataParams1 paymentMethodData, PaymentMethodOptionsParam36 paymentMethodOptions, String returnUrl, bool useStripeSdk }) async
    ...
    //
    //Future<SetupIntent> postSetupIntentsIntentVerifyMicrodeposits(String intent, { BuiltList<int> amounts, String clientSecret, String descriptorCode, BuiltList<String> expand }) async
    ...
    //
    //Future<ShippingRate> postShippingRates(String displayName, { DeliveryEstimate1 deliveryEstimate, BuiltList<String> expand, FixedAmount1 fixedAmount, BuiltMap<String, String> metadata, String taxBehavior, String taxCode, String type }) async
    ...
    //
    //Future<ShippingRate> postShippingRatesShippingRateToken(String shippingRateToken, { bool active, BuiltList<String> expand, FixedAmountUpdate fixedAmount, PostAccountsRequestMetadata metadata, String taxBehavior }) async
    ...
    //
    //Future<SigmaSigmaApiQuery> postSigmaSavedQueriesId(String id, { BuiltList<String> expand, String name, String sql }) async
    ...
    //
    //Future<ModelSource> postSources({ int amount, String currency, String customer, BuiltList<String> expand, String flow, MandateParams mandate, BuiltMap<String, String> metadata, String originalSource, Owner1 owner, ReceiverParams receiver, RedirectParams redirect, ShallowOrderSpecs sourceOrder, String statementDescriptor, String token, String type, String usage }) async
    ...
    //
    //Future<ModelSource> postSourcesSource(String source_, { int amount, BuiltList<String> expand, MandateParams mandate, PostAccountsRequestMetadata metadata, Owner1 owner, OrderParams sourceOrder }) async
    ...
    //
    //Future<ModelSource> postSourcesSourceVerify(String source_, BuiltList<String> values, { BuiltList<String> expand }) async
    ...
    //
    //Future<SubscriptionItem> postSubscriptionItems(String subscription, { PostSubscriptionItemsRequestBillingThresholds billingThresholds, PostSubscriptionItemsRequestDiscounts discounts, BuiltList<String> expand, BuiltMap<String, String> metadata, String paymentBehavior, String price, RecurringPriceData1 priceData, String prorationBehavior, int prorationDate, int quantity, PostSubscriptionItemsRequestTaxRates taxRates }) async
    ...
    //
    //Future<SubscriptionSchedule> postSubscriptionSchedules({ BillingMode1 billingMode, String customer, DefaultSettingsParams defaultSettings, String endBehavior, BuiltList<String> expand, String fromSubscription, PostAccountsRequestMetadata metadata, BuiltList<PhaseConfigurationParams1> phases, PostSubscriptionSchedulesRequestStartDate startDate }) async
    ...
    //
    //Future<SubscriptionSchedule> postSubscriptionSchedulesSchedule(String schedule, { DefaultSettingsParams defaultSettings, String endBehavior, BuiltList<String> expand, PostAccountsRequestMetadata metadata, BuiltList<PhaseConfigurationParams> phases, String prorationBehavior }) async
    ...
    //
    //Future<SubscriptionSchedule> postSubscriptionSchedulesScheduleCancel(String schedule, { BuiltList<String> expand, bool invoiceNow, bool prorate }) async
    ...
    //
    //Future<SubscriptionSchedule> postSubscriptionSchedulesScheduleRelease(String schedule, { BuiltList<String> expand, bool preserveCancelDate }) async
    ...
    //
    //Future<Subscription> postSubscriptionsSubscriptionMigrate(String subscription, BillingModeMigrate billingMode, { BuiltList<String> expand }) async
    ...
    //
    //Future<Subscription> postSubscriptionsSubscriptionResume(String subscription, { String billingCycleAnchor, BuiltList<String> expand, String prorationBehavior, int prorationDate }) async
    ...
    //
    //Future<TaxCalculation> postTaxCalculations(String currency, BuiltList<CalculationLineItem> lineItems, { String customer, CustomerDetails customerDetails, BuiltList<String> expand, ShipFromDetails shipFromDetails, ShippingCost2 shippingCost, int taxDate }) async
    ...
    //
    //Future<TaxId> postTaxIds(String type, String value, { BuiltList<String> expand, OwnerParams1 owner }) async
    ...
    //
    //Future<TaxRate> postTaxRates(String displayName, bool inclusive, num percentage, { bool active, String country, String description, BuiltList<String> expand, String jurisdiction, BuiltMap<String, String> metadata, String state, String taxType }) async
    ...
    //
    //Future<TaxRate> postTaxRatesTaxRate(String taxRate, { bool active, String country, String description, String displayName, BuiltList<String> expand, String jurisdiction, PostAccountsRequestMetadata metadata, String state, String taxType }) async
    ...
    //
    //Future<TaxRegistration> postTaxRegistrations(PostTaxRegistrationsRequestActiveFrom activeFrom, String country, CountryOptions countryOptions, { BuiltList<String> expand, int expiresAt }) async
    ...
    //
    //Future<TaxRegistration> postTaxRegistrationsId(String id, { PostTaxRegistrationsIdRequestActiveFrom activeFrom, BuiltList<String> expand, PostTaxRegistrationsIdRequestExpiresAt expiresAt }) async
    ...
    //
    //Future<TaxSettings> postTaxSettings({ DefaultsParam defaults, BuiltList<String> expand, HeadOfficeParam headOffice }) async
    ...
    //
    //Future<TaxTransaction> postTaxTransactionsCreateFromCalculation(String calculation, String reference, { BuiltList<String> expand, BuiltMap<String, String> metadata, int postedAt }) async
    ...
    //
    //Future<TaxTransaction> postTaxTransactionsCreateReversal(String mode, String originalTransaction, String reference, { BuiltList<String> expand, int flatAmount, BuiltList<TransactionLineItemReversal> lineItems, BuiltMap<String, String> metadata, TransactionShippingCostReversal shippingCost }) async
    ...
    //
    //Future<TerminalConfiguration> postTerminalConfigurations({ BbposWisePose bbposWiseposE, BuiltList<String> expand, String name, PostTerminalConfigurationsRequestOffline offline, RebootWindow rebootWindow, StripeS700 stripeS700, PostTerminalConfigurationsRequestTipping tipping, VerifoneP400 verifoneP400, PostTerminalConfigurationsRequestWifi wifi }) async
    ...
    //
    //Future<GetTerminalConfigurationsConfiguration200Response> postTerminalConfigurationsConfiguration(String configuration, { PostTerminalConfigurationsConfigurationRequestBbposWiseposE bbposWiseposE, BuiltList<String> expand, String name, PostTerminalConfigurationsRequestOffline offline, PostTerminalConfigurationsConfigurationRequestRebootWindow rebootWindow, PostTerminalConfigurationsConfigurationRequestStripeS700 stripeS700, PostTerminalConfigurationsRequestTipping tipping, PostTerminalConfigurationsConfigurationRequestVerifoneP400 verifoneP400, PostTerminalConfigurationsRequestWifi wifi }) async
    ...
    //
    //Future<TerminalConnectionToken> postTerminalConnectionTokens({ BuiltList<String> expand, String location }) async
    ...
    //
    //Future<TerminalLocation> postTerminalLocations(CreateLocationAddressParam address, String displayName, { String configurationOverrides, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<TerminalReader> postTerminalReaders(String registrationCode, { BuiltList<String> expand, String label, String location, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<GetTerminalReadersReader200Response> postTerminalReadersReader(String reader, { BuiltList<String> expand, PostTerminalReadersReaderRequestLabel label, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderCancelAction(String reader, { BuiltList<String> expand }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderCollectInputs(String reader, BuiltList<InputParams> inputs, { BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderCollectPaymentMethod(String reader, String paymentIntent, { CollectConfig collectConfig, BuiltList<String> expand }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderConfirmPaymentIntent(String reader, String paymentIntent, { ConfirmConfig confirmConfig, BuiltList<String> expand }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderProcessPaymentIntent(String reader, String paymentIntent, { BuiltList<String> expand, ProcessConfig processConfig }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderProcessSetupIntent(String reader, String allowRedisplay, String setupIntent, { BuiltList<String> expand, ProcessSetupConfig processConfig }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderRefundPayment(String reader, { int amount, String charge, BuiltList<String> expand, BuiltMap<String, String> metadata, String paymentIntent, bool refundApplicationFee, RefundPaymentConfig refundPaymentConfig, bool reverseTransfer }) async
    ...
    //
    //Future<TerminalReader> postTerminalReadersReaderSetReaderDisplay(String reader, String type, { Cart cart, BuiltList<String> expand }) async
    ...
    //
    //Future<ConfirmationToken> postTestHelpersConfirmationTokens({ BuiltList<String> expand, String paymentMethod, PaymentMethodDataParams2 paymentMethodData, TestPaymentMethodOptionsParam paymentMethodOptions, String returnUrl, String setupFutureUsage, RecipientShippingWithOptionalFieldsAddress2 shipping }) async
    ...
    //
    //Future<CustomerCashBalanceTransaction> postTestHelpersCustomersCustomerFundCashBalance(String customer, int amount, String currency, { BuiltList<String> expand, String reference }) async
    ...
    //
    //Future<IssuingAuthorization> postTestHelpersIssuingAuthorizations(String card, { int amount, AmountDetailsSpecs amountDetails, String authorizationMethod, String currency, BuiltList<String> expand, FleetTestmodeAuthorizationSpecs fleet, FuelSpecs fuel, bool isAmountControllable, int merchantAmount, String merchantCurrency, MerchantDataSpecs merchantData, NetworkDataSpecs networkData, VerificationDataSpecs verificationData, String wallet }) async
    ...
    //
    //Future<IssuingAuthorization> postTestHelpersIssuingAuthorizationsAuthorizationCapture(String authorization, { int captureAmount, bool closeAuthorization, BuiltList<String> expand, PurchaseDetailsSpecs purchaseDetails }) async
    ...
    //
    //Future<IssuingAuthorization> postTestHelpersIssuingAuthorizationsAuthorizationExpire(String authorization, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingAuthorization> postTestHelpersIssuingAuthorizationsAuthorizationFinalizeAmount(String authorization, int finalAmount, { BuiltList<String> expand, FleetSpecs1 fleet, FuelSpecs fuel }) async
    ...
    //
    //Future<IssuingAuthorization> postTestHelpersIssuingAuthorizationsAuthorizationFraudChallengesRespond(String authorization, bool confirmed, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingAuthorization> postTestHelpersIssuingAuthorizationsAuthorizationIncrement(String authorization, int incrementAmount, { BuiltList<String> expand, bool isAmountControllable }) async
    ...
    //
    //Future<IssuingAuthorization> postTestHelpersIssuingAuthorizationsAuthorizationReverse(String authorization, { BuiltList<String> expand, int reverseAmount }) async
    ...
    //
    //Future<IssuingCard> postTestHelpersIssuingCardsCardShippingDeliver(String card, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingCard> postTestHelpersIssuingCardsCardShippingFail(String card, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingCard> postTestHelpersIssuingCardsCardShippingReturn(String card, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingCard> postTestHelpersIssuingCardsCardShippingShip(String card, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingCard> postTestHelpersIssuingCardsCardShippingSubmit(String card, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingPersonalizationDesign> postTestHelpersIssuingPersonalizationDesignsPersonalizationDesignActivate(String personalizationDesign, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingPersonalizationDesign> postTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivate(String personalizationDesign, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingPersonalizationDesign> postTestHelpersIssuingPersonalizationDesignsPersonalizationDesignReject(String personalizationDesign, RejectionReasonsParam rejectionReasons, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingSettlement> postTestHelpersIssuingSettlements(String bin, int clearingDate, String currency, int netTotalAmount, { BuiltList<String> expand, int interchangeFeesAmount, String network, String networkSettlementIdentifier, int transactionAmount, int transactionCount }) async
    ...
    //
    //Future<IssuingSettlement> postTestHelpersIssuingSettlementsSettlementComplete(String settlement, { BuiltList<String> expand }) async
    ...
    //
    //Future<IssuingTransaction> postTestHelpersIssuingTransactionsCreateForceCapture(int amount, String card, { String currency, BuiltList<String> expand, MerchantDataSpecs merchantData, PurchaseDetailsSpecs purchaseDetails }) async
    ...
    //
    //Future<IssuingTransaction> postTestHelpersIssuingTransactionsCreateUnlinkedRefund(int amount, String card, { String currency, BuiltList<String> expand, MerchantDataSpecs merchantData, PurchaseDetailsSpecs purchaseDetails }) async
    ...
    //
    //Future<IssuingTransaction> postTestHelpersIssuingTransactionsTransactionRefund(String transaction, { BuiltList<String> expand, int refundAmount }) async
    ...
    //
    //Future<Refund> postTestHelpersRefundsRefundExpire(String refund, { BuiltList<String> expand }) async
    ...
    //
    //Future<TerminalReader> postTestHelpersTerminalReadersReaderPresentPaymentMethod(String reader, { int amountTip, CardPresent cardPresent, BuiltList<String> expand, InteracPresent interacPresent, String type }) async
    ...
    //
    //Future<TerminalReader> postTestHelpersTerminalReadersReaderSucceedInputCollection(String reader, { BuiltList<String> expand, String skipNonRequiredInputs }) async
    ...
    //
    //Future<TerminalReader> postTestHelpersTerminalReadersReaderTimeoutInputCollection(String reader, { BuiltList<String> expand }) async
    ...
    //
    //Future<TestHelpersTestClock> postTestHelpersTestClocks(int frozenTime, { BuiltList<String> expand, String name }) async
    ...
    //
    //Future<TestHelpersTestClock> postTestHelpersTestClocksTestClockAdvance(String testClock, int frozenTime, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryInboundTransfer> postTestHelpersTreasuryInboundTransfersIdFail(String id, { BuiltList<String> expand, FailureDetailsParam failureDetails }) async
    ...
    //
    //Future<TreasuryInboundTransfer> postTestHelpersTreasuryInboundTransfersIdReturn(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryInboundTransfer> postTestHelpersTreasuryInboundTransfersIdSucceed(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundPayment> postTestHelpersTreasuryOutboundPaymentsId(String id, TrackingDetailsParams trackingDetails, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundPayment> postTestHelpersTreasuryOutboundPaymentsIdFail(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundPayment> postTestHelpersTreasuryOutboundPaymentsIdPost(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundPayment> postTestHelpersTreasuryOutboundPaymentsIdReturn(String id, { BuiltList<String> expand, ReturnedDetailsParams returnedDetails }) async
    ...
    //
    //Future<TreasuryOutboundTransfer> postTestHelpersTreasuryOutboundTransfersOutboundTransfer(String outboundTransfer, TrackingDetailsParams trackingDetails, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundTransfer> postTestHelpersTreasuryOutboundTransfersOutboundTransferFail(String outboundTransfer, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundTransfer> postTestHelpersTreasuryOutboundTransfersOutboundTransferPost(String outboundTransfer, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundTransfer> postTestHelpersTreasuryOutboundTransfersOutboundTransferReturn(String outboundTransfer, { BuiltList<String> expand, ReturnedDetailsParams1 returnedDetails }) async
    ...
    //
    //Future<TreasuryReceivedCredit> postTestHelpersTreasuryReceivedCredits(int amount, String currency, String financialAccount, String network, { String description, BuiltList<String> expand, SourceParams initiatingPaymentMethodDetails }) async
    ...
    //
    //Future<TreasuryReceivedDebit> postTestHelpersTreasuryReceivedDebits(int amount, String currency, String financialAccount, String network, { String description, BuiltList<String> expand, SourceParams initiatingPaymentMethodDetails }) async
    ...
    //
    //Future<Token> postTokens({ ConnectJsAccountTokenSpecs account, TokenCreateBankAccount bankAccount, PostTokensRequestCard card, String customer, CvcParams cvcUpdate, BuiltList<String> expand, PersonTokenSpecs person, PiiTokenSpecs pii }) async
    ...
    //
    //Future<Topup> postTopups(int amount, String currency, { String description, BuiltList<String> expand, PostAccountsRequestMetadata metadata, String source_, String statementDescriptor, String transferGroup }) async
    ...
    //
    //Future<Topup> postTopupsTopup(String topup, { String description, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<Topup> postTopupsTopupCancel(String topup, { BuiltList<String> expand }) async
    ...
    //
    //Future<Transfer> postTransfers(String currency, String destination, { int amount, String description, BuiltList<String> expand, BuiltMap<String, String> metadata, String sourceTransaction, String sourceType, String transferGroup }) async
    ...
    //
    //Future<TransferReversal> postTransfersIdReversals(String id, { int amount, String description, BuiltList<String> expand, PostAccountsRequestMetadata metadata, bool refundApplicationFee }) async
    ...
    //
    //Future<Transfer> postTransfersTransfer(String transfer, { String description, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<TransferReversal> postTransfersTransferReversalsId(String id, String transfer, { BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<TreasuryCreditReversal> postTreasuryCreditReversals(String receivedCredit, { BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<TreasuryDebitReversal> postTreasuryDebitReversals(String receivedDebit, { BuiltList<String> expand, BuiltMap<String, String> metadata }) async
    ...
    //
    //Future<TreasuryFinancialAccount> postTreasuryFinancialAccounts(BuiltList<String> supportedCurrencies, { BuiltList<String> expand, FeatureAccess features, BuiltMap<String, String> metadata, PostTreasuryFinancialAccountsRequestNickname nickname, PlatformRestrictions platformRestrictions }) async
    ...
    //
    //Future<TreasuryFinancialAccount> postTreasuryFinancialAccountsFinancialAccount(String financialAccount, { BuiltList<String> expand, FeatureAccess1 features, ForwardingSettings forwardingSettings, BuiltMap<String, String> metadata, PostTreasuryFinancialAccountsRequestNickname nickname, PlatformRestrictions platformRestrictions }) async
    ...
    //
    //Future<TreasuryFinancialAccount> postTreasuryFinancialAccountsFinancialAccountClose(String financialAccount, { BuiltList<String> expand, ForwardingSettings forwardingSettings }) async
    ...
    //
    //Future<TreasuryFinancialAccountFeatures> postTreasuryFinancialAccountsFinancialAccountFeatures(String financialAccount, { Access1 cardIssuing, Access2 depositInsurance, BuiltList<String> expand, FinancialAddresses1 financialAddresses, InboundTransfers2 inboundTransfers, Access3 intraStripeFlows, OutboundPayments1 outboundPayments, OutboundTransfers1 outboundTransfers }) async
    ...
    //
    //Future<TreasuryInboundTransfer> postTreasuryInboundTransfers(int amount, String currency, String financialAccount, String originPaymentMethod, { String description, BuiltList<String> expand, BuiltMap<String, String> metadata, String statementDescriptor }) async
    ...
    //
    //Future<TreasuryInboundTransfer> postTreasuryInboundTransfersInboundTransferCancel(String inboundTransfer, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundPayment> postTreasuryOutboundPaymentsIdCancel(String id, { BuiltList<String> expand }) async
    ...
    //
    //Future<TreasuryOutboundTransfer> postTreasuryOutboundTransfers(int amount, String currency, String financialAccount, { String description, String destinationPaymentMethod, PaymentMethodData1 destinationPaymentMethodData, PaymentMethodOptions3 destinationPaymentMethodOptions, BuiltList<String> expand, BuiltMap<String, String> metadata, String statementDescriptor }) async
    ...
    //
    //Future<TreasuryOutboundTransfer> postTreasuryOutboundTransfersOutboundTransferCancel(String outboundTransfer, { BuiltList<String> expand }) async
    ...
    //
    //Future<WebhookEndpoint> postWebhookEndpoints(BuiltList<String> enabledEvents, String url, { String apiVersion, bool connect, PostWebhookEndpointsRequestDescription description, BuiltList<String> expand, PostAccountsRequestMetadata metadata }) async
    ...
    //
    //Future<WebhookEndpoint> postWebhookEndpointsWebhookEndpoint(String webhookEndpoint, { PostWebhookEndpointsRequestDescription description, bool disabled, BuiltList<String> enabledEvents, BuiltList<String> expand, PostAccountsRequestMetadata metadata, String url }) async
