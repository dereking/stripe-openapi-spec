...
// tests for ConfirmationTokensResourcePaymentMethodPreview
void main() {
  final instance = ConfirmationTokensResourcePaymentMethodPreviewBuilder();
  // TODO add properties to the builder and call build()

  group(ConfirmationTokensResourcePaymentMethodPreview, () {
