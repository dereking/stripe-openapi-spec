...
// tests for PaymentPagesCheckoutSessionDiscountPromotionCode
void main() {
  final instance = PaymentPagesCheckoutSessionDiscountPromotionCodeBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentPagesCheckoutSessionDiscountPromotionCode, () {
