...
// tests for PaymentIntentPaymentMethodOptionsCrypto
void main() {
  final instance = PaymentIntentPaymentMethodOptionsCryptoBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsCrypto, () {
