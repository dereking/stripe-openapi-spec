...
// tests for PaymentLinksResourceShippingOptionShippingRate
void main() {
  final instance = PaymentLinksResourceShippingOptionShippingRateBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentLinksResourceShippingOptionShippingRate, () {
