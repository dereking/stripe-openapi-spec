...
// tests for PaymentIntentPaymentMethodOptionsPix
void main() {
  final instance = PaymentIntentPaymentMethodOptionsPixBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsPix, () {
    // The number of seconds (between 10 and 1209600) after which Pix payment will expire.
    // int expiresAfterSeconds
    test('to test the property `expiresAfterSeconds`', () async {
      // TODO
    });
