...
// tests for ClimateProduct
void main() {
  // final instance = ClimateProduct();

  group('test ClimateProduct', () {
    ...
    // Map<String, ClimateRemovalsProductsPrice> currentPricesPerMetricTon (default value: const {})
    ...
    // List<ClimateSupplier> suppliers (default value: const [])
