...
// tests for TerminalReaderReaderResourceCollectConfig
void main() {
  // final instance = TerminalReaderReaderResourceCollectConfig();

  group('test TerminalReaderReaderResourceCollectConfig', () {
