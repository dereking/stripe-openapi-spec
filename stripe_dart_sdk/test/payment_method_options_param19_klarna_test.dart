...
// tests for PaymentMethodOptionsParam19Klarna
void main() {
  // final instance = PaymentMethodOptionsParam19Klarna();

  group('test PaymentMethodOptionsParam19Klarna', () {
    ...
    test('to test the property `onDemand`', () async {
      // TODO
    });
