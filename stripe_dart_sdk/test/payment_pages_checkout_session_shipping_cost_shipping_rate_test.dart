...
// tests for PaymentPagesCheckoutSessionShippingCostShippingRate
void main() {
  final instance = PaymentPagesCheckoutSessionShippingCostShippingRateBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentPagesCheckoutSessionShippingCostShippingRate, () {
