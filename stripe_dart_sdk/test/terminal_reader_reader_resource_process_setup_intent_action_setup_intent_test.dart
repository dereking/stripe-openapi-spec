...
void main() {
  final instance = TerminalReaderReaderResourceProcessSetupIntentActionSetupIntentBuilder();
  // TODO add properties to the builder and call build()

  group(TerminalReaderReaderResourceProcessSetupIntentActionSetupIntent, () {
