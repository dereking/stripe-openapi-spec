...
// tests for BillingCreditBalanceTransactionTestClock
void main() {
  final instance = BillingCreditBalanceTransactionTestClockBuilder();
  // TODO add properties to the builder and call build()

  group(BillingCreditBalanceTransactionTestClock, () {
