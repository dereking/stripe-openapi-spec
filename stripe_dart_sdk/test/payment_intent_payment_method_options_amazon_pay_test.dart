...
// tests for PaymentIntentPaymentMethodOptionsAmazonPay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsAmazonPayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsAmazonPay, () {
