...
// tests for PaymentMethodConfiguration
void main() {
  final instance = PaymentMethodConfigurationBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentMethodConfiguration, () {
    ...
    test('to test the property `cartesBancaires`', () async {
      // TODO
    });
    ...
    test('to test the property `jcb`', () async {
      // TODO
    });
