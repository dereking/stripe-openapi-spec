...
// tests for PaymentMethodOptionsCustomerBalanceBankTransfer
void main() {
  // final instance = PaymentMethodOptionsCustomerBalanceBankTransfer();

  group('test PaymentMethodOptionsCustomerBalanceBankTransfer', () {
    ...
    // List<String> requestedAddressTypes (default value: const [])
