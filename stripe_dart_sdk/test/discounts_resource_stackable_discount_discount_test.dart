...
// tests for DiscountsResourceStackableDiscountDiscount
void main() {
  final instance = DiscountsResourceStackableDiscountDiscountBuilder();
  // TODO add properties to the builder and call build()

  group(DiscountsResourceStackableDiscountDiscount, () {
