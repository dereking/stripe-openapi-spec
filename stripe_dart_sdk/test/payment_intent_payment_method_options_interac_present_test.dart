...
// tests for PaymentIntentPaymentMethodOptionsInteracPresent
void main() {
  final instance = PaymentIntentPaymentMethodOptionsInteracPresentBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsInteracPresent, () {
