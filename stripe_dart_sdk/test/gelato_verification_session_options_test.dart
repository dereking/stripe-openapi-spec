...
// tests for GelatoVerificationSessionOptions
void main() {
  // final instance = GelatoVerificationSessionOptions();

  group('test GelatoVerificationSessionOptions', () {
    ...
    test('to test the property `matching`', () async {
      // TODO
    });
