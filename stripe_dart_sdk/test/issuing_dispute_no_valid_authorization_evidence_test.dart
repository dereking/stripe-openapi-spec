...
// tests for IssuingDisputeNoValidAuthorizationEvidence
void main() {
  // final instance = IssuingDisputeNoValidAuthorizationEvidence();

  group('test IssuingDisputeNoValidAuthorizationEvidence', () {
