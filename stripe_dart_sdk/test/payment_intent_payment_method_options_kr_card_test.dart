...
// tests for PaymentIntentPaymentMethodOptionsKrCard
void main() {
  final instance = PaymentIntentPaymentMethodOptionsKrCardBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsKrCard, () {
