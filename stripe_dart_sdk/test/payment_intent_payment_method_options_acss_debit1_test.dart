...
// tests for PaymentIntentPaymentMethodOptionsAcssDebit1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsAcssDebit1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsAcssDebit1, () {
