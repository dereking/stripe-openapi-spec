...
// tests for PaymentIntentPaymentMethodOptionsPromptpay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsPromptpayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsPromptpay, () {
