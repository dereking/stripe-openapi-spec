...
// tests for PaymentIntentPaymentMethodOptionsNzBankAccount1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsNzBankAccount1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsNzBankAccount1, () {
