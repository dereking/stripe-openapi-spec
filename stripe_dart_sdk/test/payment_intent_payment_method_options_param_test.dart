...
// tests for PaymentIntentPaymentMethodOptionsParam
void main() {
  final instance = PaymentIntentPaymentMethodOptionsParamBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsParam, () {
