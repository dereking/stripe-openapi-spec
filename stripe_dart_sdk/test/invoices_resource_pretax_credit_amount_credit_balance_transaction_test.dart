...
// tests for InvoicesResourcePretaxCreditAmountCreditBalanceTransaction
void main() {
  final instance = InvoicesResourcePretaxCreditAmountCreditBalanceTransactionBuilder();
  // TODO add properties to the builder and call build()

  group(InvoicesResourcePretaxCreditAmountCreditBalanceTransaction, () {
    ...
    test('to test the property `creditGrant`', () async {
      // TODO
    });

    // BillingCreditGrantsResourceBalanceDebit debit
    test('to test the property `debit`', () async {
      // TODO
    });
