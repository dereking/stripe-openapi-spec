...
// tests for PaymentIntentPaymentMethodOptionsCardPresent
void main() {
  final instance = PaymentIntentPaymentMethodOptionsCardPresentBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsCardPresent, () {
