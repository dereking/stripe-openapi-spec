...
// tests for SetupAttemptPaymentMethodDetailsCardPresentGeneratedCard
void main() {
  final instance = SetupAttemptPaymentMethodDetailsCardPresentGeneratedCardBuilder();
  // TODO add properties to the builder and call build()

  group(SetupAttemptPaymentMethodDetailsCardPresentGeneratedCard, () {
