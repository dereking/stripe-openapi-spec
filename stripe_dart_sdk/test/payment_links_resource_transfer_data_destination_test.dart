...
// tests for PaymentLinksResourceTransferDataDestination
void main() {
  final instance = PaymentLinksResourceTransferDataDestinationBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentLinksResourceTransferDataDestination, () {
