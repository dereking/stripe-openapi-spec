...
// tests for AuthorizationControlsParam
void main() {
  // final instance = AuthorizationControlsParam();

  group('test AuthorizationControlsParam', () {
    ...
    // List<SpendingLimitsParam> spendingLimits (default value: const [])
