...
// tests for PaymentIntentPaymentMethodOptionsSepaDebit
void main() {
  final instance = PaymentIntentPaymentMethodOptionsSepaDebitBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsSepaDebit, () {
