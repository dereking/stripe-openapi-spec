...
// tests for SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod
void main() {
  final instance = SubscriptionSchedulePhaseConfigurationDefaultPaymentMethodBuilder();
  // TODO add properties to the builder and call build()

  group(SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod, () {
