...
// tests for SubscriptionScheduleConfigurationItemPrice
void main() {
  final instance = SubscriptionScheduleConfigurationItemPriceBuilder();
  // TODO add properties to the builder and call build()

  group(SubscriptionScheduleConfigurationItemPrice, () {
    ...
    // BuiltMap<String, CurrencyOption> currencyOptions
