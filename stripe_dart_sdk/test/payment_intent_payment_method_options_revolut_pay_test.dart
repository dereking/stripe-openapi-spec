...
// tests for PaymentIntentPaymentMethodOptionsRevolutPay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsRevolutPayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsRevolutPay, () {
