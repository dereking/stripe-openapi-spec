...
void main() {
  // final instance = TerminalReaderReaderResourceCollectPaymentMethodActionPaymentIntent();

  group('test TerminalReaderReaderResourceCollectPaymentMethodActionPaymentIntent', () {
