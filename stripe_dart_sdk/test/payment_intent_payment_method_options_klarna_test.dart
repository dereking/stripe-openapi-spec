...
// tests for PaymentIntentPaymentMethodOptionsKlarna
void main() {
  final instance = PaymentIntentPaymentMethodOptionsKlarnaBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsKlarna, () {
