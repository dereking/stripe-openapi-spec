...
// tests for ThresholdsResourceUsageAlertFilterCustomer
void main() {
  // final instance = ThresholdsResourceUsageAlertFilterCustomer();

  group('test ThresholdsResourceUsageAlertFilterCustomer', () {
    // Address address
