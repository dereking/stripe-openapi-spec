...
// tests for PaymentIntentPaymentMethodOptionsSepaDebit1
void main() {
  final instance = PaymentIntentPaymentMethodOptionsSepaDebit1Builder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsSepaDebit1, () {
