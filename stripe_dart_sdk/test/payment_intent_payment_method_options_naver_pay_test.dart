...
// tests for PaymentIntentPaymentMethodOptionsNaverPay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsNaverPayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsNaverPay, () {
