...
// tests for InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge
void main() {
  final instance = InvoicesPaymentsInvoicePaymentAssociatedPaymentChargeBuilder();
  // TODO add properties to the builder and call build()

  group(InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge, () {
