...
// tests for PaymentIntentPaymentMethodOptionsSatispay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsSatispayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsSatispay, () {
