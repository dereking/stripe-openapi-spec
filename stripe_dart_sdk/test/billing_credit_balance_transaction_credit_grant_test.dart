...
// tests for BillingCreditBalanceTransactionCreditGrant
void main() {
  final instance = BillingCreditBalanceTransactionCreditGrantBuilder();
  // TODO add properties to the builder and call build()

  group(BillingCreditBalanceTransactionCreditGrant, () {
    ...
    test('to test the property `applicabilityConfig`', () async {
      // TODO
    });
