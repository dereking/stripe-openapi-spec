...
// tests for PaymentIntentTypeSpecificPaymentMethodOptionsClient
void main() {
  final instance = PaymentIntentTypeSpecificPaymentMethodOptionsClientBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentTypeSpecificPaymentMethodOptionsClient, () {
