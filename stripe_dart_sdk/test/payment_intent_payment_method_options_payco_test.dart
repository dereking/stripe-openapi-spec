...
// tests for PaymentIntentPaymentMethodOptionsPayco
void main() {
  final instance = PaymentIntentPaymentMethodOptionsPaycoBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsPayco, () {
