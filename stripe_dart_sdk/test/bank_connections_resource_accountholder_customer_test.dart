...
// tests for BankConnectionsResourceAccountholderCustomer
void main() {
  // final instance = BankConnectionsResourceAccountholderCustomer();

  group('test BankConnectionsResourceAccountholderCustomer', () {
    // Address address
