...
// tests for TerminalReaderReaderResourceRefundPaymentActionCharge
void main() {
  final instance = TerminalReaderReaderResourceRefundPaymentActionChargeBuilder();
  // TODO add properties to the builder and call build()

  group(TerminalReaderReaderResourceRefundPaymentActionCharge, () {
