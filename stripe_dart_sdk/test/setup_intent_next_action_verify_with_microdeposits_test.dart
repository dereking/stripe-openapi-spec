...
// tests for SetupIntentNextActionVerifyWithMicrodeposits
void main() {
  final instance = SetupIntentNextActionVerifyWithMicrodepositsBuilder();
  // TODO add properties to the builder and call build()

  group(SetupIntentNextActionVerifyWithMicrodeposits, () {
