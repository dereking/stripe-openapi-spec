...
void main() {
  // final instance = SubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethod();

  group('test SubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethod', () {
