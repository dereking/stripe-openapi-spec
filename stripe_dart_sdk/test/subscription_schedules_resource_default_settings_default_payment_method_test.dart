...
// tests for SubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethod
void main() {
  final instance = SubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodBuilder();
  // TODO add properties to the builder and call build()

  group(SubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethod, () {
