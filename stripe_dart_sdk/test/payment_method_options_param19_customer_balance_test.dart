...
// tests for PaymentMethodOptionsParam19CustomerBalance
void main() {
  // final instance = PaymentMethodOptionsParam19CustomerBalance();

  group('test PaymentMethodOptionsParam19CustomerBalance', () {
