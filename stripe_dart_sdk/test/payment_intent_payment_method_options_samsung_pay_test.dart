...
// tests for PaymentIntentPaymentMethodOptionsSamsungPay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsSamsungPayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsSamsungPay, () {
