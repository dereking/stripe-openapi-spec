...
// tests for PaymentIntentPaymentMethodOptionsAlipay
void main() {
  final instance = PaymentIntentPaymentMethodOptionsAlipayBuilder();
  // TODO add properties to the builder and call build()

  group(PaymentIntentPaymentMethodOptionsAlipay, () {
