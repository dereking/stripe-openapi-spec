...
// tests for PaymentMethodOptionsCardMandateOptions
void main() {
  // final instance = PaymentMethodOptionsCardMandateOptions();

  group('test PaymentMethodOptionsCardMandateOptions', () {
    ...
    // List<String> supportedTypes (default value: const [])
