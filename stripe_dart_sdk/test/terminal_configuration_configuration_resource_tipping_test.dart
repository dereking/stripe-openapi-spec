...
// tests for TerminalConfigurationConfigurationResourceTipping
void main() {
  // final instance = TerminalConfigurationConfigurationResourceTipping();

  group('test TerminalConfigurationConfigurationResourceTipping', () {
