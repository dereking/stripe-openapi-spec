...
// tests for DiscountsResourceStackableDiscountPromotionCode
void main() {
  final instance = DiscountsResourceStackableDiscountPromotionCodeBuilder();
  // TODO add properties to the builder and call build()

  group(DiscountsResourceStackableDiscountPromotionCode, () {
