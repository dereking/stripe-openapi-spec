# stripe_dart_sdk.model.PaymentIntentPaymentMethodOptionsAfterpayClearpay
...
**reference** | **String** | An internal identifier or reference that this payment corresponds to. You must limit the identifier to 128 characters, and it can only contain letters, numbers, underscores, backslashes, and dashes. This field differs from the statement descriptor and item name. | [optional] 
