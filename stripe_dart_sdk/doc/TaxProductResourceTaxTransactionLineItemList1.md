# openapi.model.TaxProductResourceTaxTransactionLineItemList1
...
------------ | ------------- | ------------- | -------------
**data** | [**List<TaxTransactionLineItem>**](TaxTransactionLineItem.md) | Details about each object. | [default to const []]
