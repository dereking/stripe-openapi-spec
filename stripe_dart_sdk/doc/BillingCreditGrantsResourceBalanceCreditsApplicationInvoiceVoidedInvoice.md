# openapi.model.BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedInvoice
...
**accountTaxIds** | [**List<InvoiceAccountTaxIdsInner>**](InvoiceAccountTaxIdsInner.md) | The account tax IDs associated with the invoice. Only editable when the invoice is a draft. | [optional] [default to const []]
