# openapi.model.TreasuryReceivedDebitsResourceDebitReversalList
...
------------ | ------------- | ------------- | -------------
**data** | [**List<TreasuryDebitReversal>**](TreasuryDebitReversal.md) | Details about each object. | [default to const []]
