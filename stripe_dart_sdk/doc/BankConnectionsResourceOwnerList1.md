# openapi.model.BankConnectionsResourceOwnerList1
...
------------ | ------------- | ------------- | -------------
**data** | [**List<FinancialConnectionsAccountOwner>**](FinancialConnectionsAccountOwner.md) | Details about each object. | [default to const []]
