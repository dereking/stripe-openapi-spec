# stripe_dart_sdk.model.PaymentMethodAuBecsDebit
...
------------ | ------------- | ------------- | -------------
**bsbNumber** | **String** | Six-digit number identifying bank and branch associated with this bank account. | [optional] 
