# stripe_dart_sdk.model.CheckoutAcssDebitPaymentMethodOptions
...
------------ | ------------- | ------------- | -------------
**currency** | **String** | Currency supported by the bank account. Returned when the Session is in `setup` mode. | [optional] 
**mandateOptions** | [**CheckoutAcssDebitMandateOptions**](CheckoutAcssDebitMandateOptions.md) |  | [optional] 
