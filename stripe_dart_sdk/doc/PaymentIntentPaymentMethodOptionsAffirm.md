# stripe_dart_sdk.model.PaymentIntentPaymentMethodOptionsAffirm
...
**preferredLocale** | **String** | Preferred language of the Affirm authorization page that the customer is redirected to. | [optional] 
