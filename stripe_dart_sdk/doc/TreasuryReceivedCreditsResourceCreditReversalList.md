# openapi.model.TreasuryReceivedCreditsResourceCreditReversalList
...
------------ | ------------- | ------------- | -------------
**data** | [**List<TreasuryCreditReversal>**](TreasuryCreditReversal.md) | Details about each object. | [default to const []]
