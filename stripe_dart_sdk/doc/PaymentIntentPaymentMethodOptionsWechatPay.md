# stripe_dart_sdk.model.PaymentIntentPaymentMethodOptionsWechatPay
...
------------ | ------------- | ------------- | -------------
**appId** | **String** | The app ID registered with WeChat Pay. Only required when client is ios or android. | [optional] 
**client** | **String** | The client type that the end customer will pay from | [optional] 
