# openapi.model.TreasuryReceivedDebitsResourceReceivedDebitList
...
------------ | ------------- | ------------- | -------------
**data** | [**List<TreasuryReceivedDebit>**](TreasuryReceivedDebit.md) | Details about each object. | [default to const []]
