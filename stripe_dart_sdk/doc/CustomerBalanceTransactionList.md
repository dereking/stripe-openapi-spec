# openapi.model.CustomerBalanceTransactionList
...
------------ | ------------- | ------------- | -------------
**data** | [**List<CustomerBalanceTransaction>**](CustomerBalanceTransaction.md) | Details about each object. | [default to const []]
