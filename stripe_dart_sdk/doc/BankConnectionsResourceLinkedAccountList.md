# openapi.model.BankConnectionsResourceLinkedAccountList
...
------------ | ------------- | ------------- | -------------
**data** | [**List<FinancialConnectionsAccount>**](FinancialConnectionsAccount.md) | Details about each object. | [default to const []]
