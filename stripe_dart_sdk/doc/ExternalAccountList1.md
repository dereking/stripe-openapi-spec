# openapi.model.ExternalAccountList1
...
------------ | ------------- | ------------- | -------------
**data** | [**List<Polymorphic>**](Polymorphic.md) | The list contains all external accounts that have been attached to the Stripe account. These may be bank accounts or cards. | [default to const []]
