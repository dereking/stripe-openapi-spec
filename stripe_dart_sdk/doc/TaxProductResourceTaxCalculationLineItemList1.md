# openapi.model.TaxProductResourceTaxCalculationLineItemList1
...
------------ | ------------- | ------------- | -------------
**data** | [**List<TaxCalculationLineItem>**](TaxCalculationLineItem.md) | Details about each object. | [default to const []]
